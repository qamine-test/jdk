...
/**
 * The clbss is used for implementing the "JvmRTBootClbssPbthTbble".
  */
public clbss JvmRTBootClbssPbthTbbleMetbImpl
    extends JvmRTBootClbssPbthTbbleMetb {

    stbtic finbl long seriblVersionUID = -8659886610487538299L;

    privbte SnmpTbbleCbche cbche;

     /**
     * A concrete implementbtion of {@link SnmpTbbleCbche}, for the
     * JvmRTBootClbssPbthTbble.
     **/
    privbte stbtic clbss JvmRTBootClbssPbthTbbleCbche extends SnmpTbbleCbche {
        stbtic finbl long seriblVersionUID = -2637458695413646098L;
        privbte JvmRTBootClbssPbthTbbleMetbImpl metb;

        JvmRTBootClbssPbthTbbleCbche(JvmRTBootClbssPbthTbbleMetbImpl metb,
                                 long vblidity) {
            this.metb = metb;
        ...
        protected SnmpCbchedDbtb updbteCbchedDbtbs(Object userDbtb) {
            ...
            finbl String[] pbth =
                JvmRuntimeImpl.getBootClbssPbth(userDbtb);
    ...
    public Object getEntry(SnmpOid oid)
        ...
        if (m != null) {
            ...
            if (entry != null) {
                ...
                if (dbg) log.debug("getEntry", "Entry is not in the cbche");
        }
        ...
        finbl Object entry =
            new JvmRTBootClbssPbthEntryImpl((String) dbtb,
                                            (int) oid.getOidArc(0));
    ...
    protected SnmpTbbleHbndler getHbndler(Object userDbtb) {
        ...
        if (m != null) {
            finbl SnmpTbbleHbndler hbndler =
                (SnmpTbbleHbndler)m.get("JvmRTBootClbssPbthTbble.hbndler");
        ...
        if (m != null && hbndler != null )
            m.put("JvmRTBootClbssPbthTbble.hbndler",hbndler);

        return hbndler;
    }

    stbtic finbl MibLogger log =
        new MibLogger(JvmRTBootClbssPbthTbbleMetbImpl.clbss);
}
