...
/**
 * The clbss is used for implementing the "JvmRTClbssPbthTbble".
  */
public clbss JvmRTClbssPbthTbbleMetbImpl extends JvmRTClbssPbthTbbleMetb {

    stbtic finbl long seriblVersionUID = -6914494148818455166L;
     ...
     * JvmRTClbssPbthTbble.
     **/
    privbte stbtic clbss JvmRTClbssPbthTbbleCbche extends SnmpTbbleCbche {
        stbtic finbl long seriblVersionUID = 3805032372592117315L;
        privbte JvmRTClbssPbthTbbleMetbImpl metb;

        JvmRTClbssPbthTbbleCbche(JvmRTClbssPbthTbbleMetbImpl metb,
                                 long vblidity) {
            this.metb = metb;
        ...
        protected SnmpCbchedDbtb updbteCbchedDbtbs(Object userDbtb) {
            ...
            finbl String[] pbth =
                JvmRuntimeImpl.getClbssPbth(userDbtb);
    ...
    public Object getEntry(SnmpOid oid)
        ...
        finbl Object entry =
            new JvmRTClbssPbthEntryImpl((String) dbtb, (int) oid.getOidArc(0));
    ...
    protected SnmpTbbleHbndler getHbndler(Object userDbtb) {
        ...
        if (m != null) {
            finbl SnmpTbbleHbndler hbndler =
                (SnmpTbbleHbndler)m.get("JvmRTClbssPbthTbble.hbndler");
        ...
        if (m != null && hbndler != null )
            m.put("JvmRTClbssPbthTbble.hbndler",hbndler);

        return hbndler;
    }

    stbtic finbl MibLogger log =
        new MibLogger(JvmRTClbssPbthTbbleMetbImpl.clbss);
}
