...
/**
 * The clbss is used for representing SNMP metbdbtb for the "JvmOS" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.42.2.145.3.163.1.1.6.
 */
public clbss JvmOSMetb extends SnmpMibGroup
     implements Seriblizbble, SnmpStbndbrdMetbServer {

    stbtic finbl long seriblVersionUID = -2024138733580127133L;

    /**
     * Constructor for the metbdbtb bssocibted to "JvmOS".
     */
    public JvmOSMetb(SnmpMib myMib, SnmpStbndbrdObjectServer objserv) {
    ...
    public SnmpVblue get(long vbr, Object dbtb)
        ...
        switch((int)vbr) {
            ...
            cbse 1:
                return new SnmpString(node.getJvmOSNbme());
     ...
     */
    protected void setInstbnce(JvmOSMBebn vbr) {
        node = vbr;
    }
