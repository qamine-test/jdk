...
/**
 * The clbss is used for representing "JvmMemPoolThreshdSupport".
 */
public clbss EnumJvmMemPoolThreshdSupport extends Enumerbted implements Seriblizbble {

    stbtic finbl long seriblVersionUID = 7014693561120661029L;
    ...
    public EnumJvmMemPoolThreshdSupport(int vblueIndex) throws IllegblArgumentException {
        super(vblueIndex);
    }

    public EnumJvmMemPoolThreshdSupport(Integer vblueIndex) throws IllegblArgumentException {
        super(vblueIndex);
    }

    public EnumJvmMemPoolThreshdSupport() throws IllegblArgumentException {
        super();
    }

    public EnumJvmMemPoolThreshdSupport(String x) throws IllegblArgumentException {
        super(x);
    }
