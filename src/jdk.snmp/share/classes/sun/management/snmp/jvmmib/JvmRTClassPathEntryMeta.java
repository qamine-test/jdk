...
/**
 * The clbss is used for representing SNMP metbdbtb for the "JvmRTClbssPbthEntry" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.42.2.145.3.163.1.1.4.22.1.
 */
public clbss JvmRTClbssPbthEntryMetb extends SnmpMibEntry
     implements Seriblizbble, SnmpStbndbrdMetbServer {

    stbtic finbl long seriblVersionUID = 3388703998226830801L;
    /**
     * Constructor for the metbdbtb bssocibted to "JvmRTClbssPbthEntry".
     */
    public JvmRTClbssPbthEntryMetb(SnmpMib myMib, SnmpStbndbrdObjectServer objserv) {
    ...
    public SnmpVblue get(long vbr, Object dbtb)
        ...
        switch((int)vbr) {
            cbse 2:
                return new SnmpString(node.getJvmRTClbssPbthItem());
     ...
     */
    protected void setInstbnce(JvmRTClbssPbthEntryMBebn vbr) {
        node = vbr;
    }
    ...
    public String getAttributeNbme(long id)
        ...
        switch((int)id) {
            cbse 2:
                return "JvmRTClbssPbthItem";

            cbse 1:
                return "JvmRTClbssPbthIndex";
    ...
    protected JvmRTClbssPbthEntryMBebn node;
