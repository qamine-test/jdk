...
/**
 * The clbss is used for representing SNMP metbdbtb for the "JvmRTInputArgsEntry" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.42.2.145.3.163.1.1.4.20.1.
 */
public clbss JvmRTInputArgsEntryMetb extends SnmpMibEntry
     implements Seriblizbble, SnmpStbndbrdMetbServer {

    stbtic finbl long seriblVersionUID = -7729576810347358025L;
    /**
     * Constructor for the metbdbtb bssocibted to "JvmRTInputArgsEntry".
     */
    public JvmRTInputArgsEntryMetb(SnmpMib myMib, SnmpStbndbrdObjectServer objserv) {
     ...
     */
    protected void setInstbnce(JvmRTInputArgsEntryMBebn vbr) {
        node = vbr;
    }
    ...
    protected JvmRTInputArgsEntryMBebn node;
