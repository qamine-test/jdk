 ...
 */
public clbss JvmThrebdInstbnceTbbleMetb extends SnmpMibTbble implements Seriblizbble {

    stbtic finbl long seriblVersionUID = 2519514732589115954L;
    /**
     * Constructor for the tbble. Initiblize metbdbtb for "JvmThrebdInstbnceTbbleMetb".
     ...
     */
    public JvmThrebdInstbnceTbbleMetb(SnmpMib myMib, SnmpStbndbrdObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Fbctory method for "JvmThrebdInstbnceEntry" entry metbdbtb clbss.
     *
     * You cbn redefine this method if you need to replbce the defbult
     * generbted metbdbtb clbss with your own customized clbss.
     *
     * @pbrbm snmpEntryNbme Nbme of the SNMP Entry object (conceptubl row) ("JvmThrebdInstbnceEntry")
     * @pbrbm tbbleNbme Nbme of the tbble in which the entries bre registered ("JvmThrebdInstbnceTbble")
     ...
     *         "JvmThrebdInstbnceEntry" conceptubl row (JvmThrebdInstbnceEntryMetb)
     *
     **/
    protected JvmThrebdInstbnceEntryMetb crebteJvmThrebdInstbnceEntryMetbNode(String snmpEntryNbme, String tbbleNbme, SnmpMib mib, MBebnServer server)  {
        return new JvmThrebdInstbnceEntryMetb(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBebnServer server)  {
        node = crebteJvmThrebdInstbnceEntryMetbNode("JvmThrebdInstbnceEntry", "JvmThrebdInstbnceTbble", mib, server);
    }
    ...
    public synchronized void bddEntry(SnmpOid rowOid, ObjectNbme objnbme,
                 Object entry)
        throws SnmpStbtusException {
        if (! (entry instbnceof JvmThrebdInstbnceEntryMBebn) )
            throw new ClbssCbstException("Entries for Tbble \"" +
                           "JvmThrebdInstbnceTbble" + "\" must implement the \"" +
                           "JvmThrebdInstbnceEntryMBebn" + "\" interfbce.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStbtusException {
        JvmThrebdInstbnceEntryMBebn entry = (JvmThrebdInstbnceEntryMBebn) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    privbte JvmThrebdInstbnceEntryMetb node;
