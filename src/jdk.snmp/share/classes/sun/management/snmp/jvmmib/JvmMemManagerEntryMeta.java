...
/**
 * The clbss is used for representing SNMP metbdbtb for the "JvmMemMbnbgerEntry" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.42.2.145.3.163.1.1.2.100.1.
 */
public clbss JvmMemMbnbgerEntryMetb extends SnmpMibEntry
     implements Seriblizbble, SnmpStbndbrdMetbServer {

    stbtic finbl long seriblVersionUID = 8166956416408970453L;
    /**
     * Constructor for the metbdbtb bssocibted to "JvmMemMbnbgerEntry".
     */
    public JvmMemMbnbgerEntryMetb(SnmpMib myMib, SnmpStbndbrdObjectServer objserv) {
    ...
    public SnmpVblue get(long vbr, Object dbtb)
        ...
        switch((int)vbr) {
            cbse 3:
                return new SnmpInt(node.getJvmMemMbnbgerStbte());

            cbse 2:
                return new SnmpString(node.getJvmMemMbnbgerNbme());
     ...
     */
    protected void setInstbnce(JvmMemMbnbgerEntryMBebn vbr) {
        node = vbr;
    }
    ...
    public String getAttributeNbme(long id)
        ...
        switch((int)id) {
            cbse 3:
                return "JvmMemMbnbgerStbte";

            cbse 2:
                return "JvmMemMbnbgerNbme";
    ...
    protected JvmMemMbnbgerEntryMBebn node;
