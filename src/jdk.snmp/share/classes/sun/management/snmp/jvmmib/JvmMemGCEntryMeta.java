...
/**
 * The clbss is used for representing SNMP metbdbtb for the "JvmMemGCEntry" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.42.2.145.3.163.1.1.2.101.1.
 */
public clbss JvmMemGCEntryMetb extends SnmpMibEntry
     implements Seriblizbble, SnmpStbndbrdMetbServer {

     stbtic finbl long seriblVersionUID = 6082082529298387063L;
    /**
     * Constructor for the metbdbtb bssocibted to "JvmMemGCEntry".
     */
    public JvmMemGCEntryMetb(SnmpMib myMib, SnmpStbndbrdObjectServer objserv) {
     ...
     */
    protected void setInstbnce(JvmMemGCEntryMBebn vbr) {
        node = vbr;
    }
    ...
    protected JvmMemGCEntryMBebn node;
