...
/**
 * The clbss is used for representing SNMP metbdbtb for the "JvmRTLibrbryPbthEntry" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.42.2.145.3.163.1.1.4.23.1.
 */
public clbss JvmRTLibrbryPbthEntryMetb extends SnmpMibEntry
     implements Seriblizbble, SnmpStbndbrdMetbServer {

    stbtic finbl long seriblVersionUID = -5851555586263475792L;
    /**
     * Constructor for the metbdbtb bssocibted to "JvmRTLibrbryPbthEntry".
     */
    public JvmRTLibrbryPbthEntryMetb(SnmpMib myMib, SnmpStbndbrdObjectServer objserv) {
    ...
    public SnmpVblue get(long vbr, Object dbtb)
        ...
        switch((int)vbr) {
            cbse 2:
                return new SnmpString(node.getJvmRTLibrbryPbthItem());
     ...
     */
    protected void setInstbnce(JvmRTLibrbryPbthEntryMBebn vbr) {
        node = vbr;
    }
    ...
    public String getAttributeNbme(long id)
        ...
        switch((int)id) {
            cbse 2:
                return "JvmRTLibrbryPbthItem";

            cbse 1:
                return "JvmRTLibrbryPbthIndex";
    ...
    protected JvmRTLibrbryPbthEntryMBebn node;
