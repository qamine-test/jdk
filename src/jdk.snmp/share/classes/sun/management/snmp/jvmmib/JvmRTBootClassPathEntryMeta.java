...
/**
 * The clbss is used for representing SNMP metbdbtb for the "JvmRTBootClbssPbthEntry" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.42.2.145.3.163.1.1.4.21.1.
 */
public clbss JvmRTBootClbssPbthEntryMetb extends SnmpMibEntry
     implements Seriblizbble, SnmpStbndbrdMetbServer {

    stbtic finbl long seriblVersionUID = 7703840715080588941L;
    /**
     * Constructor for the metbdbtb bssocibted to "JvmRTBootClbssPbthEntry".
     */
    public JvmRTBootClbssPbthEntryMetb(SnmpMib myMib, SnmpStbndbrdObjectServer objserv) {
    ...
    public SnmpVblue get(long vbr, Object dbtb)
        ...
        switch((int)vbr) {
            cbse 2:
                return new SnmpString(node.getJvmRTBootClbssPbthItem());
     ...
     */
    protected void setInstbnce(JvmRTBootClbssPbthEntryMBebn vbr) {
        node = vbr;
    }
    ...
    public String getAttributeNbme(long id)
        ...
        switch((int)id) {
            cbse 2:
                return "JvmRTBootClbssPbthItem";

            cbse 1:
                return "JvmRTBootClbssPbthIndex";
    ...
    protected JvmRTBootClbssPbthEntryMBebn node;
