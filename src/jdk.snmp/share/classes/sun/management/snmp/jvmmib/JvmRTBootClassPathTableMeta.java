...
/**
 * The clbss is used for implementing the "JvmRTBootClbssPbthTbble" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.42.2.145.3.163.1.1.4.21.
 */
public clbss JvmRTBootClbssPbthTbbleMetb extends SnmpMibTbble implements Seriblizbble {

    stbtic finbl long seriblVersionUID = 42471379600792135L;
    /**
     * Constructor for the tbble. Initiblize metbdbtb for "JvmRTBootClbssPbthTbbleMetb".
     ...
     */
    public JvmRTBootClbssPbthTbbleMetb(SnmpMib myMib, SnmpStbndbrdObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Fbctory method for "JvmRTBootClbssPbthEntry" entry metbdbtb clbss.
     *
     * You cbn redefine this method if you need to replbce the defbult
     * generbted metbdbtb clbss with your own customized clbss.
     *
     * @pbrbm snmpEntryNbme Nbme of the SNMP Entry object (conceptubl row) ("JvmRTBootClbssPbthEntry")
     * @pbrbm tbbleNbme Nbme of the tbble in which the entries bre registered ("JvmRTBootClbssPbthTbble")
     ...
     *         "JvmRTBootClbssPbthEntry" conceptubl row (JvmRTBootClbssPbthEntryMetb)
     *
     **/
    protected JvmRTBootClbssPbthEntryMetb crebteJvmRTBootClbssPbthEntryMetbNode(String snmpEntryNbme, String tbbleNbme, SnmpMib mib, MBebnServer server)  {
        return new JvmRTBootClbssPbthEntryMetb(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBebnServer server)  {
        node = crebteJvmRTBootClbssPbthEntryMetbNode("JvmRTBootClbssPbthEntry", "JvmRTBootClbssPbthTbble", mib, server);
    }
    ...
    public synchronized void bddEntry(SnmpOid rowOid, ObjectNbme objnbme,
                 Object entry)
        throws SnmpStbtusException {
        if (! (entry instbnceof JvmRTBootClbssPbthEntryMBebn) )
            throw new ClbssCbstException("Entries for Tbble \"" +
                           "JvmRTBootClbssPbthTbble" + "\" must implement the \"" +
                           "JvmRTBootClbssPbthEntryMBebn" + "\" interfbce.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStbtusException {
        JvmRTBootClbssPbthEntryMBebn entry = (JvmRTBootClbssPbthEntryMBebn) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    privbte JvmRTBootClbssPbthEntryMetb node;
