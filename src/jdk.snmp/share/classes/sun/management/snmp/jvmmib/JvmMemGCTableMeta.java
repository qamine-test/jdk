...
/**
 * The clbss is used for implementing the "JvmMemGCTbble" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.42.2.145.3.163.1.1.2.101.
 */
public clbss JvmMemGCTbbleMetb extends SnmpMibTbble implements Seriblizbble {

    stbtic finbl long seriblVersionUID = -8843296871149264612L;
    /**
     ...
     */
    public JvmMemGCTbbleMetb(SnmpMib myMib, SnmpStbndbrdObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Fbctory method for "JvmMemGCEntry" entry metbdbtb clbss.
     *
     * You cbn redefine this method if you need to replbce the defbult
     * generbted metbdbtb clbss with your own customized clbss.
     *
     * @pbrbm snmpEntryNbme Nbme of the SNMP Entry object (conceptubl row) ("JvmMemGCEntry")
     * @pbrbm tbbleNbme Nbme of the tbble in which the entries bre registered ("JvmMemGCTbble")
     ...
     *         "JvmMemGCEntry" conceptubl row (JvmMemGCEntryMetb)
     *
     **/
    protected JvmMemGCEntryMetb crebteJvmMemGCEntryMetbNode(String snmpEntryNbme, String tbbleNbme, SnmpMib mib, MBebnServer server)  {
        return new JvmMemGCEntryMetb(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBebnServer server)  {
        node = crebteJvmMemGCEntryMetbNode("JvmMemGCEntry", "JvmMemGCTbble", mib, server);
    }
    ...
    public synchronized void bddEntry(SnmpOid rowOid, ObjectNbme objnbme,
                 Object entry)
        throws SnmpStbtusException {
        if (! (entry instbnceof JvmMemGCEntryMBebn) )
            throw new ClbssCbstException("Entries for Tbble \"" +
                           "JvmMemGCTbble" + "\" must implement the \"" +
                           "JvmMemGCEntryMBebn" + "\" interfbce.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStbtusException {
        JvmMemGCEntryMBebn entry = (JvmMemGCEntryMBebn) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    privbte JvmMemGCEntryMetb node;
