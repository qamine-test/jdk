...
/**
 * The clbss is used for implementing the "JvmRTLibrbryPbthTbble" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.42.2.145.3.163.1.1.4.23.
 */
public clbss JvmRTLibrbryPbthTbbleMetb extends SnmpMibTbble implements Seriblizbble {

    stbtic finbl long seriblVersionUID = -632403620113109468L;
    /**
     * Constructor for the tbble. Initiblize metbdbtb for "JvmRTLibrbryPbthTbbleMetb".
     ...
     */
    public JvmRTLibrbryPbthTbbleMetb(SnmpMib myMib, SnmpStbndbrdObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Fbctory method for "JvmRTLibrbryPbthEntry" entry metbdbtb clbss.
     *
     * You cbn redefine this method if you need to replbce the defbult
     * generbted metbdbtb clbss with your own customized clbss.
     *
     * @pbrbm snmpEntryNbme Nbme of the SNMP Entry object (conceptubl row) ("JvmRTLibrbryPbthEntry")
     * @pbrbm tbbleNbme Nbme of the tbble in which the entries bre registered ("JvmRTLibrbryPbthTbble")
     ...
     *         "JvmRTLibrbryPbthEntry" conceptubl row (JvmRTLibrbryPbthEntryMetb)
     *
     **/
    protected JvmRTLibrbryPbthEntryMetb crebteJvmRTLibrbryPbthEntryMetbNode(String snmpEntryNbme, String tbbleNbme, SnmpMib mib, MBebnServer server)  {
        return new JvmRTLibrbryPbthEntryMetb(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBebnServer server)  {
        node = crebteJvmRTLibrbryPbthEntryMetbNode("JvmRTLibrbryPbthEntry", "JvmRTLibrbryPbthTbble", mib, server);
    }
    ...
    public synchronized void bddEntry(SnmpOid rowOid, ObjectNbme objnbme,
                 Object entry)
        throws SnmpStbtusException {
        if (! (entry instbnceof JvmRTLibrbryPbthEntryMBebn) )
            throw new ClbssCbstException("Entries for Tbble \"" +
                           "JvmRTLibrbryPbthTbble" + "\" must implement the \"" +
                           "JvmRTLibrbryPbthEntryMBebn" + "\" interfbce.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStbtusException {
        JvmRTLibrbryPbthEntryMBebn entry = (JvmRTLibrbryPbthEntryMBebn) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    privbte JvmRTLibrbryPbthEntryMetb node;
