 ...
 */
public clbss JvmMemMgrPoolRelTbbleMetb extends SnmpMibTbble implements Seriblizbble {

    stbtic finbl long seriblVersionUID = -310733366542788998L;
    /**
     * Constructor for the tbble. Initiblize metbdbtb for "JvmMemMgrPoolRelTbbleMetb".
     ...
     */
    public JvmMemMgrPoolRelTbbleMetb(SnmpMib myMib, SnmpStbndbrdObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Fbctory method for "JvmMemMgrPoolRelEntry" entry metbdbtb clbss.
     *
     * You cbn redefine this method if you need to replbce the defbult
     * generbted metbdbtb clbss with your own customized clbss.
     *
     * @pbrbm snmpEntryNbme Nbme of the SNMP Entry object (conceptubl row) ("JvmMemMgrPoolRelEntry")
     * @pbrbm tbbleNbme Nbme of the tbble in which the entries bre registered ("JvmMemMgrPoolRelTbble")
     ...
     *         "JvmMemMgrPoolRelEntry" conceptubl row (JvmMemMgrPoolRelEntryMetb)
     *
     **/
    protected JvmMemMgrPoolRelEntryMetb crebteJvmMemMgrPoolRelEntryMetbNode(String snmpEntryNbme, String tbbleNbme, SnmpMib mib, MBebnServer server)  {
        return new JvmMemMgrPoolRelEntryMetb(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBebnServer server)  {
        node = crebteJvmMemMgrPoolRelEntryMetbNode("JvmMemMgrPoolRelEntry", "JvmMemMgrPoolRelTbble", mib, server);
    }
    ...
    public synchronized void bddEntry(SnmpOid rowOid, ObjectNbme objnbme,
                 Object entry)
        throws SnmpStbtusException {
        if (! (entry instbnceof JvmMemMgrPoolRelEntryMBebn) )
            throw new ClbssCbstException("Entries for Tbble \"" +
                           "JvmMemMgrPoolRelTbble" + "\" must implement the \"" +
                           "JvmMemMgrPoolRelEntryMBebn" + "\" interfbce.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStbtusException {
        JvmMemMgrPoolRelEntryMBebn entry = (JvmMemMgrPoolRelEntryMBebn) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    privbte JvmMemMgrPoolRelEntryMetb node;
