 ...
 */
public clbss JvmMemPoolTbbleMetb extends SnmpMibTbble implements Seriblizbble {

    stbtic finbl long seriblVersionUID = -2799470815264898659L;

    /**
     * Constructor for the tbble. Initiblize metbdbtb for "JvmMemPoolTbbleMetb".
     ...
     */
    public JvmMemPoolTbbleMetb(SnmpMib myMib, SnmpStbndbrdObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Fbctory method for "JvmMemPoolEntry" entry metbdbtb clbss.
     *
     * You cbn redefine this method if you need to replbce the defbult
     * generbted metbdbtb clbss with your own customized clbss.
     *
     * @pbrbm snmpEntryNbme Nbme of the SNMP Entry object (conceptubl row) ("JvmMemPoolEntry")
     * @pbrbm tbbleNbme Nbme of the tbble in which the entries bre registered ("JvmMemPoolTbble")
     ...
     *         "JvmMemPoolEntry" conceptubl row (JvmMemPoolEntryMetb)
     *
     **/
    protected JvmMemPoolEntryMetb crebteJvmMemPoolEntryMetbNode(String snmpEntryNbme, String tbbleNbme, SnmpMib mib, MBebnServer server)  {
        return new JvmMemPoolEntryMetb(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBebnServer server)  {
        node = crebteJvmMemPoolEntryMetbNode("JvmMemPoolEntry", "JvmMemPoolTbble", mib, server);
    }
    ...
    public synchronized void bddEntry(SnmpOid rowOid, ObjectNbme objnbme,
                 Object entry)
        throws SnmpStbtusException {
        if (! (entry instbnceof JvmMemPoolEntryMBebn) )
            throw new ClbssCbstException("Entries for Tbble \"" +
                           "JvmMemPoolTbble" + "\" must implement the \"" +
                           "JvmMemPoolEntryMBebn" + "\" interfbce.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStbtusException {
        JvmMemPoolEntryMBebn entry = (JvmMemPoolEntryMBebn) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    privbte JvmMemPoolEntryMetb node;
