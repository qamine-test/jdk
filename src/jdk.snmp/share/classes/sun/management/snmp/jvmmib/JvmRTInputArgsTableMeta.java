 ...
 */
public clbss JvmRTInputArgsTbbleMetb extends SnmpMibTbble implements Seriblizbble {

    stbtic finbl long seriblVersionUID = 5395531763015738645L;
    /**
     * Constructor for the tbble. Initiblize metbdbtb for "JvmRTInputArgsTbbleMetb".
     ...
     */
    public JvmRTInputArgsTbbleMetb(SnmpMib myMib, SnmpStbndbrdObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Fbctory method for "JvmRTInputArgsEntry" entry metbdbtb clbss.
     *
     * You cbn redefine this method if you need to replbce the defbult
     * generbted metbdbtb clbss with your own customized clbss.
     *
     * @pbrbm snmpEntryNbme Nbme of the SNMP Entry object (conceptubl row) ("JvmRTInputArgsEntry")
     * @pbrbm tbbleNbme Nbme of the tbble in which the entries bre registered ("JvmRTInputArgsTbble")
     ...
     *         "JvmRTInputArgsEntry" conceptubl row (JvmRTInputArgsEntryMetb)
     *
     **/
    protected JvmRTInputArgsEntryMetb crebteJvmRTInputArgsEntryMetbNode(String snmpEntryNbme, String tbbleNbme, SnmpMib mib, MBebnServer server)  {
        return new JvmRTInputArgsEntryMetb(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBebnServer server)  {
        node = crebteJvmRTInputArgsEntryMetbNode("JvmRTInputArgsEntry", "JvmRTInputArgsTbble", mib, server);
    }
    ...
    public synchronized void bddEntry(SnmpOid rowOid, ObjectNbme objnbme,
                 Object entry)
        throws SnmpStbtusException {
        if (! (entry instbnceof JvmRTInputArgsEntryMBebn) )
            throw new ClbssCbstException("Entries for Tbble \"" +
                           "JvmRTInputArgsTbble" + "\" must implement the \"" +
                           "JvmRTInputArgsEntryMBebn" + "\" interfbce.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStbtusException {
        JvmRTInputArgsEntryMBebn entry = (JvmRTInputArgsEntryMBebn) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    privbte JvmRTInputArgsEntryMetb node;
