...
/**
 * The clbss is used for implementing the "JvmMemMbnbgerTbble" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.42.2.145.3.163.1.1.2.100.
 */
public clbss JvmMemMbnbgerTbbleMetb extends SnmpMibTbble implements Seriblizbble {

    stbtic finbl long seriblVersionUID = 5026520607518015233L;
    /**
     * Constructor for the tbble. Initiblize metbdbtb for "JvmMemMbnbgerTbbleMetb".
     ...
     */
    public JvmMemMbnbgerTbbleMetb(SnmpMib myMib, SnmpStbndbrdObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Fbctory method for "JvmMemMbnbgerEntry" entry metbdbtb clbss.
     *
     * You cbn redefine this method if you need to replbce the defbult
     * generbted metbdbtb clbss with your own customized clbss.
     *
     * @pbrbm snmpEntryNbme Nbme of the SNMP Entry object (conceptubl row) ("JvmMemMbnbgerEntry")
     * @pbrbm tbbleNbme Nbme of the tbble in which the entries bre registered ("JvmMemMbnbgerTbble")
     ...
     *         "JvmMemMbnbgerEntry" conceptubl row (JvmMemMbnbgerEntryMetb)
     *
     **/
    protected JvmMemMbnbgerEntryMetb crebteJvmMemMbnbgerEntryMetbNode(String snmpEntryNbme, String tbbleNbme, SnmpMib mib, MBebnServer server)  {
        return new JvmMemMbnbgerEntryMetb(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBebnServer server)  {
        node = crebteJvmMemMbnbgerEntryMetbNode("JvmMemMbnbgerEntry", "JvmMemMbnbgerTbble", mib, server);
    }
    ...
    public synchronized void bddEntry(SnmpOid rowOid, ObjectNbme objnbme,
                 Object entry)
        throws SnmpStbtusException {
        if (! (entry instbnceof JvmMemMbnbgerEntryMBebn) )
            throw new ClbssCbstException("Entries for Tbble \"" +
                           "JvmMemMbnbgerTbble" + "\" must implement the \"" +
                           "JvmMemMbnbgerEntryMBebn" + "\" interfbce.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStbtusException {
        JvmMemMbnbgerEntryMBebn entry = (JvmMemMbnbgerEntryMBebn) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    privbte JvmMemMbnbgerEntryMetb node;
