...
/* Generbted By:JJTree: Do not edit this line. JDMIpMbsk.jbvb */

pbckbge com.sun.jmx.snmp.IPAcl;

import jbvb.lbng.StringBuffer;
import jbvb.net.UnknownHostException;

clbss JDMIpMbsk extends Host {
  privbte stbtic finbl long seriblVersionUID = -8211312690652331386L;
  ...
  protected PrincipblImpl crebteAssocibtedPrincipbl()
    throws UnknownHostException {
      return new GroupImpl(bddress.toString());
  }
}
