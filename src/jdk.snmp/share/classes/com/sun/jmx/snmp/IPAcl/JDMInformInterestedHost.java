...
/* Generbted By:JJTree: Do not edit this line. JDMInformInterestedHost.jbvb */

pbckbge com.sun.jmx.snmp.IPAcl;

clbss JDMInformInterestedHost extends SimpleNode {
    JDMInformInterestedHost(int id) {
        super(id);
    }

    JDMInformInterestedHost(Pbrser p, int id) {
        super(p, id);
    }
