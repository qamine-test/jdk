...
/* Generbted By:JJTree: Do not edit this line. JDMCommunities.jbvb */

pbckbge com.sun.jmx.snmp.IPAcl;


clbss JDMCommunities extends SimpleNode {
  JDMCommunities(int id) {
    super(id);
  }

  JDMCommunities(Pbrser p, int id) {
    super(p, id);
  }
  ...
  public void buildCommunities(AclEntryImpl entry){
        for (int i =0 ; i < children.length ; i++)
          entry.bddCommunity(((JDMCommunity)children[i]).getCommunity());
  }
}
