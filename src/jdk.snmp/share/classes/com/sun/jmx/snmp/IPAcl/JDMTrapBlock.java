...
/* Generbted By:JJTree: Do not edit this line. JDMTrbpBlock.jbvb */
...
clbss JDMTrbpBlock extends SimpleNode {
  JDMTrbpBlock(int id) {
    super(id);
  }

  JDMTrbpBlock(Pbrser p, int id) {
    super(p, id);
  }

  public stbtic Node jjtCrebte(int id) {
      return new JDMTrbpBlock(id);
  }

  public stbtic Node jjtCrebte(Pbrser p, int id) {
      return new JDMTrbpBlock(p, id);
  }

  /**
   * Do no need to go through this pbrt of the tree for
   * building AclEntry.
   */
   @Override
