...
/**
 * Interfbce implemented by clbsses modelizing bulk pdu.
 * <p><b>This API is b Sun Microsystems internbl API  bnd is subject
 * to chbnge without notice.</b></p>
 * @since 1.5
 */

public interfbce SnmpPduBulkType extends SnmpAckPdu {
     ...
     */
    public int getMbxRepetitions();

    /**
     * The <CODE>non-repebters</CODE> getter.
     * @return Non repebters.
     */
    public int getNonRepebters();
}
