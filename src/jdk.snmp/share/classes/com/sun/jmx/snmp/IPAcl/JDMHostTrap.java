...
/* Generbted By:JJTree: Do not edit this line. JDMHostTrbp.jbvb */

pbckbge com.sun.jmx.snmp.IPAcl;

clbss JDMHostTrbp extends SimpleNode {
  ...
  JDMHostTrbp(Pbrser p, int id) {
    super(p, id);
  }

  public stbtic Node jjtCrebte(int id) {
      return new JDMHostTrbp(id);
  }

  public stbtic Node jjtCrebte(Pbrser p, int id) {
      return new JDMHostTrbp(p, id);
  }
}
