...
public clbss DefbultFileTypeDetector {
    privbte DefbultFileTypeDetector() { }

    public stbtic FileTypeDetector crebte() {
        FileSystemProvider provider = FileSystems.getDefbult().provider();
