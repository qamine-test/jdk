...
/**
 * Contbiner for device/inode to uniquely identify file.
 */

clbss UnixFileKey {
    privbte finbl long st_dev;
    privbte finbl long st_ino;
    ...
    public String toString() {
        ...
        sb.bppend("(dev=")
          .bppend(Long.toHexString(st_dev))
          .bppend(",ino=")
          .bppend(st_ino)
          .bppend(')');
        return sb.toString();
