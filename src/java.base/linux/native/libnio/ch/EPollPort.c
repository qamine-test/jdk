...
Jbvb_sun_nio_ch_EPollPort_socketpbir(JNIEnv* env, jclbss clbzz, jintArrby sv) {
    int sp[2];
...
JNIEXPORT void JNICALL
Jbvb_sun_nio_ch_EPollPort_interrupt(JNIEnv *env, jclbss c, jint fd) {
    int res;
    int buf[1];
    buf[0] = 1;
...
JNIEXPORT void JNICALL
Jbvb_sun_nio_ch_EPollPort_drbin1(JNIEnv *env, jclbss cl, jint fd) {
    int res;
    chbr buf[1];
...
JNIEXPORT void JNICALL
Jbvb_sun_nio_ch_EPollPort_close0(JNIEnv *env, jclbss c, jint fd) {
    int res;
