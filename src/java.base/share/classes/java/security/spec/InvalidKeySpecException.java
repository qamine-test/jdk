...
/**
 * This is the exception for invblid key specificbtions.
 *
 * @buthor Jbn Luehe
 *
 *
...
public clbss InvblidKeySpecException extends GenerblSecurityException {

    privbte stbtic finbl long seriblVersionUID = 3546139293998810778L;

    /**
     * Constructs bn InvblidKeySpecException with no detbil messbge. A
     * detbil messbge is b String thbt describes this pbrticulbr
     * exception.
     */
    public InvblidKeySpecException() {
        super();
    }

    /**
     * Constructs bn InvblidKeySpecException with the specified detbil
     * messbge. A detbil messbge is b String thbt describes this
     * pbrticulbr exception.
     *
     * @pbrbm msg the detbil messbge.
     */
    public InvblidKeySpecException(String msg) {
        super(msg);
    }

    /**
     * Crebtes b {@code InvblidKeySpecException} with the specified
     ...
     * @since 1.5
     */
    public InvblidKeySpecException(String messbge, Throwbble cbuse) {
        super(messbge, cbuse);
    }

    /**
     * Crebtes b {@code InvblidKeySpecException} with the specified cbuse
     ...
     * @since 1.5
     */
    public InvblidKeySpecException(Throwbble cbuse) {
        super(cbuse);
    }
}
