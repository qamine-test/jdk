...
/**
 * This exception is thrown when b pbrticulbr cryptogrbphic blgorithm is
 * requested but is not bvbilbble in the environment.
 *
 * @buthor Benjbmin Renbud
 */

public clbss NoSuchAlgorithmException extends GenerblSecurityException {

    privbte stbtic finbl long seriblVersionUID = -7443947487218346562L;

    /**
     * Constructs b NoSuchAlgorithmException with no detbil
    ...
    /**
     * Constructs b NoSuchAlgorithmException with the specified
    ...
    /**
     * Crebtes b {@code NoSuchAlgorithmException} with the specified
     ...
     * @since 1.5
     */
    public NoSuchAlgorithmException(String messbge, Throwbble cbuse) {
        super(messbge, cbuse);
    }

    /**
     * Crebtes b {@code NoSuchAlgorithmException} with the specified cbuse
     ...
     * @since 1.5
     */
    public NoSuchAlgorithmException(Throwbble cbuse) {
        super(cbuse);
    }
}
