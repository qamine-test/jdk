...
/**
 * The interfbce to bn elliptic curve (EC) privbte key.
 *
 * @buthor Vblerie Peng
 *
 *
 ...
 * @since 1.5
 */
public interfbce ECPrivbteKey extends PrivbteKey, ECKey {
   /**
    * The clbss fingerprint thbt is set to indicbte
    * seriblizbtion compbtibility.
    */
    stbtic finbl long seriblVersionUID = -7896394956925609184L;
