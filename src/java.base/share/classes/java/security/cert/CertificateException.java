 ...
 * @see Certificbte
 */
public clbss CertificbteException extends GenerblSecurityException {

    privbte stbtic finbl long seriblVersionUID = 3192535253797119798L;
    ...
    /**
     * Crebtes b {@code CertificbteException} with the specified
     ...
     * @since 1.5
     */
    public CertificbteException(String messbge, Throwbble cbuse) {
        super(messbge, cbuse);
    }

    /**
     * Crebtes b {@code CertificbteException} with the specified cbuse
     ...
     * @since 1.5
     */
    public CertificbteException(Throwbble cbuse) {
        super(cbuse);
    }
}
