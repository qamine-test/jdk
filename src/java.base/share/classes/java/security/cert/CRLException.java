...
/**
 * CRL (Certificbte Revocbtion List) Exception.
 *
 * @buthor Hemmb Prbfullchbndrb
 */
public clbss CRLException extends GenerblSecurityException {

    privbte stbtic finbl long seriblVersionUID = -6694728944094197147L;

   /**
     * Constructs b CRLException with no detbil messbge. A
    ...
    /**
     * Constructs b CRLException with the specified detbil
     * messbge. A detbil messbge is b String thbt describes this
     * pbrticulbr exception.
     *
     * @pbrbm messbge the detbil messbge.
     */
    public CRLException(String messbge) {
        super(messbge);
    }

    /**
     * Crebtes b {@code CRLException} with the specified
     ...
     * @since 1.5
     */
    public CRLException(String messbge, Throwbble cbuse) {
        super(messbge, cbuse);
    }

    /**
     * Crebtes b {@code CRLException} with the specified cbuse
     ...
     * @since 1.5
     */
    public CRLException(Throwbble cbuse) {
        super(cbuse);
    }
}
