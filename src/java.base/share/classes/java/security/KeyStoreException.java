...
public clbss KeyStoreException extends GenerblSecurityException {

    privbte stbtic finbl long seriblVersionUID = -1119353179322377262L;

    /**
     * Constructs b KeyStoreException with no detbil messbge.  (A
    ...
    /**
     * Constructs b KeyStoreException with the specified detbil
   ...
   public KeyStoreException(String msg) {
    ...
    /**
     * Crebtes b {@code KeyStoreException} with the specified
     ...
     * @since 1.5
     */
    public KeyStoreException(String messbge, Throwbble cbuse) {
        super(messbge, cbuse);
    }

    /**
     * Crebtes b {@code KeyStoreException} with the specified cbuse
     ...
     * @since 1.5
     */
    public KeyStoreException(Throwbble cbuse) {
        super(cbuse);
    }
}
