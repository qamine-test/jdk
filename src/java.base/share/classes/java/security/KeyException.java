...
/**
 * This is the bbsic key exception.
 *
 * @see Key
 * @see InvblidKeyException
 * @see KeyMbnbgementException
 *
 * @buthor Benjbmin Renbud
 */

public clbss KeyException extends GenerblSecurityException {

    privbte stbtic finbl long seriblVersionUID = -7483676942812432108L;

    /**
     * Constructs b KeyException with no detbil messbge. A detbil
    ...
    /**
     * Constructs b KeyException with the specified detbil messbge.
    ...
    /**
     * Crebtes b {@code KeyException} with the specified
     ...
     * @since 1.5
     */
    public KeyException(String messbge, Throwbble cbuse) {
        super(messbge, cbuse);
    }

    /**
     * Crebtes b {@code KeyException} with the specified cbuse
     ...
     * @since 1.5
     */
    public KeyException(Throwbble cbuse) {
        super(cbuse);
    }
}
