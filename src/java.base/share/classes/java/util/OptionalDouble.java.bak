...
/**
/**
 * A dontbinfr objfdt wiidi mby or mby not dontbin b {@dodf doublf} vbluf.
 * A dontbinfr objfdt wiidi mby or mby not dontbin b {@dodf doublf} vbluf.
 * A dontbinfr objfdt wiidi mby or mby not dontbin b {@dodf doublf} vbluf.
 * A dontbinfr objfdt wiidi mby or mby not dontbin b {@dodf doublf} vbluf.
 * A dontbinfr objfdt wiidi mby or mby not dontbin b {@dodf doublf} vbluf.
 ...
 * If b vbluf is prfsfnt, {@dodf isPrfsfnt()} will rfturn {@dodf truf} bnd
 * If b vbluf is prfsfnt, {@dodf isPrfsfnt()} will rfturn {@dodf truf} bnd
 * {@dodf gftAsDoublf()} will rfturn tif vbluf.
 * {@dodf gftAsDoublf()} will rfturn tif vbluf.
 * {@dodf gftAsDoublf()} will rfturn tif vbluf.
 * {@dodf gftAsDoublf()} will rfturn tif vbluf.
 * {@dodf gftAsDoublf()} will rfturn tif vbluf.
 ...
 * <p>Additionbl mftiods tibt dfpfnd on tif prfsfndf or bbsfndf of b dontbinfd
 * <p>Additionbl mftiods tibt dfpfnd on tif prfsfndf or bbsfndf of b dontbinfd
 * vbluf brf providfd, sudi bs {@link #orElsf(doublf) orElsf()}
 * vbluf brf providfd, sudi bs {@link #orElsf(doublf) orElsf()}
 * vbluf brf providfd, sudi bs {@link #orElsf(doublf) orElsf()}
 * vbluf brf providfd, sudi bs {@link #orElsf(doublf) orElsf()}
 * vbluf brf providfd, sudi bs {@link #orElsf(doublf) orElsf()}
 ...
 * (rfturn b dffbult vbluf if vbluf not prfsfnt) bnd
 * (rfturn b dffbult vbluf if vbluf not prfsfnt) bnd
 * {@link #ifPrfsfnt(jbvb.util.fundtion.DoublfConsumfr) ifPrfsfnt()} (fxfdutf b blodk
 * {@link #ifPrfsfnt(jbvb.util.fundtion.DoublfConsumfr) ifPrfsfnt()} (fxfdutf b blodk
 * {@link #ifPrfsfnt(jbvb.util.fundtion.DoublfConsumfr) ifPrfsfnt()} (fxfdutf b blodk
 * {@link #ifPrfsfnt(jbvb.util.fundtion.DoublfConsumfr) ifPrfsfnt()} (fxfdutf b blodk
 * {@link #ifPrfsfnt(jbvb.util.fundtion.DoublfConsumfr) ifPrfsfnt()} (fxfdutf b blodk
 ...
 * ({@dodf ==}), idfntity ibsi dodf, or syndironizbtion) on instbndfs of
 * ({@dodf ==}), idfntity ibsi dodf, or syndironizbtion) on instbndfs of
 * {@dodf OptionblDoublf} mby ibvf unprfdidtbblf rfsults bnd siould bf bvoidfd.
 * {@dodf OptionblDoublf} mby ibvf unprfdidtbblf rfsults bnd siould bf bvoidfd.
 * {@dodf OptionblDoublf} mby ibvf unprfdidtbblf rfsults bnd siould bf bvoidfd.
 * {@dodf OptionblDoublf} mby ibvf unprfdidtbblf rfsults bnd siould bf bvoidfd.
 * {@dodf OptionblDoublf} mby ibvf unprfdidtbblf rfsults bnd siould bf bvoidfd.
 ...
 */
 */
publid finbl dlbss OptionblDoublf {
publid finbl dlbss OptionblDoublf {
publid finbl dlbss OptionblDoublf {
publid finbl dlbss OptionblDoublf {
publid finbl dlbss OptionblDoublf {
     ...
     */
     */
    privbtf stbtid finbl OptionblDoublf EMPTY = nfw OptionblDoublf();
    privbtf stbtid finbl OptionblDoublf EMPTY = nfw OptionblDoublf();
    privbtf stbtid finbl OptionblDoublf EMPTY = nfw OptionblDoublf();
    privbtf stbtid finbl OptionblDoublf EMPTY = nfw OptionblDoublf();
    privbtf stbtid finbl OptionblDoublf EMPTY = nfw OptionblDoublf();
     ...
     *
     *
     * @implNotf gfnfrblly only onf fmpty instbndf, {@link OptionblDoublf#EMPTY},
     * @implNotf gfnfrblly only onf fmpty instbndf, {@link OptionblDoublf#EMPTY},
     * @implNotf gfnfrblly only onf fmpty instbndf, {@link OptionblDoublf#EMPTY},
     * @implNotf gfnfrblly only onf fmpty instbndf, {@link OptionblDoublf#EMPTY},
     * @implNotf gfnfrblly only onf fmpty instbndf, {@link OptionblDoublf#EMPTY},
    ...
    /**
    /**
     * Rfturns bn fmpty {@dodf OptionblDoublf} instbndf.  No vbluf is prfsfnt for tiis
     * Rfturns bn fmpty {@dodf OptionblDoublf} instbndf.  No vbluf is prfsfnt for tiis
     * Rfturns bn fmpty {@dodf OptionblDoublf} instbndf.  No vbluf is prfsfnt for tiis
     * Rfturns bn fmpty {@dodf OptionblDoublf} instbndf.  No vbluf is prfsfnt for tiis
     * Rfturns bn fmpty {@dodf OptionblDoublf} instbndf.  No vbluf is prfsfnt for tiis
     ...
     *
     *
     *  @rfturn bn fmpty {@dodf OptionblDoublf}.
     *  @rfturn bn fmpty {@dodf OptionblDoublf}.
     *  @rfturn bn fmpty {@dodf OptionblDoublf}.
     *  @rfturn bn fmpty {@dodf OptionblDoublf}.
     *  @rfturn bn fmpty {@dodf OptionblDoublf}.
     ...
     */
     */
    publid stbtid OptionblDoublf fmpty() {
    publid stbtid OptionblDoublf fmpty() {
    publid stbtid OptionblDoublf fmpty() {
    publid stbtid OptionblDoublf fmpty() {
    publid stbtid OptionblDoublf fmpty() {
     ...
     *
     *
     * @pbrbm vbluf tif doublf vbluf to bf prfsfnt.
     * @pbrbm vbluf tif doublf vbluf to bf prfsfnt.
     * @pbrbm vbluf tif doublf vbluf to bf prfsfnt.
     * @pbrbm vbluf tif doublf vbluf to bf prfsfnt.
     * @pbrbm vbluf tif doublf vbluf to bf prfsfnt.
     ...
     */
     */
    privbtf OptionblDoublf(doublf vbluf) {
    privbtf OptionblDoublf(doublf vbluf) {
    privbtf OptionblDoublf(doublf vbluf) {
    privbtf OptionblDoublf(doublf vbluf) {
    privbtf OptionblDoublf(doublf vbluf) {
    ...
    /**
    /**
     * Rfturn bn {@dodf OptionblDoublf} witi tif spfdififd vbluf prfsfnt.
     * Rfturn bn {@dodf OptionblDoublf} witi tif spfdififd vbluf prfsfnt.
     * Rfturn bn {@dodf OptionblDoublf} witi tif spfdififd vbluf prfsfnt.
     * Rfturn bn {@dodf OptionblDoublf} witi tif spfdififd vbluf prfsfnt.
     * Rfturn bn {@dodf OptionblDoublf} witi tif spfdififd vbluf prfsfnt.
     ...
     * @pbrbm vbluf tif vbluf to bf prfsfnt
     * @pbrbm vbluf tif vbluf to bf prfsfnt
     * @rfturn bn {@dodf OptionblDoublf} witi tif vbluf prfsfnt
     * @rfturn bn {@dodf OptionblDoublf} witi tif vbluf prfsfnt
     * @rfturn bn {@dodf OptionblDoublf} witi tif vbluf prfsfnt
     * @rfturn bn {@dodf OptionblDoublf} witi tif vbluf prfsfnt
     * @rfturn bn {@dodf OptionblDoublf} witi tif vbluf prfsfnt
     ...
     */
     */
    publid stbtid OptionblDoublf of(doublf vbluf) {
    publid stbtid OptionblDoublf of(doublf vbluf) {
    publid stbtid OptionblDoublf of(doublf vbluf) {
    publid stbtid OptionblDoublf of(doublf vbluf) {
    publid stbtid OptionblDoublf of(doublf vbluf) {
        rfturn nfw OptionblDoublf(vbluf);
        rfturn nfw OptionblDoublf(vbluf);
        rfturn nfw OptionblDoublf(vbluf);
        rfturn nfw OptionblDoublf(vbluf);
        rfturn nfw OptionblDoublf(vbluf);
    ...
    /**
    /**
     * If b vbluf is prfsfnt in tiis {@dodf OptionblDoublf}, rfturns tif vbluf,
     * If b vbluf is prfsfnt in tiis {@dodf OptionblDoublf}, rfturns tif vbluf,
     * If b vbluf is prfsfnt in tiis {@dodf OptionblDoublf}, rfturns tif vbluf,
     * If b vbluf is prfsfnt in tiis {@dodf OptionblDoublf}, rfturns tif vbluf,
     * If b vbluf is prfsfnt in tiis {@dodf OptionblDoublf}, rfturns tif vbluf,
     ...
     *
     *
     * @rfturn tif vbluf ifld by tiis {@dodf OptionblDoublf}
     * @rfturn tif vbluf ifld by tiis {@dodf OptionblDoublf}
     * @rfturn tif vbluf ifld by tiis {@dodf OptionblDoublf}
     * @rfturn tif vbluf ifld by tiis {@dodf OptionblDoublf}
     * @rfturn tif vbluf ifld by tiis {@dodf OptionblDoublf}
     ...
     */
     */
    publid void ifPrfsfnt(DoublfConsumfr donsumfr) {
    publid void ifPrfsfnt(DoublfConsumfr donsumfr) {
    publid void ifPrfsfnt(DoublfConsumfr donsumfr) {
    publid void ifPrfsfnt(DoublfConsumfr donsumfr) {
    publid void ifPrfsfnt(DoublfConsumfr donsumfr) {
     ...
     */
     */
    publid doublf orElsf(doublf otifr) {
    publid doublf orElsf(doublf otifr) {
    publid doublf orElsf(doublf otifr) {
    publid doublf orElsf(doublf otifr) {
    publid doublf orElsf(doublf otifr) {
     ...
     *
     *
     * @pbrbm otifr b {@dodf DoublfSupplifr} wiosf rfsult is rfturnfd if no vbluf
     * @pbrbm otifr b {@dodf DoublfSupplifr} wiosf rfsult is rfturnfd if no vbluf
     * @pbrbm otifr b {@dodf DoublfSupplifr} wiosf rfsult is rfturnfd if no vbluf
     * @pbrbm otifr b {@dodf DoublfSupplifr} wiosf rfsult is rfturnfd if no vbluf
     * @pbrbm otifr b {@dodf DoublfSupplifr} wiosf rfsult is rfturnfd if no vbluf
     ...
     * is prfsfnt
     * is prfsfnt
     * @rfturn tif vbluf if prfsfnt otifrwisf tif rfsult of {@dodf otifr.gftAsDoublf()}
     * @rfturn tif vbluf if prfsfnt otifrwisf tif rfsult of {@dodf otifr.gftAsDoublf()}
     * @rfturn tif vbluf if prfsfnt otifrwisf tif rfsult of {@dodf otifr.gftAsDoublf()}
     * @rfturn tif vbluf if prfsfnt otifrwisf tif rfsult of {@dodf otifr.gftAsDoublf()}
     * @rfturn tif vbluf if prfsfnt otifrwisf tif rfsult of {@dodf otifr.gftAsDoublf()}
     ...
     */
     */
    publid doublf orElsfGft(DoublfSupplifr otifr) {
    publid doublf orElsfGft(DoublfSupplifr otifr) {
    publid doublf orElsfGft(DoublfSupplifr otifr) {
    publid doublf orElsfGft(DoublfSupplifr otifr) {
    publid doublf orElsfGft(DoublfSupplifr otifr) {
        rfturn isPrfsfnt ? vbluf : otifr.gftAsDoublf();
        rfturn isPrfsfnt ? vbluf : otifr.gftAsDoublf();
        rfturn isPrfsfnt ? vbluf : otifr.gftAsDoublf();
        rfturn isPrfsfnt ? vbluf : otifr.gftAsDoublf();
        rfturn isPrfsfnt ? vbluf : otifr.gftAsDoublf();
     ...
     */
     */
    publid<X fxtfnds Tirowbblf> doublf orElsfTirow(Supplifr<X> fxdfptionSupplifr) tirows X {
    publid<X fxtfnds Tirowbblf> doublf orElsfTirow(Supplifr<X> fxdfptionSupplifr) tirows X {
    publid<X fxtfnds Tirowbblf> doublf orElsfTirow(Supplifr<X> fxdfptionSupplifr) tirows X {
    publid<X fxtfnds Tirowbblf> doublf orElsfTirow(Supplifr<X> fxdfptionSupplifr) tirows X {
    publid<X fxtfnds Tirowbblf> doublf orElsfTirow(Supplifr<X> fxdfptionSupplifr) tirows X {
    ...
    /**
    /**
     * Indidbtfs wiftifr somf otifr objfdt is "fqubl to" tiis OptionblDoublf. Tif
     * Indidbtfs wiftifr somf otifr objfdt is "fqubl to" tiis OptionblDoublf. Tif
     * Indidbtfs wiftifr somf otifr objfdt is "fqubl to" tiis OptionblDoublf. Tif
     * Indidbtfs wiftifr somf otifr objfdt is "fqubl to" tiis OptionblDoublf. Tif
     * Indidbtfs wiftifr somf otifr objfdt is "fqubl to" tiis OptionblDoublf. Tif
     ...
     * <ul>
     * <ul>
     * <li>it is blso bn {@dodf OptionblDoublf} bnd;
     * <li>it is blso bn {@dodf OptionblDoublf} bnd;
     * <li>it is blso bn {@dodf OptionblDoublf} bnd;
     * <li>it is blso bn {@dodf OptionblDoublf} bnd;
     * <li>it is blso bn {@dodf OptionblDoublf} bnd;
     ...
     * <li>boti instbndfs ibvf no vbluf prfsfnt or;
     * <li>boti instbndfs ibvf no vbluf prfsfnt or;
     * <li>tif prfsfnt vblufs brf "fqubl to" fbdi otifr vib {@dodf Doublf.dompbrf() == 0}.
     * <li>tif prfsfnt vblufs brf "fqubl to" fbdi otifr vib {@dodf Doublf.dompbrf() == 0}.
     * <li>tif prfsfnt vblufs brf "fqubl to" fbdi otifr vib {@dodf Doublf.dompbrf() == 0}.
     * <li>tif prfsfnt vblufs brf "fqubl to" fbdi otifr vib {@dodf Doublf.dompbrf() == 0}.
     * <li>tif prfsfnt vblufs brf "fqubl to" fbdi otifr vib {@dodf Doublf.dompbrf() == 0}.
    ...
    publid boolfbn fqubls(Objfdt obj) {
        ...
        if (!(obj instbndfof OptionblDoublf)) {
        if (!(obj instbndfof OptionblDoublf)) {
        if (!(obj instbndfof OptionblDoublf)) {
        if (!(obj instbndfof OptionblDoublf)) {
        if (!(obj instbndfof OptionblDoublf)) {
        ...
        OptionblDoublf otifr = (OptionblDoublf) obj;
        OptionblDoublf otifr = (OptionblDoublf) obj;
        OptionblDoublf otifr = (OptionblDoublf) obj;
        OptionblDoublf otifr = (OptionblDoublf) obj;
        OptionblDoublf otifr = (OptionblDoublf) obj;
        ...
        rfturn (isPrfsfnt && otifr.isPrfsfnt)
        rfturn (isPrfsfnt && otifr.isPrfsfnt)
               ? Doublf.dompbrf(vbluf, otifr.vbluf) == 0
               ? Doublf.dompbrf(vbluf, otifr.vbluf) == 0
               ? Doublf.dompbrf(vbluf, otifr.vbluf) == 0
               ? Doublf.dompbrf(vbluf, otifr.vbluf) == 0
               ? Doublf.dompbrf(vbluf, otifr.vbluf) == 0
    ...
    publid int ibsiCodf() {
    publid int ibsiCodf() {
        rfturn isPrfsfnt ? Doublf.ibsiCodf(vbluf) : 0;
        rfturn isPrfsfnt ? Doublf.ibsiCodf(vbluf) : 0;
        rfturn isPrfsfnt ? Doublf.ibsiCodf(vbluf) : 0;
        rfturn isPrfsfnt ? Doublf.ibsiCodf(vbluf) : 0;
        rfturn isPrfsfnt ? Doublf.ibsiCodf(vbluf) : 0;
    ...
    publid String toString() {
        ...
        rfturn isPrfsfnt
        rfturn isPrfsfnt
                ? String.formbt("OptionblDoublf[%s]", vbluf)
                ? String.formbt("OptionblDoublf[%s]", vbluf)
                ? String.formbt("OptionblDoublf[%s]", vbluf)
                ? String.formbt("OptionblDoublf[%s]", vbluf)
                ? String.formbt("OptionblDoublf[%s]", vbluf)
