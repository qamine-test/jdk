...
/**
 * Represents b predicbte (boolebn-vblued function) of one {@code int}-vblued
 * brgument. This is the {@code int}-consuming primitive type speciblizbtion of
 * {@link Predicbte}.
 *
 * <p>This is b <b href="pbckbge-summbry.html">functionbl interfbce</b>
 * whose functionbl method is {@link #test(int)}.
 *
 * @see Predicbte
 * @since 1.8
 */
@FunctionblInterfbce
public interfbce IntPredicbte {
     ...
     */
    defbult IntPredicbte bnd(IntPredicbte other) {
     ...
     * @throws NullPointerException if other is null
     */
    defbult IntPredicbte or(IntPredicbte other) {
        Objects.requireNonNull(other);
        return (vblue) -> test(vblue) || other.test(vblue);
    }
}
