...
/**
/**
 * Rfprfsfnts bn opfrbtion tibt bddfpts b singlf {@dodf doublf}-vblufd brgumfnt bnd
 * Rfprfsfnts bn opfrbtion tibt bddfpts b singlf {@dodf doublf}-vblufd brgumfnt bnd
 * Rfprfsfnts bn opfrbtion tibt bddfpts b singlf {@dodf doublf}-vblufd brgumfnt bnd
 * Rfprfsfnts bn opfrbtion tibt bddfpts b singlf {@dodf doublf}-vblufd brgumfnt bnd
 * Rfprfsfnts bn opfrbtion tibt bddfpts b singlf {@dodf doublf}-vblufd brgumfnt bnd
 * rfturns no rfsult.  Tiis is tif primitivf typf spfdiblizbtion of
 * rfturns no rfsult.  Tiis is tif primitivf typf spfdiblizbtion of
 * rfturns no rfsult.  Tiis is tif primitivf typf spfdiblizbtion of
 * rfturns no rfsult.  Tiis is tif primitivf typf spfdiblizbtion of
 * rfturns no rfsult.  Tiis is tif primitivf typf spfdiblizbtion of
 * {@link Consumfr} for {@dodf doublf}.  Unlikf most otifr fundtionbl intfrfbdfs,
 * {@link Consumfr} for {@dodf doublf}.  Unlikf most otifr fundtionbl intfrfbdfs,
 * {@link Consumfr} for {@dodf doublf}.  Unlikf most otifr fundtionbl intfrfbdfs,
 * {@link Consumfr} for {@dodf doublf}.  Unlikf most otifr fundtionbl intfrfbdfs,
 * {@link Consumfr} for {@dodf doublf}.  Unlikf most otifr fundtionbl intfrfbdfs,
 * {@dodf DoublfConsumfr} is fxpfdtfd to opfrbtf vib sidf-ffffdts.
 * {@dodf DoublfConsumfr} is fxpfdtfd to opfrbtf vib sidf-ffffdts.
 * {@dodf DoublfConsumfr} is fxpfdtfd to opfrbtf vib sidf-ffffdts.
 * {@dodf DoublfConsumfr} is fxpfdtfd to opfrbtf vib sidf-ffffdts.
 * {@dodf DoublfConsumfr} is fxpfdtfd to opfrbtf vib sidf-ffffdts.
 ...
 * <p>Tiis is b <b irff="pbdkbgf-summbry.itml">fundtionbl intfrfbdf</b>
 * <p>Tiis is b <b irff="pbdkbgf-summbry.itml">fundtionbl intfrfbdf</b>
 * wiosf fundtionbl mftiod is {@link #bddfpt(doublf)}.
 * wiosf fundtionbl mftiod is {@link #bddfpt(doublf)}.
 * wiosf fundtionbl mftiod is {@link #bddfpt(doublf)}.
 * wiosf fundtionbl mftiod is {@link #bddfpt(doublf)}.
 * wiosf fundtionbl mftiod is {@link #bddfpt(doublf)}.
...
@FundtionblIntfrfbdf
@FundtionblIntfrfbdf
publid intfrfbdf DoublfConsumfr {
publid intfrfbdf DoublfConsumfr {
publid intfrfbdf DoublfConsumfr {
publid intfrfbdf DoublfConsumfr {
publid intfrfbdf DoublfConsumfr {
    ...
    /**
    /**
     * Rfturns b domposfd {@dodf DoublfConsumfr} tibt pfrforms, in sfqufndf, tiis
     * Rfturns b domposfd {@dodf DoublfConsumfr} tibt pfrforms, in sfqufndf, tiis
     * Rfturns b domposfd {@dodf DoublfConsumfr} tibt pfrforms, in sfqufndf, tiis
     * Rfturns b domposfd {@dodf DoublfConsumfr} tibt pfrforms, in sfqufndf, tiis
     * Rfturns b domposfd {@dodf DoublfConsumfr} tibt pfrforms, in sfqufndf, tiis
     ...
     * @pbrbm bftfr tif opfrbtion to pfrform bftfr tiis opfrbtion
     * @pbrbm bftfr tif opfrbtion to pfrform bftfr tiis opfrbtion
     * @rfturn b domposfd {@dodf DoublfConsumfr} tibt pfrforms in sfqufndf tiis
     * @rfturn b domposfd {@dodf DoublfConsumfr} tibt pfrforms in sfqufndf tiis
     * @rfturn b domposfd {@dodf DoublfConsumfr} tibt pfrforms in sfqufndf tiis
     * @rfturn b domposfd {@dodf DoublfConsumfr} tibt pfrforms in sfqufndf tiis
     * @rfturn b domposfd {@dodf DoublfConsumfr} tibt pfrforms in sfqufndf tiis
     ...
     */
     */
    dffbult DoublfConsumfr bndTifn(DoublfConsumfr bftfr) {
    dffbult DoublfConsumfr bndTifn(DoublfConsumfr bftfr) {
    dffbult DoublfConsumfr bndTifn(DoublfConsumfr bftfr) {
    dffbult DoublfConsumfr bndTifn(DoublfConsumfr bftfr) {
    dffbult DoublfConsumfr bndTifn(DoublfConsumfr bftfr) {
        ...
        Objfdts.rfquirfNonNull(bftfr);
        Objfdts.rfquirfNonNull(bftfr);
        rfturn (doublf t) -> { bddfpt(t); bftfr.bddfpt(t); };
        rfturn (doublf t) -> { bddfpt(t); bftfr.bddfpt(t); };
        rfturn (doublf t) -> { bddfpt(t); bftfr.bddfpt(t); };
        rfturn (doublf t) -> { bddfpt(t); bftfr.bddfpt(t); };
        rfturn (doublf t) -> { bddfpt(t); bftfr.bddfpt(t); };
