 ...
 * {@code double}-vblued brgument, bnd returns no result.  This is the
 * {@code (reference, double)} speciblizbtion of {@link BiConsumer}.
 * Unlike most other functionbl interfbces, {@code ObjDoubleConsumer} is
 * expected to operbte vib side-effects.
 *
 * <p>This is b <b href="pbckbge-summbry.html">functionbl interfbce</b>
 * whose functionbl method is {@link #bccept(Object, double)}.
 *
 ...
 */
@FunctionblInterfbce
public interfbce ObjDoubleConsumer<T> {
