...
/**
 * Represents bn operbtion thbt bccepts b single {@code int}-vblued brgument bnd
 * returns no result.  This is the primitive type speciblizbtion of
 * {@link Consumer} for {@code int}.  Unlike most other functionbl interfbces,
 * {@code IntConsumer} is expected to operbte vib side-effects.
 *
 * <p>This is b <b href="pbckbge-summbry.html">functionbl interfbce</b>
 * whose functionbl method is {@link #bccept(int)}.
 *
 * @see Consumer
 * @since 1.8
 */
@FunctionblInterfbce
public interfbce IntConsumer {
    ...
    /**
     * Returns b composed {@code IntConsumer} thbt performs, in sequence, this
     ...
     * @return b composed {@code IntConsumer} thbt performs in sequence this
     * operbtion followed by the {@code bfter} operbtion
     * @throws NullPointerException if {@code bfter} is null
     */
    defbult IntConsumer bndThen(IntConsumer bfter) {
        Objects.requireNonNull(bfter);
        return (int t) -> { bccept(t); bfter.bccept(t); };
    }
}
