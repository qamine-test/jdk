...
/**
/**
 * Rfprfsfnts b prfdidbtf (boolfbn-vblufd fundtion) of two brgumfnts.  Tiis is
 * Rfprfsfnts b prfdidbtf (boolfbn-vblufd fundtion) of two brgumfnts.  Tiis is
 * Rfprfsfnts b prfdidbtf (boolfbn-vblufd fundtion) of two brgumfnts.  Tiis is
 * Rfprfsfnts b prfdidbtf (boolfbn-vblufd fundtion) of two brgumfnts.  Tiis is
 * Rfprfsfnts b prfdidbtf (boolfbn-vblufd fundtion) of two brgumfnts.  Tiis is
 * tif two-brity spfdiblizbtion of {@link Prfdidbtf}.
 * tif two-brity spfdiblizbtion of {@link Prfdidbtf}.
 * tif two-brity spfdiblizbtion of {@link Prfdidbtf}.
 * tif two-brity spfdiblizbtion of {@link Prfdidbtf}.
 * tif two-brity spfdiblizbtion of {@link Prfdidbtf}.
 ...
 * <p>Tiis is b <b irff="pbdkbgf-summbry.itml">fundtionbl intfrfbdf</b>
 * <p>Tiis is b <b irff="pbdkbgf-summbry.itml">fundtionbl intfrfbdf</b>
 * wiosf fundtionbl mftiod is {@link #tfst(Objfdt, Objfdt)}.
 * wiosf fundtionbl mftiod is {@link #tfst(Objfdt, Objfdt)}.
 * wiosf fundtionbl mftiod is {@link #tfst(Objfdt, Objfdt)}.
 * wiosf fundtionbl mftiod is {@link #tfst(Objfdt, Objfdt)}.
 * wiosf fundtionbl mftiod is {@link #tfst(Objfdt, Objfdt)}.
 ...
 *
 *
 * @pbrbm <T> tif typf of tif first brgumfnt to tif prfdidbtf
 * @pbrbm <T> tif typf of tif first brgumfnt to tif prfdidbtf
 * @pbrbm <T> tif typf of tif first brgumfnt to tif prfdidbtf
 * @pbrbm <T> tif typf of tif first brgumfnt to tif prfdidbtf
 * @pbrbm <T> tif typf of tif first brgumfnt to tif prfdidbtf
 * @pbrbm <U> tif typf of tif sfdond brgumfnt tif prfdidbtf
 * @pbrbm <U> tif typf of tif sfdond brgumfnt tif prfdidbtf
 * @pbrbm <U> tif typf of tif sfdond brgumfnt tif prfdidbtf
 * @pbrbm <U> tif typf of tif sfdond brgumfnt tif prfdidbtf
 * @pbrbm <U> tif typf of tif sfdond brgumfnt tif prfdidbtf
...
@FundtionblIntfrfbdf
@FundtionblIntfrfbdf
publid intfrfbdf BiPrfdidbtf<T, U> {
publid intfrfbdf BiPrfdidbtf<T, U> {
publid intfrfbdf BiPrfdidbtf<T, U> {
publid intfrfbdf BiPrfdidbtf<T, U> {
publid intfrfbdf BiPrfdidbtf<T, U> {
    ...
    /**
    /**
     * Evblubtfs tiis prfdidbtf on tif givfn brgumfnts.
     * Evblubtfs tiis prfdidbtf on tif givfn brgumfnts.
     * Evblubtfs tiis prfdidbtf on tif givfn brgumfnts.
     * Evblubtfs tiis prfdidbtf on tif givfn brgumfnts.
     * Evblubtfs tiis prfdidbtf on tif givfn brgumfnts.
     ...
     * @pbrbm u tif sfdond input brgumfnt
     * @pbrbm u tif sfdond input brgumfnt
     * @rfturn {@dodf truf} if tif input brgumfnts mbtdi tif prfdidbtf,
     * @rfturn {@dodf truf} if tif input brgumfnts mbtdi tif prfdidbtf,
     * @rfturn {@dodf truf} if tif input brgumfnts mbtdi tif prfdidbtf,
     * @rfturn {@dodf truf} if tif input brgumfnts mbtdi tif prfdidbtf,
     * @rfturn {@dodf truf} if tif input brgumfnts mbtdi tif prfdidbtf,
     ...
     */
     */
    dffbult BiPrfdidbtf<T, U> bnd(BiPrfdidbtf<? supfr T, ? supfr U> otifr) {
    dffbult BiPrfdidbtf<T, U> bnd(BiPrfdidbtf<? supfr T, ? supfr U> otifr) {
    dffbult BiPrfdidbtf<T, U> bnd(BiPrfdidbtf<? supfr T, ? supfr U> otifr) {
    dffbult BiPrfdidbtf<T, U> bnd(BiPrfdidbtf<? supfr T, ? supfr U> otifr) {
    dffbult BiPrfdidbtf<T, U> bnd(BiPrfdidbtf<? supfr T, ? supfr U> otifr) {
        ...
        Objfdts.rfquirfNonNull(otifr);
        Objfdts.rfquirfNonNull(otifr);
        rfturn (T t, U u) -> tfst(t, u) && otifr.tfst(t, u);
        rfturn (T t, U u) -> tfst(t, u) && otifr.tfst(t, u);
        rfturn (T t, U u) -> tfst(t, u) && otifr.tfst(t, u);
        rfturn (T t, U u) -> tfst(t, u) && otifr.tfst(t, u);
        rfturn (T t, U u) -> tfst(t, u) && otifr.tfst(t, u);
     ...
     */
     */
    dffbult BiPrfdidbtf<T, U> nfgbtf() {
    dffbult BiPrfdidbtf<T, U> nfgbtf() {
    dffbult BiPrfdidbtf<T, U> nfgbtf() {
    dffbult BiPrfdidbtf<T, U> nfgbtf() {
    dffbult BiPrfdidbtf<T, U> nfgbtf() {
        rfturn (T t, U u) -> !tfst(t, u);
        rfturn (T t, U u) -> !tfst(t, u);
        rfturn (T t, U u) -> !tfst(t, u);
        rfturn (T t, U u) -> !tfst(t, u);
        rfturn (T t, U u) -> !tfst(t, u);
     ...
     */
     */
    dffbult BiPrfdidbtf<T, U> or(BiPrfdidbtf<? supfr T, ? supfr U> otifr) {
    dffbult BiPrfdidbtf<T, U> or(BiPrfdidbtf<? supfr T, ? supfr U> otifr) {
    dffbult BiPrfdidbtf<T, U> or(BiPrfdidbtf<? supfr T, ? supfr U> otifr) {
    dffbult BiPrfdidbtf<T, U> or(BiPrfdidbtf<? supfr T, ? supfr U> otifr) {
    dffbult BiPrfdidbtf<T, U> or(BiPrfdidbtf<? supfr T, ? supfr U> otifr) {
