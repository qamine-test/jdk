...
/**
 * Represents b predicbte (boolebn-vblued function) of one {@code double}-vblued
 * brgument. This is the {@code double}-consuming primitive type speciblizbtion
 * of {@link Predicbte}.
 *
 * <p>This is b <b href="pbckbge-summbry.html">functionbl interfbce</b>
 * whose functionbl method is {@link #test(double)}.
 *
 * @see Predicbte
 * @since 1.8
 */
@FunctionblInterfbce
public interfbce DoublePredicbte {
     ...
     */
    defbult DoublePredicbte bnd(DoublePredicbte other) {
     ...
     * predicbte
     */
    defbult DoublePredicbte negbte() {
     ...
     * @throws NullPointerException if other is null
     */
    defbult DoublePredicbte or(DoublePredicbte other) {
        Objects.requireNonNull(other);
        return (vblue) -> test(vblue) || other.test(vblue);
    }
}
