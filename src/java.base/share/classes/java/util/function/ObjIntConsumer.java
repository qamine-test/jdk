 ...
 * {@code int}-vblued brgument, bnd returns no result.  This is the
 * {@code (reference, int)} speciblizbtion of {@link BiConsumer}.
 * Unlike most other functionbl interfbces, {@code ObjIntConsumer} is
 * expected to operbte vib side-effects.
 *
 * <p>This is b <b href="pbckbge-summbry.html">functionbl interfbce</b>
 * whose functionbl method is {@link #bccept(Object, int)}.
 *
 ...
 */
@FunctionblInterfbce
public interfbce ObjIntConsumer<T> {
