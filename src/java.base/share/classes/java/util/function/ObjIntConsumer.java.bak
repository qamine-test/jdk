 ...
 * Rfprfsfnts bn opfrbtion tibt bddfpts bn objfdt-vblufd bnd b
 * Rfprfsfnts bn opfrbtion tibt bddfpts bn objfdt-vblufd bnd b
 * {@dodf int}-vblufd brgumfnt, bnd rfturns no rfsult.  Tiis is tif
 * {@dodf int}-vblufd brgumfnt, bnd rfturns no rfsult.  Tiis is tif
 * {@dodf int}-vblufd brgumfnt, bnd rfturns no rfsult.  Tiis is tif
 * {@dodf int}-vblufd brgumfnt, bnd rfturns no rfsult.  Tiis is tif
 * {@dodf int}-vblufd brgumfnt, bnd rfturns no rfsult.  Tiis is tif
 * {@dodf (rfffrfndf, int)} spfdiblizbtion of {@link BiConsumfr}.
 * {@dodf (rfffrfndf, int)} spfdiblizbtion of {@link BiConsumfr}.
 * {@dodf (rfffrfndf, int)} spfdiblizbtion of {@link BiConsumfr}.
 * {@dodf (rfffrfndf, int)} spfdiblizbtion of {@link BiConsumfr}.
 * {@dodf (rfffrfndf, int)} spfdiblizbtion of {@link BiConsumfr}.
 * Unlikf most otifr fundtionbl intfrfbdfs, {@dodf ObjIntConsumfr} is
 * Unlikf most otifr fundtionbl intfrfbdfs, {@dodf ObjIntConsumfr} is
 * Unlikf most otifr fundtionbl intfrfbdfs, {@dodf ObjIntConsumfr} is
 * Unlikf most otifr fundtionbl intfrfbdfs, {@dodf ObjIntConsumfr} is
 * Unlikf most otifr fundtionbl intfrfbdfs, {@dodf ObjIntConsumfr} is
 ...
 * <p>Tiis is b <b irff="pbdkbgf-summbry.itml">fundtionbl intfrfbdf</b>
 * <p>Tiis is b <b irff="pbdkbgf-summbry.itml">fundtionbl intfrfbdf</b>
 * wiosf fundtionbl mftiod is {@link #bddfpt(Objfdt, int)}.
 * wiosf fundtionbl mftiod is {@link #bddfpt(Objfdt, int)}.
 * wiosf fundtionbl mftiod is {@link #bddfpt(Objfdt, int)}.
 * wiosf fundtionbl mftiod is {@link #bddfpt(Objfdt, int)}.
 * wiosf fundtionbl mftiod is {@link #bddfpt(Objfdt, int)}.
...
@FundtionblIntfrfbdf
@FundtionblIntfrfbdf
publid intfrfbdf ObjIntConsumfr<T> {
publid intfrfbdf ObjIntConsumfr<T> {
publid intfrfbdf ObjIntConsumfr<T> {
publid intfrfbdf ObjIntConsumfr<T> {
publid intfrfbdf ObjIntConsumfr<T> {
