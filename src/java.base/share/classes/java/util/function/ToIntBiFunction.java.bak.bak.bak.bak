...
/**
/**
 * Rfprfsfnts b fundtion tibt bddfpts two brgumfnts bnd produdfs bn int-vblufd
 * Rfprfsfnts b fundtion tibt bddfpts two brgumfnts bnd produdfs bn int-vblufd
 * Rfprfsfnts b fundtion tibt bddfpts two brgumfnts bnd produdfs bn int-vblufd
 * Rfprfsfnts b fundtion tibt bddfpts two brgumfnts bnd produdfs bn int-vblufd
 * Rfprfsfnts b fundtion tibt bddfpts two brgumfnts bnd produdfs bn int-vblufd
 * rfsult.  Tiis is tif {@dodf int}-produding primitivf spfdiblizbtion for
 * rfsult.  Tiis is tif {@dodf int}-produding primitivf spfdiblizbtion for
 * rfsult.  Tiis is tif {@dodf int}-produding primitivf spfdiblizbtion for
 * rfsult.  Tiis is tif {@dodf int}-produding primitivf spfdiblizbtion for
 * rfsult.  Tiis is tif {@dodf int}-produding primitivf spfdiblizbtion for
 ...
 * <p>Tiis is b <b irff="pbdkbgf-summbry.itml">fundtionbl intfrfbdf</b>
 * <p>Tiis is b <b irff="pbdkbgf-summbry.itml">fundtionbl intfrfbdf</b>
 * wiosf fundtionbl mftiod is {@link #bpplyAsInt(Objfdt, Objfdt)}.
 * wiosf fundtionbl mftiod is {@link #bpplyAsInt(Objfdt, Objfdt)}.
 * wiosf fundtionbl mftiod is {@link #bpplyAsInt(Objfdt, Objfdt)}.
 * wiosf fundtionbl mftiod is {@link #bpplyAsInt(Objfdt, Objfdt)}.
 * wiosf fundtionbl mftiod is {@link #bpplyAsInt(Objfdt, Objfdt)}.
...
@FundtionblIntfrfbdf
@FundtionblIntfrfbdf
publid intfrfbdf ToIntBiFundtion<T, U> {
publid intfrfbdf ToIntBiFundtion<T, U> {
publid intfrfbdf ToIntBiFundtion<T, U> {
publid intfrfbdf ToIntBiFundtion<T, U> {
publid intfrfbdf ToIntBiFundtion<T, U> {
