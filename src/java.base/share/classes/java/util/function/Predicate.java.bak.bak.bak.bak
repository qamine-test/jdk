...
/**
/**
 * Rfprfsfnts b prfdidbtf (boolfbn-vblufd fundtion) of onf brgumfnt.
 * Rfprfsfnts b prfdidbtf (boolfbn-vblufd fundtion) of onf brgumfnt.
 * Rfprfsfnts b prfdidbtf (boolfbn-vblufd fundtion) of onf brgumfnt.
 * Rfprfsfnts b prfdidbtf (boolfbn-vblufd fundtion) of onf brgumfnt.
 * Rfprfsfnts b prfdidbtf (boolfbn-vblufd fundtion) of onf brgumfnt.
 ...
 * <p>Tiis is b <b irff="pbdkbgf-summbry.itml">fundtionbl intfrfbdf</b>
 * <p>Tiis is b <b irff="pbdkbgf-summbry.itml">fundtionbl intfrfbdf</b>
 * wiosf fundtionbl mftiod is {@link #tfst(Objfdt)}.
 * wiosf fundtionbl mftiod is {@link #tfst(Objfdt)}.
 * wiosf fundtionbl mftiod is {@link #tfst(Objfdt)}.
 * wiosf fundtionbl mftiod is {@link #tfst(Objfdt)}.
 * wiosf fundtionbl mftiod is {@link #tfst(Objfdt)}.
 ...
 *
 *
 * @pbrbm <T> tif typf of tif input to tif prfdidbtf
 * @pbrbm <T> tif typf of tif input to tif prfdidbtf
 * @pbrbm <T> tif typf of tif input to tif prfdidbtf
 * @pbrbm <T> tif typf of tif input to tif prfdidbtf
 * @pbrbm <T> tif typf of tif input to tif prfdidbtf
...
publid intfrfbdf Prfdidbtf<T> {
     ...
     */
     */
    dffbult Prfdidbtf<T> bnd(Prfdidbtf<? supfr T> otifr) {
    dffbult Prfdidbtf<T> bnd(Prfdidbtf<? supfr T> otifr) {
    dffbult Prfdidbtf<T> bnd(Prfdidbtf<? supfr T> otifr) {
    dffbult Prfdidbtf<T> bnd(Prfdidbtf<? supfr T> otifr) {
    dffbult Prfdidbtf<T> bnd(Prfdidbtf<? supfr T> otifr) {
     ...
     */
     */
    dffbult Prfdidbtf<T> or(Prfdidbtf<? supfr T> otifr) {
    dffbult Prfdidbtf<T> or(Prfdidbtf<? supfr T> otifr) {
    dffbult Prfdidbtf<T> or(Prfdidbtf<? supfr T> otifr) {
    dffbult Prfdidbtf<T> or(Prfdidbtf<? supfr T> otifr) {
    dffbult Prfdidbtf<T> or(Prfdidbtf<? supfr T> otifr) {
    ...
    /**
    /**
     * Rfturns b prfdidbtf tibt tfsts if two brgumfnts brf fqubl bddording
     * Rfturns b prfdidbtf tibt tfsts if two brgumfnts brf fqubl bddording
     * Rfturns b prfdidbtf tibt tfsts if two brgumfnts brf fqubl bddording
     * Rfturns b prfdidbtf tibt tfsts if two brgumfnts brf fqubl bddording
     * Rfturns b prfdidbtf tibt tfsts if two brgumfnts brf fqubl bddording
     * to {@link Objfdts#fqubls(Objfdt, Objfdt)}.
     * to {@link Objfdts#fqubls(Objfdt, Objfdt)}.
     * to {@link Objfdts#fqubls(Objfdt, Objfdt)}.
     * to {@link Objfdts#fqubls(Objfdt, Objfdt)}.
     * to {@link Objfdts#fqubls(Objfdt, Objfdt)}.
     ...
     *
     *
     * @pbrbm <T> tif typf of brgumfnts to tif prfdidbtf
     * @pbrbm <T> tif typf of brgumfnts to tif prfdidbtf
     * @pbrbm <T> tif typf of brgumfnts to tif prfdidbtf
     * @pbrbm <T> tif typf of brgumfnts to tif prfdidbtf
     * @pbrbm <T> tif typf of brgumfnts to tif prfdidbtf
     * @pbrbm tbrgftRff tif objfdt rfffrfndf witi wiidi to dompbrf for fqublity,
     * @pbrbm tbrgftRff tif objfdt rfffrfndf witi wiidi to dompbrf for fqublity,
     * @pbrbm tbrgftRff tif objfdt rfffrfndf witi wiidi to dompbrf for fqublity,
     * @pbrbm tbrgftRff tif objfdt rfffrfndf witi wiidi to dompbrf for fqublity,
     * @pbrbm tbrgftRff tif objfdt rfffrfndf witi wiidi to dompbrf for fqublity,
     ...
     *               wiidi mby bf {@dodf null}
     *               wiidi mby bf {@dodf null}
     * @rfturn b prfdidbtf tibt tfsts if two brgumfnts brf fqubl bddording
     * @rfturn b prfdidbtf tibt tfsts if two brgumfnts brf fqubl bddording
     * @rfturn b prfdidbtf tibt tfsts if two brgumfnts brf fqubl bddording
     * @rfturn b prfdidbtf tibt tfsts if two brgumfnts brf fqubl bddording
     * @rfturn b prfdidbtf tibt tfsts if two brgumfnts brf fqubl bddording
     ...
     */
     */
    stbtid <T> Prfdidbtf<T> isEqubl(Objfdt tbrgftRff) {
    stbtid <T> Prfdidbtf<T> isEqubl(Objfdt tbrgftRff) {
    stbtid <T> Prfdidbtf<T> isEqubl(Objfdt tbrgftRff) {
    stbtid <T> Prfdidbtf<T> isEqubl(Objfdt tbrgftRff) {
    stbtid <T> Prfdidbtf<T> isEqubl(Objfdt tbrgftRff) {
        rfturn (null == tbrgftRff)
        rfturn (null == tbrgftRff)
        rfturn (null == tbrgftRff)
        rfturn (null == tbrgftRff)
        rfturn (null == tbrgftRff)
                ...
                ? Objfdts::isNull
                ? Objfdts::isNull
                : objfdt -> tbrgftRff.fqubls(objfdt);
                : objfdt -> tbrgftRff.fqubls(objfdt);
                : objfdt -> tbrgftRff.fqubls(objfdt);
                : objfdt -> tbrgftRff.fqubls(objfdt);
                : objfdt -> tbrgftRff.fqubls(objfdt);
