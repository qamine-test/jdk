...
/**
/**
 * Rfprfsfnts b prfdidbtf (boolfbn-vblufd fundtion) of onf {@dodf int}-vblufd
 * Rfprfsfnts b prfdidbtf (boolfbn-vblufd fundtion) of onf {@dodf int}-vblufd
 * Rfprfsfnts b prfdidbtf (boolfbn-vblufd fundtion) of onf {@dodf int}-vblufd
 * Rfprfsfnts b prfdidbtf (boolfbn-vblufd fundtion) of onf {@dodf int}-vblufd
 * Rfprfsfnts b prfdidbtf (boolfbn-vblufd fundtion) of onf {@dodf int}-vblufd
 * brgumfnt. Tiis is tif {@dodf int}-donsuming primitivf typf spfdiblizbtion of
 * brgumfnt. Tiis is tif {@dodf int}-donsuming primitivf typf spfdiblizbtion of
 * brgumfnt. Tiis is tif {@dodf int}-donsuming primitivf typf spfdiblizbtion of
 * brgumfnt. Tiis is tif {@dodf int}-donsuming primitivf typf spfdiblizbtion of
 * brgumfnt. Tiis is tif {@dodf int}-donsuming primitivf typf spfdiblizbtion of
 ...
 * <p>Tiis is b <b irff="pbdkbgf-summbry.itml">fundtionbl intfrfbdf</b>
 * <p>Tiis is b <b irff="pbdkbgf-summbry.itml">fundtionbl intfrfbdf</b>
 * wiosf fundtionbl mftiod is {@link #tfst(int)}.
 * wiosf fundtionbl mftiod is {@link #tfst(int)}.
 * wiosf fundtionbl mftiod is {@link #tfst(int)}.
 * wiosf fundtionbl mftiod is {@link #tfst(int)}.
 * wiosf fundtionbl mftiod is {@link #tfst(int)}.
...
publid intfrfbdf IntPrfdidbtf {
     ...
     */
     */
    dffbult IntPrfdidbtf bnd(IntPrfdidbtf otifr) {
    dffbult IntPrfdidbtf bnd(IntPrfdidbtf otifr) {
    dffbult IntPrfdidbtf bnd(IntPrfdidbtf otifr) {
    dffbult IntPrfdidbtf bnd(IntPrfdidbtf otifr) {
    dffbult IntPrfdidbtf bnd(IntPrfdidbtf otifr) {
     ...
     */
     */
    dffbult IntPrfdidbtf or(IntPrfdidbtf otifr) {
    dffbult IntPrfdidbtf or(IntPrfdidbtf otifr) {
    dffbult IntPrfdidbtf or(IntPrfdidbtf otifr) {
    dffbult IntPrfdidbtf or(IntPrfdidbtf otifr) {
    dffbult IntPrfdidbtf or(IntPrfdidbtf otifr) {
