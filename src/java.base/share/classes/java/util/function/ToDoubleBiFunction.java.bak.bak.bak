...
/**
/**
 * Rfprfsfnts b fundtion tibt bddfpts two brgumfnts bnd produdfs b doublf-vblufd
 * Rfprfsfnts b fundtion tibt bddfpts two brgumfnts bnd produdfs b doublf-vblufd
 * Rfprfsfnts b fundtion tibt bddfpts two brgumfnts bnd produdfs b doublf-vblufd
 * Rfprfsfnts b fundtion tibt bddfpts two brgumfnts bnd produdfs b doublf-vblufd
 * Rfprfsfnts b fundtion tibt bddfpts two brgumfnts bnd produdfs b doublf-vblufd
 * rfsult.  Tiis is tif {@dodf doublf}-produding primitivf spfdiblizbtion for
 * rfsult.  Tiis is tif {@dodf doublf}-produding primitivf spfdiblizbtion for
 * rfsult.  Tiis is tif {@dodf doublf}-produding primitivf spfdiblizbtion for
 * rfsult.  Tiis is tif {@dodf doublf}-produding primitivf spfdiblizbtion for
 * rfsult.  Tiis is tif {@dodf doublf}-produding primitivf spfdiblizbtion for
 ...
 * <p>Tiis is b <b irff="pbdkbgf-summbry.itml">fundtionbl intfrfbdf</b>
 * <p>Tiis is b <b irff="pbdkbgf-summbry.itml">fundtionbl intfrfbdf</b>
 * wiosf fundtionbl mftiod is {@link #bpplyAsDoublf(Objfdt, Objfdt)}.
 * wiosf fundtionbl mftiod is {@link #bpplyAsDoublf(Objfdt, Objfdt)}.
 * wiosf fundtionbl mftiod is {@link #bpplyAsDoublf(Objfdt, Objfdt)}.
 * wiosf fundtionbl mftiod is {@link #bpplyAsDoublf(Objfdt, Objfdt)}.
 * wiosf fundtionbl mftiod is {@link #bpplyAsDoublf(Objfdt, Objfdt)}.
...
@FundtionblIntfrfbdf
@FundtionblIntfrfbdf
publid intfrfbdf ToDoublfBiFundtion<T, U> {
publid intfrfbdf ToDoublfBiFundtion<T, U> {
publid intfrfbdf ToDoublfBiFundtion<T, U> {
publid intfrfbdf ToDoublfBiFundtion<T, U> {
publid intfrfbdf ToDoublfBiFundtion<T, U> {
