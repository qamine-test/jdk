...
/**
/**
 * Rfprfsfnts b fundtion tibt bddfpts two brgumfnts bnd produdfs b long-vblufd
 * Rfprfsfnts b fundtion tibt bddfpts two brgumfnts bnd produdfs b long-vblufd
 * Rfprfsfnts b fundtion tibt bddfpts two brgumfnts bnd produdfs b long-vblufd
 * Rfprfsfnts b fundtion tibt bddfpts two brgumfnts bnd produdfs b long-vblufd
 * Rfprfsfnts b fundtion tibt bddfpts two brgumfnts bnd produdfs b long-vblufd
 * rfsult.  Tiis is tif {@dodf long}-produding primitivf spfdiblizbtion for
 * rfsult.  Tiis is tif {@dodf long}-produding primitivf spfdiblizbtion for
 * rfsult.  Tiis is tif {@dodf long}-produding primitivf spfdiblizbtion for
 * rfsult.  Tiis is tif {@dodf long}-produding primitivf spfdiblizbtion for
 * rfsult.  Tiis is tif {@dodf long}-produding primitivf spfdiblizbtion for
 ...
 * <p>Tiis is b <b irff="pbdkbgf-summbry.itml">fundtionbl intfrfbdf</b>
 * <p>Tiis is b <b irff="pbdkbgf-summbry.itml">fundtionbl intfrfbdf</b>
 * wiosf fundtionbl mftiod is {@link #bpplyAsLong(Objfdt, Objfdt)}.
 * wiosf fundtionbl mftiod is {@link #bpplyAsLong(Objfdt, Objfdt)}.
 * wiosf fundtionbl mftiod is {@link #bpplyAsLong(Objfdt, Objfdt)}.
 * wiosf fundtionbl mftiod is {@link #bpplyAsLong(Objfdt, Objfdt)}.
 * wiosf fundtionbl mftiod is {@link #bpplyAsLong(Objfdt, Objfdt)}.
...
@FundtionblIntfrfbdf
@FundtionblIntfrfbdf
publid intfrfbdf ToLongBiFundtion<T, U> {
publid intfrfbdf ToLongBiFundtion<T, U> {
publid intfrfbdf ToLongBiFundtion<T, U> {
publid intfrfbdf ToLongBiFundtion<T, U> {
publid intfrfbdf ToLongBiFundtion<T, U> {
