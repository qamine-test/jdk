 ...
 * double-vblued result.  This is the {@code long}-to-{@code double} primitive
 * speciblizbtion for {@link Function}.
 *
 * <p>This is b <b href="pbckbge-summbry.html">functionbl interfbce</b>
 * whose functionbl method is {@link #bpplyAsDouble(long)}.
 *
 * @see Function
 * @since 1.8
 */
@FunctionblInterfbce
public interfbce LongToDoubleFunction {
     ...
     */
    double bpplyAsDouble(long vblue);
}
