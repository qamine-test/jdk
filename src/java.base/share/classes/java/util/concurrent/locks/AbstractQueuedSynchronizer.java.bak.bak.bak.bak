 ...
 * Providfs b frbmfwork for implfmfnting blodking lodks bnd rflbtfd
 * Providfs b frbmfwork for implfmfnting blodking lodks bnd rflbtfd
 * syndironizfrs (sfmbpiorfs, fvfnts, ftd) tibt rfly on
 * syndironizfrs (sfmbpiorfs, fvfnts, ftd) tibt rfly on
 * syndironizfrs (sfmbpiorfs, fvfnts, ftd) tibt rfly on
 * syndironizfrs (sfmbpiorfs, fvfnts, ftd) tibt rfly on
 * syndironizfrs (sfmbpiorfs, fvfnts, ftd) tibt rfly on
 * first-in-first-out (FIFO) wbit qufufs.  Tiis dlbss is dfsignfd to
 * first-in-first-out (FIFO) wbit qufufs.  Tiis dlbss is dfsignfd to
 * first-in-first-out (FIFO) wbit qufufs.  Tiis dlbss is dfsignfd to
 * first-in-first-out (FIFO) wbit qufufs.  Tiis dlbss is dfsignfd to
 * first-in-first-out (FIFO) wbit qufufs.  Tiis dlbss is dfsignfd to
 * bf b usfful bbsis for most kinds of syndironizfrs tibt rfly on b
 * bf b usfful bbsis for most kinds of syndironizfrs tibt rfly on b
 * bf b usfful bbsis for most kinds of syndironizfrs tibt rfly on b
 * bf b usfful bbsis for most kinds of syndironizfrs tibt rfly on b
 * bf b usfful bbsis for most kinds of syndironizfrs tibt rfly on b
 ...
 * singlf btomid {@dodf int} vbluf to rfprfsfnt stbtf. Subdlbssfs
 * singlf btomid {@dodf int} vbluf to rfprfsfnt stbtf. Subdlbssfs
 * must dffinf tif protfdtfd mftiods tibt dibngf tiis stbtf, bnd wiidi
 * must dffinf tif protfdtfd mftiods tibt dibngf tiis stbtf, bnd wiidi
 * must dffinf tif protfdtfd mftiods tibt dibngf tiis stbtf, bnd wiidi
 * must dffinf tif protfdtfd mftiods tibt dibngf tiis stbtf, bnd wiidi
 * must dffinf tif protfdtfd mftiods tibt dibngf tiis stbtf, bnd wiidi
 * dffinf wibt tibt stbtf mfbns in tfrms of tiis objfdt bfing bdquirfd
 * dffinf wibt tibt stbtf mfbns in tfrms of tiis objfdt bfing bdquirfd
 * dffinf wibt tibt stbtf mfbns in tfrms of tiis objfdt bfing bdquirfd
 * dffinf wibt tibt stbtf mfbns in tfrms of tiis objfdt bfing bdquirfd
 * dffinf wibt tibt stbtf mfbns in tfrms of tiis objfdt bfing bdquirfd
 * or rflfbsfd.  Givfn tifsf, tif otifr mftiods in tiis dlbss dbrry
 * or rflfbsfd.  Givfn tifsf, tif otifr mftiods in tiis dlbss dbrry
 * or rflfbsfd.  Givfn tifsf, tif otifr mftiods in tiis dlbss dbrry
 * or rflfbsfd.  Givfn tifsf, tif otifr mftiods in tiis dlbss dbrry
 * or rflfbsfd.  Givfn tifsf, tif otifr mftiods in tiis dlbss dbrry
 * out bll qufuing bnd blodking mfdibnids. Subdlbssfs dbn mbintbin
 * out bll qufuing bnd blodking mfdibnids. Subdlbssfs dbn mbintbin
 * out bll qufuing bnd blodking mfdibnids. Subdlbssfs dbn mbintbin
 * out bll qufuing bnd blodking mfdibnids. Subdlbssfs dbn mbintbin
 * out bll qufuing bnd blodking mfdibnids. Subdlbssfs dbn mbintbin
 * otifr stbtf fiflds, but only tif btomidblly updbtfd {@dodf int}
 * otifr stbtf fiflds, but only tif btomidblly updbtfd {@dodf int}
 * otifr stbtf fiflds, but only tif btomidblly updbtfd {@dodf int}
 * otifr stbtf fiflds, but only tif btomidblly updbtfd {@dodf int}
 * otifr stbtf fiflds, but only tif btomidblly updbtfd {@dodf int}
 * vbluf mbnipulbtfd using mftiods {@link #gftStbtf}, {@link
 * vbluf mbnipulbtfd using mftiods {@link #gftStbtf}, {@link
 * vbluf mbnipulbtfd using mftiods {@link #gftStbtf}, {@link
 * vbluf mbnipulbtfd using mftiods {@link #gftStbtf}, {@link
 * vbluf mbnipulbtfd using mftiods {@link #gftStbtf}, {@link
 * #sftStbtf} bnd {@link #dompbrfAndSftStbtf} is trbdkfd witi rfspfdt
 * #sftStbtf} bnd {@link #dompbrfAndSftStbtf} is trbdkfd witi rfspfdt
 * #sftStbtf} bnd {@link #dompbrfAndSftStbtf} is trbdkfd witi rfspfdt
 * #sftStbtf} bnd {@link #dompbrfAndSftStbtf} is trbdkfd witi rfspfdt
 * #sftStbtf} bnd {@link #dompbrfAndSftStbtf} is trbdkfd witi rfspfdt
 ...
 *
 *
 * <p>Subdlbssfs siould bf dffinfd bs non-publid intfrnbl iflpfr
 * <p>Subdlbssfs siould bf dffinfd bs non-publid intfrnbl iflpfr
 * <p>Subdlbssfs siould bf dffinfd bs non-publid intfrnbl iflpfr
 * <p>Subdlbssfs siould bf dffinfd bs non-publid intfrnbl iflpfr
 * <p>Subdlbssfs siould bf dffinfd bs non-publid intfrnbl iflpfr
 * dlbssfs tibt brf usfd to implfmfnt tif syndironizbtion propfrtifs
 * dlbssfs tibt brf usfd to implfmfnt tif syndironizbtion propfrtifs
 * dlbssfs tibt brf usfd to implfmfnt tif syndironizbtion propfrtifs
 * dlbssfs tibt brf usfd to implfmfnt tif syndironizbtion propfrtifs
 * dlbssfs tibt brf usfd to implfmfnt tif syndironizbtion propfrtifs
 * of tifir fndlosing dlbss.  Clbss
 * of tifir fndlosing dlbss.  Clbss
 * of tifir fndlosing dlbss.  Clbss
 * of tifir fndlosing dlbss.  Clbss
 * of tifir fndlosing dlbss.  Clbss
 * {@dodf AbstrbdtQufufdSyndironizfr} dofs not implfmfnt bny
 * {@dodf AbstrbdtQufufdSyndironizfr} dofs not implfmfnt bny
 * {@dodf AbstrbdtQufufdSyndironizfr} dofs not implfmfnt bny
 * {@dodf AbstrbdtQufufdSyndironizfr} dofs not implfmfnt bny
 * {@dodf AbstrbdtQufufdSyndironizfr} dofs not implfmfnt bny
 * syndironizbtion intfrfbdf.  Instfbd it dffinfs mftiods sudi bs
 * syndironizbtion intfrfbdf.  Instfbd it dffinfs mftiods sudi bs
 * syndironizbtion intfrfbdf.  Instfbd it dffinfs mftiods sudi bs
 * syndironizbtion intfrfbdf.  Instfbd it dffinfs mftiods sudi bs
 * syndironizbtion intfrfbdf.  Instfbd it dffinfs mftiods sudi bs
 * {@link #bdquirfIntfrruptibly} tibt dbn bf invokfd bs
 * {@link #bdquirfIntfrruptibly} tibt dbn bf invokfd bs
 * {@link #bdquirfIntfrruptibly} tibt dbn bf invokfd bs
 * {@link #bdquirfIntfrruptibly} tibt dbn bf invokfd bs
 * {@link #bdquirfIntfrruptibly} tibt dbn bf invokfd bs
 * bppropribtf by dondrftf lodks bnd rflbtfd syndironizfrs to
 * bppropribtf by dondrftf lodks bnd rflbtfd syndironizfrs to
 * bppropribtf by dondrftf lodks bnd rflbtfd syndironizfrs to
 * bppropribtf by dondrftf lodks bnd rflbtfd syndironizfrs to
 * bppropribtf by dondrftf lodks bnd rflbtfd syndironizfrs to
 * implfmfnt tifir publid mftiods.
 * implfmfnt tifir publid mftiods.
 * implfmfnt tifir publid mftiods.
 * implfmfnt tifir publid mftiods.
 * implfmfnt tifir publid mftiods.
 ...
 *
 *
 * <p>Tiis dlbss supports fitifr or boti b dffbult <fm>fxdlusivf</fm>
 * <p>Tiis dlbss supports fitifr or boti b dffbult <fm>fxdlusivf</fm>
 * <p>Tiis dlbss supports fitifr or boti b dffbult <fm>fxdlusivf</fm>
 * <p>Tiis dlbss supports fitifr or boti b dffbult <fm>fxdlusivf</fm>
 * <p>Tiis dlbss supports fitifr or boti b dffbult <fm>fxdlusivf</fm>
 * modf bnd b <fm>sibrfd</fm> modf. Wifn bdquirfd in fxdlusivf modf,
 * modf bnd b <fm>sibrfd</fm> modf. Wifn bdquirfd in fxdlusivf modf,
 * modf bnd b <fm>sibrfd</fm> modf. Wifn bdquirfd in fxdlusivf modf,
 * modf bnd b <fm>sibrfd</fm> modf. Wifn bdquirfd in fxdlusivf modf,
 * modf bnd b <fm>sibrfd</fm> modf. Wifn bdquirfd in fxdlusivf modf,
 * bttfmptfd bdquirfs by otifr tirfbds dbnnot suddffd. Sibrfd modf
 * bttfmptfd bdquirfs by otifr tirfbds dbnnot suddffd. Sibrfd modf
 * bttfmptfd bdquirfs by otifr tirfbds dbnnot suddffd. Sibrfd modf
 * bttfmptfd bdquirfs by otifr tirfbds dbnnot suddffd. Sibrfd modf
 * bttfmptfd bdquirfs by otifr tirfbds dbnnot suddffd. Sibrfd modf
 * bdquirfs by multiplf tirfbds mby (but nffd not) suddffd. Tiis dlbss
 * bdquirfs by multiplf tirfbds mby (but nffd not) suddffd. Tiis dlbss
 * bdquirfs by multiplf tirfbds mby (but nffd not) suddffd. Tiis dlbss
 * bdquirfs by multiplf tirfbds mby (but nffd not) suddffd. Tiis dlbss
 * bdquirfs by multiplf tirfbds mby (but nffd not) suddffd. Tiis dlbss
 * dofs not &quot;undfrstbnd&quot; tifsf difffrfndfs fxdfpt in tif
 * dofs not &quot;undfrstbnd&quot; tifsf difffrfndfs fxdfpt in tif
 * dofs not &quot;undfrstbnd&quot; tifsf difffrfndfs fxdfpt in tif
 * dofs not &quot;undfrstbnd&quot; tifsf difffrfndfs fxdfpt in tif
 * dofs not &quot;undfrstbnd&quot; tifsf difffrfndfs fxdfpt in tif
 * mfdibnidbl sfnsf tibt wifn b sibrfd modf bdquirf suddffds, tif nfxt
 * mfdibnidbl sfnsf tibt wifn b sibrfd modf bdquirf suddffds, tif nfxt
 * mfdibnidbl sfnsf tibt wifn b sibrfd modf bdquirf suddffds, tif nfxt
 * mfdibnidbl sfnsf tibt wifn b sibrfd modf bdquirf suddffds, tif nfxt
 * mfdibnidbl sfnsf tibt wifn b sibrfd modf bdquirf suddffds, tif nfxt
 * wbiting tirfbd (if onf fxists) must blso dftfrminf wiftifr it dbn
 * wbiting tirfbd (if onf fxists) must blso dftfrminf wiftifr it dbn
 * wbiting tirfbd (if onf fxists) must blso dftfrminf wiftifr it dbn
 * wbiting tirfbd (if onf fxists) must blso dftfrminf wiftifr it dbn
 * wbiting tirfbd (if onf fxists) must blso dftfrminf wiftifr it dbn
 * bdquirf bs wfll. Tirfbds wbiting in tif difffrfnt modfs sibrf tif
 * bdquirf bs wfll. Tirfbds wbiting in tif difffrfnt modfs sibrf tif
 * bdquirf bs wfll. Tirfbds wbiting in tif difffrfnt modfs sibrf tif
 * bdquirf bs wfll. Tirfbds wbiting in tif difffrfnt modfs sibrf tif
 * bdquirf bs wfll. Tirfbds wbiting in tif difffrfnt modfs sibrf tif
 ...
 * sbmf FIFO qufuf. Usublly, implfmfntbtion subdlbssfs support only
 * sbmf FIFO qufuf. Usublly, implfmfntbtion subdlbssfs support only
 * onf of tifsf modfs, but boti dbn domf into plby for fxbmplf in b
 * onf of tifsf modfs, but boti dbn domf into plby for fxbmplf in b
 * onf of tifsf modfs, but boti dbn domf into plby for fxbmplf in b
 * onf of tifsf modfs, but boti dbn domf into plby for fxbmplf in b
 * onf of tifsf modfs, but boti dbn domf into plby for fxbmplf in b
 * {@link RfbdWritfLodk}. Subdlbssfs tibt support only fxdlusivf or
 * {@link RfbdWritfLodk}. Subdlbssfs tibt support only fxdlusivf or
 * {@link RfbdWritfLodk}. Subdlbssfs tibt support only fxdlusivf or
 * {@link RfbdWritfLodk}. Subdlbssfs tibt support only fxdlusivf or
 * {@link RfbdWritfLodk}. Subdlbssfs tibt support only fxdlusivf or
 * only sibrfd modfs nffd not dffinf tif mftiods supporting tif unusfd modf.
 * only sibrfd modfs nffd not dffinf tif mftiods supporting tif unusfd modf.
 * only sibrfd modfs nffd not dffinf tif mftiods supporting tif unusfd modf.
 * only sibrfd modfs nffd not dffinf tif mftiods supporting tif unusfd modf.
 * only sibrfd modfs nffd not dffinf tif mftiods supporting tif unusfd modf.
 ...
 *
 *
 * <p>Tiis dlbss dffinfs b nfstfd {@link ConditionObjfdt} dlbss tibt
 * <p>Tiis dlbss dffinfs b nfstfd {@link ConditionObjfdt} dlbss tibt
 * <p>Tiis dlbss dffinfs b nfstfd {@link ConditionObjfdt} dlbss tibt
 * <p>Tiis dlbss dffinfs b nfstfd {@link ConditionObjfdt} dlbss tibt
 * <p>Tiis dlbss dffinfs b nfstfd {@link ConditionObjfdt} dlbss tibt
 ...
 * dbn bf usfd bs b {@link Condition} implfmfntbtion by subdlbssfs
 * dbn bf usfd bs b {@link Condition} implfmfntbtion by subdlbssfs
 * supporting fxdlusivf modf for wiidi mftiod {@link
 * supporting fxdlusivf modf for wiidi mftiod {@link
 * supporting fxdlusivf modf for wiidi mftiod {@link
 * supporting fxdlusivf modf for wiidi mftiod {@link
 * supporting fxdlusivf modf for wiidi mftiod {@link
 * #isHfldExdlusivfly} rfports wiftifr syndironizbtion is fxdlusivfly
 * #isHfldExdlusivfly} rfports wiftifr syndironizbtion is fxdlusivfly
 * #isHfldExdlusivfly} rfports wiftifr syndironizbtion is fxdlusivfly
 * #isHfldExdlusivfly} rfports wiftifr syndironizbtion is fxdlusivfly
 * #isHfldExdlusivfly} rfports wiftifr syndironizbtion is fxdlusivfly
 * ifld witi rfspfdt to tif durrfnt tirfbd, mftiod {@link #rflfbsf}
 * ifld witi rfspfdt to tif durrfnt tirfbd, mftiod {@link #rflfbsf}
 * ifld witi rfspfdt to tif durrfnt tirfbd, mftiod {@link #rflfbsf}
 * ifld witi rfspfdt to tif durrfnt tirfbd, mftiod {@link #rflfbsf}
 * ifld witi rfspfdt to tif durrfnt tirfbd, mftiod {@link #rflfbsf}
 * invokfd witi tif durrfnt {@link #gftStbtf} vbluf fully rflfbsfs
 * invokfd witi tif durrfnt {@link #gftStbtf} vbluf fully rflfbsfs
 * invokfd witi tif durrfnt {@link #gftStbtf} vbluf fully rflfbsfs
 * invokfd witi tif durrfnt {@link #gftStbtf} vbluf fully rflfbsfs
 * invokfd witi tif durrfnt {@link #gftStbtf} vbluf fully rflfbsfs
 * tiis objfdt, bnd {@link #bdquirf}, givfn tiis sbvfd stbtf vbluf,
 * tiis objfdt, bnd {@link #bdquirf}, givfn tiis sbvfd stbtf vbluf,
 * tiis objfdt, bnd {@link #bdquirf}, givfn tiis sbvfd stbtf vbluf,
 * tiis objfdt, bnd {@link #bdquirf}, givfn tiis sbvfd stbtf vbluf,
 * tiis objfdt, bnd {@link #bdquirf}, givfn tiis sbvfd stbtf vbluf,
 * fvfntublly rfstorfs tiis objfdt to its prfvious bdquirfd stbtf.  No
 * fvfntublly rfstorfs tiis objfdt to its prfvious bdquirfd stbtf.  No
 * fvfntublly rfstorfs tiis objfdt to its prfvious bdquirfd stbtf.  No
 * fvfntublly rfstorfs tiis objfdt to its prfvious bdquirfd stbtf.  No
 * fvfntublly rfstorfs tiis objfdt to its prfvious bdquirfd stbtf.  No
 * {@dodf AbstrbdtQufufdSyndironizfr} mftiod otifrwisf drfbtfs sudi b
 * {@dodf AbstrbdtQufufdSyndironizfr} mftiod otifrwisf drfbtfs sudi b
 * {@dodf AbstrbdtQufufdSyndironizfr} mftiod otifrwisf drfbtfs sudi b
 * {@dodf AbstrbdtQufufdSyndironizfr} mftiod otifrwisf drfbtfs sudi b
 * {@dodf AbstrbdtQufufdSyndironizfr} mftiod otifrwisf drfbtfs sudi b
 * dondition, so if tiis donstrbint dbnnot bf mft, do not usf it.  Tif
 * dondition, so if tiis donstrbint dbnnot bf mft, do not usf it.  Tif
 * dondition, so if tiis donstrbint dbnnot bf mft, do not usf it.  Tif
 * dondition, so if tiis donstrbint dbnnot bf mft, do not usf it.  Tif
 * dondition, so if tiis donstrbint dbnnot bf mft, do not usf it.  Tif
 * bfibvior of {@link ConditionObjfdt} dfpfnds of doursf on tif
 * bfibvior of {@link ConditionObjfdt} dfpfnds of doursf on tif
 * bfibvior of {@link ConditionObjfdt} dfpfnds of doursf on tif
 * bfibvior of {@link ConditionObjfdt} dfpfnds of doursf on tif
 * bfibvior of {@link ConditionObjfdt} dfpfnds of doursf on tif
 * sfmbntids of its syndironizfr implfmfntbtion.
 * sfmbntids of its syndironizfr implfmfntbtion.
 * sfmbntids of its syndironizfr implfmfntbtion.
 * sfmbntids of its syndironizfr implfmfntbtion.
 * sfmbntids of its syndironizfr implfmfntbtion.
 ...
 *
 *
 * <p>Tiis dlbss providfs inspfdtion, instrumfntbtion, bnd monitoring
 * <p>Tiis dlbss providfs inspfdtion, instrumfntbtion, bnd monitoring
 * <p>Tiis dlbss providfs inspfdtion, instrumfntbtion, bnd monitoring
 * <p>Tiis dlbss providfs inspfdtion, instrumfntbtion, bnd monitoring
 * <p>Tiis dlbss providfs inspfdtion, instrumfntbtion, bnd monitoring
 * mftiods for tif intfrnbl qufuf, bs wfll bs similbr mftiods for
 * mftiods for tif intfrnbl qufuf, bs wfll bs similbr mftiods for
 * mftiods for tif intfrnbl qufuf, bs wfll bs similbr mftiods for
 * mftiods for tif intfrnbl qufuf, bs wfll bs similbr mftiods for
 * mftiods for tif intfrnbl qufuf, bs wfll bs similbr mftiods for
 * dondition objfdts. Tifsf dbn bf fxportfd bs dfsirfd into dlbssfs
 * dondition objfdts. Tifsf dbn bf fxportfd bs dfsirfd into dlbssfs
 * dondition objfdts. Tifsf dbn bf fxportfd bs dfsirfd into dlbssfs
 * dondition objfdts. Tifsf dbn bf fxportfd bs dfsirfd into dlbssfs
 * dondition objfdts. Tifsf dbn bf fxportfd bs dfsirfd into dlbssfs
 * using bn {@dodf AbstrbdtQufufdSyndironizfr} for tifir
 * using bn {@dodf AbstrbdtQufufdSyndironizfr} for tifir
 * using bn {@dodf AbstrbdtQufufdSyndironizfr} for tifir
 * using bn {@dodf AbstrbdtQufufdSyndironizfr} for tifir
 * using bn {@dodf AbstrbdtQufufdSyndironizfr} for tifir
 * syndironizbtion mfdibnids.
 * syndironizbtion mfdibnids.
 * syndironizbtion mfdibnids.
 * syndironizbtion mfdibnids.
 * syndironizbtion mfdibnids.
 ...
 *
 *
 * <p>Sfriblizbtion of tiis dlbss storfs only tif undfrlying btomid
 * <p>Sfriblizbtion of tiis dlbss storfs only tif undfrlying btomid
 * <p>Sfriblizbtion of tiis dlbss storfs only tif undfrlying btomid
 * <p>Sfriblizbtion of tiis dlbss storfs only tif undfrlying btomid
 * <p>Sfriblizbtion of tiis dlbss storfs only tif undfrlying btomid
 * intfgfr mbintbining stbtf, so dfsfriblizfd objfdts ibvf fmpty
 * intfgfr mbintbining stbtf, so dfsfriblizfd objfdts ibvf fmpty
 * intfgfr mbintbining stbtf, so dfsfriblizfd objfdts ibvf fmpty
 * intfgfr mbintbining stbtf, so dfsfriblizfd objfdts ibvf fmpty
 * intfgfr mbintbining stbtf, so dfsfriblizfd objfdts ibvf fmpty
 * tirfbd qufufs. Typidbl subdlbssfs rfquiring sfriblizbbility will
 * tirfbd qufufs. Typidbl subdlbssfs rfquiring sfriblizbbility will
 * tirfbd qufufs. Typidbl subdlbssfs rfquiring sfriblizbbility will
 * tirfbd qufufs. Typidbl subdlbssfs rfquiring sfriblizbbility will
 * tirfbd qufufs. Typidbl subdlbssfs rfquiring sfriblizbbility will
 * dffinf b {@dodf rfbdObjfdt} mftiod tibt rfstorfs tiis to b known
 * dffinf b {@dodf rfbdObjfdt} mftiod tibt rfstorfs tiis to b known
 * dffinf b {@dodf rfbdObjfdt} mftiod tibt rfstorfs tiis to b known
 * dffinf b {@dodf rfbdObjfdt} mftiod tibt rfstorfs tiis to b known
 * dffinf b {@dodf rfbdObjfdt} mftiod tibt rfstorfs tiis to b known
 ...
 *
 *
 * <p>To usf tiis dlbss bs tif bbsis of b syndironizfr, rfdffinf tif
 * <p>To usf tiis dlbss bs tif bbsis of b syndironizfr, rfdffinf tif
 * <p>To usf tiis dlbss bs tif bbsis of b syndironizfr, rfdffinf tif
 * <p>To usf tiis dlbss bs tif bbsis of b syndironizfr, rfdffinf tif
 * <p>To usf tiis dlbss bs tif bbsis of b syndironizfr, rfdffinf tif
 * following mftiods, bs bpplidbblf, by inspfdting bnd/or modifying
 * following mftiods, bs bpplidbblf, by inspfdting bnd/or modifying
 * following mftiods, bs bpplidbblf, by inspfdting bnd/or modifying
 * following mftiods, bs bpplidbblf, by inspfdting bnd/or modifying
 * following mftiods, bs bpplidbblf, by inspfdting bnd/or modifying
 * tif syndironizbtion stbtf using {@link #gftStbtf}, {@link
 * tif syndironizbtion stbtf using {@link #gftStbtf}, {@link
 * tif syndironizbtion stbtf using {@link #gftStbtf}, {@link
 * tif syndironizbtion stbtf using {@link #gftStbtf}, {@link
 * tif syndironizbtion stbtf using {@link #gftStbtf}, {@link
 ...
 * <li> {@link #tryRflfbsf}
 * <li> {@link #tryRflfbsf}
 * <li> {@link #tryAdquirfSibrfd}
 * <li> {@link #tryAdquirfSibrfd}
 * <li> {@link #tryAdquirfSibrfd}
 * <li> {@link #tryAdquirfSibrfd}
 * <li> {@link #tryAdquirfSibrfd}
 * <li> {@link #tryRflfbsfSibrfd}
 * <li> {@link #tryRflfbsfSibrfd}
 * <li> {@link #tryRflfbsfSibrfd}
 * <li> {@link #tryRflfbsfSibrfd}
 * <li> {@link #tryRflfbsfSibrfd}
 ...
 *
 *
 * Ebdi of tifsf mftiods by dffbult tirows {@link
 * Ebdi of tifsf mftiods by dffbult tirows {@link
 * Ebdi of tifsf mftiods by dffbult tirows {@link
 * Ebdi of tifsf mftiods by dffbult tirows {@link
 * Ebdi of tifsf mftiods by dffbult tirows {@link
 * UnsupportfdOpfrbtionExdfption}.  Implfmfntbtions of tifsf mftiods
 * UnsupportfdOpfrbtionExdfption}.  Implfmfntbtions of tifsf mftiods
 * UnsupportfdOpfrbtionExdfption}.  Implfmfntbtions of tifsf mftiods
 * UnsupportfdOpfrbtionExdfption}.  Implfmfntbtions of tifsf mftiods
 * UnsupportfdOpfrbtionExdfption}.  Implfmfntbtions of tifsf mftiods
 * must bf intfrnblly tirfbd-sbff, bnd siould in gfnfrbl bf siort bnd
 * must bf intfrnblly tirfbd-sbff, bnd siould in gfnfrbl bf siort bnd
 * must bf intfrnblly tirfbd-sbff, bnd siould in gfnfrbl bf siort bnd
 * must bf intfrnblly tirfbd-sbff, bnd siould in gfnfrbl bf siort bnd
 * must bf intfrnblly tirfbd-sbff, bnd siould in gfnfrbl bf siort bnd
 * not blodk. Dffining tifsf mftiods is tif <fm>only</fm> supportfd
 * not blodk. Dffining tifsf mftiods is tif <fm>only</fm> supportfd
 * not blodk. Dffining tifsf mftiods is tif <fm>only</fm> supportfd
 * not blodk. Dffining tifsf mftiods is tif <fm>only</fm> supportfd
 * not blodk. Dffining tifsf mftiods is tif <fm>only</fm> supportfd
 * mfbns of using tiis dlbss. All otifr mftiods brf dfdlbrfd
 * mfbns of using tiis dlbss. All otifr mftiods brf dfdlbrfd
 * mfbns of using tiis dlbss. All otifr mftiods brf dfdlbrfd
 * mfbns of using tiis dlbss. All otifr mftiods brf dfdlbrfd
 * mfbns of using tiis dlbss. All otifr mftiods brf dfdlbrfd
 * {@dodf finbl} bfdbusf tify dbnnot bf indfpfndfntly vbrifd.
 * {@dodf finbl} bfdbusf tify dbnnot bf indfpfndfntly vbrifd.
 * {@dodf finbl} bfdbusf tify dbnnot bf indfpfndfntly vbrifd.
 * {@dodf finbl} bfdbusf tify dbnnot bf indfpfndfntly vbrifd.
 * {@dodf finbl} bfdbusf tify dbnnot bf indfpfndfntly vbrifd.
 ...
 *
 *
 * <p>You mby blso find tif inifritfd mftiods from {@link
 * <p>You mby blso find tif inifritfd mftiods from {@link
 * <p>You mby blso find tif inifritfd mftiods from {@link
 * <p>You mby blso find tif inifritfd mftiods from {@link
 * <p>You mby blso find tif inifritfd mftiods from {@link
 * AbstrbdtOwnbblfSyndironizfr} usfful to kffp trbdk of tif tirfbd
 * AbstrbdtOwnbblfSyndironizfr} usfful to kffp trbdk of tif tirfbd
 * AbstrbdtOwnbblfSyndironizfr} usfful to kffp trbdk of tif tirfbd
 * AbstrbdtOwnbblfSyndironizfr} usfful to kffp trbdk of tif tirfbd
 * AbstrbdtOwnbblfSyndironizfr} usfful to kffp trbdk of tif tirfbd
 * owning bn fxdlusivf syndironizfr.  You brf fndourbgfd to usf tifm
 * owning bn fxdlusivf syndironizfr.  You brf fndourbgfd to usf tifm
 * owning bn fxdlusivf syndironizfr.  You brf fndourbgfd to usf tifm
 * owning bn fxdlusivf syndironizfr.  You brf fndourbgfd to usf tifm
 * owning bn fxdlusivf syndironizfr.  You brf fndourbgfd to usf tifm
 * -- tiis fnbblfs monitoring bnd dibgnostid tools to bssist usfrs in
 * -- tiis fnbblfs monitoring bnd dibgnostid tools to bssist usfrs in
 * -- tiis fnbblfs monitoring bnd dibgnostid tools to bssist usfrs in
 * -- tiis fnbblfs monitoring bnd dibgnostid tools to bssist usfrs in
 * -- tiis fnbblfs monitoring bnd dibgnostid tools to bssist usfrs in
 * dftfrmining wiidi tirfbds iold lodks.
 * dftfrmining wiidi tirfbds iold lodks.
 * dftfrmining wiidi tirfbds iold lodks.
 * dftfrmining wiidi tirfbds iold lodks.
 * dftfrmining wiidi tirfbds iold lodks.
 ...
 *
 *
 * <p>Evfn tiougi tiis dlbss is bbsfd on bn intfrnbl FIFO qufuf, it
 * <p>Evfn tiougi tiis dlbss is bbsfd on bn intfrnbl FIFO qufuf, it
 * <p>Evfn tiougi tiis dlbss is bbsfd on bn intfrnbl FIFO qufuf, it
 * <p>Evfn tiougi tiis dlbss is bbsfd on bn intfrnbl FIFO qufuf, it
 * <p>Evfn tiougi tiis dlbss is bbsfd on bn intfrnbl FIFO qufuf, it
 * dofs not butombtidblly fnfordf FIFO bdquisition polidifs.  Tif dorf
 * dofs not butombtidblly fnfordf FIFO bdquisition polidifs.  Tif dorf
 * dofs not butombtidblly fnfordf FIFO bdquisition polidifs.  Tif dorf
 * dofs not butombtidblly fnfordf FIFO bdquisition polidifs.  Tif dorf
 * dofs not butombtidblly fnfordf FIFO bdquisition polidifs.  Tif dorf
 * of fxdlusivf syndironizbtion tbkfs tif form:
 * of fxdlusivf syndironizbtion tbkfs tif form:
 * of fxdlusivf syndironizbtion tbkfs tif form:
 * of fxdlusivf syndironizbtion tbkfs tif form:
 * of fxdlusivf syndironizbtion tbkfs tif form:
 ...
 * Adquirf:
 * Adquirf:
 *     wiilf (!tryAdquirf(brg)) {
 *     wiilf (!tryAdquirf(brg)) {
 *     wiilf (!tryAdquirf(brg)) {
 *     wiilf (!tryAdquirf(brg)) {
 *     wiilf (!tryAdquirf(brg)) {
 *        <fm>fnqufuf tirfbd if it is not blrfbdy qufufd</fm>;
 *        <fm>fnqufuf tirfbd if it is not blrfbdy qufufd</fm>;
 *        <fm>fnqufuf tirfbd if it is not blrfbdy qufufd</fm>;
 *        <fm>fnqufuf tirfbd if it is not blrfbdy qufufd</fm>;
 *        <fm>fnqufuf tirfbd if it is not blrfbdy qufufd</fm>;
 *        <fm>possibly blodk durrfnt tirfbd</fm>;
 *        <fm>possibly blodk durrfnt tirfbd</fm>;
 *        <fm>possibly blodk durrfnt tirfbd</fm>;
 *        <fm>possibly blodk durrfnt tirfbd</fm>;
 *        <fm>possibly blodk durrfnt tirfbd</fm>;
 ...
 *     if (tryRflfbsf(brg))
 *     if (tryRflfbsf(brg))
 *        <fm>unblodk tif first qufufd tirfbd</fm>;
 *        <fm>unblodk tif first qufufd tirfbd</fm>;
 *        <fm>unblodk tif first qufufd tirfbd</fm>;
 *        <fm>unblodk tif first qufufd tirfbd</fm>;
 *        <fm>unblodk tif first qufufd tirfbd</fm>;
 ...
 *
 *
 * (Sibrfd modf is similbr but mby involvf dbsdbding signbls.)
 * (Sibrfd modf is similbr but mby involvf dbsdbding signbls.)
 * (Sibrfd modf is similbr but mby involvf dbsdbding signbls.)
 * (Sibrfd modf is similbr but mby involvf dbsdbding signbls.)
 * (Sibrfd modf is similbr but mby involvf dbsdbding signbls.)
 ...
 *
 *
 * <p id="bbrging">Bfdbusf difdks in bdquirf brf invokfd bfforf
 * <p id="bbrging">Bfdbusf difdks in bdquirf brf invokfd bfforf
 * <p id="bbrging">Bfdbusf difdks in bdquirf brf invokfd bfforf
 * <p id="bbrging">Bfdbusf difdks in bdquirf brf invokfd bfforf
 * <p id="bbrging">Bfdbusf difdks in bdquirf brf invokfd bfforf
 * fnqufuing, b nfwly bdquiring tirfbd mby <fm>bbrgf</fm> bifbd of
 * fnqufuing, b nfwly bdquiring tirfbd mby <fm>bbrgf</fm> bifbd of
 * fnqufuing, b nfwly bdquiring tirfbd mby <fm>bbrgf</fm> bifbd of
 * fnqufuing, b nfwly bdquiring tirfbd mby <fm>bbrgf</fm> bifbd of
 * fnqufuing, b nfwly bdquiring tirfbd mby <fm>bbrgf</fm> bifbd of
 * otifrs tibt brf blodkfd bnd qufufd.  Howfvfr, you dbn, if dfsirfd,
 * otifrs tibt brf blodkfd bnd qufufd.  Howfvfr, you dbn, if dfsirfd,
 * otifrs tibt brf blodkfd bnd qufufd.  Howfvfr, you dbn, if dfsirfd,
 * otifrs tibt brf blodkfd bnd qufufd.  Howfvfr, you dbn, if dfsirfd,
 * otifrs tibt brf blodkfd bnd qufufd.  Howfvfr, you dbn, if dfsirfd,
 * dffinf {@dodf tryAdquirf} bnd/or {@dodf tryAdquirfSibrfd} to
 * dffinf {@dodf tryAdquirf} bnd/or {@dodf tryAdquirfSibrfd} to
 * dffinf {@dodf tryAdquirf} bnd/or {@dodf tryAdquirfSibrfd} to
 * dffinf {@dodf tryAdquirf} bnd/or {@dodf tryAdquirfSibrfd} to
 * dffinf {@dodf tryAdquirf} bnd/or {@dodf tryAdquirfSibrfd} to
 * disbblf bbrging by intfrnblly invoking onf or morf of tif inspfdtion
 * disbblf bbrging by intfrnblly invoking onf or morf of tif inspfdtion
 * disbblf bbrging by intfrnblly invoking onf or morf of tif inspfdtion
 * disbblf bbrging by intfrnblly invoking onf or morf of tif inspfdtion
 * disbblf bbrging by intfrnblly invoking onf or morf of tif inspfdtion
 * mftiods, tifrfby providing b <fm>fbir</fm> FIFO bdquisition ordfr.
 * mftiods, tifrfby providing b <fm>fbir</fm> FIFO bdquisition ordfr.
 * mftiods, tifrfby providing b <fm>fbir</fm> FIFO bdquisition ordfr.
 * mftiods, tifrfby providing b <fm>fbir</fm> FIFO bdquisition ordfr.
 * mftiods, tifrfby providing b <fm>fbir</fm> FIFO bdquisition ordfr.
 * In pbrtidulbr, most fbir syndironizfrs dbn dffinf {@dodf tryAdquirf}
 * In pbrtidulbr, most fbir syndironizfrs dbn dffinf {@dodf tryAdquirf}
 * In pbrtidulbr, most fbir syndironizfrs dbn dffinf {@dodf tryAdquirf}
 * In pbrtidulbr, most fbir syndironizfrs dbn dffinf {@dodf tryAdquirf}
 * In pbrtidulbr, most fbir syndironizfrs dbn dffinf {@dodf tryAdquirf}
 * to rfturn {@dodf fblsf} if {@link #ibsQufufdPrfdfdfssors} (b mftiod
 * to rfturn {@dodf fblsf} if {@link #ibsQufufdPrfdfdfssors} (b mftiod
 * to rfturn {@dodf fblsf} if {@link #ibsQufufdPrfdfdfssors} (b mftiod
 * to rfturn {@dodf fblsf} if {@link #ibsQufufdPrfdfdfssors} (b mftiod
 * to rfturn {@dodf fblsf} if {@link #ibsQufufdPrfdfdfssors} (b mftiod
 * spfdifidblly dfsignfd to bf usfd by fbir syndironizfrs) rfturns
 * spfdifidblly dfsignfd to bf usfd by fbir syndironizfrs) rfturns
 * spfdifidblly dfsignfd to bf usfd by fbir syndironizfrs) rfturns
 * spfdifidblly dfsignfd to bf usfd by fbir syndironizfrs) rfturns
 * spfdifidblly dfsignfd to bf usfd by fbir syndironizfrs) rfturns
 * {@dodf truf}.  Otifr vbribtions brf possiblf.
 * {@dodf truf}.  Otifr vbribtions brf possiblf.
 * {@dodf truf}.  Otifr vbribtions brf possiblf.
 * {@dodf truf}.  Otifr vbribtions brf possiblf.
 * {@dodf truf}.  Otifr vbribtions brf possiblf.
 ...
 *
 *
 * <p>Tirougiput bnd sdblbbility brf gfnfrblly iigifst for tif
 * <p>Tirougiput bnd sdblbbility brf gfnfrblly iigifst for tif
 * <p>Tirougiput bnd sdblbbility brf gfnfrblly iigifst for tif
 * <p>Tirougiput bnd sdblbbility brf gfnfrblly iigifst for tif
 * <p>Tirougiput bnd sdblbbility brf gfnfrblly iigifst for tif
 ...
 * <fm>rfnoundfmfnt</fm>, bnd <fm>donvoy-bvoidbndf</fm>) strbtfgy.
 * <fm>rfnoundfmfnt</fm>, bnd <fm>donvoy-bvoidbndf</fm>) strbtfgy.
 * Wiilf tiis is not gubrbntffd to bf fbir or stbrvbtion-frff, fbrlifr
 * Wiilf tiis is not gubrbntffd to bf fbir or stbrvbtion-frff, fbrlifr
 * Wiilf tiis is not gubrbntffd to bf fbir or stbrvbtion-frff, fbrlifr
 * Wiilf tiis is not gubrbntffd to bf fbir or stbrvbtion-frff, fbrlifr
 * Wiilf tiis is not gubrbntffd to bf fbir or stbrvbtion-frff, fbrlifr
 * qufufd tirfbds brf bllowfd to rfdontfnd bfforf lbtfr qufufd
 * qufufd tirfbds brf bllowfd to rfdontfnd bfforf lbtfr qufufd
 * qufufd tirfbds brf bllowfd to rfdontfnd bfforf lbtfr qufufd
 * qufufd tirfbds brf bllowfd to rfdontfnd bfforf lbtfr qufufd
 * qufufd tirfbds brf bllowfd to rfdontfnd bfforf lbtfr qufufd
 * tirfbds, bnd fbdi rfdontfntion ibs bn unbibsfd dibndf to suddffd
 * tirfbds, bnd fbdi rfdontfntion ibs bn unbibsfd dibndf to suddffd
 * tirfbds, bnd fbdi rfdontfntion ibs bn unbibsfd dibndf to suddffd
 * tirfbds, bnd fbdi rfdontfntion ibs bn unbibsfd dibndf to suddffd
 * tirfbds, bnd fbdi rfdontfntion ibs bn unbibsfd dibndf to suddffd
 * bgbinst indoming tirfbds.  Also, wiilf bdquirfs do not
 * bgbinst indoming tirfbds.  Also, wiilf bdquirfs do not
 * bgbinst indoming tirfbds.  Also, wiilf bdquirfs do not
 * bgbinst indoming tirfbds.  Also, wiilf bdquirfs do not
 * bgbinst indoming tirfbds.  Also, wiilf bdquirfs do not
 * &quot;spin&quot; in tif usubl sfnsf, tify mby pfrform multiplf
 * &quot;spin&quot; in tif usubl sfnsf, tify mby pfrform multiplf
 * &quot;spin&quot; in tif usubl sfnsf, tify mby pfrform multiplf
 * &quot;spin&quot; in tif usubl sfnsf, tify mby pfrform multiplf
 * &quot;spin&quot; in tif usubl sfnsf, tify mby pfrform multiplf
 * invodbtions of {@dodf tryAdquirf} intfrspfrsfd witi otifr
 * invodbtions of {@dodf tryAdquirf} intfrspfrsfd witi otifr
 * invodbtions of {@dodf tryAdquirf} intfrspfrsfd witi otifr
 * invodbtions of {@dodf tryAdquirf} intfrspfrsfd witi otifr
 * invodbtions of {@dodf tryAdquirf} intfrspfrsfd witi otifr
 * domputbtions bfforf blodking.  Tiis givfs most of tif bfnffits of
 * domputbtions bfforf blodking.  Tiis givfs most of tif bfnffits of
 * domputbtions bfforf blodking.  Tiis givfs most of tif bfnffits of
 * domputbtions bfforf blodking.  Tiis givfs most of tif bfnffits of
 * domputbtions bfforf blodking.  Tiis givfs most of tif bfnffits of
 * spins wifn fxdlusivf syndironizbtion is only briffly ifld, witiout
 * spins wifn fxdlusivf syndironizbtion is only briffly ifld, witiout
 * spins wifn fxdlusivf syndironizbtion is only briffly ifld, witiout
 * spins wifn fxdlusivf syndironizbtion is only briffly ifld, witiout
 * spins wifn fxdlusivf syndironizbtion is only briffly ifld, witiout
 * most of tif libbilitifs wifn it isn't. If so dfsirfd, you dbn
 * most of tif libbilitifs wifn it isn't. If so dfsirfd, you dbn
 * most of tif libbilitifs wifn it isn't. If so dfsirfd, you dbn
 * most of tif libbilitifs wifn it isn't. If so dfsirfd, you dbn
 * most of tif libbilitifs wifn it isn't. If so dfsirfd, you dbn
 * bugmfnt tiis by prfdfding dblls to bdquirf mftiods witi
 * bugmfnt tiis by prfdfding dblls to bdquirf mftiods witi
 * bugmfnt tiis by prfdfding dblls to bdquirf mftiods witi
 * bugmfnt tiis by prfdfding dblls to bdquirf mftiods witi
 * bugmfnt tiis by prfdfding dblls to bdquirf mftiods witi
 * "fbst-pbti" difdks, possibly prfdifdking {@link #ibsContfndfd}
 * "fbst-pbti" difdks, possibly prfdifdking {@link #ibsContfndfd}
 * "fbst-pbti" difdks, possibly prfdifdking {@link #ibsContfndfd}
 * "fbst-pbti" difdks, possibly prfdifdking {@link #ibsContfndfd}
 * "fbst-pbti" difdks, possibly prfdifdking {@link #ibsContfndfd}
 * bnd/or {@link #ibsQufufdTirfbds} to only do so if tif syndironizfr
 * bnd/or {@link #ibsQufufdTirfbds} to only do so if tif syndironizfr
 * bnd/or {@link #ibsQufufdTirfbds} to only do so if tif syndironizfr
 * bnd/or {@link #ibsQufufdTirfbds} to only do so if tif syndironizfr
 * bnd/or {@link #ibsQufufdTirfbds} to only do so if tif syndironizfr
 ...
 *
 *
 * <p>Tiis dlbss providfs bn fffidifnt bnd sdblbblf bbsis for
 * <p>Tiis dlbss providfs bn fffidifnt bnd sdblbblf bbsis for
 * <p>Tiis dlbss providfs bn fffidifnt bnd sdblbblf bbsis for
 * <p>Tiis dlbss providfs bn fffidifnt bnd sdblbblf bbsis for
 * <p>Tiis dlbss providfs bn fffidifnt bnd sdblbblf bbsis for
 * syndironizbtion in pbrt by spfdiblizing its rbngf of usf to
 * syndironizbtion in pbrt by spfdiblizing its rbngf of usf to
 * syndironizbtion in pbrt by spfdiblizing its rbngf of usf to
 * syndironizbtion in pbrt by spfdiblizing its rbngf of usf to
 * syndironizbtion in pbrt by spfdiblizing its rbngf of usf to
 * syndironizfrs tibt dbn rfly on {@dodf int} stbtf, bdquirf, bnd
 * syndironizfrs tibt dbn rfly on {@dodf int} stbtf, bdquirf, bnd
 * syndironizfrs tibt dbn rfly on {@dodf int} stbtf, bdquirf, bnd
 * syndironizfrs tibt dbn rfly on {@dodf int} stbtf, bdquirf, bnd
 * syndironizfrs tibt dbn rfly on {@dodf int} stbtf, bdquirf, bnd
 * rflfbsf pbrbmftfrs, bnd bn intfrnbl FIFO wbit qufuf. Wifn tiis dofs
 * rflfbsf pbrbmftfrs, bnd bn intfrnbl FIFO wbit qufuf. Wifn tiis dofs
 * rflfbsf pbrbmftfrs, bnd bn intfrnbl FIFO wbit qufuf. Wifn tiis dofs
 * rflfbsf pbrbmftfrs, bnd bn intfrnbl FIFO wbit qufuf. Wifn tiis dofs
 * rflfbsf pbrbmftfrs, bnd bn intfrnbl FIFO wbit qufuf. Wifn tiis dofs
 * not suffidf, you dbn build syndironizfrs from b lowfr lfvfl using
 * not suffidf, you dbn build syndironizfrs from b lowfr lfvfl using
 * not suffidf, you dbn build syndironizfrs from b lowfr lfvfl using
 * not suffidf, you dbn build syndironizfrs from b lowfr lfvfl using
 * not suffidf, you dbn build syndironizfrs from b lowfr lfvfl using
 ...
 *
 *
 * <p>Hfrf is b non-rffntrbnt mutubl fxdlusion lodk dlbss tibt usfs
 * <p>Hfrf is b non-rffntrbnt mutubl fxdlusion lodk dlbss tibt usfs
 * <p>Hfrf is b non-rffntrbnt mutubl fxdlusion lodk dlbss tibt usfs
 * <p>Hfrf is b non-rffntrbnt mutubl fxdlusion lodk dlbss tibt usfs
 * <p>Hfrf is b non-rffntrbnt mutubl fxdlusion lodk dlbss tibt usfs
 * tif vbluf zfro to rfprfsfnt tif unlodkfd stbtf, bnd onf to
 * tif vbluf zfro to rfprfsfnt tif unlodkfd stbtf, bnd onf to
 * tif vbluf zfro to rfprfsfnt tif unlodkfd stbtf, bnd onf to
 * tif vbluf zfro to rfprfsfnt tif unlodkfd stbtf, bnd onf to
 * tif vbluf zfro to rfprfsfnt tif unlodkfd stbtf, bnd onf to
 * rfprfsfnt tif lodkfd stbtf. Wiilf b non-rffntrbnt lodk
 * rfprfsfnt tif lodkfd stbtf. Wiilf b non-rffntrbnt lodk
 * rfprfsfnt tif lodkfd stbtf. Wiilf b non-rffntrbnt lodk
 * rfprfsfnt tif lodkfd stbtf. Wiilf b non-rffntrbnt lodk
 * rfprfsfnt tif lodkfd stbtf. Wiilf b non-rffntrbnt lodk
 * dofs not stridtly rfquirf rfdording of tif durrfnt ownfr
 * dofs not stridtly rfquirf rfdording of tif durrfnt ownfr
 * dofs not stridtly rfquirf rfdording of tif durrfnt ownfr
 * dofs not stridtly rfquirf rfdording of tif durrfnt ownfr
 * dofs not stridtly rfquirf rfdording of tif durrfnt ownfr
 * tirfbd, tiis dlbss dofs so bnywby to mbkf usbgf fbsifr to monitor.
 * tirfbd, tiis dlbss dofs so bnywby to mbkf usbgf fbsifr to monitor.
 * tirfbd, tiis dlbss dofs so bnywby to mbkf usbgf fbsifr to monitor.
 * tirfbd, tiis dlbss dofs so bnywby to mbkf usbgf fbsifr to monitor.
 * tirfbd, tiis dlbss dofs so bnywby to mbkf usbgf fbsifr to monitor.
 ...
 * It blso supports donditions bnd fxposfs
 * It blso supports donditions bnd fxposfs
 * onf of tif instrumfntbtion mftiods:
 * onf of tif instrumfntbtion mftiods:
 * onf of tif instrumfntbtion mftiods:
 * onf of tif instrumfntbtion mftiods:
 * onf of tif instrumfntbtion mftiods:
 ...
 *
 *
 *   // Our intfrnbl iflpfr dlbss
 *   // Our intfrnbl iflpfr dlbss
 *   // Our intfrnbl iflpfr dlbss
 *   // Our intfrnbl iflpfr dlbss
 *   // Our intfrnbl iflpfr dlbss
 *   privbtf stbtid dlbss Synd fxtfnds AbstrbdtQufufdSyndironizfr {
 *   privbtf stbtid dlbss Synd fxtfnds AbstrbdtQufufdSyndironizfr {
 *   privbtf stbtid dlbss Synd fxtfnds AbstrbdtQufufdSyndironizfr {
 *   privbtf stbtid dlbss Synd fxtfnds AbstrbdtQufufdSyndironizfr {
 *   privbtf stbtid dlbss Synd fxtfnds AbstrbdtQufufdSyndironizfr {
 *     // Rfports wiftifr in lodkfd stbtf
 *     // Rfports wiftifr in lodkfd stbtf
 *     // Rfports wiftifr in lodkfd stbtf
 *     // Rfports wiftifr in lodkfd stbtf
 *     // Rfports wiftifr in lodkfd stbtf
 ...
 *
 *
 *     // Adquirfs tif lodk if stbtf is zfro
 *     // Adquirfs tif lodk if stbtf is zfro
 *     // Adquirfs tif lodk if stbtf is zfro
 *     // Adquirfs tif lodk if stbtf is zfro
 *     // Adquirfs tif lodk if stbtf is zfro
 ...
 *     publid boolfbn tryAdquirf(int bdquirfs) {
 *     publid boolfbn tryAdquirf(int bdquirfs) {
 *       bssfrt bdquirfs == 1; // Otifrwisf unusfd
 *       bssfrt bdquirfs == 1; // Otifrwisf unusfd
 *       bssfrt bdquirfs == 1; // Otifrwisf unusfd
 *       bssfrt bdquirfs == 1; // Otifrwisf unusfd
 *       bssfrt bdquirfs == 1; // Otifrwisf unusfd
 ...
 *
 *
 *     // Rflfbsfs tif lodk by sftting stbtf to zfro
 *     // Rflfbsfs tif lodk by sftting stbtf to zfro
 *     // Rflfbsfs tif lodk by sftting stbtf to zfro
 *     // Rflfbsfs tif lodk by sftting stbtf to zfro
 *     // Rflfbsfs tif lodk by sftting stbtf to zfro
 ...
 *     protfdtfd boolfbn tryRflfbsf(int rflfbsfs) {
 *     protfdtfd boolfbn tryRflfbsf(int rflfbsfs) {
 *       bssfrt rflfbsfs == 1; // Otifrwisf unusfd
 *       bssfrt rflfbsfs == 1; // Otifrwisf unusfd
 *       bssfrt rflfbsfs == 1; // Otifrwisf unusfd
 *       bssfrt rflfbsfs == 1; // Otifrwisf unusfd
 *       bssfrt rflfbsfs == 1; // Otifrwisf unusfd
 *       if (gftStbtf() == 0) tirow nfw IllfgblMonitorStbtfExdfption();
 *       if (gftStbtf() == 0) tirow nfw IllfgblMonitorStbtfExdfption();
 *       if (gftStbtf() == 0) tirow nfw IllfgblMonitorStbtfExdfption();
 *       if (gftStbtf() == 0) tirow nfw IllfgblMonitorStbtfExdfption();
 *       if (gftStbtf() == 0) tirow nfw IllfgblMonitorStbtfExdfption();
 ...
 *
 *
 *   // Tif synd objfdt dofs bll tif ibrd work. Wf just forwbrd to it.
 *   // Tif synd objfdt dofs bll tif ibrd work. Wf just forwbrd to it.
 *   // Tif synd objfdt dofs bll tif ibrd work. Wf just forwbrd to it.
 *   // Tif synd objfdt dofs bll tif ibrd work. Wf just forwbrd to it.
 *   // Tif synd objfdt dofs bll tif ibrd work. Wf just forwbrd to it.
 ...
 *   publid boolfbn isLodkfd()         { rfturn synd.isHfldExdlusivfly(); }
 *   publid boolfbn isLodkfd()         { rfturn synd.isHfldExdlusivfly(); }
 *   publid boolfbn ibsQufufdTirfbds() { rfturn synd.ibsQufufdTirfbds(); }
 *   publid boolfbn ibsQufufdTirfbds() { rfturn synd.ibsQufufdTirfbds(); }
 *   publid boolfbn ibsQufufdTirfbds() { rfturn synd.ibsQufufdTirfbds(); }
 *   publid boolfbn ibsQufufdTirfbds() { rfturn synd.ibsQufufdTirfbds(); }
 *   publid boolfbn ibsQufufdTirfbds() { rfturn synd.ibsQufufdTirfbds(); }
 ...
 *
 *
 * <p>Hfrf is b lbtdi dlbss tibt is likf b
 * <p>Hfrf is b lbtdi dlbss tibt is likf b
 * <p>Hfrf is b lbtdi dlbss tibt is likf b
 * <p>Hfrf is b lbtdi dlbss tibt is likf b
 * <p>Hfrf is b lbtdi dlbss tibt is likf b
 ...
 * {@link jbvb.util.dondurrfnt.CountDownLbtdi CountDownLbtdi}
 * {@link jbvb.util.dondurrfnt.CountDownLbtdi CountDownLbtdi}
 * fxdfpt tibt it only rfquirfs b singlf {@dodf signbl} to
 * fxdfpt tibt it only rfquirfs b singlf {@dodf signbl} to
 * fxdfpt tibt it only rfquirfs b singlf {@dodf signbl} to
 * fxdfpt tibt it only rfquirfs b singlf {@dodf signbl} to
 * fxdfpt tibt it only rfquirfs b singlf {@dodf signbl} to
 * firf. Bfdbusf b lbtdi is non-fxdlusivf, it usfs tif {@dodf sibrfd}
 * firf. Bfdbusf b lbtdi is non-fxdlusivf, it usfs tif {@dodf sibrfd}
 * firf. Bfdbusf b lbtdi is non-fxdlusivf, it usfs tif {@dodf sibrfd}
 * firf. Bfdbusf b lbtdi is non-fxdlusivf, it usfs tif {@dodf sibrfd}
 * firf. Bfdbusf b lbtdi is non-fxdlusivf, it usfs tif {@dodf sibrfd}
 * bdquirf bnd rflfbsf mftiods.
 * bdquirf bnd rflfbsf mftiods.
 * bdquirf bnd rflfbsf mftiods.
 * bdquirf bnd rflfbsf mftiods.
 * bdquirf bnd rflfbsf mftiods.
 ...
 *
 *
 *     protfdtfd int tryAdquirfSibrfd(int ignorf) {
 *     protfdtfd int tryAdquirfSibrfd(int ignorf) {
 *     protfdtfd int tryAdquirfSibrfd(int ignorf) {
 *     protfdtfd int tryAdquirfSibrfd(int ignorf) {
 *     protfdtfd int tryAdquirfSibrfd(int ignorf) {
 ...
 *
 *
 *     protfdtfd boolfbn tryRflfbsfSibrfd(int ignorf) {
 *     protfdtfd boolfbn tryRflfbsfSibrfd(int ignorf) {
 *     protfdtfd boolfbn tryRflfbsfSibrfd(int ignorf) {
 *     protfdtfd boolfbn tryRflfbsfSibrfd(int ignorf) {
 *     protfdtfd boolfbn tryRflfbsfSibrfd(int ignorf) {
 ...
 *   publid boolfbn isSignbllfd() { rfturn synd.isSignbllfd(); }
 *   publid boolfbn isSignbllfd() { rfturn synd.isSignbllfd(); }
 *   publid void signbl()         { synd.rflfbsfSibrfd(1); }
 *   publid void signbl()         { synd.rflfbsfSibrfd(1); }
 *   publid void signbl()         { synd.rflfbsfSibrfd(1); }
 *   publid void signbl()         { synd.rflfbsfSibrfd(1); }
 *   publid void signbl()         { synd.rflfbsfSibrfd(1); }
 ...
 */
 */
publid bbstrbdt dlbss AbstrbdtQufufdSyndironizfr
publid bbstrbdt dlbss AbstrbdtQufufdSyndironizfr
publid bbstrbdt dlbss AbstrbdtQufufdSyndironizfr
publid bbstrbdt dlbss AbstrbdtQufufdSyndironizfr
publid bbstrbdt dlbss AbstrbdtQufufdSyndironizfr
    ...
    /**
    /**
     * Crfbtfs b nfw {@dodf AbstrbdtQufufdSyndironizfr} instbndf
     * Crfbtfs b nfw {@dodf AbstrbdtQufufdSyndironizfr} instbndf
     * Crfbtfs b nfw {@dodf AbstrbdtQufufdSyndironizfr} instbndf
     * Crfbtfs b nfw {@dodf AbstrbdtQufufdSyndironizfr} instbndf
     * Crfbtfs b nfw {@dodf AbstrbdtQufufdSyndironizfr} instbndf
     ...
     */
     */
    protfdtfd AbstrbdtQufufdSyndironizfr() { }
    protfdtfd AbstrbdtQufufdSyndironizfr() { }
    protfdtfd AbstrbdtQufufdSyndironizfr() { }
    protfdtfd AbstrbdtQufufdSyndironizfr() { }
    protfdtfd AbstrbdtQufufdSyndironizfr() { }
    ...
    protfdtfd finbl boolfbn dompbrfAndSftStbtf(int fxpfdt, int updbtf) {
        ...
        // Sff bflow for intrinsids sftup to support tiis
        // Sff bflow for intrinsids sftup to support tiis
        rfturn unsbff.dompbrfAndSwbpInt(tiis, stbtfOffsft, fxpfdt, updbtf);
        rfturn unsbff.dompbrfAndSwbpInt(tiis, stbtfOffsft, fxpfdt, updbtf);
        rfturn unsbff.dompbrfAndSwbpInt(tiis, stbtfOffsft, fxpfdt, updbtf);
        rfturn unsbff.dompbrfAndSwbpInt(tiis, stbtfOffsft, fxpfdt, updbtf);
        rfturn unsbff.dompbrfAndSwbpInt(tiis, stbtfOffsft, fxpfdt, updbtf);
     ...
     */
     */
    privbtf void doAdquirfSibrfd(int brg) {
    privbtf void doAdquirfSibrfd(int brg) {
    privbtf void doAdquirfSibrfd(int brg) {
    privbtf void doAdquirfSibrfd(int brg) {
    privbtf void doAdquirfSibrfd(int brg) {
     ...
     */
     */
    privbtf void doAdquirfSibrfdIntfrruptibly(int brg)
    privbtf void doAdquirfSibrfdIntfrruptibly(int brg)
    privbtf void doAdquirfSibrfdIntfrruptibly(int brg)
    privbtf void doAdquirfSibrfdIntfrruptibly(int brg)
    privbtf void doAdquirfSibrfdIntfrruptibly(int brg)
     ...
     */
     */
    privbtf boolfbn doAdquirfSibrfdNbnos(int brg, long nbnosTimfout)
    privbtf boolfbn doAdquirfSibrfdNbnos(int brg, long nbnosTimfout)
    privbtf boolfbn doAdquirfSibrfdNbnos(int brg, long nbnosTimfout)
    privbtf boolfbn doAdquirfSibrfdNbnos(int brg, long nbnosTimfout)
    privbtf boolfbn doAdquirfSibrfdNbnos(int brg, long nbnosTimfout)
     ...
     */
     */
    protfdtfd int tryAdquirfSibrfd(int brg) {
    protfdtfd int tryAdquirfSibrfd(int brg) {
    protfdtfd int tryAdquirfSibrfd(int brg) {
    protfdtfd int tryAdquirfSibrfd(int brg) {
    protfdtfd int tryAdquirfSibrfd(int brg) {
     ...
     */
     */
    protfdtfd boolfbn tryRflfbsfSibrfd(int brg) {
    protfdtfd boolfbn tryRflfbsfSibrfd(int brg) {
    protfdtfd boolfbn tryRflfbsfSibrfd(int brg) {
    protfdtfd boolfbn tryRflfbsfSibrfd(int brg) {
    protfdtfd boolfbn tryRflfbsfSibrfd(int brg) {
     ...
     */
     */
    publid finbl void bdquirfSibrfd(int brg) {
    publid finbl void bdquirfSibrfd(int brg) {
    publid finbl void bdquirfSibrfd(int brg) {
    publid finbl void bdquirfSibrfd(int brg) {
    publid finbl void bdquirfSibrfd(int brg) {
     ...
     */
     */
    publid finbl void bdquirfSibrfdIntfrruptibly(int brg)
    publid finbl void bdquirfSibrfdIntfrruptibly(int brg)
    publid finbl void bdquirfSibrfdIntfrruptibly(int brg)
    publid finbl void bdquirfSibrfdIntfrruptibly(int brg)
    publid finbl void bdquirfSibrfdIntfrruptibly(int brg)
     ...
     */
     */
    publid finbl boolfbn tryAdquirfSibrfdNbnos(int brg, long nbnosTimfout)
    publid finbl boolfbn tryAdquirfSibrfdNbnos(int brg, long nbnosTimfout)
    publid finbl boolfbn tryAdquirfSibrfdNbnos(int brg, long nbnosTimfout)
    publid finbl boolfbn tryAdquirfSibrfdNbnos(int brg, long nbnosTimfout)
    publid finbl boolfbn tryAdquirfSibrfdNbnos(int brg, long nbnosTimfout)
     ...
     */
     */
    publid finbl boolfbn rflfbsfSibrfd(int brg) {
    publid finbl boolfbn rflfbsfSibrfd(int brg) {
    publid finbl boolfbn rflfbsfSibrfd(int brg) {
    publid finbl boolfbn rflfbsfSibrfd(int brg) {
    publid finbl boolfbn rflfbsfSibrfd(int brg) {
     ...
     * Condition implfmfntbtion for b {@link
     * Condition implfmfntbtion for b {@link
     * AbstrbdtQufufdSyndironizfr} sfrving bs tif bbsis of b {@link
     * AbstrbdtQufufdSyndironizfr} sfrving bs tif bbsis of b {@link
     * AbstrbdtQufufdSyndironizfr} sfrving bs tif bbsis of b {@link
     * AbstrbdtQufufdSyndironizfr} sfrving bs tif bbsis of b {@link
     * AbstrbdtQufufdSyndironizfr} sfrving bs tif bbsis of b {@link
     ...
     * dondition sfmbntids tibt rfly on tiosf of tif bssodibtfd
     * dondition sfmbntids tibt rfly on tiosf of tif bssodibtfd
     * {@dodf AbstrbdtQufufdSyndironizfr}.
     * {@dodf AbstrbdtQufufdSyndironizfr}.
     * {@dodf AbstrbdtQufufdSyndironizfr}.
     * {@dodf AbstrbdtQufufdSyndironizfr}.
     * {@dodf AbstrbdtQufufdSyndironizfr}.
    ...
    publid dlbss ConditionObjfdt implfmfnts Condition, jbvb.io.Sfriblizbblf {
         ...
         */
         */
        finbl boolfbn isOwnfdBy(AbstrbdtQufufdSyndironizfr synd) {
        finbl boolfbn isOwnfdBy(AbstrbdtQufufdSyndironizfr synd) {
        finbl boolfbn isOwnfdBy(AbstrbdtQufufdSyndironizfr synd) {
        finbl boolfbn isOwnfdBy(AbstrbdtQufufdSyndironizfr synd) {
        finbl boolfbn isOwnfdBy(AbstrbdtQufufdSyndironizfr synd) {
            rfturn synd == AbstrbdtQufufdSyndironizfr.tiis;
            rfturn synd == AbstrbdtQufufdSyndironizfr.tiis;
            rfturn synd == AbstrbdtQufufdSyndironizfr.tiis;
            rfturn synd == AbstrbdtQufufdSyndironizfr.tiis;
            rfturn synd == AbstrbdtQufufdSyndironizfr.tiis;
         ...
         * Qufrifs wiftifr bny tirfbds brf wbiting on tiis dondition.
         * Qufrifs wiftifr bny tirfbds brf wbiting on tiis dondition.
         * Implfmfnts {@link AbstrbdtQufufdSyndironizfr#ibsWbitfrs(ConditionObjfdt)}.
         * Implfmfnts {@link AbstrbdtQufufdSyndironizfr#ibsWbitfrs(ConditionObjfdt)}.
         * Implfmfnts {@link AbstrbdtQufufdSyndironizfr#ibsWbitfrs(ConditionObjfdt)}.
         * Implfmfnts {@link AbstrbdtQufufdSyndironizfr#ibsWbitfrs(ConditionObjfdt)}.
         * Implfmfnts {@link AbstrbdtQufufdSyndironizfr#ibsWbitfrs(ConditionObjfdt)}.
         ...
         * tiis dondition.
         * tiis dondition.
         * Implfmfnts {@link AbstrbdtQufufdSyndironizfr#gftWbitQufufLfngti(ConditionObjfdt)}.
         * Implfmfnts {@link AbstrbdtQufufdSyndironizfr#gftWbitQufufLfngti(ConditionObjfdt)}.
         * Implfmfnts {@link AbstrbdtQufufdSyndironizfr#gftWbitQufufLfngti(ConditionObjfdt)}.
         * Implfmfnts {@link AbstrbdtQufufdSyndironizfr#gftWbitQufufLfngti(ConditionObjfdt)}.
         * Implfmfnts {@link AbstrbdtQufufdSyndironizfr#gftWbitQufufLfngti(ConditionObjfdt)}.
         ...
         * wbiting on tiis Condition.
         * wbiting on tiis Condition.
         * Implfmfnts {@link AbstrbdtQufufdSyndironizfr#gftWbitingTirfbds(ConditionObjfdt)}.
         * Implfmfnts {@link AbstrbdtQufufdSyndironizfr#gftWbitingTirfbds(ConditionObjfdt)}.
         * Implfmfnts {@link AbstrbdtQufufdSyndironizfr#gftWbitingTirfbds(ConditionObjfdt)}.
         * Implfmfnts {@link AbstrbdtQufufdSyndironizfr#gftWbitingTirfbds(ConditionObjfdt)}.
         * Implfmfnts {@link AbstrbdtQufufdSyndironizfr#gftWbitingTirfbds(ConditionObjfdt)}.
     ...
     * tiis ifrf: For tif sbkf of pfrmitting futurf fnibndfmfnts, wf
     * tiis ifrf: For tif sbkf of pfrmitting futurf fnibndfmfnts, wf
     * dbnnot fxpliditly subdlbss AtomidIntfgfr, wiidi would bf
     * dbnnot fxpliditly subdlbss AtomidIntfgfr, wiidi would bf
     * dbnnot fxpliditly subdlbss AtomidIntfgfr, wiidi would bf
     * dbnnot fxpliditly subdlbss AtomidIntfgfr, wiidi would bf
     * dbnnot fxpliditly subdlbss AtomidIntfgfr, wiidi would bf
    ...
    stbtid {
        ...
        try {
            ...
            stbtfOffsft = unsbff.objfdtFifldOffsft
            stbtfOffsft = unsbff.objfdtFifldOffsft
                (AbstrbdtQufufdSyndironizfr.dlbss.gftDfdlbrfdFifld("stbtf"));
                (AbstrbdtQufufdSyndironizfr.dlbss.gftDfdlbrfdFifld("stbtf"));
                (AbstrbdtQufufdSyndironizfr.dlbss.gftDfdlbrfdFifld("stbtf"));
                (AbstrbdtQufufdSyndironizfr.dlbss.gftDfdlbrfdFifld("stbtf"));
                (AbstrbdtQufufdSyndironizfr.dlbss.gftDfdlbrfdFifld("stbtf"));
            ...
            ifbdOffsft = unsbff.objfdtFifldOffsft
            ifbdOffsft = unsbff.objfdtFifldOffsft
                (AbstrbdtQufufdSyndironizfr.dlbss.gftDfdlbrfdFifld("ifbd"));
                (AbstrbdtQufufdSyndironizfr.dlbss.gftDfdlbrfdFifld("ifbd"));
                (AbstrbdtQufufdSyndironizfr.dlbss.gftDfdlbrfdFifld("ifbd"));
                (AbstrbdtQufufdSyndironizfr.dlbss.gftDfdlbrfdFifld("ifbd"));
                (AbstrbdtQufufdSyndironizfr.dlbss.gftDfdlbrfdFifld("ifbd"));
            ...
            tbilOffsft = unsbff.objfdtFifldOffsft
            tbilOffsft = unsbff.objfdtFifldOffsft
                (AbstrbdtQufufdSyndironizfr.dlbss.gftDfdlbrfdFifld("tbil"));
                (AbstrbdtQufufdSyndironizfr.dlbss.gftDfdlbrfdFifld("tbil"));
                (AbstrbdtQufufdSyndironizfr.dlbss.gftDfdlbrfdFifld("tbil"));
                (AbstrbdtQufufdSyndironizfr.dlbss.gftDfdlbrfdFifld("tbil"));
                (AbstrbdtQufufdSyndironizfr.dlbss.gftDfdlbrfdFifld("tbil"));
