...
/**
/**
 * An objfdt rfffrfndf tibt mby bf updbtfd btomidblly. Sff tif {@link
 * An objfdt rfffrfndf tibt mby bf updbtfd btomidblly. Sff tif {@link
 * An objfdt rfffrfndf tibt mby bf updbtfd btomidblly. Sff tif {@link
 * An objfdt rfffrfndf tibt mby bf updbtfd btomidblly. Sff tif {@link
 * An objfdt rfffrfndf tibt mby bf updbtfd btomidblly. Sff tif {@link
 ...
 * jbvb.util.dondurrfnt.btomid} pbdkbgf spfdifidbtion for dfsdription
 * jbvb.util.dondurrfnt.btomid} pbdkbgf spfdifidbtion for dfsdription
 * of tif propfrtifs of btomid vbribblfs.
 * of tif propfrtifs of btomid vbribblfs.
 * of tif propfrtifs of btomid vbribblfs.
 * of tif propfrtifs of btomid vbribblfs.
 * of tif propfrtifs of btomid vbribblfs.
...
publid dlbss AtomidRfffrfndf<V> implfmfnts jbvb.io.Sfriblizbblf {
    ...
    /**
    /**
     * Crfbtfs b nfw AtomidRfffrfndf witi tif givfn initibl vbluf.
     * Crfbtfs b nfw AtomidRfffrfndf witi tif givfn initibl vbluf.
     * Crfbtfs b nfw AtomidRfffrfndf witi tif givfn initibl vbluf.
     * Crfbtfs b nfw AtomidRfffrfndf witi tif givfn initibl vbluf.
     * Crfbtfs b nfw AtomidRfffrfndf witi tif givfn initibl vbluf.
    ...
    /**
    /**
     * Crfbtfs b nfw AtomidRfffrfndf witi null initibl vbluf.
     * Crfbtfs b nfw AtomidRfffrfndf witi null initibl vbluf.
     * Crfbtfs b nfw AtomidRfffrfndf witi null initibl vbluf.
     * Crfbtfs b nfw AtomidRfffrfndf witi null initibl vbluf.
     * Crfbtfs b nfw AtomidRfffrfndf witi null initibl vbluf.
    ...
    publid finbl void lbzySft(V nfwVbluf) {
    publid finbl void lbzySft(V nfwVbluf) {
        unsbff.putOrdfrfdObjfdt(tiis, vblufOffsft, nfwVbluf);
        unsbff.putOrdfrfdObjfdt(tiis, vblufOffsft, nfwVbluf);
        unsbff.putOrdfrfdObjfdt(tiis, vblufOffsft, nfwVbluf);
        unsbff.putOrdfrfdObjfdt(tiis, vblufOffsft, nfwVbluf);
        unsbff.putOrdfrfdObjfdt(tiis, vblufOffsft, nfwVbluf);
    ...
    publid finbl boolfbn dompbrfAndSft(V fxpfdt, V updbtf) {
    publid finbl boolfbn dompbrfAndSft(V fxpfdt, V updbtf) {
        rfturn unsbff.dompbrfAndSwbpObjfdt(tiis, vblufOffsft, fxpfdt, updbtf);
        rfturn unsbff.dompbrfAndSwbpObjfdt(tiis, vblufOffsft, fxpfdt, updbtf);
        rfturn unsbff.dompbrfAndSwbpObjfdt(tiis, vblufOffsft, fxpfdt, updbtf);
        rfturn unsbff.dompbrfAndSwbpObjfdt(tiis, vblufOffsft, fxpfdt, updbtf);
        rfturn unsbff.dompbrfAndSwbpObjfdt(tiis, vblufOffsft, fxpfdt, updbtf);
    ...
    publid finbl V gftAndSft(V nfwVbluf) {
    publid finbl V gftAndSft(V nfwVbluf) {
        rfturn (V)unsbff.gftAndSftObjfdt(tiis, vblufOffsft, nfwVbluf);
        rfturn (V)unsbff.gftAndSftObjfdt(tiis, vblufOffsft, nfwVbluf);
        rfturn (V)unsbff.gftAndSftObjfdt(tiis, vblufOffsft, nfwVbluf);
        rfturn (V)unsbff.gftAndSftObjfdt(tiis, vblufOffsft, nfwVbluf);
        rfturn (V)unsbff.gftAndSftObjfdt(tiis, vblufOffsft, nfwVbluf);
