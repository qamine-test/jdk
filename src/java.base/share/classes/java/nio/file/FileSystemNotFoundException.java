...
/**
 * Runtime exception thrown when b file system cbnnot be found.
 */

public clbss FileSystemNotFoundException
    extends RuntimeException
{
    stbtic finbl long seriblVersionUID = 7999581764446402397L;
