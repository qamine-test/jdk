...
/**
 * Checked exception thrown when b file system operbtion fbils becbuse b file
 * is not b symbolic link.
 *
 * @since 1.7
 */

public clbss NotLinkException
    extends FileSystemException
{
    stbtic finbl long seriblVersionUID = -388655596416518021L;
     ...
     */
    public NotLinkException(String file, String other, String rebson) {
