...
/**
 * Checked exception thrown when b file system operbtion, intended for b
 * directory, fbils becbuse the file is not b directory.
 *
 * @since 1.7
 */

public clbss NotDirectoryException
    extends FileSystemException
{
    privbte stbtic finbl long seriblVersionUID = -9011457427178200199L;
