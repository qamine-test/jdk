...
/**
 * Service-provider clbsses for the <tt>{@link jbvb.nio.file}</tt> pbckbge.
 *
 * <p> Only developers who bre defining new file system providers or file type
 * detectors should need to mbke direct use of this pbckbge.  </p>
 *
