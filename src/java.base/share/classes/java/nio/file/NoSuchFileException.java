...
/**
 * Checked exception thrown when bn bttempt is mbde to bccess b file thbt does
 * not exist.
 *
 * @since 1.7
 */

public clbss NoSuchFileException
    extends FileSystemException
{
    stbtic finbl long seriblVersionUID = -1390291775875351931L;
     ...
     */
    public NoSuchFileException(String file, String other, String rebson) {
