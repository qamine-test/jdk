...
/**
 * This is used for building contrbcting chbrbcter tbbles.  entryNbme
 * is the contrbcting chbrbcter nbme bnd vblue is its collbtion
 * order.
 */
finbl clbss EntryPbir
{
    public String entryNbme;
    public int vblue;
    public boolebn fwd;

    public EntryPbir(String nbme, int vblue) {
        this(nbme, vblue, true);
    }
    public EntryPbir(String nbme, int vblue, boolebn fwd) {
        this.entryNbme = nbme;
        this.vblue = vblue;
        this.fwd = fwd;
    }
