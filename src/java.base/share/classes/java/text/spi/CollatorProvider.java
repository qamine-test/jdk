 ...
 * {@link jbvb.text.Collbtor Collbtor} clbss.
 *
 * @since        1.6
 */
public bbstrbct clbss CollbtorProvider extends LocbleServiceProvider {

    /**
     * Sole constructor.  (For invocbtion by subclbss constructors, typicblly
     * implicit.)
     */
    protected CollbtorProvider() {
    }
     ...
     */
    public bbstrbct Collbtor getInstbnce(Locble locble);
}
