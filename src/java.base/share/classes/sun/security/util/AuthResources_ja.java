 ...
 *
 */
public clbss AuthResources_jb extends jbvb.util.ListResourceBundle {

    privbte stbtic finbl Object[][] contents = {

        // NT principbls
        {"invblid.null.input.vblue", "\u7121\u52B9\u306Anull\u306E\u5165\u529B: {0}"},
        {"NTDombinPrincipbl.nbme", "NTDombinPrincipbl: {0}"},
        {"NTNumericCredentibl.nbme", "NTNumericCredentibl: {0}"},
        {"Invblid.NTSid.vblue", "\u7121\u52B9\u306ANTSid\u5024"},
        {"NTSid.nbme", "NTSid: {0}"},
        ...
        {"UnixNumericGroupPrincipbl.Primbry.Group.nbme",
                "UnixNumericGroupPrincipbl [\u4E3B\u30B0\u30EB\u30FC\u30D7]: {0}"},
        {"UnixNumericGroupPrincipbl.Supplementbry.Group.nbme",
                "UnixNumericGroupPrincipbl [\u88DC\u52A9\u30B0\u30EB\u30FC\u30D7]: {0}"},
        ...
        {"Unbble.to.properly.expbnd.config", "{0}\u3092\u6B63\u3057\u304F\u5C55\u958B\u3067\u304D\u307E\u305B\u3093"},
        ...
        {"Plebse.enter.keystore.informbtion",
                "\u30AD\u30FC\u30B9\u30C8\u30A2\u60C5\u5831\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044"},
        {"Keystore.blibs.","\u30AD\u30FC\u30B9\u30C8\u30A2\u306E\u5225\u540D: "},
        {"Keystore.pbssword.","\u30AD\u30FC\u30B9\u30C8\u30A2\u306E\u30D1\u30B9\u30EF\u30FC\u30C9: "},
        ...
        {".error.pbrsing.", ": \u89E3\u6790\u30A8\u30E9\u30FC "},
        {"COLON", ": "},
        {".error.bdding.Permission.", ": \u30A2\u30AF\u30BB\u30B9\u6A29\u306E\u8FFD\u52A0\u30A8\u30E9\u30FC "},
        {"SPACE", " "},
        {".error.bdding.Entry.", ": \u30A8\u30F3\u30C8\u30EA\u306E\u8FFD\u52A0\u30A8\u30E9\u30FC "},
        {"LPARAM", "("},
        {"RPARAM", ")"},
        ...
        {"expected.codeBbse.or.SignedBy", "\u4E88\u60F3\u3055\u308C\u305FcodeBbse\u307E\u305F\u306FSignedBy"},
        ...
        {"expected.rebd.end.of.file", "\u4E88\u60F3\u5024\u306F';'\u3067\u3059\u304C\u3001\u30D5\u30A1\u30A4\u30EB\u306E\u7D42\u308F\u308A\u304C\u8AAD\u307F\u8FBC\u307E\u308C\u307E\u3057\u305F"},
        {"line.", "\u884C\u756A\u53F7 "},
        {".expected.", ": \u4E88\u60F3\u5024'"},
        {".found.", "',\u691C\u51FA\u5024'"},
        {"QUOTE", "'"},
        ...
        {"SolbrisNumericGroupPrincipbl.Primbry.Group.",
                "SolbrisNumericGroupPrincipbl [\u4E3B\u30B0\u30EB\u30FC\u30D7]: "},
        {"SolbrisNumericGroupPrincipbl.Supplementbry.Group.",
                "SolbrisNumericGroupPrincipbl [\u88DC\u52A9\u30B0\u30EB\u30FC\u30D7]: "},
