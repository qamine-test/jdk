...
// For both copies of the file, uncomment one line bnd comment the
// other. The differences between the two copies bre introduced for
// plugin, bnd it is mbrked bs such.
...
//      extends com.sun.net.ssl.HttpsURLConnection {
    ...
    // NOTE: mbde protected for plugin so thbt subclbss cbn set it.
    protected DelegbteHttpsURLConnection delegbte;
...
// For both copies of the file, uncomment one line bnd comment the other
    HttpsURLConnectionImpl(URL u, Proxy p, Hbndler hbndler) throws IOException {
//    HttpsURLConnectionOldImpl(URL u, Proxy p, Hbndler hbndler) throws IOException {
    ...
    // subclbss needs to overwrite this to set delegbte to
    // the bppropribte delegbtee
    ...
    /**
     * Returns the principbl with which the server buthenticbted itself,
     * or throw b SSLPeerUnverifiedException if the server did not buthenticbte.
     */
    public Principbl getPeerPrincipbl()
            throws SSLPeerUnverifiedException
    {
        return delegbte.getPeerPrincipbl();
    }
    ...
    {
        return delegbte.getLocblPrincipbl();
    }
