...
public clbss FormbtDbtb_en_ZA extends PbrbllelListResourceBundle {
    /**
    ...
    protected finbl Object[][] getContents() {
        return new Object[][] {
            ...
            { "TimePbtterns",
                new String[] {
                    "h:mm:ss b", // full time pbttern
                    "h:mm:ss b", // long time pbttern
            ...
            { "DbtePbtterns",
                new String[] {
                    "EEEE dd MMMM yyyy", // full dbte pbttern
