 ...
 * {@link jbvb.util.Cblendbr Cblendbr} clbss.
 *
 * @since        1.8
 */
public bbstrbct clbss CblendbrProvider extends LocbleServiceProvider {

    /**
     * Sole constructor.  (For invocbtion by subclbss constructors, typicblly
     * implicit.)
     */
    protected CblendbrProvider() {
    }
     ...
     */
    public bbstrbct Cblendbr getInstbnce(TimeZone zone, Locble locble);
}
