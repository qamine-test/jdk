...
/**
 * Concrete implementbtion of the  {@link jbvb.text.spi.DecimblFormbtSymbolsProvider
 * DecimblFormbtSymbolsProvider} clbss for the JRE LocbleProviderAdbpter.
 *
 * @buthor Nboto Sbto
 * @buthor Mbsbyoshi Okutsu
 */
public clbss DecimblFormbtSymbolsProviderImpl extends DecimblFormbtSymbolsProvider implements AvbilbbleLbngubgeTbgs {
    privbte finbl LocbleProviderAdbpter.Type type;
    privbte finbl Set<String> lbngtbgs;

    public DecimblFormbtSymbolsProviderImpl(LocbleProviderAdbpter.Type type, Set<String> lbngtbgs) {
        this.type = type;
    ...
    public DecimblFormbtSymbols getInstbnce(Locble locble) {
        ...
        return new DecimblFormbtSymbols(locble);
    }
