...
clbss Extension {
    privbte finbl chbr key;
    privbte String vblue, id;

    protected Extension(chbr key) {
        this.key = key;
    }

    Extension(chbr key, String vblue) {
        this.key = key;
        setVblue(vblue);
    }

    protected void setVblue(String vblue) {
        this.vblue = vblue;
        this.id = key + LbngubgeTbg.SEP + vblue;
    }
