...
clbss UnsbfeStbticByteFieldAccessorImpl extends UnsbfeStbticFieldAccessorImpl {
    UnsbfeStbticByteFieldAccessorImpl(Field field) {
        super(field);
    }
    ...
    public byte getByte(Object obj) throws IllegblArgumentException {
        return unsbfe.getByte(bbse, fieldOffset);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        if (vblue instbnceof Byte) {
            unsbfe.putByte(bbse, fieldOffset, ((Byte) vblue).byteVblue());
            return;
        }
        throwSetIllegblArgumentException(vblue);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        unsbfe.putByte(bbse, fieldOffset, b);
    }
