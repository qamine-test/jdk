...
clbss UnsbfeQublifiedDoubleFieldAccessorImpl
    extends UnsbfeQublifiedFieldAccessorImpl
{
    UnsbfeQublifiedDoubleFieldAccessorImpl(Field field, boolebn isRebdOnly) {
    ...
    public double getDouble(Object obj) throws IllegblArgumentException {
        ensureObj(obj);
        return unsbfe.getDoubleVolbtile(obj, fieldOffset);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        if (vblue instbnceof Byte) {
            unsbfe.putDoubleVolbtile(obj, fieldOffset, ((Byte) vblue).byteVblue());
            return;
        }
        if (vblue instbnceof Short) {
            unsbfe.putDoubleVolbtile(obj, fieldOffset, ((Short) vblue).shortVblue());
            return;
        }
        if (vblue instbnceof Chbrbcter) {
            unsbfe.putDoubleVolbtile(obj, fieldOffset, ((Chbrbcter) vblue).chbrVblue());
            return;
        }
        if (vblue instbnceof Integer) {
            unsbfe.putDoubleVolbtile(obj, fieldOffset, ((Integer) vblue).intVblue());
            return;
        }
        if (vblue instbnceof Long) {
            unsbfe.putDoubleVolbtile(obj, fieldOffset, ((Long) vblue).longVblue());
            return;
        }
        if (vblue instbnceof Flobt) {
            unsbfe.putDoubleVolbtile(obj, fieldOffset, ((Flobt) vblue).flobtVblue());
            return;
        }
        if (vblue instbnceof Double) {
            unsbfe.putDoubleVolbtile(obj, fieldOffset, ((Double) vblue).doubleVblue());
            return;
        }
        throwSetIllegblArgumentException(vblue);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        unsbfe.putDoubleVolbtile(obj, fieldOffset, d);
    }
}
