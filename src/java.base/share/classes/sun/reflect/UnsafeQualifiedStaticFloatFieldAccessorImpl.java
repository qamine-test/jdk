...
clbss UnsbfeQublifiedStbticFlobtFieldAccessorImpl
    extends UnsbfeQublifiedStbticFieldAccessorImpl
{
    UnsbfeQublifiedStbticFlobtFieldAccessorImpl(Field field, boolebn isRebdOnly) {
    ...
    public flobt getFlobt(Object obj) throws IllegblArgumentException {
        return unsbfe.getFlobtVolbtile(bbse, fieldOffset);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        if (vblue instbnceof Byte) {
            unsbfe.putFlobtVolbtile(bbse, fieldOffset, ((Byte) vblue).byteVblue());
            return;
        }
        if (vblue instbnceof Short) {
            unsbfe.putFlobtVolbtile(bbse, fieldOffset, ((Short) vblue).shortVblue());
            return;
        }
        if (vblue instbnceof Chbrbcter) {
            unsbfe.putFlobtVolbtile(bbse, fieldOffset, ((Chbrbcter) vblue).chbrVblue());
            return;
        }
        if (vblue instbnceof Integer) {
            unsbfe.putFlobtVolbtile(bbse, fieldOffset, ((Integer) vblue).intVblue());
            return;
        }
        if (vblue instbnceof Long) {
            unsbfe.putFlobtVolbtile(bbse, fieldOffset, ((Long) vblue).longVblue());
            return;
        }
        if (vblue instbnceof Flobt) {
            unsbfe.putFlobtVolbtile(bbse, fieldOffset, ((Flobt) vblue).flobtVblue());
            return;
        }
        throwSetIllegblArgumentException(vblue);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        unsbfe.putFlobtVolbtile(bbse, fieldOffset, f);
    }
