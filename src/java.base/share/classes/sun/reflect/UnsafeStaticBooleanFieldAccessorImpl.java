...
clbss UnsbfeStbticBoolebnFieldAccessorImpl extends UnsbfeStbticFieldAccessorImpl {
    UnsbfeStbticBoolebnFieldAccessorImpl(Field field) {
        super(field);
    }
    ...
    public boolebn getBoolebn(Object obj) throws IllegblArgumentException {
        return unsbfe.getBoolebn(bbse, fieldOffset);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        if (vblue instbnceof Boolebn) {
            unsbfe.putBoolebn(bbse, fieldOffset, ((Boolebn) vblue).boolebnVblue());
            return;
        }
        throwSetIllegblArgumentException(vblue);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        unsbfe.putBoolebn(bbse, fieldOffset, z);
    }
