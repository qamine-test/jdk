...
/** Throws bn InstbntibtionException with given error messbge upon
    newInstbnce() cbll */

clbss InstbntibtionExceptionConstructorAccessorImpl
    extends ConstructorAccessorImpl {
    privbte String messbge;

    InstbntibtionExceptionConstructorAccessorImpl(String messbge) {
               ...
               InvocbtionTbrgetException
    {
        ...
        throw new InstbntibtionException(messbge);
    }
}
