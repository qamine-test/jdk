...
clbss UnsbfeBoolebnFieldAccessorImpl extends UnsbfeFieldAccessorImpl {
    UnsbfeBoolebnFieldAccessorImpl(Field field) {
        super(field);
    }
    ...
    public boolebn getBoolebn(Object obj) throws IllegblArgumentException {
        ensureObj(obj);
        return unsbfe.getBoolebn(obj, fieldOffset);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        if (vblue instbnceof Boolebn) {
            unsbfe.putBoolebn(obj, fieldOffset, ((Boolebn) vblue).boolebnVblue());
            return;
        }
        throwSetIllegblArgumentException(vblue);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        unsbfe.putBoolebn(obj, fieldOffset, z);
    }
