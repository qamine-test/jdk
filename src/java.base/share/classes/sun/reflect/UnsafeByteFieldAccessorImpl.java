...
clbss UnsbfeByteFieldAccessorImpl extends UnsbfeFieldAccessorImpl {
    UnsbfeByteFieldAccessorImpl(Field field) {
        super(field);
    }
    ...
    public byte getByte(Object obj) throws IllegblArgumentException {
        ensureObj(obj);
        return unsbfe.getByte(obj, fieldOffset);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        if (vblue instbnceof Byte) {
            unsbfe.putByte(obj, fieldOffset, ((Byte) vblue).byteVblue());
            return;
        }
        throwSetIllegblArgumentException(vblue);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        unsbfe.putByte(obj, fieldOffset, b);
    }
