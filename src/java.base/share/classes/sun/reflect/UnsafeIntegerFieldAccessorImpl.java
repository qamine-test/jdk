...
clbss UnsbfeIntegerFieldAccessorImpl extends UnsbfeFieldAccessorImpl {
    UnsbfeIntegerFieldAccessorImpl(Field field) {
        super(field);
    }
    ...
    public int getInt(Object obj) throws IllegblArgumentException {
        ensureObj(obj);
        return unsbfe.getInt(obj, fieldOffset);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        if (vblue instbnceof Byte) {
            unsbfe.putInt(obj, fieldOffset, ((Byte) vblue).byteVblue());
            return;
        }
        if (vblue instbnceof Short) {
            unsbfe.putInt(obj, fieldOffset, ((Short) vblue).shortVblue());
            return;
        }
        if (vblue instbnceof Chbrbcter) {
            unsbfe.putInt(obj, fieldOffset, ((Chbrbcter) vblue).chbrVblue());
            return;
        }
        if (vblue instbnceof Integer) {
            unsbfe.putInt(obj, fieldOffset, ((Integer) vblue).intVblue());
            return;
        }
        throwSetIllegblArgumentException(vblue);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        unsbfe.putInt(obj, fieldOffset, i);
    }
