...
clbss UnsbfeStbticShortFieldAccessorImpl extends UnsbfeStbticFieldAccessorImpl {
    UnsbfeStbticShortFieldAccessorImpl(Field field) {
        super(field);
    }
    ...
    public short getShort(Object obj) throws IllegblArgumentException {
        return unsbfe.getShort(bbse, fieldOffset);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        if (vblue instbnceof Byte) {
            unsbfe.putShort(bbse, fieldOffset, ((Byte) vblue).byteVblue());
            return;
        }
        if (vblue instbnceof Short) {
            unsbfe.putShort(bbse, fieldOffset, ((Short) vblue).shortVblue());
            return;
        }
        throwSetIllegblArgumentException(vblue);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        unsbfe.putShort(bbse, fieldOffset, s);
    }
