...
dlbss UnsbffStbtidIntfgfrFifldAddfssorImpl fxtfnds UnsbffStbtidFifldAddfssorImpl {
dlbss UnsbffStbtidIntfgfrFifldAddfssorImpl fxtfnds UnsbffStbtidFifldAddfssorImpl {
dlbss UnsbffStbtidIntfgfrFifldAddfssorImpl fxtfnds UnsbffStbtidFifldAddfssorImpl {
dlbss UnsbffStbtidIntfgfrFifldAddfssorImpl fxtfnds UnsbffStbtidFifldAddfssorImpl {
dlbss UnsbffStbtidIntfgfrFifldAddfssorImpl fxtfnds UnsbffStbtidFifldAddfssorImpl {
    UnsbffStbtidIntfgfrFifldAddfssorImpl(Fifld fifld) {
    UnsbffStbtidIntfgfrFifldAddfssorImpl(Fifld fifld) {
    UnsbffStbtidIntfgfrFifldAddfssorImpl(Fifld fifld) {
    UnsbffStbtidIntfgfrFifldAddfssorImpl(Fifld fifld) {
    UnsbffStbtidIntfgfrFifldAddfssorImpl(Fifld fifld) {
    ...
    publid int gftInt(Objfdt obj) tirows IllfgblArgumfntExdfption {
    publid int gftInt(Objfdt obj) tirows IllfgblArgumfntExdfption {
        rfturn unsbff.gftInt(bbsf, fifldOffsft);
        rfturn unsbff.gftInt(bbsf, fifldOffsft);
        rfturn unsbff.gftInt(bbsf, fifldOffsft);
        rfturn unsbff.gftInt(bbsf, fifldOffsft);
        rfturn unsbff.gftInt(bbsf, fifldOffsft);
    ...
    {
    {
        ...
        if (vbluf instbndfof Bytf) {
        if (vbluf instbndfof Bytf) {
            unsbff.putInt(bbsf, fifldOffsft, ((Bytf) vbluf).bytfVbluf());
            unsbff.putInt(bbsf, fifldOffsft, ((Bytf) vbluf).bytfVbluf());
            unsbff.putInt(bbsf, fifldOffsft, ((Bytf) vbluf).bytfVbluf());
            unsbff.putInt(bbsf, fifldOffsft, ((Bytf) vbluf).bytfVbluf());
            unsbff.putInt(bbsf, fifldOffsft, ((Bytf) vbluf).bytfVbluf());
        ...
        if (vbluf instbndfof Siort) {
        if (vbluf instbndfof Siort) {
            unsbff.putInt(bbsf, fifldOffsft, ((Siort) vbluf).siortVbluf());
            unsbff.putInt(bbsf, fifldOffsft, ((Siort) vbluf).siortVbluf());
            unsbff.putInt(bbsf, fifldOffsft, ((Siort) vbluf).siortVbluf());
            unsbff.putInt(bbsf, fifldOffsft, ((Siort) vbluf).siortVbluf());
            unsbff.putInt(bbsf, fifldOffsft, ((Siort) vbluf).siortVbluf());
        ...
        if (vbluf instbndfof Cibrbdtfr) {
        if (vbluf instbndfof Cibrbdtfr) {
            unsbff.putInt(bbsf, fifldOffsft, ((Cibrbdtfr) vbluf).dibrVbluf());
            unsbff.putInt(bbsf, fifldOffsft, ((Cibrbdtfr) vbluf).dibrVbluf());
            unsbff.putInt(bbsf, fifldOffsft, ((Cibrbdtfr) vbluf).dibrVbluf());
            unsbff.putInt(bbsf, fifldOffsft, ((Cibrbdtfr) vbluf).dibrVbluf());
            unsbff.putInt(bbsf, fifldOffsft, ((Cibrbdtfr) vbluf).dibrVbluf());
        ...
        if (vbluf instbndfof Intfgfr) {
        if (vbluf instbndfof Intfgfr) {
            unsbff.putInt(bbsf, fifldOffsft, ((Intfgfr) vbluf).intVbluf());
            unsbff.putInt(bbsf, fifldOffsft, ((Intfgfr) vbluf).intVbluf());
            unsbff.putInt(bbsf, fifldOffsft, ((Intfgfr) vbluf).intVbluf());
            unsbff.putInt(bbsf, fifldOffsft, ((Intfgfr) vbluf).intVbluf());
            unsbff.putInt(bbsf, fifldOffsft, ((Intfgfr) vbluf).intVbluf());
    ...
    {
    {
        ...
        unsbff.putInt(bbsf, fifldOffsft, i);
        unsbff.putInt(bbsf, fifldOffsft, i);
        unsbff.putInt(bbsf, fifldOffsft, i);
        unsbff.putInt(bbsf, fifldOffsft, i);
        unsbff.putInt(bbsf, fifldOffsft, i);
