...
clbss UnsbfeShortFieldAccessorImpl extends UnsbfeFieldAccessorImpl {
    UnsbfeShortFieldAccessorImpl(Field field) {
        super(field);
    }
    ...
    public short getShort(Object obj) throws IllegblArgumentException {
        ensureObj(obj);
        return unsbfe.getShort(obj, fieldOffset);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        if (vblue instbnceof Byte) {
            unsbfe.putShort(obj, fieldOffset, ((Byte) vblue).byteVblue());
            return;
        }
        if (vblue instbnceof Short) {
            unsbfe.putShort(obj, fieldOffset, ((Short) vblue).shortVblue());
            return;
        }
        throwSetIllegblArgumentException(vblue);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        unsbfe.putShort(obj, fieldOffset, s);
    }
