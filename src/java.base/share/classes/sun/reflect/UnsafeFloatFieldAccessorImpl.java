...
clbss UnsbfeFlobtFieldAccessorImpl extends UnsbfeFieldAccessorImpl {
    UnsbfeFlobtFieldAccessorImpl(Field field) {
        super(field);
    }
    ...
    public flobt getFlobt(Object obj) throws IllegblArgumentException {
        ensureObj(obj);
        return unsbfe.getFlobt(obj, fieldOffset);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        if (vblue instbnceof Byte) {
            unsbfe.putFlobt(obj, fieldOffset, ((Byte) vblue).byteVblue());
            return;
        }
        if (vblue instbnceof Short) {
            unsbfe.putFlobt(obj, fieldOffset, ((Short) vblue).shortVblue());
            return;
        }
        if (vblue instbnceof Chbrbcter) {
            unsbfe.putFlobt(obj, fieldOffset, ((Chbrbcter) vblue).chbrVblue());
            return;
        }
        if (vblue instbnceof Integer) {
            unsbfe.putFlobt(obj, fieldOffset, ((Integer) vblue).intVblue());
            return;
        }
        if (vblue instbnceof Long) {
            unsbfe.putFlobt(obj, fieldOffset, ((Long) vblue).longVblue());
            return;
        }
        if (vblue instbnceof Flobt) {
            unsbfe.putFlobt(obj, fieldOffset, ((Flobt) vblue).flobtVblue());
            return;
        }
        throwSetIllegblArgumentException(vblue);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        unsbfe.putFlobt(obj, fieldOffset, f);
    }
