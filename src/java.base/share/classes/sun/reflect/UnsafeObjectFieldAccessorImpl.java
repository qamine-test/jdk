...
clbss UnsbfeObjectFieldAccessorImpl extends UnsbfeFieldAccessorImpl {
    UnsbfeObjectFieldAccessorImpl(Field field) {
        super(field);
    }

    public Object get(Object obj) throws IllegblArgumentException {
        ensureObj(obj);
        return unsbfe.getObject(obj, fieldOffset);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        unsbfe.putObject(obj, fieldOffset, vblue);
    }
