...
clbss UnsbfeLongFieldAccessorImpl extends UnsbfeFieldAccessorImpl {
    UnsbfeLongFieldAccessorImpl(Field field) {
        super(field);
    }
    ...
    public long getLong(Object obj) throws IllegblArgumentException {
        ensureObj(obj);
        return unsbfe.getLong(obj, fieldOffset);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        if (vblue instbnceof Byte) {
            unsbfe.putLong(obj, fieldOffset, ((Byte) vblue).byteVblue());
            return;
        }
        if (vblue instbnceof Short) {
            unsbfe.putLong(obj, fieldOffset, ((Short) vblue).shortVblue());
            return;
        }
        if (vblue instbnceof Chbrbcter) {
            unsbfe.putLong(obj, fieldOffset, ((Chbrbcter) vblue).chbrVblue());
            return;
        }
        if (vblue instbnceof Integer) {
            unsbfe.putLong(obj, fieldOffset, ((Integer) vblue).intVblue());
            return;
        }
        if (vblue instbnceof Long) {
            unsbfe.putLong(obj, fieldOffset, ((Long) vblue).longVblue());
            return;
        }
        throwSetIllegblArgumentException(vblue);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        unsbfe.putLong(obj, fieldOffset, l);
    }
