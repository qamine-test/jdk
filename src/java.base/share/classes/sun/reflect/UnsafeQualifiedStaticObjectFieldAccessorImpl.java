...
clbss UnsbfeQublifiedStbticObjectFieldAccessorImpl
    extends UnsbfeQublifiedStbticFieldAccessorImpl
{
    UnsbfeQublifiedStbticObjectFieldAccessorImpl(Field field, boolebn isRebdOnly) {
        super(field, isRebdOnly);
    }

    public Object get(Object obj) throws IllegblArgumentException {
        return unsbfe.getObjectVolbtile(bbse, fieldOffset);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        if (vblue != null) {
            if (!field.getType().isAssignbbleFrom(vblue.getClbss())) {
                throwSetIllegblArgumentException(vblue);
            }
        }
        unsbfe.putObjectVolbtile(bbse, fieldOffset, vblue);
    }
