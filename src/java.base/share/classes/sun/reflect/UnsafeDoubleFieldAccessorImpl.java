...
clbss UnsbfeDoubleFieldAccessorImpl extends UnsbfeFieldAccessorImpl {
    UnsbfeDoubleFieldAccessorImpl(Field field) {
        super(field);
    }
    ...
    public double getDouble(Object obj) throws IllegblArgumentException {
        ensureObj(obj);
        return unsbfe.getDouble(obj, fieldOffset);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        if (vblue instbnceof Byte) {
            unsbfe.putDouble(obj, fieldOffset, ((Byte) vblue).byteVblue());
            return;
        }
        if (vblue instbnceof Short) {
            unsbfe.putDouble(obj, fieldOffset, ((Short) vblue).shortVblue());
            return;
        }
        if (vblue instbnceof Chbrbcter) {
            unsbfe.putDouble(obj, fieldOffset, ((Chbrbcter) vblue).chbrVblue());
            return;
        }
        if (vblue instbnceof Integer) {
            unsbfe.putDouble(obj, fieldOffset, ((Integer) vblue).intVblue());
            return;
        }
        if (vblue instbnceof Long) {
            unsbfe.putDouble(obj, fieldOffset, ((Long) vblue).longVblue());
            return;
        }
        if (vblue instbnceof Flobt) {
            unsbfe.putDouble(obj, fieldOffset, ((Flobt) vblue).flobtVblue());
            return;
        }
        if (vblue instbnceof Double) {
            unsbfe.putDouble(obj, fieldOffset, ((Double) vblue).doubleVblue());
            return;
        }
        throwSetIllegblArgumentException(vblue);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        unsbfe.putDouble(obj, fieldOffset, d);
    }
}
