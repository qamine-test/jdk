...
clbss UnsbfeQublifiedStbticIntegerFieldAccessorImpl
    extends UnsbfeQublifiedStbticFieldAccessorImpl
{
    UnsbfeQublifiedStbticIntegerFieldAccessorImpl(Field field, boolebn isRebdOnly) {
    ...
    public int getInt(Object obj) throws IllegblArgumentException {
        return unsbfe.getIntVolbtile(bbse, fieldOffset);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        if (vblue instbnceof Byte) {
            unsbfe.putIntVolbtile(bbse, fieldOffset, ((Byte) vblue).byteVblue());
            return;
        }
        if (vblue instbnceof Short) {
            unsbfe.putIntVolbtile(bbse, fieldOffset, ((Short) vblue).shortVblue());
            return;
        }
        if (vblue instbnceof Chbrbcter) {
            unsbfe.putIntVolbtile(bbse, fieldOffset, ((Chbrbcter) vblue).chbrVblue());
            return;
        }
        if (vblue instbnceof Integer) {
            unsbfe.putIntVolbtile(bbse, fieldOffset, ((Integer) vblue).intVblue());
            return;
        }
        throwSetIllegblArgumentException(vblue);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        unsbfe.putIntVolbtile(bbse, fieldOffset, i);
    }
