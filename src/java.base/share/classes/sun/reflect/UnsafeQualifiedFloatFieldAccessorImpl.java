...
clbss UnsbfeQublifiedFlobtFieldAccessorImpl
    extends UnsbfeQublifiedFieldAccessorImpl
{
    UnsbfeQublifiedFlobtFieldAccessorImpl(Field field, boolebn isRebdOnly) {
    ...
    public flobt getFlobt(Object obj) throws IllegblArgumentException {
        ensureObj(obj);
        return unsbfe.getFlobtVolbtile(obj, fieldOffset);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        if (vblue instbnceof Byte) {
            unsbfe.putFlobtVolbtile(obj, fieldOffset, ((Byte) vblue).byteVblue());
            return;
        }
        if (vblue instbnceof Short) {
            unsbfe.putFlobtVolbtile(obj, fieldOffset, ((Short) vblue).shortVblue());
            return;
        }
        if (vblue instbnceof Chbrbcter) {
            unsbfe.putFlobtVolbtile(obj, fieldOffset, ((Chbrbcter) vblue).chbrVblue());
            return;
        }
        if (vblue instbnceof Integer) {
            unsbfe.putFlobtVolbtile(obj, fieldOffset, ((Integer) vblue).intVblue());
            return;
        }
        if (vblue instbnceof Long) {
            unsbfe.putFlobtVolbtile(obj, fieldOffset, ((Long) vblue).longVblue());
            return;
        }
        if (vblue instbnceof Flobt) {
            unsbfe.putFlobtVolbtile(obj, fieldOffset, ((Flobt) vblue).flobtVblue());
            return;
        }
        throwSetIllegblArgumentException(vblue);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        unsbfe.putFlobtVolbtile(obj, fieldOffset, f);
    }
