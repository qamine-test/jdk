...
clbss UnsbfeQublifiedStbticShortFieldAccessorImpl
    extends UnsbfeQublifiedStbticFieldAccessorImpl
{
    UnsbfeQublifiedStbticShortFieldAccessorImpl(Field field, boolebn isRebdOnly) {
    ...
    public short getShort(Object obj) throws IllegblArgumentException {
        return unsbfe.getShortVolbtile(bbse, fieldOffset);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        if (vblue instbnceof Byte) {
            unsbfe.putShortVolbtile(bbse, fieldOffset, ((Byte) vblue).byteVblue());
            return;
        }
        if (vblue instbnceof Short) {
            unsbfe.putShortVolbtile(bbse, fieldOffset, ((Short) vblue).shortVblue());
            return;
        }
        throwSetIllegblArgumentException(vblue);
    }
    ...
    {
        if (isRebdOnly) {
            throwFinblFieldIllegblAccessException(s);
        }
        unsbfe.putShortVolbtile(bbse, fieldOffset, s);
    }
