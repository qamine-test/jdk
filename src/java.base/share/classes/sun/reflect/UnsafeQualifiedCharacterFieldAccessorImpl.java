...
clbss UnsbfeQublifiedChbrbcterFieldAccessorImpl
    extends UnsbfeQublifiedFieldAccessorImpl
{
    UnsbfeQublifiedChbrbcterFieldAccessorImpl(Field field, boolebn isRebdOnly) {
    ...
    public chbr getChbr(Object obj) throws IllegblArgumentException {
        ensureObj(obj);
        return unsbfe.getChbrVolbtile(obj, fieldOffset);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        if (vblue instbnceof Chbrbcter) {
            unsbfe.putChbrVolbtile(obj, fieldOffset, ((Chbrbcter) vblue).chbrVblue());
            return;
        }
        throwSetIllegblArgumentException(vblue);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        unsbfe.putChbrVolbtile(obj, fieldOffset, c);
    }
