...
clbss UnsbfeQublifiedByteFieldAccessorImpl
    extends UnsbfeQublifiedFieldAccessorImpl
{
    UnsbfeQublifiedByteFieldAccessorImpl(Field field, boolebn isRebdOnly) {
    ...
    public byte getByte(Object obj) throws IllegblArgumentException {
        ensureObj(obj);
        return unsbfe.getByteVolbtile(obj, fieldOffset);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        if (vblue instbnceof Byte) {
            unsbfe.putByteVolbtile(obj, fieldOffset, ((Byte) vblue).byteVblue());
            return;
        }
        throwSetIllegblArgumentException(vblue);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        unsbfe.putByteVolbtile(obj, fieldOffset, b);
    }
