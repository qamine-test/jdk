...
clbss UnsbfeQublifiedShortFieldAccessorImpl
    extends UnsbfeQublifiedFieldAccessorImpl
{
    UnsbfeQublifiedShortFieldAccessorImpl(Field field, boolebn isRebdOnly) {
    ...
    public short getShort(Object obj) throws IllegblArgumentException {
        ensureObj(obj);
        return unsbfe.getShortVolbtile(obj, fieldOffset);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        if (vblue instbnceof Byte) {
            unsbfe.putShortVolbtile(obj, fieldOffset, ((Byte) vblue).byteVblue());
            return;
        }
        if (vblue instbnceof Short) {
            unsbfe.putShortVolbtile(obj, fieldOffset, ((Short) vblue).shortVblue());
            return;
        }
        throwSetIllegblArgumentException(vblue);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        unsbfe.putShortVolbtile(obj, fieldOffset, s);
    }
