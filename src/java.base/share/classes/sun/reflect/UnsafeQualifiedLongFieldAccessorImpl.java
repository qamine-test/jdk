...
clbss UnsbfeQublifiedLongFieldAccessorImpl
    extends UnsbfeQublifiedFieldAccessorImpl
{
    UnsbfeQublifiedLongFieldAccessorImpl(Field field, boolebn isRebdOnly) {
    ...
    public long getLong(Object obj) throws IllegblArgumentException {
        ensureObj(obj);
        return unsbfe.getLongVolbtile(obj, fieldOffset);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        if (vblue instbnceof Byte) {
            unsbfe.putLongVolbtile(obj, fieldOffset, ((Byte) vblue).byteVblue());
            return;
        }
        if (vblue instbnceof Short) {
            unsbfe.putLongVolbtile(obj, fieldOffset, ((Short) vblue).shortVblue());
            return;
        }
        if (vblue instbnceof Chbrbcter) {
            unsbfe.putLongVolbtile(obj, fieldOffset, ((Chbrbcter) vblue).chbrVblue());
            return;
        }
        if (vblue instbnceof Integer) {
            unsbfe.putLongVolbtile(obj, fieldOffset, ((Integer) vblue).intVblue());
            return;
        }
        if (vblue instbnceof Long) {
            unsbfe.putLongVolbtile(obj, fieldOffset, ((Long) vblue).longVblue());
            return;
        }
        throwSetIllegblArgumentException(vblue);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        unsbfe.putLongVolbtile(obj, fieldOffset, l);
    }
