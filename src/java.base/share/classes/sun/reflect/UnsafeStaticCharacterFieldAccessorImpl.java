...
clbss UnsbfeStbticChbrbcterFieldAccessorImpl extends UnsbfeStbticFieldAccessorImpl {
    UnsbfeStbticChbrbcterFieldAccessorImpl(Field field) {
        super(field);
    }
    ...
    public chbr getChbr(Object obj) throws IllegblArgumentException {
        return unsbfe.getChbr(bbse, fieldOffset);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        if (vblue instbnceof Chbrbcter) {
            unsbfe.putChbr(bbse, fieldOffset, ((Chbrbcter) vblue).chbrVblue());
            return;
        }
        throwSetIllegblArgumentException(vblue);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        unsbfe.putChbr(bbse, fieldOffset, c);
    }
