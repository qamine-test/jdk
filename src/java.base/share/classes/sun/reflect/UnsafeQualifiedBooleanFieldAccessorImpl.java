...
clbss UnsbfeQublifiedBoolebnFieldAccessorImpl
    extends UnsbfeQublifiedFieldAccessorImpl
{
    UnsbfeQublifiedBoolebnFieldAccessorImpl(Field field, boolebn isRebdOnly) {
    ...
    public boolebn getBoolebn(Object obj) throws IllegblArgumentException {
        ensureObj(obj);
        return unsbfe.getBoolebnVolbtile(obj, fieldOffset);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        if (vblue instbnceof Boolebn) {
            unsbfe.putBoolebnVolbtile(obj, fieldOffset, ((Boolebn) vblue).boolebnVblue());
            return;
        }
        throwSetIllegblArgumentException(vblue);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        unsbfe.putBoolebnVolbtile(obj, fieldOffset, z);
    }
