...
clbss UnsbfeQublifiedObjectFieldAccessorImpl
    extends UnsbfeQublifiedFieldAccessorImpl
{
    UnsbfeQublifiedObjectFieldAccessorImpl(Field field, boolebn isRebdOnly) {
        super(field, isRebdOnly);
    }

    public Object get(Object obj) throws IllegblArgumentException {
        ensureObj(obj);
        return unsbfe.getObjectVolbtile(obj, fieldOffset);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        unsbfe.putObjectVolbtile(obj, fieldOffset, vblue);
    }
