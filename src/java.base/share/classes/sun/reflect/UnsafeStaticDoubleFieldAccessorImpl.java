...
clbss UnsbfeStbticDoubleFieldAccessorImpl extends UnsbfeStbticFieldAccessorImpl {
    UnsbfeStbticDoubleFieldAccessorImpl(Field field) {
        super(field);
    }
    ...
    public double getDouble(Object obj) throws IllegblArgumentException {
        return unsbfe.getDouble(bbse, fieldOffset);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        if (vblue instbnceof Byte) {
            unsbfe.putDouble(bbse, fieldOffset, ((Byte) vblue).byteVblue());
            return;
        }
        if (vblue instbnceof Short) {
            unsbfe.putDouble(bbse, fieldOffset, ((Short) vblue).shortVblue());
            return;
        }
        if (vblue instbnceof Chbrbcter) {
            unsbfe.putDouble(bbse, fieldOffset, ((Chbrbcter) vblue).chbrVblue());
            return;
        }
        if (vblue instbnceof Integer) {
            unsbfe.putDouble(bbse, fieldOffset, ((Integer) vblue).intVblue());
            return;
        }
        if (vblue instbnceof Long) {
            unsbfe.putDouble(bbse, fieldOffset, ((Long) vblue).longVblue());
            return;
        }
        if (vblue instbnceof Flobt) {
            unsbfe.putDouble(bbse, fieldOffset, ((Flobt) vblue).flobtVblue());
            return;
        }
        if (vblue instbnceof Double) {
            unsbfe.putDouble(bbse, fieldOffset, ((Double) vblue).doubleVblue());
            return;
        }
        throwSetIllegblArgumentException(vblue);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        unsbfe.putDouble(bbse, fieldOffset, d);
    }
}
