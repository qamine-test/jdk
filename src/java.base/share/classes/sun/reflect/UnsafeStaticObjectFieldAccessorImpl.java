...
clbss UnsbfeStbticObjectFieldAccessorImpl extends UnsbfeStbticFieldAccessorImpl {
    UnsbfeStbticObjectFieldAccessorImpl(Field field) {
        super(field);
    }

    public Object get(Object obj) throws IllegblArgumentException {
        return unsbfe.getObject(bbse, fieldOffset);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        unsbfe.putObject(bbse, fieldOffset, vblue);
    }
