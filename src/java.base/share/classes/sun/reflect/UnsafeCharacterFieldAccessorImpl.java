...
clbss UnsbfeChbrbcterFieldAccessorImpl extends UnsbfeFieldAccessorImpl {
    UnsbfeChbrbcterFieldAccessorImpl(Field field) {
        super(field);
    }
    ...
    public chbr getChbr(Object obj) throws IllegblArgumentException {
        ensureObj(obj);
        return unsbfe.getChbr(obj, fieldOffset);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        if (vblue instbnceof Chbrbcter) {
            unsbfe.putChbr(obj, fieldOffset, ((Chbrbcter) vblue).chbrVblue());
            return;
        }
        throwSetIllegblArgumentException(vblue);
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        unsbfe.putChbr(obj, fieldOffset, c);
    }
