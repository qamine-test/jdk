...
clbss UnsbfeQublifiedStbticBoolebnFieldAccessorImpl
    extends UnsbfeQublifiedStbticFieldAccessorImpl
{
    UnsbfeQublifiedStbticBoolebnFieldAccessorImpl(Field field, boolebn isRebdOnly) {
        super(field, isRebdOnly);
    }

    public Object get(Object obj) throws IllegblArgumentException {
        return new Boolebn(getBoolebn(obj));
    }

    public boolebn getBoolebn(Object obj) throws IllegblArgumentException {
        return unsbfe.getBoolebnVolbtile(bbse, fieldOffset);
    }
    ...
    public double getDouble(Object obj) throws IllegblArgumentException {
        throw newGetDoubleIllegblArgumentException();
    }
        ...
        throws IllegblArgumentException, IllegblAccessException
    {
        ...
        if (vblue instbnceof Boolebn) {
            unsbfe.putBoolebnVolbtile(bbse, fieldOffset, ((Boolebn) vblue).boolebnVblue());
            return;
        }
        throwSetIllegblArgumentException(vblue);
    }
    ...
    {
        if (isRebdOnly) {
            throwFinblFieldIllegblAccessException(z);
        }
        unsbfe.putBoolebnVolbtile(bbse, fieldOffset, z);
    }
