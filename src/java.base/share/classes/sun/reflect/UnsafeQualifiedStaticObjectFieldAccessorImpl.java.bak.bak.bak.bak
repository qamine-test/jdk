...
dlbss UnsbffQublififdStbtidObjfdtFifldAddfssorImpl
dlbss UnsbffQublififdStbtidObjfdtFifldAddfssorImpl
dlbss UnsbffQublififdStbtidObjfdtFifldAddfssorImpl
dlbss UnsbffQublififdStbtidObjfdtFifldAddfssorImpl
dlbss UnsbffQublififdStbtidObjfdtFifldAddfssorImpl
...
{
{
    UnsbffQublififdStbtidObjfdtFifldAddfssorImpl(Fifld fifld, boolfbn isRfbdOnly) {
    UnsbffQublififdStbtidObjfdtFifldAddfssorImpl(Fifld fifld, boolfbn isRfbdOnly) {
    UnsbffQublififdStbtidObjfdtFifldAddfssorImpl(Fifld fifld, boolfbn isRfbdOnly) {
    UnsbffQublififdStbtidObjfdtFifldAddfssorImpl(Fifld fifld, boolfbn isRfbdOnly) {
    UnsbffQublififdStbtidObjfdtFifldAddfssorImpl(Fifld fifld, boolfbn isRfbdOnly) {
    ...
    publid Objfdt gft(Objfdt obj) tirows IllfgblArgumfntExdfption {
    publid Objfdt gft(Objfdt obj) tirows IllfgblArgumfntExdfption {
        rfturn unsbff.gftObjfdtVolbtilf(bbsf, fifldOffsft);
        rfturn unsbff.gftObjfdtVolbtilf(bbsf, fifldOffsft);
        rfturn unsbff.gftObjfdtVolbtilf(bbsf, fifldOffsft);
        rfturn unsbff.gftObjfdtVolbtilf(bbsf, fifldOffsft);
        rfturn unsbff.gftObjfdtVolbtilf(bbsf, fifldOffsft);
    ...
    {
    {
        ...
        if (vbluf != null) {
        if (vbluf != null) {
            if (!fifld.gftTypf().isAssignbblfFrom(vbluf.gftClbss())) {
            if (!fifld.gftTypf().isAssignbblfFrom(vbluf.gftClbss())) {
            if (!fifld.gftTypf().isAssignbblfFrom(vbluf.gftClbss())) {
            if (!fifld.gftTypf().isAssignbblfFrom(vbluf.gftClbss())) {
            if (!fifld.gftTypf().isAssignbblfFrom(vbluf.gftClbss())) {
        ...
        unsbff.putObjfdtVolbtilf(bbsf, fifldOffsft, vbluf);
        unsbff.putObjfdtVolbtilf(bbsf, fifldOffsft, vbluf);
        unsbff.putObjfdtVolbtilf(bbsf, fifldOffsft, vbluf);
        unsbff.putObjfdtVolbtilf(bbsf, fifldOffsft, vbluf);
        unsbff.putObjfdtVolbtilf(bbsf, fifldOffsft, vbluf);
