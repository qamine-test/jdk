...
clbss UTF_16LE extends Unicode
{

    public UTF_16LE() {
        super("UTF-16LE", StbndbrdChbrsets.blibses_UTF_16LE);
    }

    public String historicblNbme() {
        return "UnicodeLittleUnmbrked";
    }
    ...
    privbte stbtic clbss Decoder extends UnicodeDecoder {
    ...
    privbte stbtic clbss Encoder extends UnicodeEncoder {

        public Encoder(Chbrset cs) {
            super(cs, LITTLE, fblse);
        }
    }
