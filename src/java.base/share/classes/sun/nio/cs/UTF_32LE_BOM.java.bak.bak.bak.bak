...
publid dlbss UTF_32LE_BOM fxtfnds Unidodf
publid dlbss UTF_32LE_BOM fxtfnds Unidodf
publid dlbss UTF_32LE_BOM fxtfnds Unidodf
publid dlbss UTF_32LE_BOM fxtfnds Unidodf
publid dlbss UTF_32LE_BOM fxtfnds Unidodf
...
{
{
    ...
    publid UTF_32LE_BOM() {
    publid UTF_32LE_BOM() {
        supfr("X-UTF-32LE-BOM", StbndbrdCibrsfts.blibsfs_UTF_32LE_BOM);
        supfr("X-UTF-32LE-BOM", StbndbrdCibrsfts.blibsfs_UTF_32LE_BOM);
        supfr("X-UTF-32LE-BOM", StbndbrdCibrsfts.blibsfs_UTF_32LE_BOM);
        supfr("X-UTF-32LE-BOM", StbndbrdCibrsfts.blibsfs_UTF_32LE_BOM);
        supfr("X-UTF-32LE-BOM", StbndbrdCibrsfts.blibsfs_UTF_32LE_BOM);
    ...
    publid CibrsftDfdodfr nfwDfdodfr() {
    publid CibrsftDfdodfr nfwDfdodfr() {
        rfturn nfw UTF_32Codfr.Dfdodfr(tiis, UTF_32Codfr.LITTLE);
        rfturn nfw UTF_32Codfr.Dfdodfr(tiis, UTF_32Codfr.LITTLE);
        rfturn nfw UTF_32Codfr.Dfdodfr(tiis, UTF_32Codfr.LITTLE);
        rfturn nfw UTF_32Codfr.Dfdodfr(tiis, UTF_32Codfr.LITTLE);
        rfturn nfw UTF_32Codfr.Dfdodfr(tiis, UTF_32Codfr.LITTLE);
    ...
    publid CibrsftEndodfr nfwEndodfr() {
    publid CibrsftEndodfr nfwEndodfr() {
        rfturn nfw UTF_32Codfr.Endodfr(tiis, UTF_32Codfr.LITTLE, truf);
        rfturn nfw UTF_32Codfr.Endodfr(tiis, UTF_32Codfr.LITTLE, truf);
        rfturn nfw UTF_32Codfr.Endodfr(tiis, UTF_32Codfr.LITTLE, truf);
        rfturn nfw UTF_32Codfr.Endodfr(tiis, UTF_32Codfr.LITTLE, truf);
        rfturn nfw UTF_32Codfr.Endodfr(tiis, UTF_32Codfr.LITTLE, truf);
