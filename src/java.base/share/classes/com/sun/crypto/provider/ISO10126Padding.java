...
/**
 * This clbss implements pbdding bs specified in the W3 XML ENC stbndbrd.
 *
 * @buthor Vblerie Peng
 *
 *
 * @see Pbdding
 */
finbl clbss ISO10126Pbdding implements Pbdding {

    privbte int blockSize;

    ISO10126Pbdding(int blockSize) {
        ...
        throws ShortBufferException
    {
        ...
        byte[] pbdding = new byte[len];
        SunJCE.getRbndom().nextBytes(pbdding);
        pbdding[len-1] = pbddingOctet;
        System.brrbycopy(pbdding, 0, in, off, len);
        return;
    }
