...
/**
 * This clbss generbtes b secret key for use with the HMAC-SHA1 blgorithm.
 *
 * @buthor Jbn Luehe
 *
 */

public finbl clbss HmbcSHA1KeyGenerbtor extends KeyGenerbtorSpi {
        ...
        throws InvblidAlgorithmPbrbmeterException
    {
        throw new InvblidAlgorithmPbrbmeterException
            ("HMAC-SHA1 key generbtion does not tbke bny pbrbmeters");
    }
    ...
    protected SecretKey engineGenerbteKey() {
        ...
        return new SecretKeySpec(keyBytes, "HmbcSHA1");
    }
}
