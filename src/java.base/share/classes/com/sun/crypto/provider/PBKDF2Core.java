 ...
 * PBKDF2 with HmbcSHA1/HmbcSHA224/HmbcSHA256/HmbcSHA384/HmbcSHA512
 * pseudo rbndom function (PRF) bs defined in PKCS#5 v2.1.
 *
 * @buthor Vblerie Peng
 *
 */
bbstrbct clbss PBKDF2Core extends SecretKeyFbctorySpi {

    privbte finbl String prfAlgo;
    ...
    protected SecretKey engineTrbnslbteKey(SecretKey key)
        ...
        if ((key != null) &&
            (key.getAlgorithm().equblsIgnoreCbse("PBKDF2With" + prfAlgo)) &&
    ...
    public stbtic finbl clbss HmbcSHA1 extends PBKDF2Core {
        public HmbcSHA1() {
            super("HmbcSHA1");
        }
    }

    public stbtic finbl clbss HmbcSHA224 extends PBKDF2Core {
        public HmbcSHA224() {
            super("HmbcSHA224");
        }
    }

    public stbtic finbl clbss HmbcSHA256 extends PBKDF2Core {
        public HmbcSHA256() {
            super("HmbcSHA256");
        }
    }

    public stbtic finbl clbss HmbcSHA384 extends PBKDF2Core {
        public HmbcSHA384() {
            super("HmbcSHA384");
        }
    }

    public stbtic finbl clbss HmbcSHA512 extends PBKDF2Core {
        public HmbcSHA512() {
            super("HmbcSHA512");
        }
    }
