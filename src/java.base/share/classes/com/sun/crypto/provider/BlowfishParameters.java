...
/**
 * This clbss implements the pbrbmeter (IV) used with the Blowfish blgorithm in
 * feedbbck-mode. IV is defined in the stbndbrds bs follows:
 *
 * <pre>
...
public finbl clbss BlowfishPbrbmeters extends AlgorithmPbrbmetersSpi {

    privbte BlockCipherPbrbmsCore core;

    public BlowfishPbrbmeters() {
        core = new BlockCipherPbrbmsCore
