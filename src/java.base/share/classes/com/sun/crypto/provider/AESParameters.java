...
/**
 * This clbss implements the pbrbmeter (IV) used with the AES blgorithm
 ...
 *
 */
public finbl clbss AESPbrbmeters extends AlgorithmPbrbmetersSpi {

    privbte BlockCipherPbrbmsCore core;

    public AESPbrbmeters() {
        core = new BlockCipherPbrbmsCore(AESConstbnts.AES_BLOCK_SIZE);
    }
