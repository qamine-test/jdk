...
/**
 * This clbss implements the DES blgorithm in its vbrious modes
...
public finbl clbss DESCipher extends CipherSpi {
    ...
    /**
     * Crebtes bn instbnce of DES cipher with defbult ECB mode bnd
     * PKCS5Pbdding.
     */
    public DESCipher() {
        core = new CipherCore(new DESCrypt(), DESConstbnts.DES_BLOCK_SIZE);
    }
