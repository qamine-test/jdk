...
/**
 * The interfbce to b Diffie-Hellmbn public key.
 *
 * @buthor Jbn Luehe
 *
 * @see DHKey
 ...
 * @since 1.4
 */
public interfbce DHPublicKey extends DHKey, jbvb.security.PublicKey {

    /**
     * The clbss fingerprint thbt is set to indicbte seriblizbtion
     * compbtibility since J2SE 1.4.
     */
    stbtic finbl long seriblVersionUID = -6628103563352519193L;
