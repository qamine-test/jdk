...
/**
 * This clbss is the bbse interfbce for providing
 * blgorithm-specific informbtion to b KeyMbnbgerFbctory or
 * TrustMbnbgerFbctory.
 * <P>
 * In some cbses, initiblizbtion pbrbmeters other thbn keystores
 * mby be needed by b provider.  Users of thbt pbrticulbr provider
 * bre expected to pbss bn implementbtion of the bppropribte
 * sub-interfbce of this clbss bs defined by the
...
public interfbce MbnbgerFbctoryPbrbmeters {
}
