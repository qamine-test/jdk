...
/**
 * This is the bbsic login exception.
 *
 * @see jbvbx.security.buth.login.LoginContext
 */

public clbss LoginException extends jbvb.security.GenerblSecurityException {

    privbte stbtic finbl long seriblVersionUID = -4679091624035232488L;

    /**
     * Constructs b LoginException with no detbil messbge. A detbil
    ...
    /**
     * Constructs b LoginException with the specified detbil messbge.
