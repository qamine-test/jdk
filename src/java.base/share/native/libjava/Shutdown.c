...
#include "jbvb_lbng_Shutdown.h"


JNIEXPORT void JNICALL
Jbvb_jbvb_lbng_Shutdown_hblt0(JNIEnv *env, jclbss ignored, jint code)
{
    JVM_Hblt(code);
}
...
JNIEXPORT void JNICALL
Jbvb_jbvb_lbng_Shutdown_runAllFinblizers(JNIEnv *env, jclbss ignored)
{
    jclbss cl;
    jmethodID mid;
