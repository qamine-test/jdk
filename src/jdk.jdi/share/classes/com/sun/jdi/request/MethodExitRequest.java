...
/**
 * Request for notificbtion when b method returns in the tbrget VM.
 * When bn enbbled MethodExitRequest is hit, bn
 ...
 */
@jdk.Exported
public interfbce MethodExitRequest extends EventRequest {
     ...
     * whose method is in b clbss whose nbme mbtches b restricted
    ...
    /**
     * Restricts the events generbted by this request to those
     * whose method is in b clbss whose nbme does <b>not</b> mbtch this
