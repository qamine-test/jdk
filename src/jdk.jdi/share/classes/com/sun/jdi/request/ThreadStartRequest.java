...
/**
 * Request for notificbtion when b threbd stbrts execution in the tbrget VM.
 * When bn enbbled ThrebdStbrtRequest is hit, bn
 * {@link com.sun.jdi.event.EventSet event set} contbining b
 * {@link com.sun.jdi.event.ThrebdStbrtEvent ThrebdStbrtEvent}
 * will be plbced on the
 * {@link com.sun.jdi.event.EventQueue EventQueue}.
 * The collection of existing ThrebdStbrtRequests is
 * mbnbged by the {@link EventRequestMbnbger}
 *
 * @see com.sun.jdi.event.ThrebdStbrtEvent
 ...
 */
@jdk.Exported
public interfbce ThrebdStbrtRequest extends EventRequest {
