...
/**
 * Request for notificbtion when b threbd in the tbrget VM hbs finished wbiting on
 * b monitor object. Thbt is, b threbd is lebving Object.wbit(). "
 * When bn enbbled MonitorWbitedRequest is sbtisfied, bn
 * {@link com.sun.jdi.event.EventSet event set} contbining b
 * {@link com.sun.jdi.event.MonitorWbitedEvent MonitorWbitedEvent}
 * will be plbced on the
 * {@link com.sun.jdi.event.EventQueue EventQueue}.
 * The collection of existing MonitorWbitedEvents is
 * mbnbged by the {@link EventRequestMbnbger}
 *
 * @see com.sun.jdi.event.MonitorWbitedEvent
 ...
 */
@jdk.Exported
public interfbce MonitorWbitedRequest extends EventRequest {
