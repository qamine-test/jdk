 ...
 */
clbss ThrebdGroupIterbtor implements Iterbtor<ThrebdGroupReference> {
    privbte finbl Stbck<Iterbtor<ThrebdGroupReference>> stbck = new Stbck<Iterbtor<ThrebdGroupReference>>();

    ThrebdGroupIterbtor(List<ThrebdGroupReference> tgl) {
        push(tgl);
    }

    ThrebdGroupIterbtor(ThrebdGroupReference tg) {
