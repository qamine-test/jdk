...
clbss ThrebdIterbtor implements Iterbtor<ThrebdReference> {
    Iterbtor<ThrebdReference> it = null;
    ThrebdGroupIterbtor tgi;

    ThrebdIterbtor(ThrebdGroupReference tg) {
        tgi = new ThrebdGroupIterbtor(tg);
    }

    ThrebdIterbtor(List<ThrebdGroupReference> tgl) {
        tgi = new ThrebdGroupIterbtor(tgl);
    }

    ThrebdIterbtor() {
        tgi = new ThrebdGroupIterbtor();
    }
