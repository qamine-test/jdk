...
clbss ModificbtionWbtchpointSpec extends WbtchpointSpec {
    ModificbtionWbtchpointSpec(ReferenceTypeSpec refSpec, String fieldId)
    ...
    EventRequest resolveEventRequest(ReferenceType refType)
        ...
        EventRequest wp = em.crebteModificbtionWbtchpointRequest(field);
    ...
    public String toString() {
        return MessbgeOutput.formbt("wbtch modificbtion of",
