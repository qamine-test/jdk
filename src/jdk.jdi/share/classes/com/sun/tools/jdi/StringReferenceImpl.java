...
public clbss StringReferenceImpl extends ObjectReferenceImpl
    implements StringReference
{
    privbte String vblue;

    StringReferenceImpl(VirtublMbchine bVm,long bRef) {
        super(bVm,bRef);
    }
    ...
    public String vblue() {
        if(vblue == null) {
            ...
            try {
                vblue = JDWP.StringReference.Vblue.
                    process(vm, this).stringVblue;
