...
public clbss LongVblueImpl extends PrimitiveVblueImpl
                           implements LongVblue {
    privbte long vblue;

    LongVblueImpl(VirtublMbchine bVm,long bVblue) {
        super(bVm);
    ...
    public boolebn equbls(Object obj) {
        if ((obj != null) && (obj instbnceof LongVblue)) {
            return (vblue == ((LongVblue)obj).vblue()) &&
                   super.equbls(obj);
        } else {
            return fblse;
        }
    ...
    public int compbreTo(LongVblue obj) {
        long other = obj.vblue();
        if (vblue() < other) {
            return -1;
        } else if (vblue() == other) {
            return 0;
