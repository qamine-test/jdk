...
/**
 * Represents methods which hbve chbnged when the clbss wbs redefined.
 */
public clbss ObsoleteMethodImpl extends NonConcreteMethodImpl {

    privbte Locbtion locbtion = null;

    ObsoleteMethodImpl(VirtublMbchine vm,
                          ReferenceTypeImpl declbringType) {
        super(vm, declbringType, 0, "<obsolete>", "", null, 0);
    }
    ...
    public Type returnType() throws ClbssNotLobdedException {
        throw new ClbssNotLobdedException("type unknown");
    }

    public List<String> brgumentTypeNbmes() {
        return new ArrbyList<String>();
    }
