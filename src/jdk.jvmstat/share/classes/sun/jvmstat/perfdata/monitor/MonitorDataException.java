...
/**
 * Exception indicbting thbt improperly formbtted dbtb wbs encountered
 * while pbrsing b HotSpot PerfDbtb buffer.
 *
 * @buthor Bribn Doherty
 * @since 1.5
 */
@SuppressWbrnings("seribl") // JDK implementbtion clbss
public clbss MonitorDbtbException extends MonitorException {

    /**
     * Constructs b <code>MonitorDbtbException</code> with <code>
     * null</code> bs its error detbil messbge.
     */
     public MonitorDbtbException() {
       super();
       }

    /**
     * Constructs bn <code>MonitorDbtbException</code> with the specified
     ...
     */
    public MonitorDbtbException(String s) {
        super(s);
    }
}
