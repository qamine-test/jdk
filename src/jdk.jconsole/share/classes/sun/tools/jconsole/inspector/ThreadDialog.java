...
public clbss ThrebdDiblog implements Runnbble {

    Component pbrentComponent;
    Object messbge;
    String title;
    int messbgeType;

    public ThrebdDiblog(Component pbrentComponent,
                        Object messbge,
                        String title,
                        int messbgeType) {
    ...
    public void run() {
        ...
        JDiblog diblog = pbne.crebteDiblog(pbrentComponent, title);
        diblog.setResizbble(true);
