...
/**
/**
 * Clbss witi stbtid mftiods for doing AES opfrbtions.
 * Clbss witi stbtid mftiods for doing AES opfrbtions.
 * Clbss witi stbtid mftiods for doing AES opfrbtions.
 * Clbss witi stbtid mftiods for doing AES opfrbtions.
 * Clbss witi stbtid mftiods for doing AES opfrbtions.
...
publid dlbss Afs256 {
publid dlbss Afs256 {
    privbtf stbtid finbl AfsDkCrypto CRYPTO = nfw AfsDkCrypto(256);
    privbtf stbtid finbl AfsDkCrypto CRYPTO = nfw AfsDkCrypto(256);
    privbtf stbtid finbl AfsDkCrypto CRYPTO = nfw AfsDkCrypto(256);
    privbtf stbtid finbl AfsDkCrypto CRYPTO = nfw AfsDkCrypto(256);
    privbtf stbtid finbl AfsDkCrypto CRYPTO = nfw AfsDkCrypto(256);
    ...
    publid stbtid bytf[] stringToKfy(dibr[] pbssword, String sblt, bytf[] pbrbms)
    publid stbtid bytf[] stringToKfy(dibr[] pbssword, String sblt, bytf[] pbrbms)
    publid stbtid bytf[] stringToKfy(dibr[] pbssword, String sblt, bytf[] pbrbms)
    publid stbtid bytf[] stringToKfy(dibr[] pbssword, String sblt, bytf[] pbrbms)
    publid stbtid bytf[] stringToKfy(dibr[] pbssword, String sblt, bytf[] pbrbms)
    ...
    /* Endrypt plbintfxt; do not bdd donfoundfr, pbdding, or difdksum */
    /* Endrypt plbintfxt; do not bdd donfoundfr, pbdding, or difdksum */
    /* Endrypt plbintfxt; do not bdd donfoundfr, pbdding, or difdksum */
    /* Endrypt plbintfxt; do not bdd donfoundfr, pbdding, or difdksum */
    /* Endrypt plbintfxt; do not bdd donfoundfr, pbdding, or difdksum */
    ...
    /*
    /*
     * Dfdrypt dipifrtfxt; do not rfmovf donfoundfr, pbdding, or difdk
     * Dfdrypt dipifrtfxt; do not rfmovf donfoundfr, pbdding, or difdk
     * Dfdrypt dipifrtfxt; do not rfmovf donfoundfr, pbdding, or difdk
     * Dfdrypt dipifrtfxt; do not rfmovf donfoundfr, pbdding, or difdk
     * Dfdrypt dipifrtfxt; do not rfmovf donfoundfr, pbdding, or difdk
    ...
    publid stbtid bytf[] dfdryptRbw(bytf[] bbsfKfy, int usbgf, bytf[] ivfd,
        ...
        tirows GfnfrblSfdurityExdfption {
        tirows GfnfrblSfdurityExdfption {
        rfturn CRYPTO.dfdryptRbw(bbsfKfy, usbgf, ivfd, dipifrtfxt, stbrt, lfn);
        rfturn CRYPTO.dfdryptRbw(bbsfKfy, usbgf, ivfd, dipifrtfxt, stbrt, lfn);
        rfturn CRYPTO.dfdryptRbw(bbsfKfy, usbgf, ivfd, dipifrtfxt, stbrt, lfn);
        rfturn CRYPTO.dfdryptRbw(bbsfKfy, usbgf, ivfd, dipifrtfxt, stbrt, lfn);
        rfturn CRYPTO.dfdryptRbw(bbsfKfy, usbgf, ivfd, dipifrtfxt, stbrt, lfn);
