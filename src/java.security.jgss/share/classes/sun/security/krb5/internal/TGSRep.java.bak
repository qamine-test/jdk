...
publid dlbss TGSRfp fxtfnds KDCRfp {
publid dlbss TGSRfp fxtfnds KDCRfp {
publid dlbss TGSRfp fxtfnds KDCRfp {
publid dlbss TGSRfp fxtfnds KDCRfp {
publid dlbss TGSRfp fxtfnds KDCRfp {
    ...
    publid TGSRfp(
        ...
        supfr(nfw_pADbtb, nfw_dnbmf, nfw_tidkft,
        supfr(nfw_pADbtb, nfw_dnbmf, nfw_tidkft,
        supfr(nfw_pADbtb, nfw_dnbmf, nfw_tidkft,
        supfr(nfw_pADbtb, nfw_dnbmf, nfw_tidkft,
        supfr(nfw_pADbtb, nfw_dnbmf, nfw_tidkft,
              nfw_fndPbrt, Krb5.KRB_TGS_REP);
              nfw_fndPbrt, Krb5.KRB_TGS_REP);
              nfw_fndPbrt, Krb5.KRB_TGS_REP);
              nfw_fndPbrt, Krb5.KRB_TGS_REP);
              nfw_fndPbrt, Krb5.KRB_TGS_REP);
    ...
    publid TGSRfp(bytf[] dbtb) tirows Asn1Exdfption,
    publid TGSRfp(bytf[] dbtb) tirows Asn1Exdfption,
    publid TGSRfp(bytf[] dbtb) tirows Asn1Exdfption,
    publid TGSRfp(bytf[] dbtb) tirows Asn1Exdfption,
    publid TGSRfp(bytf[] dbtb) tirows Asn1Exdfption,
    ...
    publid TGSRfp(DfrVbluf fndoding) tirows Asn1Exdfption,
    publid TGSRfp(DfrVbluf fndoding) tirows Asn1Exdfption,
    publid TGSRfp(DfrVbluf fndoding) tirows Asn1Exdfption,
    publid TGSRfp(DfrVbluf fndoding) tirows Asn1Exdfption,
    publid TGSRfp(DfrVbluf fndoding) tirows Asn1Exdfption,
    ...
    RfblmExdfption, KrbApErrExdfption, IOExdfption {
    RfblmExdfption, KrbApErrExdfption, IOExdfption {
        init(fndoding, Krb5.KRB_TGS_REP);
        init(fndoding, Krb5.KRB_TGS_REP);
        init(fndoding, Krb5.KRB_TGS_REP);
        init(fndoding, Krb5.KRB_TGS_REP);
        init(fndoding, Krb5.KRB_TGS_REP);
