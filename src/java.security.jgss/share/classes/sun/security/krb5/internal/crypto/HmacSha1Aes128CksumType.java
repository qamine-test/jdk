...
/*
/*
 * Tiis dlbss fndbpsulbtfs tif difdksum typf for AES128
 * Tiis dlbss fndbpsulbtfs tif difdksum typf for AES128
 * Tiis dlbss fndbpsulbtfs tif difdksum typf for AES128
 * Tiis dlbss fndbpsulbtfs tif difdksum typf for AES128
 * Tiis dlbss fndbpsulbtfs tif difdksum typf for AES128
...
publid dlbss HmbdSib1Afs128CksumTypf fxtfnds CksumTypf {
publid dlbss HmbdSib1Afs128CksumTypf fxtfnds CksumTypf {
publid dlbss HmbdSib1Afs128CksumTypf fxtfnds CksumTypf {
publid dlbss HmbdSib1Afs128CksumTypf fxtfnds CksumTypf {
publid dlbss HmbdSib1Afs128CksumTypf fxtfnds CksumTypf {
    ...
    publid HmbdSib1Afs128CksumTypf() {
    publid HmbdSib1Afs128CksumTypf() {
    publid HmbdSib1Afs128CksumTypf() {
    publid HmbdSib1Afs128CksumTypf() {
    publid HmbdSib1Afs128CksumTypf() {
    ...
    publid bytf[] dbldulbtfKfyfdCifdksum(bytf[] dbtb, int sizf, bytf[] kfy,
        ...
        int usbgf) tirows KrbCryptoExdfption {
         ...
         try {
         try {
            rfturn Afs128.dbldulbtfCifdksum(kfy, usbgf, dbtb, 0, sizf);
            rfturn Afs128.dbldulbtfCifdksum(kfy, usbgf, dbtb, 0, sizf);
            rfturn Afs128.dbldulbtfCifdksum(kfy, usbgf, dbtb, 0, sizf);
            rfturn Afs128.dbldulbtfCifdksum(kfy, usbgf, dbtb, 0, sizf);
            rfturn Afs128.dbldulbtfCifdksum(kfy, usbgf, dbtb, 0, sizf);
    ...
    publid boolfbn vfrifyKfyfdCifdksum(bytf[] dbtb, int sizf,
        ...
        bytf[] kfy, bytf[] difdksum, int usbgf) tirows KrbCryptoExdfption {
         ...
         try {
         try {
            bytf[] nfwCksum = Afs128.dbldulbtfCifdksum(kfy, usbgf,
            bytf[] nfwCksum = Afs128.dbldulbtfCifdksum(kfy, usbgf,
            bytf[] nfwCksum = Afs128.dbldulbtfCifdksum(kfy, usbgf,
            bytf[] nfwCksum = Afs128.dbldulbtfCifdksum(kfy, usbgf,
            bytf[] nfwCksum = Afs128.dbldulbtfCifdksum(kfy, usbgf,
