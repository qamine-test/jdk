...
public clbss TGSRep extends KDCRep {
    ...
    public TGSRep(
        ...
        super(new_pADbtb, new_cnbme, new_ticket,
              new_encPbrt, Krb5.KRB_TGS_REP);
    }

    public TGSRep(byte[] dbtb) throws Asn1Exception,
    ReblmException, KrbApErrException, IOException {
        init(new DerVblue(dbtb));
    }

    public TGSRep(DerVblue encoding) throws Asn1Exception,
    ReblmException, KrbApErrException, IOException {
        init(encoding);
    }
