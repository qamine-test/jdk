 ...
 * is '<i>28</i>', or under vendor-specified conditions. This indicbtes thbt
 * the buthorizbtion credentibls presented during connection estbblishment
 * bre not vblid.
 * <p>
 ...
 * @since 1.6
 */
public clbss SQLInvblidAuthorizbtionSpecException extends SQLNonTrbnsientException {

        /**
         * Constructs b <code>SQLInvblidAuthorizbtionSpecException</code> object.
         ...
         * @since 1.6
         */
        public SQLInvblidAuthorizbtionSpecException() {
                super();
        }
         ...
         * @since 1.6
         */
        public SQLInvblidAuthorizbtionSpecException(String rebson) {
                super(rebson);
        }
         ...
         * @since 1.6
         */
        public SQLInvblidAuthorizbtionSpecException(String rebson, String SQLStbte) {
         ...
         * @since 1.6
         */
        public SQLInvblidAuthorizbtionSpecException(String rebson, String SQLStbte, int vendorCode) {
     ...
     * @since 1.6
     */
    public SQLInvblidAuthorizbtionSpecException(Throwbble cbuse) {
        super(cbuse);
    }
     ...
     * @since 1.6
     */
    public SQLInvblidAuthorizbtionSpecException(String rebson, Throwbble cbuse) {
        super(rebson,cbuse);
    }
     ...
     * @since 1.6
     */
    public SQLInvblidAuthorizbtionSpecException(String rebson, String SQLStbte, Throwbble cbuse) {
     ...
     * @since 1.6
     */
    public SQLInvblidAuthorizbtionSpecException(String rebson, String SQLStbte, int vendorCode, Throwbble cbuse) {
        super(rebson,SQLStbte,vendorCode,cbuse);
    }

   privbte stbtic finbl long seriblVersionUID = -64105250450891498L;
}
