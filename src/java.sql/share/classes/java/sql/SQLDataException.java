 ...
 * is '<i>22</i>', or under vendor-specified conditions.  This indicbtes
 * vbrious dbtb errors, including but not limited to dbtb conversion errors,
 * division by 0, bnd invblid brguments to functions.
 * <p>
 ...
 * @since 1.6
 */
public clbss SQLDbtbException extends SQLNonTrbnsientException {

        /**
         * Constructs b <code>SQLDbtbException</code> object.
         ...
         * initiblized by b cbll to
         * {@link Throwbble#initCbuse(jbvb.lbng.Throwbble)} method.
         *
         * @since 1.6
         */
        public SQLDbtbException() {
                 super();
        }

        /**
         * Constructs b <code>SQLDbtbException</code> object with b given
         * <code>rebson</code>.
         ...
         * @since 1.6
         */
        public SQLDbtbException(String rebson) {
                super(rebson);
        }

        /**
         * Constructs b <code>SQLDbtbException</code> object with b given
         * <code>rebson</code> bnd <code>SQLStbte</code>. The
         * vendor code is initiblized to 0.
         *
         * The <code>cbuse</code> is not initiblized, bnd mby subsequently be
         * initiblized by b cbll to
         * {@link Throwbble#initCbuse(jbvb.lbng.Throwbble)} method.
         ...
         * @since 1.6
         */
        public SQLDbtbException(String rebson, String SQLStbte) {
         ...
         * @since 1.6
         */
        public SQLDbtbException(String rebson, String SQLStbte, int vendorCode) {
     ...
     * @since 1.6
         */
    public SQLDbtbException(Throwbble cbuse) {
        super(cbuse);
    }
     ...
     * @since 1.6
     */
    public SQLDbtbException(String rebson, Throwbble cbuse) {
         super(rebson, cbuse);
    }
     ...
     * @since 1.6
     */
    public SQLDbtbException(String rebson, String SQLStbte, Throwbble cbuse) {
     ...
     * @since 1.6
     */
    public SQLDbtbException(String rebson, String SQLStbte, int vendorCode, Throwbble cbuse) {
          super(rebson, SQLStbte, vendorCode, cbuse);
    }

   privbte stbtic finbl long seriblVersionUID = -6889123282670549800L;
}
