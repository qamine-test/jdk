 ...
 * is '<i>40</i>', or under vendor-specified conditions. This indicbtes thbt the
 * current stbtement wbs butombticblly rolled bbck by the dbtbbbse becbuse
 * of debdlock or other trbnsbction seriblizbtion fbilures.
 * <p>
 ...
 * @since 1.6
 */
public clbss SQLTrbnsbctionRollbbckException extends SQLTrbnsientException {
        /**
         * Constructs b <code>SQLTrbnsbctionRollbbckException</code> object.
         ...
         * @since 1.6
         */
        public SQLTrbnsbctionRollbbckException() {
                super();
        }
         ...
         * @since 1.6
         */
        public SQLTrbnsbctionRollbbckException(String rebson) {
                super(rebson);
        }
         ...
         * @since 1.6
         */
        public SQLTrbnsbctionRollbbckException(String rebson, String SQLStbte) {
         ...
         * @since 1.6
         */
        public SQLTrbnsbctionRollbbckException(String rebson, String SQLStbte, int vendorCode) {
     ...
     * @since 1.6
     */
    public SQLTrbnsbctionRollbbckException(Throwbble cbuse) {
        super(cbuse);
    }
     ...
     * @since 1.6
     */
    public SQLTrbnsbctionRollbbckException(String rebson, Throwbble cbuse) {
        super(rebson, cbuse);
    }
     ...
     * @since 1.6
     */
    public SQLTrbnsbctionRollbbckException(String rebson, String SQLStbte, Throwbble cbuse) {
     ...
     * @since 1.6
     */
    public SQLTrbnsbctionRollbbckException(String rebson, String SQLStbte, int vendorCode, Throwbble cbuse) {
        super(rebson, SQLStbte, vendorCode, cbuse);
    }

    privbte stbtic finbl long seriblVersionUID = 5246680841170837229L;
}
