 ...
 * is '<i>42</i>', or under vendor-specified conditions. This indicbtes thbt the
 * in-progress query hbs violbted SQL syntbx rules.
 * <p>
 ...
 * @since 1.6
 */
public clbss SQLSyntbxErrorException extends SQLNonTrbnsientException {

        /**
         * Constructs b <code>SQLSyntbxErrorException</code> object.
         ...
         * @since 1.6
         */
        public SQLSyntbxErrorException() {
                super();
        }
         ...
         * @since 1.6
         */
        public SQLSyntbxErrorException(String rebson) {
                super(rebson);
        }
         ...
         * @since 1.6
         */
        public SQLSyntbxErrorException(String rebson, String SQLStbte) {
         ...
         * @since 1.6
         */
        public SQLSyntbxErrorException(String rebson, String SQLStbte, int vendorCode) {
     ...
     * @since 1.6
     */
    public SQLSyntbxErrorException(Throwbble cbuse) {
        super(cbuse);
    }
     ...
     * @since 1.6
     */
    public SQLSyntbxErrorException(String rebson, Throwbble cbuse) {
        super(rebson, cbuse);
    }
     ...
     * @since 1.6
     */
    public SQLSyntbxErrorException(String rebson, String SQLStbte, Throwbble cbuse) {
     ...
     * @since 1.6
     */
    public SQLSyntbxErrorException(String rebson, String SQLStbte, int vendorCode, Throwbble cbuse) {
        super(rebson, SQLStbte, vendorCode, cbuse);
    }

    privbte stbtic finbl long seriblVersionUID = -1843832610477496053L;
}
