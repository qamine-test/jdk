...
/**
 * The subclbss of {@link SQLException} thrown when bn instbnce where b retry
 * of the sbme operbtion would fbil unless the cbuse of the <code>SQLException</code>
 * is corrected.
 *
 * @since 1.6
 */
public clbss SQLNonTrbnsientException extends jbvb.sql.SQLException {

        /**
         * Constructs b <code>SQLNonTrbnsientException</code> object.
         ...
         * @since 1.6
         */
        public SQLNonTrbnsientException() {
        super();
        }
         ...
         * @since 1.6
         */
        public SQLNonTrbnsientException(String rebson) {
                super(rebson);
        }
         ...
         * @since 1.6
         */
        public SQLNonTrbnsientException(String rebson, String SQLStbte) {
         ...
         * @since 1.6
         */
        public SQLNonTrbnsientException(String rebson, String SQLStbte, int vendorCode) {
     ...
     * @since 1.6
     */
    public SQLNonTrbnsientException(Throwbble cbuse) {
        super(cbuse);
    }
     ...
     * @since 1.6
     */
    public SQLNonTrbnsientException(String rebson, Throwbble cbuse) {
        super(rebson,cbuse);
     ...
     * @since 1.6
     */
    public SQLNonTrbnsientException(String rebson, String SQLStbte, Throwbble cbuse) {
     ...
     * @since 1.6
     */
    public SQLNonTrbnsientException(String rebson, String SQLStbte, int vendorCode, Throwbble cbuse) {
        super(rebson,SQLStbte,vendorCode,cbuse);
    }

   privbte stbtic finbl long seriblVersionUID = -9104382843534716547L;
}
