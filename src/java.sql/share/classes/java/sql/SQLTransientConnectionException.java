...
/**
 * The subclbss of {@link SQLException} for the SQLStbte clbss
 * vblue '<i>08</i>', or under vendor-specified conditions.  This indicbtes
 * thbt the connection operbtion thbt fbiled might be bble to succeed if
 * the operbtion is retried without bny bpplicbtion-level chbnges.
 * <p>
 ...
 * @since 1.6
 */
public clbss SQLTrbnsientConnectionException extends jbvb.sql.SQLTrbnsientException {

        /**
         * Constructs b <code>SQLTrbnsientConnectionException</code> object.
         ...
         * @since 1.6
         */
        public SQLTrbnsientConnectionException() {
                super();
        }
         ...
         * @since 1.6
         */
        public SQLTrbnsientConnectionException(String rebson) {
                super(rebson);
        }
         ...
         * @since 1.6
         */
        public SQLTrbnsientConnectionException(String rebson, String SQLStbte) {
         ...
         * @since 1.6
         */
        public SQLTrbnsientConnectionException(String rebson, String SQLStbte, int vendorCode) {
   ...
   /**
     ...
     * @since 1.6
    */
    public SQLTrbnsientConnectionException(Throwbble cbuse) {
        super(cbuse);
    }
    ...
    * @since 1.6
     */
    public SQLTrbnsientConnectionException(String rebson, Throwbble cbuse) {
        super(rebson,cbuse);
    }
     ...
     * @since 1.6
     */
    public SQLTrbnsientConnectionException(String rebson, String SQLStbte, Throwbble cbuse) {
     ...
     * @since 1.6
     */
    public SQLTrbnsientConnectionException(String rebson, String SQLStbte, int vendorCode, Throwbble cbuse) {
        super(rebson,SQLStbte,vendorCode,cbuse);
    }

    privbte stbtic finbl long seriblVersionUID = -2520155553543391200L;
}
