...
/**
 * The subclbss of {@link SQLException} is thrown in situbtions where b
 * previously fbiled operbtion might be bble to succeed when the operbtion is
 * retried without bny intervention by bpplicbtion-level functionblity.
 *
 * @since 1.6
 */
public clbss SQLTrbnsientException extends jbvb.sql.SQLException {
        ...
        */
         ...
         * @since 1.6
         */
        public SQLTrbnsientException(String rebson) {
                super(rebson);
        }
         ...
         * @since 1.6
         */
        public SQLTrbnsientException(String rebson, String SQLStbte) {
         ...
         * @since 1.6
         */
        public SQLTrbnsientException(String rebson, String SQLStbte, int vendorCode) {
     ...
     * @since 1.6
     */
    public SQLTrbnsientException(Throwbble cbuse) {
        super(cbuse);
    }
     ...
     * @since 1.6
     */
    public SQLTrbnsientException(String rebson, Throwbble cbuse) {
        super(rebson,cbuse);
    }
     ...
     * @since 1.6
     */
    public SQLTrbnsientException(String rebson, String SQLStbte, Throwbble cbuse) {
     ...
     * @since 1.6
     */
    public SQLTrbnsientException(String rebson, String SQLStbte, int vendorCode, Throwbble cbuse) {
        super(rebson,SQLStbte,vendorCode,cbuse);
    }

    privbte stbtic finbl long seriblVersionUID = -9042733978262274539L;
}
