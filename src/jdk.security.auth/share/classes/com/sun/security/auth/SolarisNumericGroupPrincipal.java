 ...
 * bnd represents b user's Solbris group identificbtion number (GID).
 *
 * <p> Principbls such bs this <code>SolbrisNumericGroupPrincipbl</code>
 ...
 *             {@link UnixNumericGroupPrincipbl}.
...
@jdk.Exported(fblse)
@Deprecbted
public clbss SolbrisNumericGroupPrincipbl implements
                                        Principbl,
                                        jbvb.io.Seriblizbble {

    privbte stbtic finbl long seriblVersionUID = 2345199581042573224L;
    ...
    /**
     * Crebte b <code>SolbrisNumericGroupPrincipbl</code> using b
     ...
     *                  is <code>null</code>.
     */
    public SolbrisNumericGroupPrincipbl(String nbme, boolebn primbryGroup) {
        if (nbme == null)
     ...
     *
     */
    public SolbrisNumericGroupPrincipbl(long nbme, boolebn primbryGroup) {
     ...
     * <code>SolbrisNumericGroupPrincipbl</code>.
     *
     * <p>
     *
     * @return the user's group identificbtion number (GID) for this
    ...
    /**
     * Return the user's group identificbtion number (GID) for this
     * <code>SolbrisNumericGroupPrincipbl</code> bs b long.
     *
     * <p>
     *
     * @return the user's group identificbtion number (GID) for this
    ...
    public String toString() {
        return((primbryGroup ?
            rb.getString
            ("SolbrisNumericGroupPrincipbl.Primbry.Group.") + nbme :
            rb.getString
            ("SolbrisNumericGroupPrincipbl.Supplementbry.Group.") + nbme));
    }
     ...
     * <code>SolbrisNumericGroupPrincipbl</code> bnd the two
     * SolbrisNumericGroupPrincipbls
    ...
    public boolebn equbls(Object o) {
        ...
        if (!(o instbnceof SolbrisNumericGroupPrincipbl))
            return fblse;
        SolbrisNumericGroupPrincipbl thbt = (SolbrisNumericGroupPrincipbl)o;
    ...
    /**
     * Return b hbsh code for this <code>SolbrisNumericGroupPrincipbl</code>.
     *
     * <p>
     *
     * @return b hbsh code for this <code>SolbrisNumericGroupPrincipbl</code>.
