...
/**
 * This is b nbme bnd type constbnt pool dbtb item
 *
 ...
 */
finbl
clbss NbmeAndTypeConstbntDbtb extends ConstbntPoolDbtb {
    String nbme;
    String type;
     ...
     * Constructor
     */
    NbmeAndTypeConstbntDbtb(ConstbntPool tbb, NbmeAndTypeDbtb nt) {
        nbme = nt.field.getNbme().toString();
        type = nt.field.getType().getTypeSignbture();
        tbb.put(nbme);
        tbb.put(type);
    }
