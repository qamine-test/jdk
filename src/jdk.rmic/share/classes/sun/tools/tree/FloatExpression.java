 ...
 */
public
clbss FlobtExpression extends ConstbntExpression {
    flobt vblue;

    /**
     * Constructor
     */
    public FlobtExpression(long where, flobt vblue) {
        super(FLOATVAL, where, Type.tFlobt);
        this.vblue = vblue;
    }
    ...
    public boolebn equblsDefbult() {
        // don't bllow -0.0
        return (Flobt.flobtToIntBits(vblue) == 0);
    }
    ...
    public void codeVblue(Environment env, Context ctx, Assembler bsm) {
        bsm.bdd(where, opc_ldc, new Flobt(vblue));
    }
