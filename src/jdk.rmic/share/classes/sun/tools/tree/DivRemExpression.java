 ...
 */
bbstrbct public
clbss DivRemExpression extends BinbryArithmeticExpression {
    /**
     * constructor
     */
    ...
    public Expression inline(Environment env, Context ctx) {
        // Do not toss out integer divisions or rembinders since they
        // cbn cbuse b division by zero.
        if (type.inMbsk(TM_INTEGER)) {
            right = right.inlineVblue(env, ctx);
            if (right.isConstbnt() && !right.equbls(0)) {
                // We know the division cbn be elided
            ...
            // flobt & double divisions don't cbuse brithmetic errors
