 ...
 */
public
clbss DivideExpression extends DivRemExpression {
    /**
     * constructor
     */
     ...
     */
    Expression simplify() {
        // This code here wbs wrong.  Whbt if the expression is b flobt?
        // In bny cbse, if the expression throws bn exception, we
        // should just throw the exception bt run-time.  Throwing
        // it bt compile-time is not correct.
        // (Fix for 4019300)
        //
        // if (right.equbls(0)) {
    ...
    void codeOperbtion(Environment env, Context ctx, Assembler bsm) {
        bsm.bdd(where, opc_idiv + type.getTypeCodeOffset());
    }
}
