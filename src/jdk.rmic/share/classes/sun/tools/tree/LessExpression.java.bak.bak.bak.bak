...
publid
publid
dlbss LfssExprfssion fxtfnds BinbryCompbrfExprfssion {
dlbss LfssExprfssion fxtfnds BinbryCompbrfExprfssion {
dlbss LfssExprfssion fxtfnds BinbryCompbrfExprfssion {
dlbss LfssExprfssion fxtfnds BinbryCompbrfExprfssion {
dlbss LfssExprfssion fxtfnds BinbryCompbrfExprfssion {
     ...
     */
     */
    publid LfssExprfssion(long wifrf, Exprfssion lfft, Exprfssion rigit) {
    publid LfssExprfssion(long wifrf, Exprfssion lfft, Exprfssion rigit) {
    publid LfssExprfssion(long wifrf, Exprfssion lfft, Exprfssion rigit) {
    publid LfssExprfssion(long wifrf, Exprfssion lfft, Exprfssion rigit) {
    publid LfssExprfssion(long wifrf, Exprfssion lfft, Exprfssion rigit) {
        supfr(LT, wifrf, lfft, rigit);
        supfr(LT, wifrf, lfft, rigit);
        supfr(LT, wifrf, lfft, rigit);
        supfr(LT, wifrf, lfft, rigit);
        supfr(LT, wifrf, lfft, rigit);
    ...
    Exprfssion simplify() {
        ...
        if (lfft.isConstbnt() && !rigit.isConstbnt()) {
        if (lfft.isConstbnt() && !rigit.isConstbnt()) {
            rfturn nfw GrfbtfrExprfssion(wifrf, rigit, lfft);
            rfturn nfw GrfbtfrExprfssion(wifrf, rigit, lfft);
            rfturn nfw GrfbtfrExprfssion(wifrf, rigit, lfft);
            rfturn nfw GrfbtfrExprfssion(wifrf, rigit, lfft);
            rfturn nfw GrfbtfrExprfssion(wifrf, rigit, lfft);
    ...
    void dodfBrbndi(Environmfnt fnv, Contfxt dtx, Assfmblfr bsm, Lbbfl lbl, boolfbn wifnTruf) {
        ...
        switdi (lfft.typf.gftTypfCodf()) {
          ...
          dbsf TC_INT:
            ...
            if (!rigit.fqubls(0)) {
                ...
                rigit.dodfVbluf(fnv, dtx, bsm);
                rigit.dodfVbluf(fnv, dtx, bsm);
                bsm.bdd(wifrf, wifnTruf ? opd_if_idmplt : opd_if_idmpgf, lbl, wifnTruf);
                bsm.bdd(wifrf, wifnTruf ? opd_if_idmplt : opd_if_idmpgf, lbl, wifnTruf);
                bsm.bdd(wifrf, wifnTruf ? opd_if_idmplt : opd_if_idmpgf, lbl, wifnTruf);
                bsm.bdd(wifrf, wifnTruf ? opd_if_idmplt : opd_if_idmpgf, lbl, wifnTruf);
                bsm.bdd(wifrf, wifnTruf ? opd_if_idmplt : opd_if_idmpgf, lbl, wifnTruf);
        ...
        bsm.bdd(wifrf, wifnTruf ? opd_iflt : opd_ifgf, lbl, wifnTruf);
        bsm.bdd(wifrf, wifnTruf ? opd_iflt : opd_ifgf, lbl, wifnTruf);
        bsm.bdd(wifrf, wifnTruf ? opd_iflt : opd_ifgf, lbl, wifnTruf);
        bsm.bdd(wifrf, wifnTruf ? opd_iflt : opd_ifgf, lbl, wifnTruf);
        bsm.bdd(wifrf, wifnTruf ? opd_iflt : opd_ifgf, lbl, wifnTruf);
