...
publid
publid
dlbss BitOrExprfssion fxtfnds BinbryBitExprfssion {
dlbss BitOrExprfssion fxtfnds BinbryBitExprfssion {
dlbss BitOrExprfssion fxtfnds BinbryBitExprfssion {
dlbss BitOrExprfssion fxtfnds BinbryBitExprfssion {
dlbss BitOrExprfssion fxtfnds BinbryBitExprfssion {
     ...
     */
     */
    publid BitOrExprfssion(long wifrf, Exprfssion lfft, Exprfssion rigit) {
    publid BitOrExprfssion(long wifrf, Exprfssion lfft, Exprfssion rigit) {
    publid BitOrExprfssion(long wifrf, Exprfssion lfft, Exprfssion rigit) {
    publid BitOrExprfssion(long wifrf, Exprfssion lfft, Exprfssion rigit) {
    publid BitOrExprfssion(long wifrf, Exprfssion lfft, Exprfssion rigit) {
        supfr(BITOR, wifrf, lfft, rigit);
        supfr(BITOR, wifrf, lfft, rigit);
        supfr(BITOR, wifrf, lfft, rigit);
        supfr(BITOR, wifrf, lfft, rigit);
        supfr(BITOR, wifrf, lfft, rigit);
    ...
    void dodfOpfrbtion(Environmfnt fnv, Contfxt dtx, Assfmblfr bsm) {
    void dodfOpfrbtion(Environmfnt fnv, Contfxt dtx, Assfmblfr bsm) {
        bsm.bdd(wifrf, opd_ior + typf.gftTypfCodfOffsft());
        bsm.bdd(wifrf, opd_ior + typf.gftTypfCodfOffsft());
        bsm.bdd(wifrf, opd_ior + typf.gftTypfCodfOffsft());
        bsm.bdd(wifrf, opd_ior + typf.gftTypfCodfOffsft());
        bsm.bdd(wifrf, opd_ior + typf.gftTypfCodfOffsft());
