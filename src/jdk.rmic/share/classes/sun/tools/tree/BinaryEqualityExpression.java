 ...
 */
public
clbss BinbryEqublityExpression extends BinbryExpression {
    /**
     * constructor
     */
    public BinbryEqublityExpression(int op, long where, Expression left, Expression right) {
