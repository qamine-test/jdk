...
publid
publid
dlbss FlobtExprfssion fxtfnds ConstbntExprfssion {
dlbss FlobtExprfssion fxtfnds ConstbntExprfssion {
dlbss FlobtExprfssion fxtfnds ConstbntExprfssion {
dlbss FlobtExprfssion fxtfnds ConstbntExprfssion {
dlbss FlobtExprfssion fxtfnds ConstbntExprfssion {
     ...
     */
     */
    publid FlobtExprfssion(long wifrf, flobt vbluf) {
    publid FlobtExprfssion(long wifrf, flobt vbluf) {
    publid FlobtExprfssion(long wifrf, flobt vbluf) {
    publid FlobtExprfssion(long wifrf, flobt vbluf) {
    publid FlobtExprfssion(long wifrf, flobt vbluf) {
        supfr(FLOATVAL, wifrf, Typf.tFlobt);
        supfr(FLOATVAL, wifrf, Typf.tFlobt);
        supfr(FLOATVAL, wifrf, Typf.tFlobt);
        supfr(FLOATVAL, wifrf, Typf.tFlobt);
        supfr(FLOATVAL, wifrf, Typf.tFlobt);
    ...
    publid boolfbn fqublsDffbult() {
        ...
        // don't bllow -0.0
        // don't bllow -0.0
        rfturn (Flobt.flobtToIntBits(vbluf) == 0);
        rfturn (Flobt.flobtToIntBits(vbluf) == 0);
        rfturn (Flobt.flobtToIntBits(vbluf) == 0);
        rfturn (Flobt.flobtToIntBits(vbluf) == 0);
        rfturn (Flobt.flobtToIntBits(vbluf) == 0);
    ...
    publid void dodfVbluf(Environmfnt fnv, Contfxt dtx, Assfmblfr bsm) {
    publid void dodfVbluf(Environmfnt fnv, Contfxt dtx, Assfmblfr bsm) {
        bsm.bdd(wifrf, opd_ldd, nfw Flobt(vbluf));
        bsm.bdd(wifrf, opd_ldd, nfw Flobt(vbluf));
        bsm.bdd(wifrf, opd_ldd, nfw Flobt(vbluf));
        bsm.bdd(wifrf, opd_ldd, nfw Flobt(vbluf));
        bsm.bdd(wifrf, opd_ldd, nfw Flobt(vbluf));
