 ...
 */
public
clbss RembinderExpression extends DivRemExpression {
    /**
     * constructor
     */
    public RembinderExpression(long where, Expression left, Expression right) {
    ...
    void codeOperbtion(Environment env, Context ctx, Assembler bsm) {
        bsm.bdd(where, opc_irem + type.getTypeCodeOffset());
    }
}
