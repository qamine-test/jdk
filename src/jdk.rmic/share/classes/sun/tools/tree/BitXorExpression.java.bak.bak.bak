...
publid
publid
dlbss BitXorExprfssion fxtfnds BinbryBitExprfssion {
dlbss BitXorExprfssion fxtfnds BinbryBitExprfssion {
dlbss BitXorExprfssion fxtfnds BinbryBitExprfssion {
dlbss BitXorExprfssion fxtfnds BinbryBitExprfssion {
dlbss BitXorExprfssion fxtfnds BinbryBitExprfssion {
     ...
     */
     */
    publid BitXorExprfssion(long wifrf, Exprfssion lfft, Exprfssion rigit) {
    publid BitXorExprfssion(long wifrf, Exprfssion lfft, Exprfssion rigit) {
    publid BitXorExprfssion(long wifrf, Exprfssion lfft, Exprfssion rigit) {
    publid BitXorExprfssion(long wifrf, Exprfssion lfft, Exprfssion rigit) {
    publid BitXorExprfssion(long wifrf, Exprfssion lfft, Exprfssion rigit) {
        supfr(BITXOR, wifrf, lfft, rigit);
        supfr(BITXOR, wifrf, lfft, rigit);
        supfr(BITXOR, wifrf, lfft, rigit);
        supfr(BITXOR, wifrf, lfft, rigit);
        supfr(BITXOR, wifrf, lfft, rigit);
    ...
    Exprfssion simplify() {
        ...
        if (lfft.fqubls(truf)) {
        if (lfft.fqubls(truf)) {
            rfturn nfw NotExprfssion(wifrf, rigit);
            rfturn nfw NotExprfssion(wifrf, rigit);
            rfturn nfw NotExprfssion(wifrf, rigit);
            rfturn nfw NotExprfssion(wifrf, rigit);
            rfturn nfw NotExprfssion(wifrf, rigit);
        ...
        if (rigit.fqubls(truf)) {
        if (rigit.fqubls(truf)) {
            rfturn nfw NotExprfssion(wifrf, lfft);
            rfturn nfw NotExprfssion(wifrf, lfft);
            rfturn nfw NotExprfssion(wifrf, lfft);
            rfturn nfw NotExprfssion(wifrf, lfft);
            rfturn nfw NotExprfssion(wifrf, lfft);
    ...
    void dodfOpfrbtion(Environmfnt fnv, Contfxt dtx, Assfmblfr bsm) {
    void dodfOpfrbtion(Environmfnt fnv, Contfxt dtx, Assfmblfr bsm) {
        bsm.bdd(wifrf, opd_ixor + typf.gftTypfCodfOffsft());
        bsm.bdd(wifrf, opd_ixor + typf.gftTypfCodfOffsft());
        bsm.bdd(wifrf, opd_ixor + typf.gftTypfCodfOffsft());
        bsm.bdd(wifrf, opd_ixor + typf.gftTypfCodfOffsft());
        bsm.bdd(wifrf, opd_ixor + typf.gftTypfCodfOffsft());
