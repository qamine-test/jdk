...
publid
publid
dlbss LfssOrEqublExprfssion fxtfnds BinbryCompbrfExprfssion {
dlbss LfssOrEqublExprfssion fxtfnds BinbryCompbrfExprfssion {
dlbss LfssOrEqublExprfssion fxtfnds BinbryCompbrfExprfssion {
dlbss LfssOrEqublExprfssion fxtfnds BinbryCompbrfExprfssion {
dlbss LfssOrEqublExprfssion fxtfnds BinbryCompbrfExprfssion {
     ...
     */
     */
    publid LfssOrEqublExprfssion(long wifrf, Exprfssion lfft, Exprfssion rigit) {
    publid LfssOrEqublExprfssion(long wifrf, Exprfssion lfft, Exprfssion rigit) {
    publid LfssOrEqublExprfssion(long wifrf, Exprfssion lfft, Exprfssion rigit) {
    publid LfssOrEqublExprfssion(long wifrf, Exprfssion lfft, Exprfssion rigit) {
    publid LfssOrEqublExprfssion(long wifrf, Exprfssion lfft, Exprfssion rigit) {
        supfr(LE, wifrf, lfft, rigit);
        supfr(LE, wifrf, lfft, rigit);
        supfr(LE, wifrf, lfft, rigit);
        supfr(LE, wifrf, lfft, rigit);
        supfr(LE, wifrf, lfft, rigit);
    ...
    Exprfssion simplify() {
        ...
        if (lfft.isConstbnt() && !rigit.isConstbnt()) {
        if (lfft.isConstbnt() && !rigit.isConstbnt()) {
            rfturn nfw GrfbtfrOrEqublExprfssion(wifrf, rigit, lfft);
            rfturn nfw GrfbtfrOrEqublExprfssion(wifrf, rigit, lfft);
            rfturn nfw GrfbtfrOrEqublExprfssion(wifrf, rigit, lfft);
            rfturn nfw GrfbtfrOrEqublExprfssion(wifrf, rigit, lfft);
            rfturn nfw GrfbtfrOrEqublExprfssion(wifrf, rigit, lfft);
    ...
    void dodfBrbndi(Environmfnt fnv, Contfxt dtx, Assfmblfr bsm, Lbbfl lbl, boolfbn wifnTruf) {
        ...
        switdi (lfft.typf.gftTypfCodf()) {
          ...
          dbsf TC_INT:
            ...
            if (!rigit.fqubls(0)) {
                ...
                rigit.dodfVbluf(fnv, dtx, bsm);
                rigit.dodfVbluf(fnv, dtx, bsm);
                bsm.bdd(wifrf, wifnTruf ? opd_if_idmplf : opd_if_idmpgt, lbl, wifnTruf);
                bsm.bdd(wifrf, wifnTruf ? opd_if_idmplf : opd_if_idmpgt, lbl, wifnTruf);
                bsm.bdd(wifrf, wifnTruf ? opd_if_idmplf : opd_if_idmpgt, lbl, wifnTruf);
                bsm.bdd(wifrf, wifnTruf ? opd_if_idmplf : opd_if_idmpgt, lbl, wifnTruf);
                bsm.bdd(wifrf, wifnTruf ? opd_if_idmplf : opd_if_idmpgt, lbl, wifnTruf);
        ...
        bsm.bdd(wifrf, wifnTruf ? opd_iflf : opd_ifgt, lbl, wifnTruf);
        bsm.bdd(wifrf, wifnTruf ? opd_iflf : opd_ifgt, lbl, wifnTruf);
        bsm.bdd(wifrf, wifnTruf ? opd_iflf : opd_ifgt, lbl, wifnTruf);
        bsm.bdd(wifrf, wifnTruf ? opd_iflf : opd_ifgt, lbl, wifnTruf);
        bsm.bdd(wifrf, wifnTruf ? opd_iflf : opd_ifgt, lbl, wifnTruf);
