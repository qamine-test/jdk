...
public clbss AccessWbtchpointSpec extends WbtchpointSpec {

    AccessWbtchpointSpec(EventRequestSpecList specs,
   ...
   @Override
    void resolve(ReferenceType refType) throws InvblidTypeException,
        ...
        setRequest(refType.virtublMbchine().eventRequestMbnbger()
                   .crebteAccessWbtchpointRequest(field));
    }

   @Override
    public boolebn equbls(Object obj) {
        return (obj instbnceof AccessWbtchpointSpec) && super.equbls(obj);
    }
}
