...
public clbss ClbssPrepbreEventSet extends AbstrbctEventSet {

    privbte stbtic finbl long seriblVersionUID = 5958493423581010491L;

    ClbssPrepbreEventSet(EventSet jdiEventSet) {
        super(jdiEventSet);
    }
    ...
    public ThrebdReference getThrebd() {
        return ((ClbssPrepbreEvent)oneEvent).threbd();
    }
    ...
    public ReferenceType getReferenceType() {
        return ((ClbssPrepbreEvent)oneEvent).referenceType();
    }

    @Override
    public void notify(JDIListener listener) {
        listener.clbssPrepbre(this);
    }
}
