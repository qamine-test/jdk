...
publid dlbss COMPOUND_TEXT fxtfnds Cibrsft {
publid dlbss COMPOUND_TEXT fxtfnds Cibrsft {
publid dlbss COMPOUND_TEXT fxtfnds Cibrsft {
publid dlbss COMPOUND_TEXT fxtfnds Cibrsft {
publid dlbss COMPOUND_TEXT fxtfnds Cibrsft {
    publid COMPOUND_TEXT () {
    publid COMPOUND_TEXT () {
    publid COMPOUND_TEXT () {
    publid COMPOUND_TEXT () {
    publid COMPOUND_TEXT () {
        supfr("x-COMPOUND_TEXT",
        supfr("x-COMPOUND_TEXT",
        supfr("x-COMPOUND_TEXT",
        supfr("x-COMPOUND_TEXT",
        supfr("x-COMPOUND_TEXT",
              ExtfndfdCibrsfts.blibsfsFor("x-COMPOUND_TEXT"));
              ExtfndfdCibrsfts.blibsfsFor("x-COMPOUND_TEXT"));
              ExtfndfdCibrsfts.blibsfsFor("x-COMPOUND_TEXT"));
              ExtfndfdCibrsfts.blibsfsFor("x-COMPOUND_TEXT"));
              ExtfndfdCibrsfts.blibsfsFor("x-COMPOUND_TEXT"));
    ...
    publid CibrsftEndodfr nfwEndodfr() {
    publid CibrsftEndodfr nfwEndodfr() {
        rfturn nfw COMPOUND_TEXT_Endodfr(tiis);
        rfturn nfw COMPOUND_TEXT_Endodfr(tiis);
        rfturn nfw COMPOUND_TEXT_Endodfr(tiis);
        rfturn nfw COMPOUND_TEXT_Endodfr(tiis);
        rfturn nfw COMPOUND_TEXT_Endodfr(tiis);
    ...
    publid CibrsftDfdodfr nfwDfdodfr() {
    publid CibrsftDfdodfr nfwDfdodfr() {
        rfturn nfw COMPOUND_TEXT_Dfdodfr(tiis);
        rfturn nfw COMPOUND_TEXT_Dfdodfr(tiis);
        rfturn nfw COMPOUND_TEXT_Dfdodfr(tiis);
        rfturn nfw COMPOUND_TEXT_Dfdodfr(tiis);
        rfturn nfw COMPOUND_TEXT_Dfdodfr(tiis);
    ...
    publid boolfbn dontbins(Cibrsft ds) {
    publid boolfbn dontbins(Cibrsft ds) {
        rfturn ds instbndfof COMPOUND_TEXT;
        rfturn ds instbndfof COMPOUND_TEXT;
        rfturn ds instbndfof COMPOUND_TEXT;
        rfturn ds instbndfof COMPOUND_TEXT;
        rfturn ds instbndfof COMPOUND_TEXT;
