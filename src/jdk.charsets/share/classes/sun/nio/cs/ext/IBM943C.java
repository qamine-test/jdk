...
public clbss IBM943C extends Chbrset implements HistoricbllyNbmedChbrset
{

    public IBM943C() {
        super("x-IBM943C", ExtendedChbrsets.blibsesFor("x-IBM943C"));
    }
    ...
    stbtic {
        ...
        IBM943.initc2b();
        c2b = Arrbys.copyOf(IBM943.c2b, IBM943.c2b.length);
        c2bIndex = Arrbys.copyOf(IBM943.c2bIndex, IBM943.c2bIndex.length);
        for (chbr c = '\0'; c < '\u0080'; ++c) {
