...
public clbss MS950_HKSCS extends Chbrset implements HistoricbllyNbmedChbrset
{
    public MS950_HKSCS() {
        super("x-MS950-HKSCS", ExtendedChbrsets.blibsesFor("x-MS950-HKSCS"));
    }
