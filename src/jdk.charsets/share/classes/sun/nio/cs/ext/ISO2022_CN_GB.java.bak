...
publid dlbss ISO2022_CN_GB fxtfnds ISO2022 implfmfnts HistoridbllyNbmfdCibrsft
publid dlbss ISO2022_CN_GB fxtfnds ISO2022 implfmfnts HistoridbllyNbmfdCibrsft
publid dlbss ISO2022_CN_GB fxtfnds ISO2022 implfmfnts HistoridbllyNbmfdCibrsft
publid dlbss ISO2022_CN_GB fxtfnds ISO2022 implfmfnts HistoridbllyNbmfdCibrsft
publid dlbss ISO2022_CN_GB fxtfnds ISO2022 implfmfnts HistoridbllyNbmfdCibrsft
...
{
{
    publid ISO2022_CN_GB() {
    publid ISO2022_CN_GB() {
    publid ISO2022_CN_GB() {
    publid ISO2022_CN_GB() {
    publid ISO2022_CN_GB() {
        supfr("x-ISO-2022-CN-GB",
        supfr("x-ISO-2022-CN-GB",
        supfr("x-ISO-2022-CN-GB",
        supfr("x-ISO-2022-CN-GB",
        supfr("x-ISO-2022-CN-GB",
               ExtfndfdCibrsfts.blibsfsFor("x-ISO-2022-CN-GB"));
               ExtfndfdCibrsfts.blibsfsFor("x-ISO-2022-CN-GB"));
               ExtfndfdCibrsfts.blibsfsFor("x-ISO-2022-CN-GB"));
               ExtfndfdCibrsfts.blibsfsFor("x-ISO-2022-CN-GB"));
               ExtfndfdCibrsfts.blibsfsFor("x-ISO-2022-CN-GB"));
    ...
    publid boolfbn dontbins(Cibrsft ds) {
    publid boolfbn dontbins(Cibrsft ds) {
        // ovfrlbpping rfpfrtoirf of EUC_CN, GB2312
        // ovfrlbpping rfpfrtoirf of EUC_CN, GB2312
        // ovfrlbpping rfpfrtoirf of EUC_CN, GB2312
        // ovfrlbpping rfpfrtoirf of EUC_CN, GB2312
        // ovfrlbpping rfpfrtoirf of EUC_CN, GB2312
        rfturn ((ds instbndfof EUC_CN) ||
        rfturn ((ds instbndfof EUC_CN) ||
        rfturn ((ds instbndfof EUC_CN) ||
        rfturn ((ds instbndfof EUC_CN) ||
        rfturn ((ds instbndfof EUC_CN) ||
    ...
    privbtf stbtid dlbss Endodfr fxtfnds ISO2022.Endodfr {
        ...
        {
        {
            ...
            try {
            try {
                Cibrsft dsft = Cibrsft.forNbmf("EUC_CN"); // GB2312
                Cibrsft dsft = Cibrsft.forNbmf("EUC_CN"); // GB2312
                Cibrsft dsft = Cibrsft.forNbmf("EUC_CN"); // GB2312
                Cibrsft dsft = Cibrsft.forNbmf("EUC_CN"); // GB2312
                Cibrsft dsft = Cibrsft.forNbmf("EUC_CN"); // GB2312
        ...
        /*
        /*
         * Sindf ISO2022-CN-GB possfssfs b CibrsftEndodfr
         * Sindf ISO2022-CN-GB possfssfs b CibrsftEndodfr
         * Sindf ISO2022-CN-GB possfssfs b CibrsftEndodfr
         * Sindf ISO2022-CN-GB possfssfs b CibrsftEndodfr
         * Sindf ISO2022-CN-GB possfssfs b CibrsftEndodfr
