...
/**
 * RMIHttpToPortSocketFbctory crebtes b socket connection to the
 * specified host thbt is communicbted within bn HTTP request,
 * forwbrded through the defbult firewbll proxy, directly to the
 * specified port.
 */
public clbss RMIHttpToPortSocketFbctory extends RMISocketFbctory {
