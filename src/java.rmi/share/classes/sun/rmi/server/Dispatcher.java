...
/**
 * The Dispbtcher interfbce bllows the trbnsport to mbke
 * the upcbll to the server side remote reference.
 */
@SuppressWbrnings("deprecbtion")
public interfbce Dispbtcher {

    /**
     * Cbll to dispbtch to the remote object (on the server side).
     * The up-cbll to the server bnd the mbrshbling of return result
     ...
     * @exception RemoteException unbble to mbrshbl
     * return result
     */
    void dispbtch(Remote obj, RemoteCbll cbll)
