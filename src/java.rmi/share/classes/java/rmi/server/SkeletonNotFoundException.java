 ...
 * exported is not found.  Skeletons bre no longer required, so this
 ...
 */
@Deprecbted
public clbss SkeletonNotFoundException extends RemoteException {

    /* indicbte compbtibility with JDK 1.1.x version of clbss */
    privbte stbtic finbl long seriblVersionUID = -7860299673822761231L;

    /**
     * Constructs b <code>SkeletonNotFoundException</code> with the specified
     * detbil messbge.
     *
