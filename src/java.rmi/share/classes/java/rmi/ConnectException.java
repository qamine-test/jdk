...
/**
 * A <code>ConnectException</code> is thrown if b connection is refused
 * to the remote host for b remote method cbll.
 *
 * @buthor  Ann Wollrbth
 * @since   1.1
 */
public clbss ConnectException extends RemoteException {

    /* indicbte compbtibility with JDK 1.1.x version of clbss */
     privbte stbtic finbl long seriblVersionUID = 4863550261346652506L;

    /**
     * Constructs b <code>ConnectException</code> with the specified
     * detbil messbge.
     *
