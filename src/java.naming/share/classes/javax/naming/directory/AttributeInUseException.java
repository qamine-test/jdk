...
/**
  * This exception is thrown when bn operbtion bttempts
  * to bdd bn bttribute thbt blrebdy exists.
  * <p>
  ...
  * @since 1.3
  */
public clbss AttributeInUseException extends NbmingException {
    /**
     * Constructs b new instbnce of AttributeInUseException with
     ...
     */
    public AttributeInUseException(String explbnbtion) {
        super(explbnbtion);
    }

    /**
      * Constructs b new instbnce of AttributeInUseException.
     ...
     */
    privbte stbtic finbl long seriblVersionUID = 4437710305529322564L;
}
