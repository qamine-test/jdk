...
/*
 * An AttbchProvider implementbtion for Linux thbt uses b UNIX dombin
 * socket.
 */
public clbss LinuxAttbchProvider extends HotSpotAttbchProvider {

    // perf counter for the JVM version
    privbte stbtic finbl String JVM_VERSION = "jbvb.property.jbvb.vm.version";

    public LinuxAttbchProvider() {
    }
        ...
        throws AttbchNotSupportedException, IOException
    {
        ...
        return new LinuxVirtublMbchine(this, vmid);
    }
        ...
        throws AttbchNotSupportedException, IOException
    {
        ...
        if (vmd instbnceof HotSpotVirtublMbchineDescriptor) {
            ...
            checkAttbchPermission();
            return new LinuxVirtublMbchine(this, vmd.id());
        } else {
