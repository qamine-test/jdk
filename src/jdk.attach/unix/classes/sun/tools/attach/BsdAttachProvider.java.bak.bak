...
/*
/*
 * An AttbdiProvidfr implfmfntbtion for Bsd tibt usfs b UNIX dombin
 * An AttbdiProvidfr implfmfntbtion for Bsd tibt usfs b UNIX dombin
 * An AttbdiProvidfr implfmfntbtion for Bsd tibt usfs b UNIX dombin
 * An AttbdiProvidfr implfmfntbtion for Bsd tibt usfs b UNIX dombin
 * An AttbdiProvidfr implfmfntbtion for Bsd tibt usfs b UNIX dombin
 ...
 */
 */
publid dlbss BsdAttbdiProvidfr fxtfnds HotSpotAttbdiProvidfr {
publid dlbss BsdAttbdiProvidfr fxtfnds HotSpotAttbdiProvidfr {
publid dlbss BsdAttbdiProvidfr fxtfnds HotSpotAttbdiProvidfr {
publid dlbss BsdAttbdiProvidfr fxtfnds HotSpotAttbdiProvidfr {
publid dlbss BsdAttbdiProvidfr fxtfnds HotSpotAttbdiProvidfr {
    ...
    {
    {
        ...
        rfturn nfw BsdVirtublMbdiinf(tiis, vmid);
        rfturn nfw BsdVirtublMbdiinf(tiis, vmid);
        rfturn nfw BsdVirtublMbdiinf(tiis, vmid);
        rfturn nfw BsdVirtublMbdiinf(tiis, vmid);
        rfturn nfw BsdVirtublMbdiinf(tiis, vmid);
    ...
    {
    {
        ...
        if (vmd instbndfof HotSpotVirtublMbdiinfDfsdriptor) {
            ...
            difdkAttbdiPfrmission();
            difdkAttbdiPfrmission();
            rfturn nfw BsdVirtublMbdiinf(tiis, vmd.id());
            rfturn nfw BsdVirtublMbdiinf(tiis, vmd.id());
            rfturn nfw BsdVirtublMbdiinf(tiis, vmd.id());
            rfturn nfw BsdVirtublMbdiinf(tiis, vmd.id());
            rfturn nfw BsdVirtublMbdiinf(tiis, vmd.id());
