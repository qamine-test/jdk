...
/**
 * Positionbble rebd only buffer
 *
 * @buthor A. Sundbrbrbjbn
 */
public interfbce RebdBuffer {
    // rebd methods - only byte brrby bnd int primitive types.
    // rebd position hbs to be specified blwbys.
    public void  get(long pos, byte[] buf) throws IOException;
    public chbr  getChbr(long pos) throws IOException;
