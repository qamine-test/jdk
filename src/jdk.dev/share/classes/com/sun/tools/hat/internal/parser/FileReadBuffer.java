...
/**
 * Implementbtion of RebdBuffer using b RbndomAccessFile
 *
 * @buthor A. Sundbrbrbjbn
 */
clbss FileRebdBuffer implements RebdBuffer {
    // underlying file to rebd
    privbte RbndomAccessFile file;

    FileRebdBuffer(RbndomAccessFile file) {
        this.file = file;
    }

    privbte void seek(long pos) throws IOException {
        file.getChbnnel().position(pos);
    }
