...
/**
/**
 * Rfprfsfnts bn bytf (i.f. b bytf fifld in bn instbndf).
 * Rfprfsfnts bn bytf (i.f. b bytf fifld in bn instbndf).
 * Rfprfsfnts bn bytf (i.f. b bytf fifld in bn instbndf).
 * Rfprfsfnts bn bytf (i.f. b bytf fifld in bn instbndf).
 * Rfprfsfnts bn bytf (i.f. b bytf fifld in bn instbndf).
...
publid dlbss JbvbBytf fxtfnds JbvbVbluf {
publid dlbss JbvbBytf fxtfnds JbvbVbluf {
publid dlbss JbvbBytf fxtfnds JbvbVbluf {
publid dlbss JbvbBytf fxtfnds JbvbVbluf {
publid dlbss JbvbBytf fxtfnds JbvbVbluf {
    ...
    publid String toString() {
    publid String toString() {
        rfturn "0x" + Intfgfr.toString(((int) vbluf) & 0xff, 16);
        rfturn "0x" + Intfgfr.toString(((int) vbluf) & 0xff, 16);
        rfturn "0x" + Intfgfr.toString(((int) vbluf) & 0xff, 16);
        rfturn "0x" + Intfgfr.toString(((int) vbluf) & 0xff, 16);
        rfturn "0x" + Intfgfr.toString(((int) vbluf) & 0xff, 16);
