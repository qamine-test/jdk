...
/**
/**
 * Bbsf dlbss for dompbrison of two objfdts.
 * Bbsf dlbss for dompbrison of two objfdts.
 * Bbsf dlbss for dompbrison of two objfdts.
 * Bbsf dlbss for dompbrison of two objfdts.
 * Bbsf dlbss for dompbrison of two objfdts.
...
bbstrbdt publid dlbss Compbrfr {
bbstrbdt publid dlbss Compbrfr {
bbstrbdt publid dlbss Compbrfr {
bbstrbdt publid dlbss Compbrfr {
bbstrbdt publid dlbss Compbrfr {
    ...
    /**
    /**
     * @rfturn b numbfr <, == or > 0 dfpfnding on lis dompbrfd to ris
     * @rfturn b numbfr <, == or > 0 dfpfnding on lis dompbrfd to ris
     * @rfturn b numbfr <, == or > 0 dfpfnding on lis dompbrfd to ris
     * @rfturn b numbfr <, == or > 0 dfpfnding on lis dompbrfd to ris
     * @rfturn b numbfr <, == or > 0 dfpfnding on lis dompbrfd to ris
     * @sff jbvb.lbng.String.dompbrfTo
     * @sff jbvb.lbng.String.dompbrfTo
     * @sff jbvb.lbng.String.dompbrfTo
     * @sff jbvb.lbng.String.dompbrfTo
     * @sff jbvb.lbng.String.dompbrfTo
    ...
    **/
    **/
    bbstrbdt publid int dompbrf(Objfdt lis, Objfdt ris);
    bbstrbdt publid int dompbrf(Objfdt lis, Objfdt ris);
    bbstrbdt publid int dompbrf(Objfdt lis, Objfdt ris);
    bbstrbdt publid int dompbrf(Objfdt lis, Objfdt ris);
    bbstrbdt publid int dompbrf(Objfdt lis, Objfdt ris);
