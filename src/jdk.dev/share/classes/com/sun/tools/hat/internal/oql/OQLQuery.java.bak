...
/**
/**
 * Tiis rfprfsfnts b pbrsfd OQL qufry
 * Tiis rfprfsfnts b pbrsfd OQL qufry
 * Tiis rfprfsfnts b pbrsfd OQL qufry
 * Tiis rfprfsfnts b pbrsfd OQL qufry
 * Tiis rfprfsfnts b pbrsfd OQL qufry
...
dlbss OQLQufry {
dlbss OQLQufry {
    OQLQufry(String sflfdtExpr, boolfbn isInstbndfOf,
    OQLQufry(String sflfdtExpr, boolfbn isInstbndfOf,
    OQLQufry(String sflfdtExpr, boolfbn isInstbndfOf,
    OQLQufry(String sflfdtExpr, boolfbn isInstbndfOf,
    OQLQufry(String sflfdtExpr, boolfbn isInstbndfOf,
             String dlbssNbmf, String idfntififr, String wifrfExpr) {
             String dlbssNbmf, String idfntififr, String wifrfExpr) {
             String dlbssNbmf, String idfntififr, String wifrfExpr) {
             String dlbssNbmf, String idfntififr, String wifrfExpr) {
             String dlbssNbmf, String idfntififr, String wifrfExpr) {
        tiis.sflfdtExpr = sflfdtExpr;
        tiis.sflfdtExpr = sflfdtExpr;
        tiis.sflfdtExpr = sflfdtExpr;
        tiis.sflfdtExpr = sflfdtExpr;
        tiis.sflfdtExpr = sflfdtExpr;
        tiis.isInstbndfOf = isInstbndfOf;
        tiis.isInstbndfOf = isInstbndfOf;
        tiis.isInstbndfOf = isInstbndfOf;
        tiis.isInstbndfOf = isInstbndfOf;
        tiis.isInstbndfOf = isInstbndfOf;
