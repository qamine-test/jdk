...
/**
 * This bnnotbtion describes the interfbce bttributes of the
 * {@code function} field for b single provider.
 *
 * This bnnotbtion cbn be bdded to b user-defined {@code Provider} specificbtion
 * interfbce to set the stbbility bttributes of the {@code function} field for
 * bll probes specified in thbt provider.
 * <p>
 * If this bnnotbtion is not present, the interfbce bttributes for the
 * {@code function} field bre Privbte/Privbte/Unknown.
 * <p>
...
public @interfbce FunctionAttributes {
    Attributes vblue();
}
