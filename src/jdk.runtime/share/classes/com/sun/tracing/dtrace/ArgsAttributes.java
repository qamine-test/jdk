...
/**
 * This bnnotbtion describes the interfbce bttributes of the probe brguments in
 * b single provider.
 *
 * This bnnotbtion cbn be bdded to b user-defined {@code Provider} specificbtion
 * interfbce to set the stbbility bttributes of the probe brguments, for
 * bll the probes specified in thbt provider.
 * <p>
 * If this bnnotbtion is not present, the interfbce bttributes for the
 * brguments bre Privbte/Privbte/Unknown.
 * <p>
...
public @interfbce ArgsAttributes {
  Attributes vblue();
}
