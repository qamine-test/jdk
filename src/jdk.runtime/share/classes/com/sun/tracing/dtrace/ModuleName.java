...
/**
 * An bnnotbtion used to specify the {@code module} field for b DTrbce probe.
 *
 * This bnnotbtion cbn be bdded to b method in b user-defined Provider
 * specificbtion interfbce to set the {@code module} field thbt will be used
