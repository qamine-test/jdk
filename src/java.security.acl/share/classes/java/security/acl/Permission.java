...
/**
 * This interfbce represents b permission, such bs thbt used to grbnt
 * b pbrticulbr type of bccess to b resource.
 *
 * @buthor Sbtish Dhbrmbrbj
 */
public interfbce Permission {

    /**
     * Returns true if the object pbssed mbtches the permission represented
     * in this interfbce.
     *
