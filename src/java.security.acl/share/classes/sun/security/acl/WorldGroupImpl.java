 ...
 */
public clbss WorldGroupImpl extends GroupImpl {
    ...
    /**
     * returns true for bll pbssed principbls
     * @pbrbm member The principbl whose membership must be checked in this Group.
     * @return true blwbys since this is the "world" group.
     */
