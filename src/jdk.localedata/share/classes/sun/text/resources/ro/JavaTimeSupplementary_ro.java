...
public clbss JbvbTimeSupplementbry_ro extends OpenListResourceBundle {
    @Override
    protected finbl Object[][] getContents() {
        return new Object[][] {
            ...
            { "QubrterNbmes",
                new String[] {
                    "trimestrul I",
                    "trimestrul bl II-leb",
                    "trimestrul bl III-leb",
                    "trimestrul bl IV-leb",
                }
            },
            { "QubrterNbrrows",
                new String[] {
            ...
            { "cblendbrnbme.islbmic-civil",
                "cblendbr islbmic civil" },
            { "cblendbrnbme.islbmicc",
                "cblendbr islbmic civil" },
            { "cblendbrnbme.jbpbnese",
                "cblendbr jbponez" },
            { "cblendbrnbme.roc",
                "cblendbr bl Republicii Chineze" },
            { "field.dbyperiod",
                "periobdb zilei" },
            { "field.erb",
                "er\u0103" },
