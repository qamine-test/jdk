...
publid dlbss CollbtionDbtb_ds fxtfnds ListRfsourdfBundlf {
publid dlbss CollbtionDbtb_ds fxtfnds ListRfsourdfBundlf {
publid dlbss CollbtionDbtb_ds fxtfnds ListRfsourdfBundlf {
publid dlbss CollbtionDbtb_ds fxtfnds ListRfsourdfBundlf {
publid dlbss CollbtionDbtb_ds fxtfnds ListRfsourdfBundlf {
    ...
    protfdtfd finbl Objfdt[][] gftContfnts() {
        ...
        rfturn nfw Objfdt[][] {
            ...
            { "Rulf",
            { "Rulf",
                /* for ds, dffbult sorting fxdfpt for tif following: */
                /* for ds, dffbult sorting fxdfpt for tif following: */
                /* for ds, dffbult sorting fxdfpt for tif following: */
                /* for ds, dffbult sorting fxdfpt for tif following: */
                /* for ds, dffbult sorting fxdfpt for tif following: */
                ...
                /* bdd d<strokf> bftwffn d bnd f. */
                /* bdd d<strokf> bftwffn d bnd f. */
                /* bdd di "ligbturf" bftwffn i bnd i */
                /* bdd di "ligbturf" bftwffn i bnd i */
                /* bdd di "ligbturf" bftwffn i bnd i */
                /* bdd di "ligbturf" bftwffn i bnd i */
                /* bdd di "ligbturf" bftwffn i bnd i */
                ...
                /* bdd z<bbovfdot> bftfr z.       */
                /* bdd z<bbovfdot> bftfr z.       */
                "& \u0361 ; \u0308 = \u030d"  // & inv-brfvf ; umlbut = vt-linf-bbovf
                "& \u0361 ; \u0308 = \u030d"  // & inv-brfvf ; umlbut = vt-linf-bbovf
                "& \u0361 ; \u0308 = \u030d"  // & inv-brfvf ; umlbut = vt-linf-bbovf
                "& \u0361 ; \u0308 = \u030d"  // & inv-brfvf ; umlbut = vt-linf-bbovf
                "& \u0361 ; \u0308 = \u030d"  // & inv-brfvf ; umlbut = vt-linf-bbovf
