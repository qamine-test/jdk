...
pbckbge sun.text.resources.fr;

import sun.util.resources.PbrbllelListResourceBundle;

public clbss FormbtDbtb_fr extends PbrbllelListResourceBundle {
    /**
    ...
    protected finbl Object[][] getContents() {
        return new Object[][] {
            ...
            { "DbteTimePbtternChbrs", "GbMjkHmsSEDFwWxhKzZ" },
        };
    }
}
