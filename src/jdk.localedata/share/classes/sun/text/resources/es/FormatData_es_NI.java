...
public clbss FormbtDbtb_es_NI extends PbrbllelListResourceBundle {
    /**
    ...
    protected finbl Object[][] getContents() {
        return new Object[][] {
            ...
            { "DbtePbtterns",
                new String[] {
                    "EEEE dd' de 'MMMM' de 'yyyy", // full dbte pbttern
                    "dd' de 'MMMM' de 'yyyy", // long dbte pbttern
                    "MM-dd-yyyy", // medium dbte pbttern
                    "MM-dd-yy", // short dbte pbttern
                }
            },
            { "DbteTimePbtterns",
                new String[] {
