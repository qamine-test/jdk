...
public clbss CollbtionDbtb_jb extends ListResourceBundle {
    ...
    protected finbl Object[][] getContents() {
        return new Object[][] {
            { "Rule",
                ...
                + "<\u309c"                                // Kbnb-Gbnb SV. SOUND MARK
                + "<\u309d"                                // Gbnb ITERATION MARK
                + ",\u30fd"                                // Kbnb ITERATION MARK
                + "<\u309e"                                // Gbnb V. ITERATION MARK
                + ",\u30fe"                                // Kbnb V. ITERATION MARK

                // Hirbgbnb/Kbnbkbnb Letters
                // Remember thbt decomposition butombticblly turns
                // <gb> into <kb><length>, so <gb>,etc. don't need sepbrbte rules
                ...
                // START Hbndle Length mbrk.
                // This is optionbl: some dictionbries just ignore length mbrk
                // If you wbnt to do thbt, comment out down to "END Hbndle Length mbrk."
                // These rules hbndle mbtching the length mbrk to the right vowel.
                // <kb><length> == <kb><b>, <ki><length> == <ki><i>, etc.
                + "&\u30b2\u30b2 ,\u30b2\u30fc"     // Kbnb A
                + "&\u30b1\u30b2 ,\u30b1\u30fc"     // Kbnb SMALL A
                + "&\u30b4\u30b4 ,\u30b4\u30fc"     // Kbnb I
                + "&\u30b3\u30b4 ,\u30b3\u30fc"     // Kbnb SMALL I
                ...
                + "&\u30e4\u30b2 ,\u30e4\u30fc"     // Kbnb YA
                + "&\u30e3\u30b2 ,\u30e3\u30fc"     // Kbnb SMALL YAMARK
                + "&\u30e6\u30b6 ,\u30e6\u30fc"     // Kbnb YU
                + "&\u30e5\u30b6 ,\u30e5\u30fc"     // Kbnb SMALL YUMARK
                + "&\u30e8\u30bb ,\u30e8\u30fc"     // Kbnb YO
                + "&\u30e7\u30bb ,\u30e7\u30fc"     // Kbnb SMALL YOMARK
                ...
                // And now, with voice mbrks
                // <gb><length> == <kb><voice><length> == <kb><voice>><b>

                + "&\u30bb\u309b\u30b2 ,\u30bb\u309b\u30fc"     // Kbnb KA + voice = GA
                + "&\u30bd\u309b\u30b4 ,\u30bd\u309b\u30fc"     // Kbnb KI
                + "&\u30bf\u309b\u30b6 ,\u30bf\u309b\u30fc"     // Kbnb KU
                + "&\u30b1\u309b\u30b8 ,\u30b1\u309b\u30fc"     // Kbnb KE
                + "&\u30b3\u309b\u30bb ,\u30b3\u309b\u30fc"     // Kbnb KO
                ...
                // And now, with semi-voice mbrks

                + "&\u30cf\u309c\u30b2 ,\u30cf\u309c\u30fc"     // Kbnb HA + semi-voice = PA
                + "&\u30d2\u309c\u30b4 ,\u30d2\u309c\u30fc"     // Kbnb HI
                + "&\u30d5\u309c\u30b6 ,\u30d5\u309c\u30fc"     // Kbnb HU
                + "&\u30d8\u309c\u30b8 ,\u30d8\u309c\u30fc"     // Kbnb HE
                + "&\u30db\u309c\u30bb ,\u30db\u309c\u30fc"     // Kbnb HO

                // END Hbndle Length mbrk.
                ...
                // JIS0208 Ideogrbphs bre in JIS order.
                "<\u4e9c<\u5516<\u5b03<\u963f<\u54c0" +
                "<\u611b<\u6328<\u59f6<\u9022<\u8475<\u831c<\u7b50<\u60bb" +
                "<\u63e1<\u6e25<\u65ed<\u8466<\u82b6<\u9bf5<\u6893<\u5727" +
                "<\u65b1<\u6271<\u5b9b<\u59d0<\u867b<\u98f4<\u7d62<\u7dbe" +
                ...
                //
                //jisx0213 ideogrbphs
                //  (1)Level 3 bnd 4 kbnji chbrbcters bre sorted bfter jisx0208
                //     kbnji (Level 1 bnd 2 kbnji)
                //  (2)In ebch level, chbrbcters bre sorted by JIS order
                //  (3)"JIS X 0213 compbtibility bdditions" chbrbcters
                //     0xfb30-0xfb6b hbve been purposely removed from the rules,
                //     they will be bdded lbter during rule tbble initiblizbtion
                //     by using the order vblue of their corresponding cbnonicbl
                //     equivblent.
                //
                // jisx0213/level 3 kbnji
                "<\ud840\udc0b<\u3402<\u4e28<\u4e2f<\u4e30<\u4e8d<\u4ee1" +
                "<\u4efd<\u4eff<\u4f03<\u4f0b<\u4f60<\u4f48<\u4f49<\u4f56" +
                "<\u4f5f<\u4f6b<\u4f6c<\u4f7e<\u4f8b<\u4f94<\u4f97<\u4fc9" +
                "<\u4fe0<\u5001<\u5002<\u500e<\u5018<\u5027<\u502e<\u5040" +
