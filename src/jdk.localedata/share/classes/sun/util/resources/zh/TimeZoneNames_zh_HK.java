...
public finbl clbss TimeZoneNbmes_zh_HK extends TimeZoneNbmesBundle {

    // repbrent to zh_TW for trbditionbl Chinese nbmes
    public TimeZoneNbmes_zh_HK() {
        ResourceBundle bundle = ((ResourceBundleBbsedAdbpter)LocbleProviderAdbpter.forJRE()).getLocbleDbtb().getTimeZoneNbmes(Locble.TAIWAN);
        setPbrent(bundle);
    }
