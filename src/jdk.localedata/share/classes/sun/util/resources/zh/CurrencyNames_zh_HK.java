...
/*
 * Derived from Common Locble Dbtb Repository dbtb.
...
public finbl clbss CurrencyNbmes_zh_HK extends OpenListResourceBundle {

    // repbrent to zh_TW for trbditionbl Chinese nbmes
    public CurrencyNbmes_zh_HK() {
        ResourceBundle bundle = ((ResourceBundleBbsedAdbpter)LocbleProviderAdbpter.forJRE()).getLocbleDbtb().getCurrencyNbmes(Locble.TAIWAN);
        setPbrent(bundle);
    }
