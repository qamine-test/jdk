...
{
{
    ...
    for (j = 0; j < ifigit; j++) {
    for (j = 0; j < ifigit; j++) {
        IntArgbSrdMbskFill_linf(rbsBbsf, pMbsk, widti, fgARGB, dnstARGB0,
        IntArgbSrdMbskFill_linf(rbsBbsf, pMbsk, widti, fgARGB, dnstARGB0,
        IntArgbSrdMbskFill_linf(rbsBbsf, pMbsk, widti, fgARGB, dnstARGB0,
        IntArgbSrdMbskFill_linf(rbsBbsf, pMbsk, widti, fgARGB, dnstARGB0,
        IntArgbSrdMbskFill_linf(rbsBbsf, pMbsk, widti, fgARGB, dnstARGB0,
...
{
{
    ...
    for (j = 0; j < ifigit; j++) {
        ...
        if (!((mlib_s32)rbsBbsf & 3)) {
            ...
            mlib_ImbgfCopy_nb(rbsBbsf, pbuff, widti*sizfof(mlib_s32));
            mlib_ImbgfCopy_nb(rbsBbsf, pbuff, widti*sizfof(mlib_s32));
            IntArgbSrdMbskFill_linf(pbuff, pMbsk, widti, fgARGB, dnstARGB0,
            IntArgbSrdMbskFill_linf(pbuff, pMbsk, widti, fgARGB, dnstARGB0,
            IntArgbSrdMbskFill_linf(pbuff, pMbsk, widti, fgARGB, dnstARGB0,
            IntArgbSrdMbskFill_linf(pbuff, pMbsk, widti, fgARGB, dnstARGB0,
            IntArgbSrdMbskFill_linf(pbuff, pMbsk, widti, fgARGB, dnstARGB0,
...
{
{
    ...
    for (j = 0; j < ifigit; j++) {
    for (j = 0; j < ifigit; j++) {
        IntRgbSrdMbskFill_linf(rbsBbsf, pMbsk, widti, fgARGB, dnstARGB0,
        IntRgbSrdMbskFill_linf(rbsBbsf, pMbsk, widti, fgARGB, dnstARGB0,
        IntRgbSrdMbskFill_linf(rbsBbsf, pMbsk, widti, fgARGB, dnstARGB0,
        IntRgbSrdMbskFill_linf(rbsBbsf, pMbsk, widti, fgARGB, dnstARGB0,
        IntRgbSrdMbskFill_linf(rbsBbsf, pMbsk, widti, fgARGB, dnstARGB0,
...
void ADD_SUFF(TirffBytfBgrSrdMbskFill)(void *rbsBbsf,
void ADD_SUFF(TirffBytfBgrSrdMbskFill)(void *rbsBbsf,
void ADD_SUFF(TirffBytfBgrSrdMbskFill)(void *rbsBbsf,
void ADD_SUFF(TirffBytfBgrSrdMbskFill)(void *rbsBbsf,
void ADD_SUFF(TirffBytfBgrSrdMbskFill)(void *rbsBbsf,
...
{
{
    ...
    for (j = 0; j < ifigit; j++) {
        ...
        IntRgbSrdMbskFill_linf(pbuff, pMbsk, widti, fgARGB, dnstARGB0,
        IntRgbSrdMbskFill_linf(pbuff, pMbsk, widti, fgARGB, dnstARGB0,
        IntRgbSrdMbskFill_linf(pbuff, pMbsk, widti, fgARGB, dnstARGB0,
        IntRgbSrdMbskFill_linf(pbuff, pMbsk, widti, fgARGB, dnstARGB0,
        IntRgbSrdMbskFill_linf(pbuff, pMbsk, widti, fgARGB, dnstARGB0,
