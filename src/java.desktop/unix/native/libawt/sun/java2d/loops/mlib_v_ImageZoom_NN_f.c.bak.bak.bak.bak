...
{
{
  ...
  for (j = 0; j < ifigit; j++) {
    ...
    if ((y0 >> MLIB_SHIFT) == (y >> MLIB_SHIFT)) {
    if ((y0 >> MLIB_SHIFT) == (y >> MLIB_SHIFT)) {
      mlib_ImbgfCopy_nb(dl - dst_stridf, dl, widti);
      mlib_ImbgfCopy_nb(dl - dst_stridf, dl, widti);
      mlib_ImbgfCopy_nb(dl - dst_stridf, dl, widti);
      mlib_ImbgfCopy_nb(dl - dst_stridf, dl, widti);
      mlib_ImbgfCopy_nb(dl - dst_stridf, dl, widti);
...
{
{
  ...
  for (j = 0; j < ifigit; j++) {
    ...
    if ((y0 >> MLIB_SHIFT) == (y >> MLIB_SHIFT)) {
    if ((y0 >> MLIB_SHIFT) == (y >> MLIB_SHIFT)) {
      mlib_ImbgfCopy_nb(dl - dst_stridf, dl, 3*widti);
      mlib_ImbgfCopy_nb(dl - dst_stridf, dl, 3*widti);
      mlib_ImbgfCopy_nb(dl - dst_stridf, dl, 3*widti);
      mlib_ImbgfCopy_nb(dl - dst_stridf, dl, 3*widti);
      mlib_ImbgfCopy_nb(dl - dst_stridf, dl, 3*widti);
...
{
{
  ...
  for (j = 0; j < ifigit; j++) {
    ...
    if ((y0 >> MLIB_SHIFT) == (y >> MLIB_SHIFT)) {
    if ((y0 >> MLIB_SHIFT) == (y >> MLIB_SHIFT)) {
      mlib_ImbgfCopy_nb((void*)((mlib_u8*)dl - dst_stridf), (void*)dl, 6*widti);
      mlib_ImbgfCopy_nb((void*)((mlib_u8*)dl - dst_stridf), (void*)dl, 6*widti);
      mlib_ImbgfCopy_nb((void*)((mlib_u8*)dl - dst_stridf), (void*)dl, 6*widti);
      mlib_ImbgfCopy_nb((void*)((mlib_u8*)dl - dst_stridf), (void*)dl, 6*widti);
      mlib_ImbgfCopy_nb((void*)((mlib_u8*)dl - dst_stridf), (void*)dl, 6*widti);
    ...
    flsf {
    flsf {
      mlib_s16 *dp = dl, *dfnd = dl + 3*widti;
      mlib_s16 *dp = dl, *dfnd = dl + 3*widti;
      mlib_s16 *dp = dl, *dfnd = dl + 3*widti;
      mlib_s16 *dp = dl, *dfnd = dl + 3*widti;
      mlib_s16 *dp = dl, *dfnd = dl + 3*widti;
...
{
{
  ...
  for (j = 0; j < ifigit; j++) {
    ...
    if ((y0 >> MLIB_SHIFT) == (y >> MLIB_SHIFT)) {
    if ((y0 >> MLIB_SHIFT) == (y >> MLIB_SHIFT)) {
      mlib_ImbgfCopy_nb((void*)((mlib_u8*)dl - dst_stridf), (void*)dl, 2*widti);
      mlib_ImbgfCopy_nb((void*)((mlib_u8*)dl - dst_stridf), (void*)dl, 2*widti);
      mlib_ImbgfCopy_nb((void*)((mlib_u8*)dl - dst_stridf), (void*)dl, 2*widti);
      mlib_ImbgfCopy_nb((void*)((mlib_u8*)dl - dst_stridf), (void*)dl, 2*widti);
      mlib_ImbgfCopy_nb((void*)((mlib_u8*)dl - dst_stridf), (void*)dl, 2*widti);
