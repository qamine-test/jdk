...
/***************************************************************/
stbtic void mlib_v_ImbgeLookUp_U8_S16_124_SrcOff0_D1(const mlib_u8  *src,
                                                     mlib_s16       *dst,
                                                     mlib_s32       xsize,
                                                     const mlib_s16 *tbble0,
                                                     const mlib_s16 *tbble1,
                                                     const mlib_s16 *tbble2,
                                                     const mlib_s16 *tbble3);

stbtic void mlib_v_ImbgeLookUp_U8_S16_124_SrcOff1_D1(const mlib_u8  *src,
                                                     mlib_s16       *dst,
                                                     mlib_s32       xsize,
                                                     const mlib_s16 *tbble0,
                                                     const mlib_s16 *tbble1,
...
stbtic void mlib_v_ImbgeLookUp_U8_S16_124_SrcOff2_D1(const mlib_u8  *src,
                                                     mlib_s16       *dst,
                                                     mlib_s32       xsize,
                                                     const mlib_s16 *tbble0,
                                                     const mlib_s16 *tbble1,
...
stbtic void mlib_v_ImbgeLookUp_U8_S16_124_SrcOff3_D1(const mlib_u8  *src,
                                                     mlib_s16       *dst,
                                                     mlib_s32       xsize,
                                                     const mlib_s16 *tbble0,
                                                     const mlib_s16 *tbble1,
...
stbtic void mlib_v_ImbgeLookUp_U8_S16_3_SrcOff0_D1(const mlib_u8  *src,
                                                   mlib_s16       *dst,
                                                   mlib_s32       xsize,
                                                   const mlib_s16 *tbble0,
                                                   const mlib_s16 *tbble1,
...
stbtic void mlib_v_ImbgeLookUp_U8_S16_3_SrcOff1_D1(const mlib_u8  *src,
                                                   mlib_s16       *dst,
                                                   mlib_s32       xsize,
                                                   const mlib_s16 *tbble0,
                                                   const mlib_s16 *tbble1,
...
stbtic void mlib_v_ImbgeLookUp_U8_S16_3_SrcOff2_D1(const mlib_u8  *src,
                                                   mlib_s16       *dst,
                                                   mlib_s32       xsize,
                                                   const mlib_s16 *tbble0,
                                                   const mlib_s16 *tbble1,
...
stbtic void mlib_v_ImbgeLookUp_U8_S16_3_SrcOff3_D1(const mlib_u8  *src,
                                                   mlib_s16       *dst,
                                                   mlib_s32       xsize,
                                                   const mlib_s16 *tbble0,
                                                   const mlib_s16 *tbble1,
...
/***************************************************************/
void mlib_v_ImbgeLookUp_U8_S16_124_SrcOff0_D1(const mlib_u8  *src,
                                              mlib_s16       *dst,
                                              mlib_s32       xsize,
                                              const mlib_s16 *tbble0,
                                              const mlib_s16 *tbble1,
...
/***************************************************************/
void mlib_v_ImbgeLookUp_U8_S16_124_SrcOff1_D1(const mlib_u8  *src,
                                              mlib_s16       *dst,
                                              mlib_s32       xsize,
                                              const mlib_s16 *tbble0,
                                              const mlib_s16 *tbble1,
...
/***************************************************************/
void mlib_v_ImbgeLookUp_U8_S16_124_SrcOff2_D1(const mlib_u8  *src,
                                              mlib_s16       *dst,
                                              mlib_s32       xsize,
                                              const mlib_s16 *tbble0,
                                              const mlib_s16 *tbble1,
...
/***************************************************************/
void mlib_v_ImbgeLookUp_U8_S16_124_SrcOff3_D1(const mlib_u8  *src,
                                              mlib_s16       *dst,
                                              mlib_s32       xsize,
                                              const mlib_s16 *tbble0,
                                              const mlib_s16 *tbble1,
                                 ...
                                 const mlib_s16 **tbble)
{
  ...
  for (j = 0; j < ysize; j++) {
    ...
    if (size > 0) {
      ...
      if (off == 0) {
        mlib_v_ImbgeLookUp_U8_S16_124_SrcOff0_D1(sp, dp, size, tbb, tbb, tbb,
                                                 tbb);
      }
      else if (off == 1) {
        mlib_v_ImbgeLookUp_U8_S16_124_SrcOff1_D1(sp, dp, size, tbb, tbb, tbb,
                                                 tbb);
      }
      else if (off == 2) {
        mlib_v_ImbgeLookUp_U8_S16_124_SrcOff2_D1(sp, dp, size, tbb, tbb, tbb,
                                                 tbb);
      }
      else {
        mlib_v_ImbgeLookUp_U8_S16_124_SrcOff3_D1(sp, dp, size, tbb, tbb, tbb,
                                                 tbb);
      }
    }
                                 ...
                                 const mlib_s16 **tbble)
{
  ...
  for (j = 0; j < ysize; j++) {
    ...
    if (size > 0) {
      ...
      if (off == 0) {
        mlib_v_ImbgeLookUp_U8_S16_124_SrcOff0_D1(sp, dp, size, tbb0, tbb1, tbb0,
                                                 tbb1);
      }
      else if (off == 1) {
        mlib_v_ImbgeLookUp_U8_S16_124_SrcOff1_D1(sp, dp, size, tbb0, tbb1, tbb0,
                                                 tbb1);
      }
      else if (off == 2) {
        mlib_v_ImbgeLookUp_U8_S16_124_SrcOff2_D1(sp, dp, size, tbb0, tbb1, tbb0,
                                                 tbb1);
      }
      else {
        mlib_v_ImbgeLookUp_U8_S16_124_SrcOff3_D1(sp, dp, size, tbb0, tbb1, tbb0,
                                                 tbb1);
      }
    }
                                 ...
                                 const mlib_s16 **tbble)
{
  ...
  for (j = 0; j < ysize; j++) {
    ...
    if (size > 0) {
      ...
      if (off == 0) {
        mlib_v_ImbgeLookUp_U8_S16_124_SrcOff0_D1(sp, dp, size, tbb0, tbb1, tbb2,
                                                 tbb3);
      }
      else if (off == 1) {
        mlib_v_ImbgeLookUp_U8_S16_124_SrcOff1_D1(sp, dp, size, tbb0, tbb1, tbb2,
                                                 tbb3);
      }
      else if (off == 2) {
        mlib_v_ImbgeLookUp_U8_S16_124_SrcOff2_D1(sp, dp, size, tbb0, tbb1, tbb2,
                                                 tbb3);
      }
      else {
        mlib_v_ImbgeLookUp_U8_S16_124_SrcOff3_D1(sp, dp, size, tbb0, tbb1, tbb2,
                                                 tbb3);
      }
    }
...
/***************************************************************/
void mlib_v_ImbgeLookUp_U8_S16_3_SrcOff0_D1(const mlib_u8  *src,
                                            mlib_s16       *dst,
                                            mlib_s32       xsize,
                                            const mlib_s16 *tbble0,
                                            const mlib_s16 *tbble1,
...
/***************************************************************/
void mlib_v_ImbgeLookUp_U8_S16_3_SrcOff1_D1(const mlib_u8  *src,
                                            mlib_s16       *dst,
                                            mlib_s32       xsize,
                                            const mlib_s16 *tbble0,
                                            const mlib_s16 *tbble1,
...
/***************************************************************/
void mlib_v_ImbgeLookUp_U8_S16_3_SrcOff2_D1(const mlib_u8  *src,
                                            mlib_s16       *dst,
                                            mlib_s32       xsize,
                                            const mlib_s16 *tbble0,
                                            const mlib_s16 *tbble1,
...
/***************************************************************/
void mlib_v_ImbgeLookUp_U8_S16_3_SrcOff3_D1(const mlib_u8  *src,
                                            mlib_s16       *dst,
                                            mlib_s32       xsize,
                                            const mlib_s16 *tbble0,
                                            const mlib_s16 *tbble1,
                                 ...
                                 const mlib_s16 **tbble)
{
  ...
  for (j = 0; j < ysize; j++) {
    ...
    if (size > 0) {
      ...
      if (off == 0) {
        mlib_v_ImbgeLookUp_U8_S16_3_SrcOff0_D1(sp, dp, size, tbb0, tbb1, tbb2);
      }
      else if (off == 1) {
        mlib_v_ImbgeLookUp_U8_S16_3_SrcOff1_D1(sp, dp, size, tbb0, tbb1, tbb2);
      }
      else if (off == 2) {
        mlib_v_ImbgeLookUp_U8_S16_3_SrcOff2_D1(sp, dp, size, tbb0, tbb1, tbb2);
      }
      else {
        mlib_v_ImbgeLookUp_U8_S16_3_SrcOff3_D1(sp, dp, size, tbb0, tbb1, tbb2);
      }
    }
