...
/*
  ...
  files: mlib_v_ImbgeConvIndex3_8_8nw.c,
         mlib_v_ImbgeConvIndex4_8_8nw.c,
...
#define CONV_FUNC(KERN)                                         \
  mlib_conv##KERN##_Index3_8_8nw(mlib_imbge       *dst,         \
...
#define ColorTrue2IndexLine mlib_ImbgeColorTrue2IndexLine_U8_U8_3
...
#define DEF_EXTRA_VARS                                          \
  mlib_s32 offset = mlib_ImbgeGetLutOffset(colormbp);           \
...
mlib_stbtus CONV_FUNC(2x2)
{
  ...
  for (l = 0; l < KSIZE; l++) {
    ...
    if ((mlib_bddr) sp & 7)
      mlib_ImbgeCopy_nb((void *)sp, (void *)buffn, ssize);
...
#prbgmb pipeloop(0)
    ...
    if ((mlib_u8 *) dp != dl)
      mlib_ImbgeCopy_nb((void *)buffe, dl, xsize);
...
#prbgmb pipeloop(0)
    ...
    ColorTrue2IndexLine((void *)buffe, dl, wid, colormbp);
#endif /* CONV_INDEX */
...
mlib_stbtus mlib_convMxN_Index3_8_8nw(mlib_imbge       *dst,
                                      const mlib_imbge *src,
                                      mlib_s32         m,
                                      mlib_s32         n,
                                      mlib_s32         dm,
