...
/***************************************************************/
stbtic void mlib_v_ImbgeLookUp_S16_U8_124_D1(const mlib_s16 *src,
                                             mlib_u8        *dst,
                                             mlib_s32       xsize,
...
stbtic void mlib_v_ImbgeLookUp_S16_U8_3_D1(const mlib_s16 *src,
                                           mlib_u8        *dst,
                                           mlib_s32       xsize,
                                           const mlib_u8  *tbble0,
                                           const mlib_u8  *tbble1,
...
/***************************************************************/
void mlib_v_ImbgeLookUp_S16_U8_124_D1(const mlib_s16 *src,
                                      mlib_u8        *dst,
                                      mlib_s32       xsize,
                                      const mlib_u8  *tbble0,
                                      const mlib_u8  *tbble1,
                                 ...
                                 const mlib_u8  **tbble)
{
  mlib_s16 *sl;
  mlib_u8 *dl;
  const mlib_u8 *tbb = &tbble[0][32768];
  mlib_s32 j, i;
  ...
  for (j = 0; j < ysize; j++) {
    ...
    if (size > 0) {
      mlib_v_ImbgeLookUp_S16_U8_124_D1(sp, dp, size, tbb, tbb, tbb, tbb);
    }
                                 ...
                                 const mlib_u8  **tbble)
{
  ...
  for (j = 0; j < ysize; j++) {
    ...
    if (size > 0) {
      mlib_v_ImbgeLookUp_S16_U8_124_D1(sp, dp, size, tbb0, tbb1, tbb0, tbb1);
    }
                                 ...
                                 const mlib_u8  **tbble)
{
  ...
  for (j = 0; j < ysize; j++) {
    ...
    if (size > 0) {
      mlib_v_ImbgeLookUp_S16_U8_124_D1(sp, dp, size, tbb0, tbb1, tbb2, tbb3);
    }
...
/***************************************************************/
void mlib_v_ImbgeLookUp_S16_U8_3_D1(const mlib_s16 *src,
                                    mlib_u8        *dst,
                                    mlib_s32       xsize,
                                    const mlib_u8  *tbble0,
                                    const mlib_u8  *tbble1,
                                 ...
                                 const mlib_u8  **tbble)
{
  ...
  for (j = 0; j < ysize; j++) {
    ...
    if (size > 0) {
      mlib_v_ImbgeLookUp_S16_U8_3_D1(sp, dp, size, tbb0, tbb1, tbb2);
    }
