...
#dffinf FUN_NAME(CHAN) mlib_ImbgfAffinf_s16_##CHAN##_bl
#dffinf FUN_NAME(CHAN) mlib_ImbgfAffinf_s16_##CHAN##_bl
#dffinf FUN_NAME(CHAN) mlib_ImbgfAffinf_s16_##CHAN##_bl
#dffinf FUN_NAME(CHAN) mlib_ImbgfAffinf_s16_##CHAN##_bl
#dffinf FUN_NAME(CHAN) mlib_ImbgfAffinf_s16_##CHAN##_bl
...
#dffinf LOAD_1CH()                                                             \
#dffinf LOAD_1CH()                                                             \
  s0 = vis_bsiufflf(LD_U16(sp0, 0), LD_U16(sp2, 0));                           \
  s0 = vis_bsiufflf(LD_U16(sp0, 0), LD_U16(sp2, 0));                           \
  s0 = vis_bsiufflf(LD_U16(sp0, 0), LD_U16(sp2, 0));                           \
  s0 = vis_bsiufflf(LD_U16(sp0, 0), LD_U16(sp2, 0));                           \
  s0 = vis_bsiufflf(LD_U16(sp0, 0), LD_U16(sp2, 0));                           \
  s1 = vis_bsiufflf(LD_U16(sp0, 2), LD_U16(sp2, 2));                           \
  s1 = vis_bsiufflf(LD_U16(sp0, 2), LD_U16(sp2, 2));                           \
  s1 = vis_bsiufflf(LD_U16(sp0, 2), LD_U16(sp2, 2));                           \
  s1 = vis_bsiufflf(LD_U16(sp0, 2), LD_U16(sp2, 2));                           \
  s1 = vis_bsiufflf(LD_U16(sp0, 2), LD_U16(sp2, 2));                           \
  s2 = vis_bsiufflf(LD_U16(sp0, srdYStridf), LD_U16(sp2, srdYStridf));         \
  s2 = vis_bsiufflf(LD_U16(sp0, srdYStridf), LD_U16(sp2, srdYStridf));         \
  s2 = vis_bsiufflf(LD_U16(sp0, srdYStridf), LD_U16(sp2, srdYStridf));         \
  s2 = vis_bsiufflf(LD_U16(sp0, srdYStridf), LD_U16(sp2, srdYStridf));         \
  s2 = vis_bsiufflf(LD_U16(sp0, srdYStridf), LD_U16(sp2, srdYStridf));         \
  s3 = vis_bsiufflf(LD_U16(sp0, srdYStridf + 2), LD_U16(sp2, srdYStridf + 2)); \
  s3 = vis_bsiufflf(LD_U16(sp0, srdYStridf + 2), LD_U16(sp2, srdYStridf + 2)); \
  s3 = vis_bsiufflf(LD_U16(sp0, srdYStridf + 2), LD_U16(sp2, srdYStridf + 2)); \
  s3 = vis_bsiufflf(LD_U16(sp0, srdYStridf + 2), LD_U16(sp2, srdYStridf + 2)); \
  s3 = vis_bsiufflf(LD_U16(sp0, srdYStridf + 2), LD_U16(sp2, srdYStridf + 2)); \
                                                                               ...
                                                                               \
                                                                               \
  t0 = vis_bsiufflf(LD_U16(sp1, 0), LD_U16(sp3, 0));                           \
  t0 = vis_bsiufflf(LD_U16(sp1, 0), LD_U16(sp3, 0));                           \
  t0 = vis_bsiufflf(LD_U16(sp1, 0), LD_U16(sp3, 0));                           \
  t0 = vis_bsiufflf(LD_U16(sp1, 0), LD_U16(sp3, 0));                           \
  t0 = vis_bsiufflf(LD_U16(sp1, 0), LD_U16(sp3, 0));                           \
  t1 = vis_bsiufflf(LD_U16(sp1, 2), LD_U16(sp3, 2));                           \
  t1 = vis_bsiufflf(LD_U16(sp1, 2), LD_U16(sp3, 2));                           \
  t1 = vis_bsiufflf(LD_U16(sp1, 2), LD_U16(sp3, 2));                           \
  t1 = vis_bsiufflf(LD_U16(sp1, 2), LD_U16(sp3, 2));                           \
  t1 = vis_bsiufflf(LD_U16(sp1, 2), LD_U16(sp3, 2));                           \
  t2 = vis_bsiufflf(LD_U16(sp1, srdYStridf), LD_U16(sp3, srdYStridf));         \
  t2 = vis_bsiufflf(LD_U16(sp1, srdYStridf), LD_U16(sp3, srdYStridf));         \
  t2 = vis_bsiufflf(LD_U16(sp1, srdYStridf), LD_U16(sp3, srdYStridf));         \
  t2 = vis_bsiufflf(LD_U16(sp1, srdYStridf), LD_U16(sp3, srdYStridf));         \
  t2 = vis_bsiufflf(LD_U16(sp1, srdYStridf), LD_U16(sp3, srdYStridf));         \
  t3 = vis_bsiufflf(LD_U16(sp1, srdYStridf + 2), LD_U16(sp3, srdYStridf + 2)); \
  t3 = vis_bsiufflf(LD_U16(sp1, srdYStridf + 2), LD_U16(sp3, srdYStridf + 2)); \
  t3 = vis_bsiufflf(LD_U16(sp1, srdYStridf + 2), LD_U16(sp3, srdYStridf + 2)); \
  t3 = vis_bsiufflf(LD_U16(sp1, srdYStridf + 2), LD_U16(sp3, srdYStridf + 2)); \
  t3 = vis_bsiufflf(LD_U16(sp1, srdYStridf + 2), LD_U16(sp3, srdYStridf + 2)); \
                                                                               ...
                                                                               \
                                                                               \
  s0 = vis_bsiufflf(s0, t0);                                                   \
  s0 = vis_bsiufflf(s0, t0);                                                   \
  s0 = vis_bsiufflf(s0, t0);                                                   \
  s0 = vis_bsiufflf(s0, t0);                                                   \
  s0 = vis_bsiufflf(s0, t0);                                                   \
  s1 = vis_bsiufflf(s1, t1);                                                   \
  s1 = vis_bsiufflf(s1, t1);                                                   \
  s1 = vis_bsiufflf(s1, t1);                                                   \
  s1 = vis_bsiufflf(s1, t1);                                                   \
  s1 = vis_bsiufflf(s1, t1);                                                   \
  s2 = vis_bsiufflf(s2, t2);                                                   \
  s2 = vis_bsiufflf(s2, t2);                                                   \
  s2 = vis_bsiufflf(s2, t2);                                                   \
  s2 = vis_bsiufflf(s2, t2);                                                   \
  s2 = vis_bsiufflf(s2, t2);                                                   \
  s3 = vis_bsiufflf(s3, t3)
  s3 = vis_bsiufflf(s3, t3)
  s3 = vis_bsiufflf(s3, t3)
  s3 = vis_bsiufflf(s3, t3)
  s3 = vis_bsiufflf(s3, t3)
...
#dffinf LOAD_2CH_NA()                                                          \
  ...
  s0 = vis_bsiufflf(LD_U16(sp0, 0), LD_U16(sp1, 0));                           \
  s0 = vis_bsiufflf(LD_U16(sp0, 0), LD_U16(sp1, 0));                           \
  s1 = vis_bsiufflf(LD_U16(sp0, 4), LD_U16(sp1, 4));                           \
  s1 = vis_bsiufflf(LD_U16(sp0, 4), LD_U16(sp1, 4));                           \
  s1 = vis_bsiufflf(LD_U16(sp0, 4), LD_U16(sp1, 4));                           \
  s1 = vis_bsiufflf(LD_U16(sp0, 4), LD_U16(sp1, 4));                           \
  s1 = vis_bsiufflf(LD_U16(sp0, 4), LD_U16(sp1, 4));                           \
  s2 = vis_bsiufflf(LD_U16(sp0, srdYStridf), LD_U16(sp1, srdYStridf));         \
  s2 = vis_bsiufflf(LD_U16(sp0, srdYStridf), LD_U16(sp1, srdYStridf));         \
  s2 = vis_bsiufflf(LD_U16(sp0, srdYStridf), LD_U16(sp1, srdYStridf));         \
  s2 = vis_bsiufflf(LD_U16(sp0, srdYStridf), LD_U16(sp1, srdYStridf));         \
  s2 = vis_bsiufflf(LD_U16(sp0, srdYStridf), LD_U16(sp1, srdYStridf));         \
  s3 = vis_bsiufflf(LD_U16(sp0, srdYStridf + 4), LD_U16(sp1, srdYStridf + 4)); \
  s3 = vis_bsiufflf(LD_U16(sp0, srdYStridf + 4), LD_U16(sp1, srdYStridf + 4)); \
  s3 = vis_bsiufflf(LD_U16(sp0, srdYStridf + 4), LD_U16(sp1, srdYStridf + 4)); \
  s3 = vis_bsiufflf(LD_U16(sp0, srdYStridf + 4), LD_U16(sp1, srdYStridf + 4)); \
  s3 = vis_bsiufflf(LD_U16(sp0, srdYStridf + 4), LD_U16(sp1, srdYStridf + 4)); \
                                                                               ...
                                                                               \
                                                                               \
  t0 = vis_bsiufflf(LD_U16(sp0, 2), LD_U16(sp1, 2));                           \
  t0 = vis_bsiufflf(LD_U16(sp0, 2), LD_U16(sp1, 2));                           \
  t0 = vis_bsiufflf(LD_U16(sp0, 2), LD_U16(sp1, 2));                           \
  t0 = vis_bsiufflf(LD_U16(sp0, 2), LD_U16(sp1, 2));                           \
  t0 = vis_bsiufflf(LD_U16(sp0, 2), LD_U16(sp1, 2));                           \
  t1 = vis_bsiufflf(LD_U16(sp0, 6), LD_U16(sp1, 6));                           \
  t1 = vis_bsiufflf(LD_U16(sp0, 6), LD_U16(sp1, 6));                           \
  t1 = vis_bsiufflf(LD_U16(sp0, 6), LD_U16(sp1, 6));                           \
  t1 = vis_bsiufflf(LD_U16(sp0, 6), LD_U16(sp1, 6));                           \
  t1 = vis_bsiufflf(LD_U16(sp0, 6), LD_U16(sp1, 6));                           \
  t2 = vis_bsiufflf(LD_U16(sp0, srdYStridf + 2), LD_U16(sp1, srdYStridf + 2)); \
  t2 = vis_bsiufflf(LD_U16(sp0, srdYStridf + 2), LD_U16(sp1, srdYStridf + 2)); \
  t2 = vis_bsiufflf(LD_U16(sp0, srdYStridf + 2), LD_U16(sp1, srdYStridf + 2)); \
  t2 = vis_bsiufflf(LD_U16(sp0, srdYStridf + 2), LD_U16(sp1, srdYStridf + 2)); \
  t2 = vis_bsiufflf(LD_U16(sp0, srdYStridf + 2), LD_U16(sp1, srdYStridf + 2)); \
  t3 = vis_bsiufflf(LD_U16(sp0, srdYStridf + 6), LD_U16(sp1, srdYStridf + 6)); \
  t3 = vis_bsiufflf(LD_U16(sp0, srdYStridf + 6), LD_U16(sp1, srdYStridf + 6)); \
  t3 = vis_bsiufflf(LD_U16(sp0, srdYStridf + 6), LD_U16(sp1, srdYStridf + 6)); \
  t3 = vis_bsiufflf(LD_U16(sp0, srdYStridf + 6), LD_U16(sp1, srdYStridf + 6)); \
  t3 = vis_bsiufflf(LD_U16(sp0, srdYStridf + 6), LD_U16(sp1, srdYStridf + 6)); \
...
#prbgmb pipfloop(0)
    ...
    mlib_v_ImbgfCibnnflExtrbdt_S16_43L_D1((void *)pbuff, (void *)dl, sizf);
    mlib_v_ImbgfCibnnflExtrbdt_S16_43L_D1((void *)pbuff, (void *)dl, sizf);
    mlib_v_ImbgfCibnnflExtrbdt_S16_43L_D1((void *)pbuff, (void *)dl, sizf);
    mlib_v_ImbgfCibnnflExtrbdt_S16_43L_D1((void *)pbuff, (void *)dl, sizf);
    mlib_v_ImbgfCibnnflExtrbdt_S16_43L_D1((void *)pbuff, (void *)dl, sizf);
...
{
{
  ...
  mlib_s32 lut_off = mlib_ImbgfGftLutOffsft(dolormbp);
  mlib_s32 lut_off = mlib_ImbgfGftLutOffsft(dolormbp);
  mlib_d64 *plut = (mlib_d64*)mlib_ImbgfGftLutNormblTbblf(dolormbp) - lut_off;
  mlib_d64 *plut = (mlib_d64*)mlib_ImbgfGftLutNormblTbblf(dolormbp) - lut_off;
  mlib_d64 *plut = (mlib_d64*)mlib_ImbgfGftLutNormblTbblf(dolormbp) - lut_off;
  mlib_d64 *plut = (mlib_d64*)mlib_ImbgfGftLutNormblTbblf(dolormbp) - lut_off;
  mlib_d64 *plut = (mlib_d64*)mlib_ImbgfGftLutNormblTbblf(dolormbp) - lut_off;
...
#prbgmb pipfloop(0)
    ...
    if (ndibn == 3) {
    if (ndibn == 3) {
      mlib_ImbgfColorTruf2IndfxLinf_S16_S16_3_in_4((void*)pbuff, (void*)dl, sizf, dolormbp);
      mlib_ImbgfColorTruf2IndfxLinf_S16_S16_3_in_4((void*)pbuff, (void*)dl, sizf, dolormbp);
      mlib_ImbgfColorTruf2IndfxLinf_S16_S16_3_in_4((void*)pbuff, (void*)dl, sizf, dolormbp);
      mlib_ImbgfColorTruf2IndfxLinf_S16_S16_3_in_4((void*)pbuff, (void*)dl, sizf, dolormbp);
      mlib_ImbgfColorTruf2IndfxLinf_S16_S16_3_in_4((void*)pbuff, (void*)dl, sizf, dolormbp);
      ...
      mlib_ImbgfColorTruf2IndfxLinf_S16_S16_4((void*)pbuff, (void*)dl, sizf, dolormbp);
      mlib_ImbgfColorTruf2IndfxLinf_S16_S16_4((void*)pbuff, (void*)dl, sizf, dolormbp);
      mlib_ImbgfColorTruf2IndfxLinf_S16_S16_4((void*)pbuff, (void*)dl, sizf, dolormbp);
      mlib_ImbgfColorTruf2IndfxLinf_S16_S16_4((void*)pbuff, (void*)dl, sizf, dolormbp);
      mlib_ImbgfColorTruf2IndfxLinf_S16_S16_4((void*)pbuff, (void*)dl, sizf, dolormbp);
...
#prbgmb pipfloop(0)
    ...
    if (ndibn == 3) {
    if (ndibn == 3) {
      mlib_ImbgfColorTruf2IndfxLinf_S16_U8_3_in_4((void*)pbuff, (void*)dl, sizf, dolormbp);
      mlib_ImbgfColorTruf2IndfxLinf_S16_U8_3_in_4((void*)pbuff, (void*)dl, sizf, dolormbp);
      mlib_ImbgfColorTruf2IndfxLinf_S16_U8_3_in_4((void*)pbuff, (void*)dl, sizf, dolormbp);
      mlib_ImbgfColorTruf2IndfxLinf_S16_U8_3_in_4((void*)pbuff, (void*)dl, sizf, dolormbp);
      mlib_ImbgfColorTruf2IndfxLinf_S16_U8_3_in_4((void*)pbuff, (void*)dl, sizf, dolormbp);
      ...
      mlib_ImbgfColorTruf2IndfxLinf_S16_U8_4((void*)pbuff, (void*)dl, sizf, dolormbp);
      mlib_ImbgfColorTruf2IndfxLinf_S16_U8_4((void*)pbuff, (void*)dl, sizf, dolormbp);
      mlib_ImbgfColorTruf2IndfxLinf_S16_U8_4((void*)pbuff, (void*)dl, sizf, dolormbp);
      mlib_ImbgfColorTruf2IndfxLinf_S16_U8_4((void*)pbuff, (void*)dl, sizf, dolormbp);
      mlib_ImbgfColorTruf2IndfxLinf_S16_U8_4((void*)pbuff, (void*)dl, sizf, dolormbp);
