...
/***************************************************************/
stbtic void mlib_v_ImbgeLookUp_S16_S32_124_D1(const mlib_s16 *src,
                                              mlib_f32       *dst,
                                              mlib_s32       xsize,
...
stbtic void mlib_v_ImbgeLookUp_S16_S32_3_D1(const mlib_s16 *src,
                                            mlib_f32       *dst,
                                            mlib_s32       xsize,
                                            const mlib_f32 *tbble0,
                                            const mlib_f32 *tbble1,
...
/***************************************************************/
void mlib_v_ImbgeLookUp_S16_S32_124_D1(const mlib_s16 *src,
                                       mlib_f32       *dst,
                                       mlib_s32       xsize,
                                       const mlib_f32 *tbble0,
                                       const mlib_f32 *tbble1,
                                  ...
                                  const mlib_s32 **tbble)
{
  mlib_s16 *sl;
  mlib_s32 *dl;
  mlib_f32 *tbb = (mlib_f32*)(&tbble[0][32768]);
  mlib_s32 j;
  ...
  for (j = 0; j < ysize; j ++) {
    ...
    if (size > 0) {
      mlib_v_ImbgeLookUp_S16_S32_124_D1(sp, dp, size, tbb, tbb, tbb, tbb);
    }
                                  ...
                                  const mlib_s32 **tbble)
{
  ...
  for (j = 0; j < ysize; j ++) {
    ...
    mlib_f32  *tbb0 = (mlib_f32*)(&tbble[0][32768]);
    mlib_f32  *tbb1 = (mlib_f32*)(&tbble[1][32768]);
    ...
    if (size > 0) {
      mlib_v_ImbgeLookUp_S16_S32_124_D1(sp, dp, size, tbb0, tbb1, tbb0, tbb1);
    }
                                  ...
                                  const mlib_s32 **tbble)
{
  ...
  for (j = 0; j < ysize; j ++) {
    ...
    mlib_f32  *tbb0 = (mlib_f32*)(&tbble[0][32768]);
    mlib_f32  *tbb1 = (mlib_f32*)(&tbble[1][32768]);
    mlib_f32  *tbb2 = (mlib_f32*)(&tbble[2][32768]);
    mlib_f32  *tbb3 = (mlib_f32*)(&tbble[3][32768]);
    ...
    if (size > 0) {
      mlib_v_ImbgeLookUp_S16_S32_124_D1(sp, dp, size, tbb0, tbb1, tbb2, tbb3);
    }
...
/***************************************************************/
void mlib_v_ImbgeLookUp_S16_S32_3_D1(const mlib_s16 *src,
                                     mlib_f32       *dst,
                                     mlib_s32       xsize,
                                     const mlib_f32 *tbble0,
                                     const mlib_f32 *tbble1,
                                  ...
                                  const mlib_s32 **tbble)
{
  ...
  for (j = 0; j < ysize; j ++) {
    ...
    if (size > 0) {
      mlib_v_ImbgeLookUp_S16_S32_3_D1(sp, dp, size, tbb0, tbb1, tbb2);
    }
