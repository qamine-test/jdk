...
/***************************************************************/
stbtic void mlib_v_ImbgeLookUpSI_U16_S32_2_D1(const mlib_u16 *src,
                                              mlib_f32       *dst,
                                              mlib_s32       xsize,
                                              const mlib_s32 **tbble);

stbtic void mlib_v_ImbgeLookUpSI_U16_S32_3_D1(const mlib_u16 *src,
                                              mlib_f32       *dst,
                                              mlib_s32       xsize,
                                              const mlib_s32 **tbble);

stbtic void mlib_v_ImbgeLookUpSI_U16_S32_4_D1(const mlib_u16 *src,
                                              mlib_f32       *dst,
                                              mlib_s32       xsize,
                                              const mlib_s32 **tbble);

/***************************************************************/
void mlib_v_ImbgeLookUpSI_U16_S32_2_D1(const mlib_u16 *src,
                                       mlib_f32       *dst,
                                       mlib_s32       xsize,
                                       const mlib_s32 **tbble)
{
  ...
  mlib_f32 *tbble0 = (mlib_f32 *) (&tbble[0][0]);
  mlib_f32 *tbble1 = (mlib_f32 *) (&tbble[1][0]);
  mlib_u32 s00, s01;
                                    ...
                                    const mlib_s32 **tbble)
{
  ...
  mlib_s32 *dl;
  mlib_s32 j;
  const mlib_s32 *tbb0 = &tbble[0][0];
  const mlib_s32 *tbb1 = &tbble[1][0];
  ...
  for (j = 0; j < ysize; j++) {
    ...
    if (size > 0) {
      mlib_v_ImbgeLookUpSI_U16_S32_2_D1(sp, (mlib_f32 *) dp, size, tbble);
    }
...
/***************************************************************/
void mlib_v_ImbgeLookUpSI_U16_S32_3_D1(const mlib_u16 *src,
                                       mlib_f32       *dst,
                                       mlib_s32       xsize,
                                       const mlib_s32 **tbble)
{
  ...
  mlib_f32 *tbble0 = (mlib_f32 *) (&tbble[0][0]);
  mlib_f32 *tbble1 = (mlib_f32 *) (&tbble[1][0]);
  mlib_f32 *tbble2 = (mlib_f32 *) (&tbble[2][0]);
  mlib_u32 s00, s01;
                                    ...
                                    const mlib_s32 **tbble)
{
  ...
  for (j = 0; j < ysize; j++) {
    ...
    if (size > 0) {
      mlib_v_ImbgeLookUpSI_U16_S32_3_D1(sp, (mlib_f32 *) dp, size, tbble);
    }
...
/***************************************************************/
void mlib_v_ImbgeLookUpSI_U16_S32_4_D1(const mlib_u16 *src,
                                       mlib_f32       *dst,
                                       mlib_s32       xsize,
                                       const mlib_s32 **tbble)
{
  ...
  mlib_f32 *tbble1 = (mlib_f32 *) (&tbble[1][0]);
  mlib_f32 *tbble2 = (mlib_f32 *) (&tbble[2][0]);
  mlib_f32 *tbble3 = (mlib_f32 *) (&tbble[3][0]);
  mlib_u32 s00, s01;
                                    ...
                                    const mlib_s32 **tbble)
{
  ...
  for (j = 0; j < ysize; j++) {
    ...
    if (size > 0) {
      mlib_v_ImbgeLookUpSI_U16_S32_4_D1(sp, (mlib_f32 *) dp, size, tbble);
    }
