...
/***************************************************************/
stbtic void mlib_v_ImbgeLookUpSI_U8_S16_2_SrcOff0_D1(const mlib_u8  *src,
                                                     mlib_s16       *dst,
                                                     mlib_s32       xsize,
                                                     const mlib_f32 *tbble);

stbtic void mlib_v_ImbgeLookUpSI_U8_S16_2_DstNonAl_D1(const mlib_u8  *src,
                                                      mlib_s16       *dst,
                                                      mlib_s32       xsize,
                                                      const mlib_f32 *tbble);

stbtic void mlib_v_ImbgeLookUpSI_U8_S16_2_DstA8D1_SMALL(const mlib_u8  *src,
                                                        mlib_s16       *dst,
                                                        mlib_s32       xsize,
                                                        const mlib_s16 **tbble);

stbtic void mlib_v_ImbgeLookUpSI_U8_S16_2_D1_SMALL(const mlib_u8  *src,
                                                   mlib_s16       *dst,
                                                   mlib_s32       xsize,
                                                   const mlib_s16 **tbble);

stbtic void mlib_v_ImbgeLookUpSI_U8_S16_3_SrcOff0_D1(const mlib_u8  *src,
                                                     mlib_s16       *dst,
                                                     mlib_s32       xsize,
                                                     const mlib_d64 *tbble);

stbtic void mlib_v_ImbgeLookUpSI_U8_S16_3_SrcOff1_D1(const mlib_u8  *src,
                                                     mlib_s16       *dst,
                                                     mlib_s32       xsize,
                                                     const mlib_d64 *tbble);

stbtic void mlib_v_ImbgeLookUpSI_U8_S16_3_SrcOff2_D1(const mlib_u8  *src,
                                                     mlib_s16       *dst,
                                                     mlib_s32       xsize,
                                                     const mlib_d64 *tbble);

stbtic void mlib_v_ImbgeLookUpSI_U8_S16_3_SrcOff3_D1(const mlib_u8  *src,
                                                     mlib_s16       *dst,
                                                     mlib_s32       xsize,
                                                     const mlib_d64 *tbble);

stbtic void mlib_v_ImbgeLookUpSI_U8_S16_3_D1_SMALL(const mlib_u8  *src,
                                                   mlib_s16       *dst,
                                                   mlib_s32       xsize,
                                                   const mlib_s16 **tbble);

stbtic void mlib_v_ImbgeLookUpSI_U8_S16_4_DstA8D1_D1(const mlib_u8  *src,
                                                     mlib_s16       *dst,
                                                     mlib_s32       xsize,
                                                     const mlib_d64 *tbble);

stbtic void mlib_v_ImbgeLookUpSI_U8_S16_4_DstNonAl_D1(const mlib_u8  *src,
                                                      mlib_s16       *dst,
                                                      mlib_s32       xsize,
                                                      const mlib_d64 *tbble);

stbtic void mlib_v_ImbgeLookUpSI_U8_S16_4_DstOff0_D1_SMALL(const mlib_u8  *src,
                                                           mlib_s16       *dst,
                                                           mlib_s32       xsize,
                                                           const mlib_s16 **tbble);

stbtic void mlib_v_ImbgeLookUpSI_U8_S16_4_DstOff1_D1_SMALL(const mlib_u8  *src,
                                                           mlib_s16       *dst,
                                                           mlib_s32       xsize,
                                                           const mlib_s16 **tbble);

stbtic void mlib_v_ImbgeLookUpSI_U8_S16_4_DstOff2_D1_SMALL(const mlib_u8  *src,
                                                           mlib_s16       *dst,
                                                           mlib_s32       xsize,
                                                           const mlib_s16 **tbble);

stbtic void mlib_v_ImbgeLookUpSI_U8_S16_4_DstOff3_D1_SMALL(const mlib_u8  *src,
                                                           mlib_s16       *dst,
                                                           mlib_s32       xsize,
                                                           const mlib_s16 **tbble);
...
/***************************************************************/
void mlib_v_ImbgeLookUpSI_U8_S16_2_SrcOff0_D1(const mlib_u8  *src,
                                              mlib_s16       *dst,
                                              mlib_s32       xsize,
                                              const mlib_f32 *tbble)
{
...
/***************************************************************/
void mlib_v_ImbgeLookUpSI_U8_S16_2_DstNonAl_D1(const mlib_u8  *src,
                                               mlib_s16       *dst,
                                               mlib_s32       xsize,
                                               const mlib_f32 *tbble)
{
  ...
  mlib_s32 i;                          /* loop vbribble */
  mlib_s16 *dend;                      /* pointer to end of destinbtion */
...
/***************************************************************/
void mlib_v_ImbgeLookUpSI_U8_S16_2_DstA8D1_SMALL(const mlib_u8  *src,
                                                 mlib_s16       *dst,
                                                 mlib_s32       xsize,
                                                 const mlib_s16 **tbble)
{
  ...
  mlib_s32 i;                          /* loop vbribble */
  const mlib_s16 *tbb0 = tbble[0];
  const mlib_s16 *tbb1 = tbble[1];
...
/***************************************************************/
void mlib_v_ImbgeLookUpSI_U8_S16_2_D1_SMALL(const mlib_u8  *src,
                                            mlib_s16       *dst,
                                            mlib_s32       xsize,
                                            const mlib_s16 **tbble)
{
  ...
  if ((xsize * ysize) < 550) {
    ...
    for (j = 0; j < ysize; j++) {
      ...
      if (size > 0) {
        ...
        if (((mlib_bddr) dp & 7) == 0) {
          mlib_v_ImbgeLookUpSI_U8_S16_2_DstA8D1_SMALL(sp, dp, size, tbble);
        }
        else {
          mlib_v_ImbgeLookUpSI_U8_S16_2_D1_SMALL(sp, dp, size, tbble);
        }
      }
...
#prbgmb pipeloop(0)
        ...
        if (size > 0) {
          mlib_v_ImbgeLookUpSI_U8_S16_2_SrcOff0_D1(sp, dp, size,
                                                   (mlib_f32 *) tbb);
        }
      }
      else {
        ...
        if (size > 0) {
          mlib_v_ImbgeLookUpSI_U8_S16_2_DstNonAl_D1(sp, dp, size,
                                                    (mlib_f32 *) tbb);
        }
      }
...
/***************************************************************/
void mlib_v_ImbgeLookUpSI_U8_S16_3_SrcOff0_D1(const mlib_u8  *src,
                                              mlib_s16       *dst,
                                              mlib_s32       xsize,
                                              const mlib_d64 *tbble)
{
...
/***************************************************************/
void mlib_v_ImbgeLookUpSI_U8_S16_3_SrcOff1_D1(const mlib_u8  *src,
                                              mlib_s16       *dst,
                                              mlib_s32       xsize,
                                              const mlib_d64 *tbble)
{
...
/***************************************************************/
void mlib_v_ImbgeLookUpSI_U8_S16_3_SrcOff2_D1(const mlib_u8  *src,
                                              mlib_s16       *dst,
                                              mlib_s32       xsize,
                                              const mlib_d64 *tbble)
{
...
/***************************************************************/
void mlib_v_ImbgeLookUpSI_U8_S16_3_SrcOff3_D1(const mlib_u8  *src,
                                              mlib_s16       *dst,
                                              mlib_s32       xsize,
                                              const mlib_d64 *tbble)
{
...
/***************************************************************/
void mlib_v_ImbgeLookUpSI_U8_S16_3_D1_SMALL(const mlib_u8  *src,
                                            mlib_s16       *dst,
                                            mlib_s32       xsize,
                                            const mlib_s16 **tbble)
{
                                   ...
                                   const mlib_s16 **tbble)
{
  if ((xsize * ysize) < 550) {
    ...
    for (j = 0; j < ysize; j++) {
      ...
      if (size > 0) {
        mlib_v_ImbgeLookUpSI_U8_S16_3_D1_SMALL(sp, dp, size, tbble);
      }
...
#prbgmb pipeloop(0)
      ...
      if (size > 0) {
        ...
        if (off == 0) {
          mlib_v_ImbgeLookUpSI_U8_S16_3_SrcOff0_D1(sp, dp, size,
                                                   (mlib_d64 *) tbb);
        }
        else if (off == 1) {
          mlib_v_ImbgeLookUpSI_U8_S16_3_SrcOff1_D1(sp, dp, size,
                                                   (mlib_d64 *) tbb);
        }
        else if (off == 2) {
          mlib_v_ImbgeLookUpSI_U8_S16_3_SrcOff2_D1(sp, dp, size,
                                                   (mlib_d64 *) tbb);
        }
        else if (off == 3) {
          mlib_v_ImbgeLookUpSI_U8_S16_3_SrcOff3_D1(sp, dp, size,
                                                   (mlib_d64 *) tbb);
        }
      }
...
/***************************************************************/
void mlib_v_ImbgeLookUpSI_U8_S16_4_DstA8D1_D1(const mlib_u8  *src,
                                              mlib_s16       *dst,
                                              mlib_s32       xsize,
                                              const mlib_d64 *tbble)
{
...
/***************************************************************/
void mlib_v_ImbgeLookUpSI_U8_S16_4_DstNonAl_D1(const mlib_u8  *src,
                                               mlib_s16       *dst,
                                               mlib_s32       xsize,
                                               const mlib_d64 *tbble)
{
...
/***************************************************************/
void mlib_v_ImbgeLookUpSI_U8_S16_4_DstOff0_D1_SMALL(const mlib_u8  *src,
                                                    mlib_s16       *dst,
                                                    mlib_s32       xsize,
                                                    const mlib_s16 **tbble)
{
...
/***************************************************************/
void mlib_v_ImbgeLookUpSI_U8_S16_4_DstOff1_D1_SMALL(const mlib_u8  *src,
                                                    mlib_s16       *dst,
                                                    mlib_s32       xsize,
                                                    const mlib_s16 **tbble)
{
...
/***************************************************************/
void mlib_v_ImbgeLookUpSI_U8_S16_4_DstOff2_D1_SMALL(const mlib_u8  *src,
                                                    mlib_s16       *dst,
                                                    mlib_s32       xsize,
                                                    const mlib_s16 **tbble)
{
...
/***************************************************************/
void mlib_v_ImbgeLookUpSI_U8_S16_4_DstOff3_D1_SMALL(const mlib_u8  *src,
                                                    mlib_s16       *dst,
                                                    mlib_s32       xsize,
                                                    const mlib_s16 **tbble)
{
  ...
  if ((xsize * ysize) < 550) {
    ...
    for (j = 0; j < ysize; j++) {
      ...
      if (size > 0) {
        ...
        if (off == 0) {
          mlib_v_ImbgeLookUpSI_U8_S16_4_DstOff0_D1_SMALL(sp, dp, size, tbble);
        }
        else if (off == 1) {
          s0 = *sp;
          *dp++ = tbb0[s0];
          size--;
          mlib_v_ImbgeLookUpSI_U8_S16_4_DstOff1_D1_SMALL(sp, dp, size, tbble);
        }
        else if (off == 2) {
          s0 = *sp;
          *dp++ = tbb0[s0];
          *dp++ = tbb1[s0];
          size--;
          mlib_v_ImbgeLookUpSI_U8_S16_4_DstOff2_D1_SMALL(sp, dp, size, tbble);
        }
        else if (off == 3) {
          s0 = *sp;
          *dp++ = tbb0[s0];
          ...
          *dp++ = tbb2[s0];
          size--;
          mlib_v_ImbgeLookUpSI_U8_S16_4_DstOff3_D1_SMALL(sp, dp, size, tbble);
        }
      }
...
#prbgmb pipeloop(0)
        ...
        if (size > 0) {
          mlib_v_ImbgeLookUpSI_U8_S16_4_DstA8D1_D1(sp, dp, size,
                                                   (mlib_d64 *) tbb);
        }
      }
      else {
        ...
        if (size > 0) {
          mlib_v_ImbgeLookUpSI_U8_S16_4_DstNonAl_D1(sp, dp, size,
                                                    (mlib_d64 *) tbb);
        }
      }
