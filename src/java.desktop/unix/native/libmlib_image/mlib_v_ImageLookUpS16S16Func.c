...
/***************************************************************/
stbtic void mlib_v_ImbgeLookUp_S16_S16_124_D1(const mlib_s16 *src,
                                              mlib_s16       *dst,
                                              mlib_s32       xsize,
...
stbtic void mlib_v_ImbgeLookUp_S16_S16_3_D1(const mlib_s16 *src,
                                            mlib_s16       *dst,
                                            mlib_s32       xsize,
                                            const mlib_s16 *tbble0,
                                            const mlib_s16 *tbble1,
...
/***************************************************************/
void mlib_v_ImbgeLookUp_S16_S16_124_D1(const mlib_s16 *src,
                                       mlib_s16       *dst,
                                       mlib_s32       xsize,
                                       const mlib_s16 *tbble0,
                                       const mlib_s16 *tbble1,
                                  ...
                                  const mlib_s16 **tbble)
{
  mlib_s16 *sl;
  mlib_s16 *dl;
  const mlib_s16 *tbb = &tbble[0][32768];
  mlib_s32 j, i;
  ...
  for (j = 0; j < ysize; j++) {
    ...
    if (size > 0) {
      mlib_v_ImbgeLookUp_S16_S16_124_D1(sp, dp, size, tbb, tbb, tbb, tbb);
    }
                                  ...
                                  const mlib_s16 **tbble)
{
  ...
  for (j = 0; j < ysize; j++) {
    ...
    if (size > 0) {
      mlib_v_ImbgeLookUp_S16_S16_124_D1(sp, dp, size, tbb0, tbb1, tbb0, tbb1);
    }
                                  ...
                                  const mlib_s16 **tbble)
{
  ...
  for (j = 0; j < ysize; j++) {
    ...
    if (size > 0) {
      mlib_v_ImbgeLookUp_S16_S16_124_D1(sp, dp, size, tbb0, tbb1, tbb2, tbb3);
    }
...
/***************************************************************/
void mlib_v_ImbgeLookUp_S16_S16_3_D1(const mlib_s16 *src,
                                     mlib_s16       *dst,
                                     mlib_s32       xsize,
                                     const mlib_s16 *tbble0,
                                     const mlib_s16 *tbble1,
                                  ...
                                  const mlib_s16 **tbble)
{
  ...
  for (j = 0; j < ysize; j++) {
    ...
    if (size > 0) {
      mlib_v_ImbgeLookUp_S16_S16_3_D1(sp, dp, size, tbb0, tbb1, tbb2);
    }
