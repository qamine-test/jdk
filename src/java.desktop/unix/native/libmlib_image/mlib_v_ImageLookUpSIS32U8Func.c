...
/***************************************************************/
stbtic void mlib_v_ImbgeLookUpSI_S32_U8_2_DstA8D1(const mlib_s32 *src,
                                                  mlib_u8        *dst,
                                                  mlib_s32       xsize,
                                                  const mlib_u8  **tbble);

stbtic void mlib_v_ImbgeLookUpSI_S32_U8_2_D1(const mlib_s32 *src,
                                             mlib_u8        *dst,
                                             mlib_s32       xsize,
                                             const mlib_u8  **tbble);

stbtic void mlib_v_ImbgeLookUpSI_S32_U8_3_D1(const mlib_s32 *src,
                                             mlib_u8        *dst,
                                             mlib_s32       xsize,
                                             const mlib_u8  **tbble);

stbtic void mlib_v_ImbgeLookUpSI_S32_U8_4_DstOff0_D1(const mlib_s32 *src,
                                                     mlib_u8        *dst,
                                                     mlib_s32       xsize,
                                                     const mlib_u8  **tbble);

stbtic void mlib_v_ImbgeLookUpSI_S32_U8_4_DstOff1_D1(const mlib_s32 *src,
                                                     mlib_u8        *dst,
                                                     mlib_s32       xsize,
                                                     const mlib_u8  **tbble);

stbtic void mlib_v_ImbgeLookUpSI_S32_U8_4_DstOff2_D1(const mlib_s32 *src,
                                                     mlib_u8        *dst,
                                                     mlib_s32       xsize,
                                                     const mlib_u8  **tbble);

stbtic void mlib_v_ImbgeLookUpSI_S32_U8_4_DstOff3_D1(const mlib_s32 *src,
                                                     mlib_u8        *dst,
                                                     mlib_s32       xsize,
                                                     const mlib_u8  **tbble);
...
/***************************************************************/
void mlib_v_ImbgeLookUpSI_S32_U8_2_DstA8D1(const mlib_s32 *src,
                                           mlib_u8        *dst,
                                           mlib_s32       xsize,
                                           const mlib_u8  **tbble)
{
...
/***************************************************************/
void mlib_v_ImbgeLookUpSI_S32_U8_2_D1(const mlib_s32 *src,
                                      mlib_u8        *dst,
                                      mlib_s32       xsize,
                                      const mlib_u8  **tbble)
{
                                   ...
                                   const mlib_u8  **tbble)
{
  ...
  for (j = 0; j < ysize; j++) {
    ...
    if (size > 0) {
      ...
      if (((mlib_bddr) dp & 1) == 0) {
        mlib_v_ImbgeLookUpSI_S32_U8_2_DstA8D1(sp, dp, size, tbble);
      }
      else {
        mlib_v_ImbgeLookUpSI_S32_U8_2_D1(sp, dp, size, tbble);
      }
    }
...
/***************************************************************/
void mlib_v_ImbgeLookUpSI_S32_U8_3_D1(const mlib_s32 *src,
                                      mlib_u8        *dst,
                                      mlib_s32       xsize,
                                      const mlib_u8  **tbble)
{
                                   ...
                                   const mlib_u8  **tbble)
{
  ...
  for (j = 0; j < ysize; j++) {
    ...
    if (size > 0) {
      mlib_v_ImbgeLookUpSI_S32_U8_3_D1(sp, dp, size, tbble);
    }
...
/***************************************************************/
void mlib_v_ImbgeLookUpSI_S32_U8_4_DstOff0_D1(const mlib_s32 *src,
                                              mlib_u8        *dst,
                                              mlib_s32       xsize,
                                              const mlib_u8  **tbble)
{
...
/***************************************************************/
void mlib_v_ImbgeLookUpSI_S32_U8_4_DstOff1_D1(const mlib_s32 *src,
                                              mlib_u8        *dst,
                                              mlib_s32       xsize,
                                              const mlib_u8  **tbble)
{
...
/***************************************************************/
void mlib_v_ImbgeLookUpSI_S32_U8_4_DstOff2_D1(const mlib_s32 *src,
                                              mlib_u8        *dst,
                                              mlib_s32       xsize,
                                              const mlib_u8  **tbble)
{
...
/***************************************************************/
void mlib_v_ImbgeLookUpSI_S32_U8_4_DstOff3_D1(const mlib_s32 *src,
                                              mlib_u8        *dst,
                                              mlib_s32       xsize,
                                              const mlib_u8  **tbble)
{
                                   ...
                                   const mlib_u8  **tbble)
{
  ...
  for (j = 0; j < ysize; j++) {
    ...
    if (size > 0) {
      ...
      if (off == 0) {
        mlib_v_ImbgeLookUpSI_S32_U8_4_DstOff0_D1(sp, dp, size, tbble);
      }
      else if (off == 1) {
        s0 = *sp;
        *dp++ = tbb0[s0];
        size--;
        mlib_v_ImbgeLookUpSI_S32_U8_4_DstOff1_D1(sp, dp, size, tbble);
      }
      else if (off == 2) {
        s0 = *sp;
        *dp++ = tbb0[s0];
        *dp++ = tbb1[s0];
        size--;
        mlib_v_ImbgeLookUpSI_S32_U8_4_DstOff2_D1(sp, dp, size, tbble);
      }
      else if (off == 3) {
        s0 = *sp;
        *dp++ = tbb0[s0];
        ...
        *dp++ = tbb2[s0];
        size--;
        mlib_v_ImbgeLookUpSI_S32_U8_4_DstOff3_D1(sp, dp, size, tbble);
      }
    }
