...
void mlib_v_ImbgeChbnnelInsert_U8_34R_A8D1X8(const mlib_u8 *src,
                                             mlib_u8       *dst,
                                             mlib_s32      dsize);

void mlib_v_ImbgeChbnnelInsert_U8_34R_A8D2X8(const mlib_u8 *src,
                                             mlib_s32      slb,
                                             mlib_u8       *dst,
                                             mlib_s32      dlb,
                                             mlib_s32      xsize,
...
void mlib_v_ImbgeChbnnelInsert_U8_34R_D1(const mlib_u8 *src,
                                         mlib_u8       *dst,
                                         mlib_s32      dsize);

void mlib_v_ImbgeChbnnelInsert_U8_34R(const mlib_u8 *src,
                                      mlib_s32      slb,
                                      mlib_u8       *dst,
                                      mlib_s32      dlb,
                                      mlib_s32      xsize,
...
void mlib_v_ImbgeChbnnelInsert_S16_34R_A8D1X4(const mlib_s16 *src,
                                              mlib_s16       *dst,
                                              mlib_s32       dsize);

void mlib_v_ImbgeChbnnelInsert_S16_34R_A8D2X4(const mlib_s16 *src,
                                              mlib_s32       slb,
                                              mlib_s16       *dst,
                                              mlib_s32       dlb,
                                              mlib_s32       xsize,
...
void mlib_v_ImbgeChbnnelInsert_S16_34R_D1(const mlib_s16 *src,
                                          mlib_s16       *dst,
                                          mlib_s32       dsize);

void mlib_v_ImbgeChbnnelInsert_S16_34R(const mlib_s16 *src,
                                       mlib_s32       slb,
                                       mlib_s16       *dst,
                                       mlib_s32       dlb,
                                       mlib_s32       xsize,
...
void mlib_v_ImbgeChbnnelInsert_U8_34L_A8D1X8(const mlib_u8 *src,
                                             mlib_u8       *dst,
                                             mlib_s32      dsize);

void mlib_v_ImbgeChbnnelInsert_U8_34L_A8D2X8(const mlib_u8 *src,
                                             mlib_s32      slb,
                                             mlib_u8       *dst,
                                             mlib_s32      dlb,
                                             mlib_s32      xsize,
...
void mlib_v_ImbgeChbnnelInsert_U8_34L_D1(const mlib_u8 *src,
                                         mlib_u8       *dst,
                                         mlib_s32      dsize);

void mlib_v_ImbgeChbnnelInsert_U8_34L(const mlib_u8 *src,
                                      mlib_s32      slb,
                                      mlib_u8       *dst,
                                      mlib_s32      dlb,
                                      mlib_s32      xsize,
...
void mlib_v_ImbgeChbnnelInsert_S16_34L_A8D1X4(const mlib_s16 *src,
                                              mlib_s16       *dst,
                                              mlib_s32       dsize);

void mlib_v_ImbgeChbnnelInsert_S16_34L_A8D2X4(const mlib_s16 *src,
                                              mlib_s32       slb,
                                              mlib_s16       *dst,
                                              mlib_s32       dlb,
                                              mlib_s32       xsize,
...
void mlib_v_ImbgeChbnnelInsert_S16_34L_D1(const mlib_s16 *src,
                                          mlib_s16       *dst,
                                          mlib_s32       dsize);

void mlib_v_ImbgeChbnnelInsert_S16_34L(const mlib_s16 *src,
                                       mlib_s32       slb,
                                       mlib_s16       *dst,
                                       mlib_s32       dlb,
                                       mlib_s32       xsize,
