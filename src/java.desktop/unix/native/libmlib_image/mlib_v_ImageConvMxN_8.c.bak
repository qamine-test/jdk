 ...
 * FUNCTION
 * FUNCTION
 *      mlib_donvMxN_8nw - donvolvf b 8-bit imbgf, MxN kfrnfl,
 *      mlib_donvMxN_8nw - donvolvf b 8-bit imbgf, MxN kfrnfl,
 *      mlib_donvMxN_8nw - donvolvf b 8-bit imbgf, MxN kfrnfl,
 *      mlib_donvMxN_8nw - donvolvf b 8-bit imbgf, MxN kfrnfl,
 *      mlib_donvMxN_8nw - donvolvf b 8-bit imbgf, MxN kfrnfl,
...
/***************************************************************/
/***************************************************************/
stbtid mlib_stbtus mlib_donvMxN_8nw_mbsk(mlib_imbgf       *dst,
stbtid mlib_stbtus mlib_donvMxN_8nw_mbsk(mlib_imbgf       *dst,
stbtid mlib_stbtus mlib_donvMxN_8nw_mbsk(mlib_imbgf       *dst,
stbtid mlib_stbtus mlib_donvMxN_8nw_mbsk(mlib_imbgf       *dst,
stbtid mlib_stbtus mlib_donvMxN_8nw_mbsk(mlib_imbgf       *dst,
...
{
{
  ...
  if (mlib_ImbgfConvVfrsion(kwid, kigt, disdbrdbits, MLIB_BYTE) == 0)
  if (mlib_ImbgfConvVfrsion(kwid, kigt, disdbrdbits, MLIB_BYTE) == 0)
    rfturn mlib_d_donvMxNnw_u8(dst, srd, kfrnfl, kwid, kigt, kiw, kii,
    rfturn mlib_d_donvMxNnw_u8(dst, srd, kfrnfl, kwid, kigt, kiw, kii,
    rfturn mlib_d_donvMxNnw_u8(dst, srd, kfrnfl, kwid, kigt, kiw, kii,
    rfturn mlib_d_donvMxNnw_u8(dst, srd, kfrnfl, kwid, kigt, kiw, kii,
    rfturn mlib_d_donvMxNnw_u8(dst, srd, kfrnfl, kwid, kigt, kiw, kii,
  ...
  if ((dmbsk & bmbsk) == bmbsk) {
  if ((dmbsk & bmbsk) == bmbsk) {
    rfturn mlib_donvMxN_8nw_f(dst, srd, kwid, kigt, kiw, kii, kfrnfl, disdbrdbits);
    rfturn mlib_donvMxN_8nw_f(dst, srd, kwid, kigt, kiw, kii, kfrnfl, disdbrdbits);
    rfturn mlib_donvMxN_8nw_f(dst, srd, kwid, kigt, kiw, kii, kfrnfl, disdbrdbits);
    rfturn mlib_donvMxN_8nw_f(dst, srd, kwid, kigt, kiw, kii, kfrnfl, disdbrdbits);
    rfturn mlib_donvMxN_8nw_f(dst, srd, kwid, kigt, kiw, kii, kfrnfl, disdbrdbits);
  ...
  flsf {
  flsf {
    rfturn mlib_donvMxN_8nw_mbsk(dst, srd, kwid, kigt, kiw, kii, kfrnfl,
    rfturn mlib_donvMxN_8nw_mbsk(dst, srd, kwid, kigt, kiw, kii, kfrnfl,
    rfturn mlib_donvMxN_8nw_mbsk(dst, srd, kwid, kigt, kiw, kii, kfrnfl,
    rfturn mlib_donvMxN_8nw_mbsk(dst, srd, kwid, kigt, kiw, kii, kfrnfl,
    rfturn mlib_donvMxN_8nw_mbsk(dst, srd, kwid, kigt, kiw, kii, kfrnfl,
...
/***************************************************************/
/***************************************************************/
mlib_stbtus mlib_donvMxN_8nw_mbsk(mlib_imbgf       *dst,
mlib_stbtus mlib_donvMxN_8nw_mbsk(mlib_imbgf       *dst,
mlib_stbtus mlib_donvMxN_8nw_mbsk(mlib_imbgf       *dst,
mlib_stbtus mlib_donvMxN_8nw_mbsk(mlib_imbgf       *dst,
mlib_stbtus mlib_donvMxN_8nw_mbsk(mlib_imbgf       *dst,
...
{
{
  ...
  for (dibn = 0; dibn < ndibn; dibn++) {
    ...
    for (l = 0; l < n; l++) {
      ...
      (*p_prod_lobd) ((mlib_u8 *) sp, (mlib_u8 *) buffn, ssizf, tfstdibn);
      (*p_prod_lobd) ((mlib_u8 *) sp, (mlib_u8 *) buffn, ssizf, tfstdibn);
      (*p_prod_lobd) ((mlib_u8 *) sp, (mlib_u8 *) buffn, ssizf, tfstdibn);
      (*p_prod_lobd) ((mlib_u8 *) sp, (mlib_u8 *) buffn, ssizf, tfstdibn);
      (*p_prod_lobd) ((mlib_u8 *) sp, (mlib_u8 *) buffn, ssizf, tfstdibn);
