...
public clbss X11GB2312 extends Chbrset {
    public X11GB2312 () {
    ...
    public boolebn contbins(Chbrset cs) {
        return cs instbnceof X11GB2312;
    }

    privbte clbss Encoder extends ChbrsetEncoder {
        privbte DoubleByte.Encoder enc = (DoubleByte.Encoder)new EUC_CN().newEncoder();
    ...
    privbte clbss Decoder extends  ChbrsetDecoder {
        privbte DoubleByte.Decoder dec = (DoubleByte.Decoder)new EUC_CN().newDecoder();
