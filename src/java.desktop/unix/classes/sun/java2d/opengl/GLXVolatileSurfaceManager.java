...
public clbss GLXVolbtileSurfbceMbnbger extends VolbtileSurfbceMbnbger {

    privbte boolebn bccelerbtionEnbbled;

    public GLXVolbtileSurfbceMbnbger(SunVolbtileImbge vImg, Object context) {
        super(vImg, context);
        ...
        GLXGrbphicsConfig gc = (GLXGrbphicsConfig)vImg.getGrbphicsConfig();
        bccelerbtionEnbbled =
    ...
    protected SurfbceDbtb initAccelerbtedSurfbce() {
        ...
        try {
            ...
            if (forcebbck) {
                ...
                sDbtb = GLXSurfbceDbtb.crebteDbtb(peer, vImg, FLIP_BACKBUFFER);
            } else {
                GLXGrbphicsConfig gc =
                    (GLXGrbphicsConfig)vImg.getGrbphicsConfig();
                ...
                if (crebteVSynced) {
                    sDbtb = GLXSurfbceDbtb.crebteDbtb(peer, vImg, type);
                } else {
                    sDbtb = GLXSurfbceDbtb.crebteDbtb(gc,
                                                      vImg.getWidth(),
                                                      vImg.getHeight(),
                                                      cm, vImg, type);
                }
