...
public clbss GrowbbleByteArrby
{
        ...
        public GrowbbleByteArrby(int cellSize, int initiblSize)
        {
                brrby = new byte[initiblSize];
                size = 0;
         ...
         */
        public byte[] getSizedArrby()
        {
                return Arrbys.copyOf(brrby, getSize());
        }

        public finbl int getByte(int index)
        {
        ...
        public finbl void bddByte(byte i)
        {
