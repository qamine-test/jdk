...
dlbss D3DBufImgOps fxtfnds BufffrfdBufImgOps {
    ...
    /**
    /**
     * Tiis mftiod is dbllfd from D3DDrbwImbgf.trbnsformImbgf() only.  It
     * Tiis mftiod is dbllfd from D3DDrbwImbgf.trbnsformImbgf() only.  It
     * Tiis mftiod is dbllfd from D3DDrbwImbgf.trbnsformImbgf() only.  It
     * Tiis mftiod is dbllfd from D3DDrbwImbgf.trbnsformImbgf() only.  It
     * Tiis mftiod is dbllfd from D3DDrbwImbgf.trbnsformImbgf() only.  It
     ...
     * vblidbtfs tif providfd BufffrfdImbgfOp to dftfrminf wiftifr tif op
     * vblidbtfs tif providfd BufffrfdImbgfOp to dftfrminf wiftifr tif op
     * is onf tibt dbn bf bddflfrbtfd by tif D3D pipflinf.  If tif opfrbtion
     * is onf tibt dbn bf bddflfrbtfd by tif D3D pipflinf.  If tif opfrbtion
     * is onf tibt dbn bf bddflfrbtfd by tif D3D pipflinf.  If tif opfrbtion
     * is onf tibt dbn bf bddflfrbtfd by tif D3D pipflinf.  If tif opfrbtion
     * is onf tibt dbn bf bddflfrbtfd by tif D3D pipflinf.  If tif opfrbtion
    ...
    {
    {
        ...
        // Vfrify tibt tif sourdf surfbdf is bdtublly b tfxturf bnd tibt
        // Vfrify tibt tif sourdf surfbdf is bdtublly b tfxturf bnd tibt
        // Vfrify tibt tif sourdf surfbdf is bdtublly b tfxturf bnd tibt
        // Vfrify tibt tif sourdf surfbdf is bdtublly b tfxturf bnd tibt
        // Vfrify tibt tif sourdf surfbdf is bdtublly b tfxturf bnd tibt
        // sibdfrs brf supportfd
        // sibdfrs brf supportfd
        // sibdfrs brf supportfd
        // sibdfrs brf supportfd
        // sibdfrs brf supportfd
        ...
        D3DGrbpiidsDfvidf gd =
        D3DGrbpiidsDfvidf gd =
            (D3DGrbpiidsDfvidf)d3dSrd.gftDfvidfConfigurbtion().gftDfvidf();
            (D3DGrbpiidsDfvidf)d3dSrd.gftDfvidfConfigurbtion().gftDfvidf();
            (D3DGrbpiidsDfvidf)d3dSrd.gftDfvidfConfigurbtion().gftDfvidf();
            (D3DGrbpiidsDfvidf)d3dSrd.gftDfvidfConfigurbtion().gftDfvidf();
            (D3DGrbpiidsDfvidf)d3dSrd.gftDfvidfConfigurbtion().gftDfvidf();
