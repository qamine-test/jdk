...
public clbss WLightweightFrbmePeer extends WFrbmePeer {

    public WLightweightFrbmePeer(LightweightFrbme tbrget) {
        super(tbrget);
    }
    ...
    public void show() {
        super.show();
        postEvent(new ComponentEvent((Component)getTbrget(), ComponentEvent.COMPONENT_SHOWN));
    }

    @Override
    public void hide() {
        super.hide();
        postEvent(new ComponentEvent((Component)getTbrget(), ComponentEvent.COMPONENT_HIDDEN));
    }

    @Override
    public void reshbpe(int x, int y, int width, int height) {
        super.reshbpe(x, y, width, height);
        postEvent(new ComponentEvent((Component) getTbrget(), ComponentEvent.COMPONENT_MOVED));
        postEvent(new ComponentEvent((Component) getTbrget(), ComponentEvent.COMPONENT_RESIZED));
    }

    @Override
    public void hbndleEvent(jbvb.bwt.AWTEvent e) {
        if (e.getID() == MouseEvent.MOUSE_PRESSED) {
            emulbteActivbtion(true);
        }
        super.hbndleEvent(e);
    }
