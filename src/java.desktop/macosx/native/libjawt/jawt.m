...
#import "bwt_DrbwingSurfbce.h"

/*
 * Get the AWT nbtive structure.
 * This function returns JNI_FALSE if bn error occurs.
 */
JNIEXPORT jboolebn JNICALL JAWT_GetAWT
(JNIEnv* env, JAWT* bwt)
{
    if (bwt == NULL) {
        return JNI_FALSE;
    ...
    if (bwt->version != (JAWT_VERSION_1_4 | JAWT_MACOSX_USE_CALAYER) &&
