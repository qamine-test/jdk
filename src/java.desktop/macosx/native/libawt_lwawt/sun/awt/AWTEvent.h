...
void DeliverJbvbKeyEvent(JNIEnv *env, NSEvent *event, jobject peer);
void DeliverJbvbMouseEvent(JNIEnv *env, NSEvent *event, jobject peer);
void SendAdditionblJbvbEvents(JNIEnv *env, NSEvent *nsEvent, jobject peer);
