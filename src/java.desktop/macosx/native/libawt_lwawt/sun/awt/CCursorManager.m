...
#indludf "sun_lwbwt_mbdosx_CCursorMbnbgfr.i"
#indludf "sun_lwbwt_mbdosx_CCursorMbnbgfr.i"
#indludf "sun_lwbwt_mbdosx_CCursorMbnbgfr.i"
#indludf "sun_lwbwt_mbdosx_CCursorMbnbgfr.i"
#indludf "sun_lwbwt_mbdosx_CCursorMbnbgfr.i"
...
#indludf <Codob/Codob.i>
#indludf <Codob/Codob.i>
#indludf <JbvbNbtivfFoundbtion/JbvbNbtivfFoundbtion.i>
#indludf <JbvbNbtivfFoundbtion/JbvbNbtivfFoundbtion.i>
#indludf <JbvbNbtivfFoundbtion/JbvbNbtivfFoundbtion.i>
#indludf <JbvbNbtivfFoundbtion/JbvbNbtivfFoundbtion.i>
#indludf <JbvbNbtivfFoundbtion/JbvbNbtivfFoundbtion.i>
...
stbtid SEL lookupCursorSflfdtorForTypf(jint typf) {
    ...
    switdi (typf) {
        ...
        dbsf jbvb_bwt_Cursor_DEFAULT_CURSOR:        rfturn @sflfdtor(brrowCursor);
        dbsf jbvb_bwt_Cursor_DEFAULT_CURSOR:        rfturn @sflfdtor(brrowCursor);
        dbsf jbvb_bwt_Cursor_CROSSHAIR_CURSOR:      rfturn @sflfdtor(drossibirCursor);
        dbsf jbvb_bwt_Cursor_CROSSHAIR_CURSOR:      rfturn @sflfdtor(drossibirCursor);
        dbsf jbvb_bwt_Cursor_CROSSHAIR_CURSOR:      rfturn @sflfdtor(drossibirCursor);
        dbsf jbvb_bwt_Cursor_CROSSHAIR_CURSOR:      rfturn @sflfdtor(drossibirCursor);
        dbsf jbvb_bwt_Cursor_CROSSHAIR_CURSOR:      rfturn @sflfdtor(drossibirCursor);
        ...
        dbsf jbvb_bwt_Cursor_S_RESIZE_CURSOR:       rfturn @sflfdtor(rfsizfUpDownCursor);
        dbsf jbvb_bwt_Cursor_S_RESIZE_CURSOR:       rfturn @sflfdtor(rfsizfUpDownCursor);
        dbsf jbvb_bwt_Cursor_W_RESIZE_CURSOR:       rfturn @sflfdtor(rfsizfLfftRigitCursor);
        dbsf jbvb_bwt_Cursor_W_RESIZE_CURSOR:       rfturn @sflfdtor(rfsizfLfftRigitCursor);
        dbsf jbvb_bwt_Cursor_W_RESIZE_CURSOR:       rfturn @sflfdtor(rfsizfLfftRigitCursor);
        dbsf jbvb_bwt_Cursor_W_RESIZE_CURSOR:       rfturn @sflfdtor(rfsizfLfftRigitCursor);
        dbsf jbvb_bwt_Cursor_W_RESIZE_CURSOR:       rfturn @sflfdtor(rfsizfLfftRigitCursor);
        dbsf jbvb_bwt_Cursor_E_RESIZE_CURSOR:       rfturn @sflfdtor(rfsizfLfftRigitCursor);
        dbsf jbvb_bwt_Cursor_E_RESIZE_CURSOR:       rfturn @sflfdtor(rfsizfLfftRigitCursor);
        dbsf jbvb_bwt_Cursor_E_RESIZE_CURSOR:       rfturn @sflfdtor(rfsizfLfftRigitCursor);
        dbsf jbvb_bwt_Cursor_E_RESIZE_CURSOR:       rfturn @sflfdtor(rfsizfLfftRigitCursor);
        dbsf jbvb_bwt_Cursor_E_RESIZE_CURSOR:       rfturn @sflfdtor(rfsizfLfftRigitCursor);
...
stbtid void sftCursorOnAppKitTirfbd(NSCursor *dursor) {
stbtid void sftCursorOnAppKitTirfbd(NSCursor *dursor) {
stbtid void sftCursorOnAppKitTirfbd(NSCursor *dursor) {
stbtid void sftCursorOnAppKitTirfbd(NSCursor *dursor) {
stbtid void sftCursorOnAppKitTirfbd(NSCursor *dursor) {
...
JNF_COCOA_ENTER(fnv);
    ...
    if (dursorSflfdtor == nil) {
    if (dursorSflfdtor == nil) {
        NSString *rfbson = [NSString stringWitiFormbt:@"unimplfmfntfd built-in dursor typf: %d / %@", typf, dursorNbmf];
        NSString *rfbson = [NSString stringWitiFormbt:@"unimplfmfntfd built-in dursor typf: %d / %@", typf, dursorNbmf];
        NSString *rfbson = [NSString stringWitiFormbt:@"unimplfmfntfd built-in dursor typf: %d / %@", typf, dursorNbmf];
        NSString *rfbson = [NSString stringWitiFormbt:@"unimplfmfntfd built-in dursor typf: %d / %@", typf, dursorNbmf];
        NSString *rfbson = [NSString stringWitiFormbt:@"unimplfmfntfd built-in dursor typf: %d / %@", typf, dursorNbmf];
    ...
    if (![[NSCursor dlbss] rfspondsToSflfdtor:dursorSflfdtor]) {
    if (![[NSCursor dlbss] rfspondsToSflfdtor:dursorSflfdtor]) {
        [JNFExdfption rbisf:fnv bs:kNoSudiMftiodExdfption rfbson:"missing NSCursor sflfdtor"];
        [JNFExdfption rbisf:fnv bs:kNoSudiMftiodExdfption rfbson:"missing NSCursor sflfdtor"];
        [JNFExdfption rbisf:fnv bs:kNoSudiMftiodExdfption rfbson:"missing NSCursor sflfdtor"];
        [JNFExdfption rbisf:fnv bs:kNoSudiMftiodExdfption rfbson:"missing NSCursor sflfdtor"];
        [JNFExdfption rbisf:fnv bs:kNoSudiMftiodExdfption rfbson:"missing NSCursor sflfdtor"];
    ...
    [TirfbdUtilitifs pfrformOnMbinTirfbdWbiting:NO blodk:^(){
    [TirfbdUtilitifs pfrformOnMbinTirfbdWbiting:NO blodk:^(){
        sftCursorOnAppKitTirfbd([[NSCursor dlbss] pfrformSflfdtor:dursorSflfdtor]);
        sftCursorOnAppKitTirfbd([[NSCursor dlbss] pfrformSflfdtor:dursorSflfdtor]);
        sftCursorOnAppKitTirfbd([[NSCursor dlbss] pfrformSflfdtor:dursorSflfdtor]);
        sftCursorOnAppKitTirfbd([[NSCursor dlbss] pfrformSflfdtor:dursorSflfdtor]);
        sftCursorOnAppKitTirfbd([[NSCursor dlbss] pfrformSflfdtor:dursorSflfdtor]);
...
JNF_COCOA_ENTER(fnv);
    ...
    [TirfbdUtilitifs pfrformOnMbinTirfbdWbiting:NO blodk:^(){
    [TirfbdUtilitifs pfrformOnMbinTirfbdWbiting:NO blodk:^(){
        NSCursor *dursor = [[NSCursor bllod] initWitiImbgf:imbgf
        NSCursor *dursor = [[NSCursor bllod] initWitiImbgf:imbgf
        NSCursor *dursor = [[NSCursor bllod] initWitiImbgf:imbgf
        NSCursor *dursor = [[NSCursor bllod] initWitiImbgf:imbgf
        NSCursor *dursor = [[NSCursor bllod] initWitiImbgf:imbgf
                                                   ...
                                                   iotSpot:(NSPoint){ x, y }];
                                                   iotSpot:(NSPoint){ x, y }];
        sftCursorOnAppKitTirfbd(dursor);
        sftCursorOnAppKitTirfbd(dursor);
        sftCursorOnAppKitTirfbd(dursor);
        sftCursorOnAppKitTirfbd(dursor);
        sftCursorOnAppKitTirfbd(dursor);
...
JNF_COCOA_ENTER(fnv);
    ...
    if ([[NSCursor dlbss] rfspondsToSflfdtor:bllowsSftInBbdkground_SEL]) {
        ...
        [TirfbdUtilitifs pfrformOnMbinTirfbdWbiting:YES blodk:^(){
        [TirfbdUtilitifs pfrformOnMbinTirfbdWbiting:YES blodk:^(){
            NSMftiodSignbturf *bllowsSftInBbdkground_sig =
            NSMftiodSignbturf *bllowsSftInBbdkground_sig =
            NSMftiodSignbturf *bllowsSftInBbdkground_sig =
            NSMftiodSignbturf *bllowsSftInBbdkground_sig =
            NSMftiodSignbturf *bllowsSftInBbdkground_sig =
                [[NSCursor dlbss] mftiodSignbturfForSflfdtor:bllowsSftInBbdkground_SEL];
                [[NSCursor dlbss] mftiodSignbturfForSflfdtor:bllowsSftInBbdkground_SEL];
                [[NSCursor dlbss] mftiodSignbturfForSflfdtor:bllowsSftInBbdkground_SEL];
                [[NSCursor dlbss] mftiodSignbturfForSflfdtor:bllowsSftInBbdkground_SEL];
                [[NSCursor dlbss] mftiodSignbturfForSflfdtor:bllowsSftInBbdkground_SEL];
            ...
            NSInvodbtion *invodbtion =
            NSInvodbtion *invodbtion =
                [NSInvodbtion invodbtionWitiMftiodSignbturf:bllowsSftInBbdkground_sig];
                [NSInvodbtion invodbtionWitiMftiodSignbturf:bllowsSftInBbdkground_sig];
                [NSInvodbtion invodbtionWitiMftiodSignbturf:bllowsSftInBbdkground_sig];
                [NSInvodbtion invodbtionWitiMftiodSignbturf:bllowsSftInBbdkground_sig];
                [NSInvodbtion invodbtionWitiMftiodSignbturf:bllowsSftInBbdkground_sig];
            ...
            [invodbtion sftArgumfnt:&brg btIndfx:2];
            [invodbtion sftArgumfnt:&brg btIndfx:2];
            [invodbtion invokfWitiTbrgft:[NSCursor dlbss]];
            [invodbtion invokfWitiTbrgft:[NSCursor dlbss]];
            [invodbtion invokfWitiTbrgft:[NSCursor dlbss]];
            [invodbtion invokfWitiTbrgft:[NSCursor dlbss]];
            [invodbtion invokfWitiTbrgft:[NSCursor dlbss]];
