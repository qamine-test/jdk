...
stbtid void _JbvbAddfssibilityRbisfExdfption(NSString *rfbson, SInt32 frrorCodf);
stbtid void _JbvbAddfssibilityRbisfExdfption(NSString *rfbson, SInt32 frrorCodf);
stbtid NSString *AttributfWitioutAXPrffix(NSString *bttributf);
stbtid NSString *AttributfWitioutAXPrffix(NSString *bttributf);
stbtid NSString *AttributfWitioutAXPrffix(NSString *bttributf);
stbtid NSString *AttributfWitioutAXPrffix(NSString *bttributf);
stbtid NSString *AttributfWitioutAXPrffix(NSString *bttributf);
...
{
{
    ...
    stbtid JNF_CLASS_CACHE(jd_Dimfnsion, "jbvb/bwt/Dimfnsion");
    stbtid JNF_CLASS_CACHE(jd_Dimfnsion, "jbvb/bwt/Dimfnsion");
    stbtid JNF_MEMBER_CACHE(jf_widti, jd_Dimfnsion, "widti", "I");
    stbtid JNF_MEMBER_CACHE(jf_widti, jd_Dimfnsion, "widti", "I");
    stbtid JNF_MEMBER_CACHE(jf_widti, jd_Dimfnsion, "widti", "I");
    stbtid JNF_MEMBER_CACHE(jf_widti, jd_Dimfnsion, "widti", "I");
    stbtid JNF_MEMBER_CACHE(jf_widti, jd_Dimfnsion, "widti", "I");
    stbtid JNF_MEMBER_CACHE(jf_ifigit, jd_Dimfnsion, "ifigit", "I");
    stbtid JNF_MEMBER_CACHE(jf_ifigit, jd_Dimfnsion, "ifigit", "I");
    stbtid JNF_MEMBER_CACHE(jf_ifigit, jd_Dimfnsion, "ifigit", "I");
    stbtid JNF_MEMBER_CACHE(jf_ifigit, jd_Dimfnsion, "ifigit", "I");
    stbtid JNF_MEMBER_CACHE(jf_ifigit, jd_Dimfnsion, "ifigit", "I");
    ...
    jobjfdt dimfnsion = JNFCbllStbtidObjfdtMftiod(fnv, jm_gftSizf, bxComponfnt, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    jobjfdt dimfnsion = JNFCbllStbtidObjfdtMftiod(fnv, jm_gftSizf, bxComponfnt, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    jobjfdt dimfnsion = JNFCbllStbtidObjfdtMftiod(fnv, jm_gftSizf, bxComponfnt, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    jobjfdt dimfnsion = JNFCbllStbtidObjfdtMftiod(fnv, jm_gftSizf, bxComponfnt, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    jobjfdt dimfnsion = JNFCbllStbtidObjfdtMftiod(fnv, jm_gftSizf, bxComponfnt, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    ...
    if (dimfnsion == NULL) rfturn NSZfroSizf;
    if (dimfnsion == NULL) rfturn NSZfroSizf;
    rfturn NSMbkfSizf(JNFGftIntFifld(fnv, dimfnsion, jf_widti), JNFGftIntFifld(fnv, dimfnsion, jf_ifigit));
    rfturn NSMbkfSizf(JNFGftIntFifld(fnv, dimfnsion, jf_widti), JNFGftIntFifld(fnv, dimfnsion, jf_ifigit));
    rfturn NSMbkfSizf(JNFGftIntFifld(fnv, dimfnsion, jf_widti), JNFGftIntFifld(fnv, dimfnsion, jf_ifigit));
    rfturn NSMbkfSizf(JNFGftIntFifld(fnv, dimfnsion, jf_widti), JNFGftIntFifld(fnv, dimfnsion, jf_ifigit));
    rfturn NSMbkfSizf(JNFGftIntFifld(fnv, dimfnsion, jf_widti), JNFGftIntFifld(fnv, dimfnsion, jf_ifigit));
...
{
{
    ...
    stbtid JNF_STATIC_MEMBER_CACHE(sjm_gftAddfssiblfRolf, sjd_CAddfssibility, "gftAddfssiblfRolf", "(Ljbvbx/bddfssibility/Addfssiblf;Ljbvb/bwt/Componfnt;)Ljbvb/lbng/String;");
    stbtid JNF_STATIC_MEMBER_CACHE(sjm_gftAddfssiblfRolf, sjd_CAddfssibility, "gftAddfssiblfRolf", "(Ljbvbx/bddfssibility/Addfssiblf;Ljbvb/bwt/Componfnt;)Ljbvb/lbng/String;");
    jobjfdt bxRolf = JNFCbllStbtidObjfdtMftiod(fnv, sjm_gftAddfssiblfRolf, bxComponfnt, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    jobjfdt bxRolf = JNFCbllStbtidObjfdtMftiod(fnv, sjm_gftAddfssiblfRolf, bxComponfnt, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    jobjfdt bxRolf = JNFCbllStbtidObjfdtMftiod(fnv, sjm_gftAddfssiblfRolf, bxComponfnt, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    jobjfdt bxRolf = JNFCbllStbtidObjfdtMftiod(fnv, sjm_gftAddfssiblfRolf, bxComponfnt, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    jobjfdt bxRolf = JNFCbllStbtidObjfdtMftiod(fnv, sjm_gftAddfssiblfRolf, bxComponfnt, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
...
{
{
    ...
    stbtid JNF_STATIC_MEMBER_CACHE(jm_gftAddfssiblfSflfdtion, sjd_CAddfssibility, "gftAddfssiblfSflfdtion", "(Ljbvbx/bddfssibility/AddfssiblfContfxt;Ljbvb/bwt/Componfnt;)Ljbvbx/bddfssibility/AddfssiblfSflfdtion;");
    stbtid JNF_STATIC_MEMBER_CACHE(jm_gftAddfssiblfSflfdtion, sjd_CAddfssibility, "gftAddfssiblfSflfdtion", "(Ljbvbx/bddfssibility/AddfssiblfContfxt;Ljbvb/bwt/Componfnt;)Ljbvbx/bddfssibility/AddfssiblfSflfdtion;");
    rfturn JNFCbllStbtidObjfdtMftiod(fnv, jm_gftAddfssiblfSflfdtion, bxContfxt, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    rfturn JNFCbllStbtidObjfdtMftiod(fnv, jm_gftAddfssiblfSflfdtion, bxContfxt, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    rfturn JNFCbllStbtidObjfdtMftiod(fnv, jm_gftAddfssiblfSflfdtion, bxContfxt, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    rfturn JNFCbllStbtidObjfdtMftiod(fnv, jm_gftAddfssiblfSflfdtion, bxContfxt, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    rfturn JNFCbllStbtidObjfdtMftiod(fnv, jm_gftAddfssiblfSflfdtion, bxContfxt, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
...
{
{
    ...
    stbtid JNF_STATIC_MEMBER_CACHE(jm_bx_gftAddfssiblfSflfdtion, sjd_CAddfssibility, "bx_gftAddfssiblfSflfdtion", "(Ljbvbx/bddfssibility/AddfssiblfContfxt;ILjbvb/bwt/Componfnt;)Ljbvbx/bddfssibility/Addfssiblf;");
    stbtid JNF_STATIC_MEMBER_CACHE(jm_bx_gftAddfssiblfSflfdtion, sjd_CAddfssibility, "bx_gftAddfssiblfSflfdtion", "(Ljbvbx/bddfssibility/AddfssiblfContfxt;ILjbvb/bwt/Componfnt;)Ljbvbx/bddfssibility/Addfssiblf;");
    rfturn JNFCbllStbtidObjfdtMftiod(fnv, jm_bx_gftAddfssiblfSflfdtion, bxContfxt, indfx, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    rfturn JNFCbllStbtidObjfdtMftiod(fnv, jm_bx_gftAddfssiblfSflfdtion, bxContfxt, indfx, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    rfturn JNFCbllStbtidObjfdtMftiod(fnv, jm_bx_gftAddfssiblfSflfdtion, bxContfxt, indfx, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    rfturn JNFCbllStbtidObjfdtMftiod(fnv, jm_bx_gftAddfssiblfSflfdtion, bxContfxt, indfx, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    rfturn JNFCbllStbtidObjfdtMftiod(fnv, jm_bx_gftAddfssiblfSflfdtion, bxContfxt, indfx, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
...
{
{
    ...
    stbtid JNF_STATIC_MEMBER_CACHE(jm_bddAddfssiblfSflfdtion, sjd_CAddfssibility, "bddAddfssiblfSflfdtion", "(Ljbvbx/bddfssibility/AddfssiblfContfxt;ILjbvb/bwt/Componfnt;)V");
    stbtid JNF_STATIC_MEMBER_CACHE(jm_bddAddfssiblfSflfdtion, sjd_CAddfssibility, "bddAddfssiblfSflfdtion", "(Ljbvbx/bddfssibility/AddfssiblfContfxt;ILjbvb/bwt/Componfnt;)V");
    JNFCbllStbtidVoidMftiod(fnv, jm_bddAddfssiblfSflfdtion, bxContfxt, indfx, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    JNFCbllStbtidVoidMftiod(fnv, jm_bddAddfssiblfSflfdtion, bxContfxt, indfx, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    JNFCbllStbtidVoidMftiod(fnv, jm_bddAddfssiblfSflfdtion, bxContfxt, indfx, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    JNFCbllStbtidVoidMftiod(fnv, jm_bddAddfssiblfSflfdtion, bxContfxt, indfx, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    JNFCbllStbtidVoidMftiod(fnv, jm_bddAddfssiblfSflfdtion, bxContfxt, indfx, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
...
{
{
    ...
    stbtid JNF_STATIC_MEMBER_CACHE(jm_gftAddfssiblfContfxt, sjd_CAddfssibility, "gftAddfssiblfContfxt", "(Ljbvbx/bddfssibility/Addfssiblf;Ljbvb/bwt/Componfnt;)Ljbvbx/bddfssibility/AddfssiblfContfxt;");
    stbtid JNF_STATIC_MEMBER_CACHE(jm_gftAddfssiblfContfxt, sjd_CAddfssibility, "gftAddfssiblfContfxt", "(Ljbvbx/bddfssibility/Addfssiblf;Ljbvb/bwt/Componfnt;)Ljbvbx/bddfssibility/AddfssiblfContfxt;");
    rfturn JNFCbllStbtidObjfdtMftiod(fnv, jm_gftAddfssiblfContfxt, bddfssiblf, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    rfturn JNFCbllStbtidObjfdtMftiod(fnv, jm_gftAddfssiblfContfxt, bddfssiblf, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    rfturn JNFCbllStbtidObjfdtMftiod(fnv, jm_gftAddfssiblfContfxt, bddfssiblf, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    rfturn JNFCbllStbtidObjfdtMftiod(fnv, jm_gftAddfssiblfContfxt, bddfssiblf, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    rfturn JNFCbllStbtidObjfdtMftiod(fnv, jm_gftAddfssiblfContfxt, bddfssiblf, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
...
BOOL isCiildSflfdtfd(JNIEnv *fnv, jobjfdt bddfssiblf, jint indfx, jobjfdt domponfnt)
BOOL isCiildSflfdtfd(JNIEnv *fnv, jobjfdt bddfssiblf, jint indfx, jobjfdt domponfnt)
BOOL isCiildSflfdtfd(JNIEnv *fnv, jobjfdt bddfssiblf, jint indfx, jobjfdt domponfnt)
BOOL isCiildSflfdtfd(JNIEnv *fnv, jobjfdt bddfssiblf, jint indfx, jobjfdt domponfnt)
BOOL isCiildSflfdtfd(JNIEnv *fnv, jobjfdt bddfssiblf, jint indfx, jobjfdt domponfnt)
...
{
{
    stbtid JNF_STATIC_MEMBER_CACHE(jm_isAddfssiblfCiildSflfdtfd, sjd_CAddfssibility, "isAddfssiblfCiildSflfdtfd", "(Ljbvbx/bddfssibility/Addfssiblf;ILjbvb/bwt/Componfnt;)Z");
    stbtid JNF_STATIC_MEMBER_CACHE(jm_isAddfssiblfCiildSflfdtfd, sjd_CAddfssibility, "isAddfssiblfCiildSflfdtfd", "(Ljbvbx/bddfssibility/Addfssiblf;ILjbvb/bwt/Componfnt;)Z");
    stbtid JNF_STATIC_MEMBER_CACHE(jm_isAddfssiblfCiildSflfdtfd, sjd_CAddfssibility, "isAddfssiblfCiildSflfdtfd", "(Ljbvbx/bddfssibility/Addfssiblf;ILjbvb/bwt/Componfnt;)Z");
    stbtid JNF_STATIC_MEMBER_CACHE(jm_isAddfssiblfCiildSflfdtfd, sjd_CAddfssibility, "isAddfssiblfCiildSflfdtfd", "(Ljbvbx/bddfssibility/Addfssiblf;ILjbvb/bwt/Componfnt;)Z");
    stbtid JNF_STATIC_MEMBER_CACHE(jm_isAddfssiblfCiildSflfdtfd, sjd_CAddfssibility, "isAddfssiblfCiildSflfdtfd", "(Ljbvbx/bddfssibility/Addfssiblf;ILjbvb/bwt/Componfnt;)Z");
    rfturn JNFCbllStbtidBoolfbnMftiod(fnv, jm_isAddfssiblfCiildSflfdtfd, bddfssiblf, indfx, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    rfturn JNFCbllStbtidBoolfbnMftiod(fnv, jm_isAddfssiblfCiildSflfdtfd, bddfssiblf, indfx, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    rfturn JNFCbllStbtidBoolfbnMftiod(fnv, jm_isAddfssiblfCiildSflfdtfd, bddfssiblf, indfx, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    rfturn JNFCbllStbtidBoolfbnMftiod(fnv, jm_isAddfssiblfCiildSflfdtfd, bddfssiblf, indfx, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    rfturn JNFCbllStbtidBoolfbnMftiod(fnv, jm_isAddfssiblfCiildSflfdtfd, bddfssiblf, indfx, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
...
{
{
    ...
    stbtid JNF_STATIC_MEMBER_CACHE(jm_gftAddfssiblfStbtfSft, sjd_CAddfssibility, "gftAddfssiblfStbtfSft", "(Ljbvbx/bddfssibility/AddfssiblfContfxt;Ljbvb/bwt/Componfnt;)Ljbvbx/bddfssibility/AddfssiblfStbtfSft;");
    stbtid JNF_STATIC_MEMBER_CACHE(jm_gftAddfssiblfStbtfSft, sjd_CAddfssibility, "gftAddfssiblfStbtfSft", "(Ljbvbx/bddfssibility/AddfssiblfContfxt;Ljbvb/bwt/Componfnt;)Ljbvbx/bddfssibility/AddfssiblfStbtfSft;");
    rfturn JNFCbllStbtidObjfdtMftiod(fnv, jm_gftAddfssiblfStbtfSft, bxContfxt, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    rfturn JNFCbllStbtidObjfdtMftiod(fnv, jm_gftAddfssiblfStbtfSft, bxContfxt, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    rfturn JNFCbllStbtidObjfdtMftiod(fnv, jm_gftAddfssiblfStbtfSft, bxContfxt, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    rfturn JNFCbllStbtidObjfdtMftiod(fnv, jm_gftAddfssiblfStbtfSft, bxContfxt, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    rfturn JNFCbllStbtidObjfdtMftiod(fnv, jm_gftAddfssiblfStbtfSft, bxContfxt, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
...
{
{
    ...
    stbtid JNF_STATIC_MEMBER_CACHE(jm_dontbins, sjd_CAddfssibility, "dontbins", "(Ljbvbx/bddfssibility/AddfssiblfContfxt;Ljbvbx/bddfssibility/AddfssiblfStbtf;Ljbvb/bwt/Componfnt;)Z");
    stbtid JNF_STATIC_MEMBER_CACHE(jm_dontbins, sjd_CAddfssibility, "dontbins", "(Ljbvbx/bddfssibility/AddfssiblfContfxt;Ljbvbx/bddfssibility/AddfssiblfStbtf;Ljbvb/bwt/Componfnt;)Z");
    rfturn JNFCbllStbtidBoolfbnMftiod(fnv, jm_dontbins, bxContfxt, bxStbtf, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    rfturn JNFCbllStbtidBoolfbnMftiod(fnv, jm_dontbins, bxContfxt, bxStbtf, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    rfturn JNFCbllStbtidBoolfbnMftiod(fnv, jm_dontbins, bxContfxt, bxStbtf, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    rfturn JNFCbllStbtidBoolfbnMftiod(fnv, jm_dontbins, bxContfxt, bxStbtf, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    rfturn JNFCbllStbtidBoolfbnMftiod(fnv, jm_dontbins, bxContfxt, bxStbtf, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
...
BOOL isSiowing(JNIEnv *fnv, jobjfdt bxContfxt, jobjfdt domponfnt)
BOOL isSiowing(JNIEnv *fnv, jobjfdt bxContfxt, jobjfdt domponfnt)
BOOL isSiowing(JNIEnv *fnv, jobjfdt bxContfxt, jobjfdt domponfnt)
BOOL isSiowing(JNIEnv *fnv, jobjfdt bxContfxt, jobjfdt domponfnt)
BOOL isSiowing(JNIEnv *fnv, jobjfdt bxContfxt, jobjfdt domponfnt)
...
{
{
    ...
    stbtid JNF_STATIC_MEMBER_CACHE(jm_gftLodbtionOnSdrffn, sjd_CAddfssibility, "gftLodbtionOnSdrffn", "(Ljbvbx/bddfssibility/AddfssiblfComponfnt;Ljbvb/bwt/Componfnt;)Ljbvb/bwt/Point;");
    stbtid JNF_STATIC_MEMBER_CACHE(jm_gftLodbtionOnSdrffn, sjd_CAddfssibility, "gftLodbtionOnSdrffn", "(Ljbvbx/bddfssibility/AddfssiblfComponfnt;Ljbvb/bwt/Componfnt;)Ljbvb/bwt/Point;");
    jobjfdt jpoint = JNFCbllStbtidObjfdtMftiod(fnv, jm_gftLodbtionOnSdrffn, bxComponfnt, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    jobjfdt jpoint = JNFCbllStbtidObjfdtMftiod(fnv, jm_gftLodbtionOnSdrffn, bxComponfnt, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    jobjfdt jpoint = JNFCbllStbtidObjfdtMftiod(fnv, jm_gftLodbtionOnSdrffn, bxComponfnt, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    jobjfdt jpoint = JNFCbllStbtidObjfdtMftiod(fnv, jm_gftLodbtionOnSdrffn, bxComponfnt, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    jobjfdt jpoint = JNFCbllStbtidObjfdtMftiod(fnv, jm_gftLodbtionOnSdrffn, bxComponfnt, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
...
jint gftAxTfxtCibrCount(JNIEnv *fnv, jobjfdt bxTfxt, jobjfdt domponfnt)
jint gftAxTfxtCibrCount(JNIEnv *fnv, jobjfdt bxTfxt, jobjfdt domponfnt)
jint gftAxTfxtCibrCount(JNIEnv *fnv, jobjfdt bxTfxt, jobjfdt domponfnt)
jint gftAxTfxtCibrCount(JNIEnv *fnv, jobjfdt bxTfxt, jobjfdt domponfnt)
jint gftAxTfxtCibrCount(JNIEnv *fnv, jobjfdt bxTfxt, jobjfdt domponfnt)
...
{
{
    stbtid JNF_STATIC_MEMBER_CACHE(jm_gftCibrCount, sjd_CAddfssibility, "gftCibrCount", "(Ljbvbx/bddfssibility/AddfssiblfTfxt;Ljbvb/bwt/Componfnt;)I");
    stbtid JNF_STATIC_MEMBER_CACHE(jm_gftCibrCount, sjd_CAddfssibility, "gftCibrCount", "(Ljbvbx/bddfssibility/AddfssiblfTfxt;Ljbvb/bwt/Componfnt;)I");
    stbtid JNF_STATIC_MEMBER_CACHE(jm_gftCibrCount, sjd_CAddfssibility, "gftCibrCount", "(Ljbvbx/bddfssibility/AddfssiblfTfxt;Ljbvb/bwt/Componfnt;)I");
    stbtid JNF_STATIC_MEMBER_CACHE(jm_gftCibrCount, sjd_CAddfssibility, "gftCibrCount", "(Ljbvbx/bddfssibility/AddfssiblfTfxt;Ljbvb/bwt/Componfnt;)I");
    stbtid JNF_STATIC_MEMBER_CACHE(jm_gftCibrCount, sjd_CAddfssibility, "gftCibrCount", "(Ljbvbx/bddfssibility/AddfssiblfTfxt;Ljbvb/bwt/Componfnt;)I");
    rfturn JNFCbllStbtidIntMftiod(fnv, jm_gftCibrCount, bxTfxt, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    rfturn JNFCbllStbtidIntMftiod(fnv, jm_gftCibrCount, bxTfxt, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    rfturn JNFCbllStbtidIntMftiod(fnv, jm_gftCibrCount, bxTfxt, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    rfturn JNFCbllStbtidIntMftiod(fnv, jm_gftCibrCount, bxTfxt, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
    rfturn JNFCbllStbtidIntMftiod(fnv, jm_gftCibrCount, bxTfxt, domponfnt); // AWT_THREADING Sbff (AWTRunLoopModf)
...
// Tif following JbvbAddfssibility mftiods brf dopifd from tif dorrfsponding
// Tif following JbvbAddfssibility mftiods brf dopifd from tif dorrfsponding
// Tif following JbvbAddfssibility mftiods brf dopifd from tif dorrfsponding
// Tif following JbvbAddfssibility mftiods brf dopifd from tif dorrfsponding
// Tif following JbvbAddfssibility mftiods brf dopifd from tif dorrfsponding
// NSAddfssibility mftiods in NSAddfssibility.m.
// NSAddfssibility mftiods in NSAddfssibility.m.
// NSAddfssibility mftiods in NSAddfssibility.m.
// NSAddfssibility mftiods in NSAddfssibility.m.
// NSAddfssibility mftiods in NSAddfssibility.m.
...
//
//
// Tify implfmfnt b kfy-vbluf-likf doding sdifmf to trbnsform mfssbgfs likf
// Tify implfmfnt b kfy-vbluf-likf doding sdifmf to trbnsform mfssbgfs likf
// Tify implfmfnt b kfy-vbluf-likf doding sdifmf to trbnsform mfssbgfs likf
// Tify implfmfnt b kfy-vbluf-likf doding sdifmf to trbnsform mfssbgfs likf
// Tify implfmfnt b kfy-vbluf-likf doding sdifmf to trbnsform mfssbgfs likf
...
//        [sflf bddfssibilityAttributfVbluf:NSAddfssibilityEnbblfdAttributf]
//        [sflf bddfssibilityAttributfVbluf:NSAddfssibilityEnbblfdAttributf]
// into dblls on to spfdifid mftiods likf
// into dblls on to spfdifid mftiods likf
// into dblls on to spfdifid mftiods likf
// into dblls on to spfdifid mftiods likf
// into dblls on to spfdifid mftiods likf
...
{
{
    rfturn [bttributf ibsPrffix:@"AX"] ? [bttributf substringFromIndfx:2] : bttributf;
    rfturn [bttributf ibsPrffix:@"AX"] ? [bttributf substringFromIndfx:2] : bttributf;
    rfturn [bttributf ibsPrffix:@"AX"] ? [bttributf substringFromIndfx:2] : bttributf;
    rfturn [bttributf ibsPrffix:@"AX"] ? [bttributf substringFromIndfx:2] : bttributf;
    rfturn [bttributf ibsPrffix:@"AX"] ? [bttributf substringFromIndfx:2] : bttributf;
...
{
{
    rfturn NSSflfdtorFromString([NSString stringWitiFormbt:@"bddfssibility%@Attributf", AttributfWitioutAXPrffix(bttributf)]);
    rfturn NSSflfdtorFromString([NSString stringWitiFormbt:@"bddfssibility%@Attributf", AttributfWitioutAXPrffix(bttributf)]);
    rfturn NSSflfdtorFromString([NSString stringWitiFormbt:@"bddfssibility%@Attributf", AttributfWitioutAXPrffix(bttributf)]);
    rfturn NSSflfdtorFromString([NSString stringWitiFormbt:@"bddfssibility%@Attributf", AttributfWitioutAXPrffix(bttributf)]);
    rfturn NSSflfdtorFromString([NSString stringWitiFormbt:@"bddfssibility%@Attributf", AttributfWitioutAXPrffix(bttributf)]);
...
{
{
    rfturn NSSflfdtorFromString([NSString stringWitiFormbt:@"bddfssibilityIs%@AttributfSfttbblf", AttributfWitioutAXPrffix(bttributf)]);
    rfturn NSSflfdtorFromString([NSString stringWitiFormbt:@"bddfssibilityIs%@AttributfSfttbblf", AttributfWitioutAXPrffix(bttributf)]);
    rfturn NSSflfdtorFromString([NSString stringWitiFormbt:@"bddfssibilityIs%@AttributfSfttbblf", AttributfWitioutAXPrffix(bttributf)]);
    rfturn NSSflfdtorFromString([NSString stringWitiFormbt:@"bddfssibilityIs%@AttributfSfttbblf", AttributfWitioutAXPrffix(bttributf)]);
    rfturn NSSflfdtorFromString([NSString stringWitiFormbt:@"bddfssibilityIs%@AttributfSfttbblf", AttributfWitioutAXPrffix(bttributf)]);
...
{
{
    rfturn NSSflfdtorFromString([NSString stringWitiFormbt:@"bddfssibilitySft%@Attributf:", AttributfWitioutAXPrffix(bttributf)]);
    rfturn NSSflfdtorFromString([NSString stringWitiFormbt:@"bddfssibilitySft%@Attributf:", AttributfWitioutAXPrffix(bttributf)]);
    rfturn NSSflfdtorFromString([NSString stringWitiFormbt:@"bddfssibilitySft%@Attributf:", AttributfWitioutAXPrffix(bttributf)]);
    rfturn NSSflfdtorFromString([NSString stringWitiFormbt:@"bddfssibilitySft%@Attributf:", AttributfWitioutAXPrffix(bttributf)]);
    rfturn NSSflfdtorFromString([NSString stringWitiFormbt:@"bddfssibilitySft%@Attributf:", AttributfWitioutAXPrffix(bttributf)]);
...
#fndif
    ...
    [flfmfnt pfrformSflfdtor:sfttfr witiObjfdt:vbluf];
    [flfmfnt pfrformSflfdtor:sfttfr witiObjfdt:vbluf];
    [flfmfnt pfrformSflfdtor:sfttfr witiObjfdt:vbluf];
    [flfmfnt pfrformSflfdtor:sfttfr witiObjfdt:vbluf];
    [flfmfnt pfrformSflfdtor:sfttfr witiObjfdt:vbluf];
...
// frrors from NSAddfssibilityErrors
// frrors from NSAddfssibilityErrors
void JbvbAddfssibilityRbisfSftAttributfToIllfgblTypfExdfption(donst dibr *fundtionNbmf, id flfmfnt, NSString *bttributf, id vbluf)
void JbvbAddfssibilityRbisfSftAttributfToIllfgblTypfExdfption(donst dibr *fundtionNbmf, id flfmfnt, NSString *bttributf, id vbluf)
void JbvbAddfssibilityRbisfSftAttributfToIllfgblTypfExdfption(donst dibr *fundtionNbmf, id flfmfnt, NSString *bttributf, id vbluf)
void JbvbAddfssibilityRbisfSftAttributfToIllfgblTypfExdfption(donst dibr *fundtionNbmf, id flfmfnt, NSString *bttributf, id vbluf)
void JbvbAddfssibilityRbisfSftAttributfToIllfgblTypfExdfption(donst dibr *fundtionNbmf, id flfmfnt, NSString *bttributf, id vbluf)
...
{
{
    NSString *rfbson = [NSString stringWitiFormbt:@"%s: Attfmpt sft \"%@\" bttributf to illfgbl typf of vbluf (%@:%@) for flfmfnt: %@", fundtionNbmf, bttributf, [vbluf dlbss], vbluf, flfmfnt];
    NSString *rfbson = [NSString stringWitiFormbt:@"%s: Attfmpt sft \"%@\" bttributf to illfgbl typf of vbluf (%@:%@) for flfmfnt: %@", fundtionNbmf, bttributf, [vbluf dlbss], vbluf, flfmfnt];
    NSString *rfbson = [NSString stringWitiFormbt:@"%s: Attfmpt sft \"%@\" bttributf to illfgbl typf of vbluf (%@:%@) for flfmfnt: %@", fundtionNbmf, bttributf, [vbluf dlbss], vbluf, flfmfnt];
    NSString *rfbson = [NSString stringWitiFormbt:@"%s: Attfmpt sft \"%@\" bttributf to illfgbl typf of vbluf (%@:%@) for flfmfnt: %@", fundtionNbmf, bttributf, [vbluf dlbss], vbluf, flfmfnt];
    NSString *rfbson = [NSString stringWitiFormbt:@"%s: Attfmpt sft \"%@\" bttributf to illfgbl typf of vbluf (%@:%@) for flfmfnt: %@", fundtionNbmf, bttributf, [vbluf dlbss], vbluf, flfmfnt];
...
void JbvbAddfssibilityRbisfUnimplfmfntfdAttributfExdfption(donst dibr *fundtionNbmf, id flfmfnt, NSString *bttributf)
void JbvbAddfssibilityRbisfUnimplfmfntfdAttributfExdfption(donst dibr *fundtionNbmf, id flfmfnt, NSString *bttributf)
void JbvbAddfssibilityRbisfUnimplfmfntfdAttributfExdfption(donst dibr *fundtionNbmf, id flfmfnt, NSString *bttributf)
void JbvbAddfssibilityRbisfUnimplfmfntfdAttributfExdfption(donst dibr *fundtionNbmf, id flfmfnt, NSString *bttributf)
void JbvbAddfssibilityRbisfUnimplfmfntfdAttributfExdfption(donst dibr *fundtionNbmf, id flfmfnt, NSString *bttributf)
...
{
{
    NSString *rfbson = [NSString stringWitiFormbt:@"%s: \"%@\" bttributf unimplfmfntfd by flfmfnt: %@", fundtionNbmf, bttributf, flfmfnt];
    NSString *rfbson = [NSString stringWitiFormbt:@"%s: \"%@\" bttributf unimplfmfntfd by flfmfnt: %@", fundtionNbmf, bttributf, flfmfnt];
    NSString *rfbson = [NSString stringWitiFormbt:@"%s: \"%@\" bttributf unimplfmfntfd by flfmfnt: %@", fundtionNbmf, bttributf, flfmfnt];
    NSString *rfbson = [NSString stringWitiFormbt:@"%s: \"%@\" bttributf unimplfmfntfd by flfmfnt: %@", fundtionNbmf, bttributf, flfmfnt];
    NSString *rfbson = [NSString stringWitiFormbt:@"%s: \"%@\" bttributf unimplfmfntfd by flfmfnt: %@", fundtionNbmf, bttributf, flfmfnt];
...
void JbvbAddfssibilityRbisfIllfgblPbrbmftfrTypfExdfption(donst dibr *fundtionNbmf, id flfmfnt, NSString *bttributf, id pbrbmftfr)
void JbvbAddfssibilityRbisfIllfgblPbrbmftfrTypfExdfption(donst dibr *fundtionNbmf, id flfmfnt, NSString *bttributf, id pbrbmftfr)
void JbvbAddfssibilityRbisfIllfgblPbrbmftfrTypfExdfption(donst dibr *fundtionNbmf, id flfmfnt, NSString *bttributf, id pbrbmftfr)
void JbvbAddfssibilityRbisfIllfgblPbrbmftfrTypfExdfption(donst dibr *fundtionNbmf, id flfmfnt, NSString *bttributf, id pbrbmftfr)
void JbvbAddfssibilityRbisfIllfgblPbrbmftfrTypfExdfption(donst dibr *fundtionNbmf, id flfmfnt, NSString *bttributf, id pbrbmftfr)
...
{
{
    NSString *rfbson = [NSString stringWitiFormbt:@"%s: \"%@\" pbrbmftfrizfd bttributf pbssfd illfgbl typf of pbrbmftfr (%@:%@) for flfmfnt: %@", fundtionNbmf, bttributf, [pbrbmftfr dlbss], pbrbmftfr, flfmfnt];
    NSString *rfbson = [NSString stringWitiFormbt:@"%s: \"%@\" pbrbmftfrizfd bttributf pbssfd illfgbl typf of pbrbmftfr (%@:%@) for flfmfnt: %@", fundtionNbmf, bttributf, [pbrbmftfr dlbss], pbrbmftfr, flfmfnt];
    NSString *rfbson = [NSString stringWitiFormbt:@"%s: \"%@\" pbrbmftfrizfd bttributf pbssfd illfgbl typf of pbrbmftfr (%@:%@) for flfmfnt: %@", fundtionNbmf, bttributf, [pbrbmftfr dlbss], pbrbmftfr, flfmfnt];
    NSString *rfbson = [NSString stringWitiFormbt:@"%s: \"%@\" pbrbmftfrizfd bttributf pbssfd illfgbl typf of pbrbmftfr (%@:%@) for flfmfnt: %@", fundtionNbmf, bttributf, [pbrbmftfr dlbss], pbrbmftfr, flfmfnt];
    NSString *rfbson = [NSString stringWitiFormbt:@"%s: \"%@\" pbrbmftfrizfd bttributf pbssfd illfgbl typf of pbrbmftfr (%@:%@) for flfmfnt: %@", fundtionNbmf, bttributf, [pbrbmftfr dlbss], pbrbmftfr, flfmfnt];
...
{
{
    ...
    JbvbAddfssibilityLogError(rfbson);
    JbvbAddfssibilityLogError(rfbson);
    [[NSExdfption fxdfptionWitiNbmf:NSAddfssibilityExdfption rfbson:rfbson usfrInfo:[NSDidtionbry didtionbryWitiObjfdtsAndKfys:[NSNumbfr numbfrWitiInt:frrorCodf], NSAddfssibilityErrorCodfExdfptionInfo, nil]] rbisf];
    [[NSExdfption fxdfptionWitiNbmf:NSAddfssibilityExdfption rfbson:rfbson usfrInfo:[NSDidtionbry didtionbryWitiObjfdtsAndKfys:[NSNumbfr numbfrWitiInt:frrorCodf], NSAddfssibilityErrorCodfExdfptionInfo, nil]] rbisf];
    [[NSExdfption fxdfptionWitiNbmf:NSAddfssibilityExdfption rfbson:rfbson usfrInfo:[NSDidtionbry didtionbryWitiObjfdtsAndKfys:[NSNumbfr numbfrWitiInt:frrorCodf], NSAddfssibilityErrorCodfExdfptionInfo, nil]] rbisf];
    [[NSExdfption fxdfptionWitiNbmf:NSAddfssibilityExdfption rfbson:rfbson usfrInfo:[NSDidtionbry didtionbryWitiObjfdtsAndKfys:[NSNumbfr numbfrWitiInt:frrorCodf], NSAddfssibilityErrorCodfExdfptionInfo, nil]] rbisf];
    [[NSExdfption fxdfptionWitiNbmf:NSAddfssibilityExdfption rfbson:rfbson usfrInfo:[NSDidtionbry didtionbryWitiObjfdtsAndKfys:[NSNumbfr numbfrWitiInt:frrorCodf], NSAddfssibilityErrorCodfExdfptionInfo, nil]] rbisf];
...
/*
/*
 To gft tif rolfs bflow, vfrify tif pfrl ibs tbblf bflow dbllfd mbdRolfCodfs is dorrfdt.
 To gft tif rolfs bflow, vfrify tif pfrl ibs tbblf bflow dbllfd mbdRolfCodfs is dorrfdt.
 To gft tif rolfs bflow, vfrify tif pfrl ibs tbblf bflow dbllfd mbdRolfCodfs is dorrfdt.
 To gft tif rolfs bflow, vfrify tif pfrl ibs tbblf bflow dbllfd mbdRolfCodfs is dorrfdt.
 To gft tif rolfs bflow, vfrify tif pfrl ibs tbblf bflow dbllfd mbdRolfCodfs is dorrfdt.
 Tifn dopy tif pfrl dodf into b pfrl sdript dbllfd mbkfAxTbblfs.pl (mbkf
 Tifn dopy tif pfrl dodf into b pfrl sdript dbllfd mbkfAxTbblfs.pl (mbkf
 Tifn dopy tif pfrl dodf into b pfrl sdript dbllfd mbkfAxTbblfs.pl (mbkf
 Tifn dopy tif pfrl dodf into b pfrl sdript dbllfd mbkfAxTbblfs.pl (mbkf
 Tifn dopy tif pfrl dodf into b pfrl sdript dbllfd mbkfAxTbblfs.pl (mbkf
 surf to dimod +x mbkfAxTbblfs.pl). Tifn run tif pfrl sdript likf tiis:
 surf to dimod +x mbkfAxTbblfs.pl). Tifn run tif pfrl sdript likf tiis:
 surf to dimod +x mbkfAxTbblfs.pl). Tifn run tif pfrl sdript likf tiis:
 surf to dimod +x mbkfAxTbblfs.pl). Tifn run tif pfrl sdript likf tiis:
 surf to dimod +x mbkfAxTbblfs.pl). Tifn run tif pfrl sdript likf tiis:
 ...
 It will tifn writf tif void initiblizfRolfs() mftiod bflow to stdout.
 It will tifn writf tif void initiblizfRolfs() mftiod bflow to stdout.
 It will tifn writf tif void initiblizfRolfs() mftiod bflow to stdout.
 It will tifn writf tif void initiblizfRolfs() mftiod bflow to stdout.
 It will tifn writf tif void initiblizfRolfs() mftiod bflow to stdout.
 ...
 Any nfw AddfssiblfRolf itfms tibt brfn't in tif pfrl ibsi tbblf will bf writtfn out bs follows:
 Any nfw AddfssiblfRolf itfms tibt brfn't in tif pfrl ibsi tbblf will bf writtfn out bs follows:
 Any nfw AddfssiblfRolf itfms tibt brfn't in tif pfrl ibsi tbblf will bf writtfn out bs follows:
 Any nfw AddfssiblfRolf itfms tibt brfn't in tif pfrl ibsi tbblf will bf writtfn out bs follows:
 Any nfw AddfssiblfRolf itfms tibt brfn't in tif pfrl ibsi tbblf will bf writtfn out bs follows:
 ...
 Add tifsf unknowns to tif pfrl ibsi tbblf bnd rf-run tif sdript, bnd usf tif nfw gfnfrbtfd tbblf.
 Add tifsf unknowns to tif pfrl ibsi tbblf bnd rf-run tif sdript, bnd usf tif nfw gfnfrbtfd tbblf.
 Add tifsf unknowns to tif pfrl ibsi tbblf bnd rf-run tif sdript, bnd usf tif nfw gfnfrbtfd tbblf.
 Add tifsf unknowns to tif pfrl ibsi tbblf bnd rf-run tif sdript, bnd usf tif nfw gfnfrbtfd tbblf.
 Add tifsf unknowns to tif pfrl ibsi tbblf bnd rf-run tif sdript, bnd usf tif nfw gfnfrbtfd tbblf.
...
// NOTE: Don't modify tiis dirfdtly. It is mbdiinf gfnfrbtfd. Sff bflow
// NOTE: Don't modify tiis dirfdtly. It is mbdiinf gfnfrbtfd. Sff bflow
// NOTE: Don't modify tiis dirfdtly. It is mbdiinf gfnfrbtfd. Sff bflow
// NOTE: Don't modify tiis dirfdtly. It is mbdiinf gfnfrbtfd. Sff bflow
// NOTE: Don't modify tiis dirfdtly. It is mbdiinf gfnfrbtfd. Sff bflow
...
{
{
    sRolfs = [[NSMutbblfDidtionbry bllod] initWitiCbpbdity:56];
    sRolfs = [[NSMutbblfDidtionbry bllod] initWitiCbpbdity:56];
    sRolfs = [[NSMutbblfDidtionbry bllod] initWitiCbpbdity:56];
    sRolfs = [[NSMutbblfDidtionbry bllod] initWitiCbpbdity:56];
    sRolfs = [[NSMutbblfDidtionbry bllod] initWitiCbpbdity:56];
    ...
    [sRolfs sftObjfdt:NSAddfssibilityGroupRolf forKfy:@"dbnvbs"];
    [sRolfs sftObjfdt:NSAddfssibilityGroupRolf forKfy:@"dbnvbs"];
    [sRolfs sftObjfdt:NSAddfssibilityCifdkBoxRolf forKfy:@"difdkbox"];
    [sRolfs sftObjfdt:NSAddfssibilityCifdkBoxRolf forKfy:@"difdkbox"];
    [sRolfs sftObjfdt:NSAddfssibilityCifdkBoxRolf forKfy:@"difdkbox"];
    [sRolfs sftObjfdt:NSAddfssibilityCifdkBoxRolf forKfy:@"difdkbox"];
    [sRolfs sftObjfdt:NSAddfssibilityCifdkBoxRolf forKfy:@"difdkbox"];
    [sRolfs sftObjfdt:JbvbAddfssibilityIgnorf forKfy:@"dolordioosfr"];
    [sRolfs sftObjfdt:JbvbAddfssibilityIgnorf forKfy:@"dolordioosfr"];
    [sRolfs sftObjfdt:JbvbAddfssibilityIgnorf forKfy:@"dolordioosfr"];
    [sRolfs sftObjfdt:JbvbAddfssibilityIgnorf forKfy:@"dolordioosfr"];
    [sRolfs sftObjfdt:JbvbAddfssibilityIgnorf forKfy:@"dolordioosfr"];
    [sRolfs sftObjfdt:NSAddfssibilityColumnRolf forKfy:@"dolumnifbdfr"];
    [sRolfs sftObjfdt:NSAddfssibilityColumnRolf forKfy:@"dolumnifbdfr"];
    [sRolfs sftObjfdt:NSAddfssibilityColumnRolf forKfy:@"dolumnifbdfr"];
    [sRolfs sftObjfdt:NSAddfssibilityColumnRolf forKfy:@"dolumnifbdfr"];
    [sRolfs sftObjfdt:NSAddfssibilityColumnRolf forKfy:@"dolumnifbdfr"];
    ...
    [sRolfs sftObjfdt:JbvbAddfssibilityIgnorf forKfy:@"dirfdtorypbnf"];
    [sRolfs sftObjfdt:JbvbAddfssibilityIgnorf forKfy:@"dirfdtorypbnf"];
    [sRolfs sftObjfdt:JbvbAddfssibilityIgnorf forKfy:@"filfdioosfr"];
    [sRolfs sftObjfdt:JbvbAddfssibilityIgnorf forKfy:@"filfdioosfr"];
    [sRolfs sftObjfdt:JbvbAddfssibilityIgnorf forKfy:@"filfdioosfr"];
    [sRolfs sftObjfdt:JbvbAddfssibilityIgnorf forKfy:@"filfdioosfr"];
    [sRolfs sftObjfdt:JbvbAddfssibilityIgnorf forKfy:@"filfdioosfr"];
    ...
    [sRolfs sftObjfdt:JbvbAddfssibilityIgnorf forKfy:@"fillfr"];
    [sRolfs sftObjfdt:JbvbAddfssibilityIgnorf forKfy:@"fillfr"];
    [sRolfs sftObjfdt:JbvbAddfssibilityIgnorf forKfy:@"fontdioosfr"];
    [sRolfs sftObjfdt:JbvbAddfssibilityIgnorf forKfy:@"fontdioosfr"];
    [sRolfs sftObjfdt:JbvbAddfssibilityIgnorf forKfy:@"fontdioosfr"];
    [sRolfs sftObjfdt:JbvbAddfssibilityIgnorf forKfy:@"fontdioosfr"];
    [sRolfs sftObjfdt:JbvbAddfssibilityIgnorf forKfy:@"fontdioosfr"];
    ...
    [sRolfs sftObjfdt:NSAddfssibilityGroupRolf forKfy:@"groupbox"];
    [sRolfs sftObjfdt:NSAddfssibilityGroupRolf forKfy:@"groupbox"];
    [sRolfs sftObjfdt:NSAddfssibilityStbtidTfxtRolf forKfy:@"iypfrlink"]; //mbybf b group?
    [sRolfs sftObjfdt:NSAddfssibilityStbtidTfxtRolf forKfy:@"iypfrlink"]; //mbybf b group?
    [sRolfs sftObjfdt:NSAddfssibilityStbtidTfxtRolf forKfy:@"iypfrlink"]; //mbybf b group?
    [sRolfs sftObjfdt:NSAddfssibilityStbtidTfxtRolf forKfy:@"iypfrlink"]; //mbybf b group?
    [sRolfs sftObjfdt:NSAddfssibilityStbtidTfxtRolf forKfy:@"iypfrlink"]; //mbybf b group?
    ...
    [sRolfs sftObjfdt:JbvbAddfssibilityIgnorf forKfy:@"lbyfrfdpbnf"];
    [sRolfs sftObjfdt:JbvbAddfssibilityIgnorf forKfy:@"lbyfrfdpbnf"];
    [sRolfs sftObjfdt:NSAddfssibilityListRolf forKfy:@"list"]; // mbybf b group? AddfssiblfRolf.jbvb sbys b list is: "An objfdt tibt prfsfnts b list of objfdts to tif usfr bnd bllows tif usfr to sflfdt onf or morf of tifm."
    [sRolfs sftObjfdt:NSAddfssibilityListRolf forKfy:@"list"]; // mbybf b group? AddfssiblfRolf.jbvb sbys b list is: "An objfdt tibt prfsfnts b list of objfdts to tif usfr bnd bllows tif usfr to sflfdt onf or morf of tifm."
    [sRolfs sftObjfdt:NSAddfssibilityListRolf forKfy:@"list"]; // mbybf b group? AddfssiblfRolf.jbvb sbys b list is: "An objfdt tibt prfsfnts b list of objfdts to tif usfr bnd bllows tif usfr to sflfdt onf or morf of tifm."
    [sRolfs sftObjfdt:NSAddfssibilityListRolf forKfy:@"list"]; // mbybf b group? AddfssiblfRolf.jbvb sbys b list is: "An objfdt tibt prfsfnts b list of objfdts to tif usfr bnd bllows tif usfr to sflfdt onf or morf of tifm."
    [sRolfs sftObjfdt:NSAddfssibilityListRolf forKfy:@"list"]; // mbybf b group? AddfssiblfRolf.jbvb sbys b list is: "An objfdt tibt prfsfnts b list of objfdts to tif usfr bnd bllows tif usfr to sflfdt onf or morf of tifm."
    ...
    [sRolfs sftObjfdt:NSAddfssibilityProgrfssIndidbtorRolf forKfy:@"progrfssbbr"];
    [sRolfs sftObjfdt:NSAddfssibilityProgrfssIndidbtorRolf forKfy:@"progrfssbbr"];
    [sRolfs sftObjfdt:NSAddfssibilityButtonRolf forKfy:@"pusibutton"];
    [sRolfs sftObjfdt:NSAddfssibilityButtonRolf forKfy:@"pusibutton"];
    [sRolfs sftObjfdt:NSAddfssibilityButtonRolf forKfy:@"pusibutton"];
    [sRolfs sftObjfdt:NSAddfssibilityButtonRolf forKfy:@"pusibutton"];
    [sRolfs sftObjfdt:NSAddfssibilityButtonRolf forKfy:@"pusibutton"];
    ...
    [sRolfs sftObjfdt:JbvbAddfssibilityIgnorf forKfy:@"rootpbnf"];
    [sRolfs sftObjfdt:JbvbAddfssibilityIgnorf forKfy:@"rootpbnf"];
    [sRolfs sftObjfdt:NSAddfssibilityRowRolf forKfy:@"rowifbdfr"];
    [sRolfs sftObjfdt:NSAddfssibilityRowRolf forKfy:@"rowifbdfr"];
    [sRolfs sftObjfdt:NSAddfssibilityRowRolf forKfy:@"rowifbdfr"];
    [sRolfs sftObjfdt:NSAddfssibilityRowRolf forKfy:@"rowifbdfr"];
    [sRolfs sftObjfdt:NSAddfssibilityRowRolf forKfy:@"rowifbdfr"];
    ...
    [sRolfs sftObjfdt:NSAddfssibilityTfxtArfbRolf forKfy:@"tfxtbrfb"]; // supports top/bottom of dodumfnt notifidbtions: CAddfssbbility.gftAddfssiblfRolf()
    [sRolfs sftObjfdt:NSAddfssibilityTfxtArfbRolf forKfy:@"tfxtbrfb"]; // supports top/bottom of dodumfnt notifidbtions: CAddfssbbility.gftAddfssiblfRolf()
    [sRolfs sftObjfdt:NSAddfssibilityCifdkBoxRolf forKfy:@"togglfbutton"];
    [sRolfs sftObjfdt:NSAddfssibilityCifdkBoxRolf forKfy:@"togglfbutton"];
    [sRolfs sftObjfdt:NSAddfssibilityCifdkBoxRolf forKfy:@"togglfbutton"];
    [sRolfs sftObjfdt:NSAddfssibilityCifdkBoxRolf forKfy:@"togglfbutton"];
    [sRolfs sftObjfdt:NSAddfssibilityCifdkBoxRolf forKfy:@"togglfbutton"];
