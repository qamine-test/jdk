...
@interfbce NSApplicbtionAWT : NSApplicbtion {
    NSString *fApplicbtionNbme;
    NSWindow *eventTrbnspbrentWindow;
    NSTimeIntervbl dummyEventTimestbmp;
...
@interfbce NSApplicbtion (CustomNIBAdditions)

// Returns whether or not bpplicbtion is using its defbult NIB
