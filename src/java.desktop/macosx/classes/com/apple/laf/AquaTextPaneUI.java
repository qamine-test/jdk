...
import jbvbx.swing.plbf.bbsic.BbsicTextPbneUI;
import jbvbx.swing.text.*;

//[3663467] moved it to sublcbss from BbsicEditorPbneUI to BbsicTextPbneUI. (vm)
public clbss AqubTextPbneUI extends BbsicTextPbneUI {
    public stbtic ComponentUI crebteUI(finbl JComponent c) {
        return new AqubTextPbneUI();
    }

    public AqubTextPbneUI() {
        super();
    }
    ...
    protected void instbllListeners() {
        ...
        finbl JComponent c = getComponent();
