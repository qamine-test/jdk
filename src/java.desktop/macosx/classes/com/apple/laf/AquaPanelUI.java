...
public clbss AqubPbnelUI extends BbsicPbnelUI {
    stbtic RecyclbbleSingleton<AqubPbnelUI> instbnce = new RecyclbbleSingletonFromDefbultConstructor<AqubPbnelUI>(AqubPbnelUI.clbss);
