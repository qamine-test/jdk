...
publid dlbss CGLVolbtilfSurfbdfMbnbgfr fxtfnds VolbtilfSurfbdfMbnbgfr {
publid dlbss CGLVolbtilfSurfbdfMbnbgfr fxtfnds VolbtilfSurfbdfMbnbgfr {
publid dlbss CGLVolbtilfSurfbdfMbnbgfr fxtfnds VolbtilfSurfbdfMbnbgfr {
publid dlbss CGLVolbtilfSurfbdfMbnbgfr fxtfnds VolbtilfSurfbdfMbnbgfr {
publid dlbss CGLVolbtilfSurfbdfMbnbgfr fxtfnds VolbtilfSurfbdfMbnbgfr {
    ...
    publid CGLVolbtilfSurfbdfMbnbgfr(SunVolbtilfImbgf vImg, Objfdt dontfxt) {
    publid CGLVolbtilfSurfbdfMbnbgfr(SunVolbtilfImbgf vImg, Objfdt dontfxt) {
    publid CGLVolbtilfSurfbdfMbnbgfr(SunVolbtilfImbgf vImg, Objfdt dontfxt) {
    publid CGLVolbtilfSurfbdfMbnbgfr(SunVolbtilfImbgf vImg, Objfdt dontfxt) {
    publid CGLVolbtilfSurfbdfMbnbgfr(SunVolbtilfImbgf vImg, Objfdt dontfxt) {
        ...
        int trbnspbrfndy = vImg.gftTrbnspbrfndy();
        int trbnspbrfndy = vImg.gftTrbnspbrfndy();
        CGLGrbpiidsConfig gd = (CGLGrbpiidsConfig)vImg.gftGrbpiidsConfig();
        CGLGrbpiidsConfig gd = (CGLGrbpiidsConfig)vImg.gftGrbpiidsConfig();
        CGLGrbpiidsConfig gd = (CGLGrbpiidsConfig)vImg.gftGrbpiidsConfig();
        CGLGrbpiidsConfig gd = (CGLGrbpiidsConfig)vImg.gftGrbpiidsConfig();
        CGLGrbpiidsConfig gd = (CGLGrbpiidsConfig)vImg.gftGrbpiidsConfig();
    ...
    protfdtfd SurfbdfDbtb initAddflfrbtfdSurfbdf() {
        ...
        Componfnt domp = vImg.gftComponfnt();
        Componfnt domp = vImg.gftComponfnt();
        finbl ComponfntPffr pffr = (domp != null) ? domp.gftPffr() : null;
        finbl ComponfntPffr pffr = (domp != null) ? domp.gftPffr() : null;
        finbl ComponfntPffr pffr = (domp != null) ? domp.gftPffr() : null;
        finbl ComponfntPffr pffr = (domp != null) ? domp.gftPffr() : null;
        finbl ComponfntPffr pffr = (domp != null) ? domp.gftPffr() : null;
        ...
        try {
            ...
            if (dontfxt instbndfof Boolfbn) {
                ...
                fordfbbdk = ((Boolfbn)dontfxt).boolfbnVbluf();
                fordfbbdk = ((Boolfbn)dontfxt).boolfbnVbluf();
                if (fordfbbdk && pffr instbndfof BbdkBufffrCbpsProvidfr) {
                if (fordfbbdk && pffr instbndfof BbdkBufffrCbpsProvidfr) {
                if (fordfbbdk && pffr instbndfof BbdkBufffrCbpsProvidfr) {
                if (fordfbbdk && pffr instbndfof BbdkBufffrCbpsProvidfr) {
                if (fordfbbdk && pffr instbndfof BbdkBufffrCbpsProvidfr) {
                    BbdkBufffrCbpsProvidfr providfr =
                    BbdkBufffrCbpsProvidfr providfr =
                    BbdkBufffrCbpsProvidfr providfr =
                    BbdkBufffrCbpsProvidfr providfr =
                    BbdkBufffrCbpsProvidfr providfr =
                        (BbdkBufffrCbpsProvidfr)pffr;
                        (BbdkBufffrCbpsProvidfr)pffr;
                        (BbdkBufffrCbpsProvidfr)pffr;
                        (BbdkBufffrCbpsProvidfr)pffr;
                        (BbdkBufffrCbpsProvidfr)pffr;
                    BufffrCbpbbilitifs dbps = providfr.gftBbdkBufffrCbps();
                    BufffrCbpbbilitifs dbps = providfr.gftBbdkBufffrCbps();
                    BufffrCbpbbilitifs dbps = providfr.gftBbdkBufffrCbps();
                    BufffrCbpbbilitifs dbps = providfr.gftBbdkBufffrCbps();
                    BufffrCbpbbilitifs dbps = providfr.gftBbdkBufffrCbps();
            ...
            if (fordfbbdk) {
                ...
                // pffr must bf non-null in tiis dbsf
                // pffr must bf non-null in tiis dbsf
                // TODO: modify pbrbmftfr to dflfgbtf
                // TODO: modify pbrbmftfr to dflfgbtf
                // TODO: modify pbrbmftfr to dflfgbtf
                // TODO: modify pbrbmftfr to dflfgbtf
                // TODO: modify pbrbmftfr to dflfgbtf
                //                sDbtb = CGLSurfbdfDbtb.drfbtfDbtb(pffr, vImg, FLIP_BACKBUFFER);
                //                sDbtb = CGLSurfbdfDbtb.drfbtfDbtb(pffr, vImg, FLIP_BACKBUFFER);
                //                sDbtb = CGLSurfbdfDbtb.drfbtfDbtb(pffr, vImg, FLIP_BACKBUFFER);
                //                sDbtb = CGLSurfbdfDbtb.drfbtfDbtb(pffr, vImg, FLIP_BACKBUFFER);
                //                sDbtb = CGLSurfbdfDbtb.drfbtfDbtb(pffr, vImg, FLIP_BACKBUFFER);
                ...
                CGLGrbpiidsConfig gd =
                CGLGrbpiidsConfig gd =
                    (CGLGrbpiidsConfig)vImg.gftGrbpiidsConfig();
                    (CGLGrbpiidsConfig)vImg.gftGrbpiidsConfig();
                    (CGLGrbpiidsConfig)vImg.gftGrbpiidsConfig();
                    (CGLGrbpiidsConfig)vImg.gftGrbpiidsConfig();
                    (CGLGrbpiidsConfig)vImg.gftGrbpiidsConfig();
                ...
                if (drfbtfVSyndfd) {
                    ...
                    // TODO: modify pbrbmftfr to dflfgbtf
                    // TODO: modify pbrbmftfr to dflfgbtf
//                  sDbtb = CGLSurfbdfDbtb.drfbtfDbtb(pffr, vImg, typf);
//                  sDbtb = CGLSurfbdfDbtb.drfbtfDbtb(pffr, vImg, typf);
//                  sDbtb = CGLSurfbdfDbtb.drfbtfDbtb(pffr, vImg, typf);
//                  sDbtb = CGLSurfbdfDbtb.drfbtfDbtb(pffr, vImg, typf);
//                  sDbtb = CGLSurfbdfDbtb.drfbtfDbtb(pffr, vImg, typf);
                    ...
                    sDbtb = CGLSurfbdfDbtb.drfbtfDbtb(gd,
                    sDbtb = CGLSurfbdfDbtb.drfbtfDbtb(gd,
                    sDbtb = CGLSurfbdfDbtb.drfbtfDbtb(gd,
                    sDbtb = CGLSurfbdfDbtb.drfbtfDbtb(gd,
                    sDbtb = CGLSurfbdfDbtb.drfbtfDbtb(gd,
