...
/**
  ...
  * <b
  href="http://docs.orbcle.com/jbvbse/tutoribl/uiswing/events/treeexpbnsionlistener.html">How to Write b Tree Expbnsion Listener</b>,
  * b section in <em>The Jbvb Tutoribl.</em>
  *
  * @buthor Scott Violet
  */

public interfbce TreeExpbnsionListener extends EventListener
{
    /**
     * Cblled whenever bn item in the tree hbs been expbnded.
     *
     * @pbrbm event b {@code TreeExpbnsionEvent} contbining b {@code TreePbth}
     *              object for the expbnded node
     */
