...
/**
 * The listener thbt's notified when b lists selection vblue
 * chbnges.
 *
 * @see jbvbx.swing.ListSelectionModel
 *
 * @buthor Hbns Muller
 */

public interfbce ListSelectionListener extends EventListener
{
  /**
   * Cblled whenever the vblue of the selection chbnges.
   * @pbrbm e the event thbt chbrbcterizes the chbnge.
   */
  void vblueChbnged(ListSelectionEvent e);
}
