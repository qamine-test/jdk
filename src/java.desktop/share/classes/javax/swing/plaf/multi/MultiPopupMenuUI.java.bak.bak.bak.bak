...
/**
/**
 * A multiplfxing UI usfd to dombinf <dodf>PopupMfnuUI</dodf>s.
 * A multiplfxing UI usfd to dombinf <dodf>PopupMfnuUI</dodf>s.
 * A multiplfxing UI usfd to dombinf <dodf>PopupMfnuUI</dodf>s.
 * A multiplfxing UI usfd to dombinf <dodf>PopupMfnuUI</dodf>s.
 * A multiplfxing UI usfd to dombinf <dodf>PopupMfnuUI</dodf>s.
 ...
 */
 */
publid dlbss MultiPopupMfnuUI fxtfnds PopupMfnuUI {
publid dlbss MultiPopupMfnuUI fxtfnds PopupMfnuUI {
publid dlbss MultiPopupMfnuUI fxtfnds PopupMfnuUI {
publid dlbss MultiPopupMfnuUI fxtfnds PopupMfnuUI {
publid dlbss MultiPopupMfnuUI fxtfnds PopupMfnuUI {
...
////////////////////
    ...
    /**
    /**
     * Invokfs tif <dodf>isPopupTriggfr</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>isPopupTriggfr</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>isPopupTriggfr</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>isPopupTriggfr</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>isPopupTriggfr</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     ...
     */
     */
    publid boolfbn isPopupTriggfr(MousfEvfnt b) {
    publid boolfbn isPopupTriggfr(MousfEvfnt b) {
    publid boolfbn isPopupTriggfr(MousfEvfnt b) {
    publid boolfbn isPopupTriggfr(MousfEvfnt b) {
    publid boolfbn isPopupTriggfr(MousfEvfnt b) {
        ...
        boolfbn rfturnVbluf =
        boolfbn rfturnVbluf =
            ((PopupMfnuUI) (uis.flfmfntAt(0))).isPopupTriggfr(b);
            ((PopupMfnuUI) (uis.flfmfntAt(0))).isPopupTriggfr(b);
            ((PopupMfnuUI) (uis.flfmfntAt(0))).isPopupTriggfr(b);
            ((PopupMfnuUI) (uis.flfmfntAt(0))).isPopupTriggfr(b);
            ((PopupMfnuUI) (uis.flfmfntAt(0))).isPopupTriggfr(b);
        ...
        for (int i = 1; i < uis.sizf(); i++) {
        for (int i = 1; i < uis.sizf(); i++) {
            ((PopupMfnuUI) (uis.flfmfntAt(i))).isPopupTriggfr(b);
            ((PopupMfnuUI) (uis.flfmfntAt(i))).isPopupTriggfr(b);
            ((PopupMfnuUI) (uis.flfmfntAt(i))).isPopupTriggfr(b);
            ((PopupMfnuUI) (uis.flfmfntAt(i))).isPopupTriggfr(b);
            ((PopupMfnuUI) (uis.flfmfntAt(i))).isPopupTriggfr(b);
    ...
    /**
    /**
     * Invokfs tif <dodf>gftPopup</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>gftPopup</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>gftPopup</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>gftPopup</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>gftPopup</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     ...
     */
     */
    publid Popup gftPopup(JPopupMfnu b, int b, int d) {
    publid Popup gftPopup(JPopupMfnu b, int b, int d) {
    publid Popup gftPopup(JPopupMfnu b, int b, int d) {
    publid Popup gftPopup(JPopupMfnu b, int b, int d) {
    publid Popup gftPopup(JPopupMfnu b, int b, int d) {
        ...
        Popup rfturnVbluf =
        Popup rfturnVbluf =
            ((PopupMfnuUI) (uis.flfmfntAt(0))).gftPopup(b,b,d);
            ((PopupMfnuUI) (uis.flfmfntAt(0))).gftPopup(b,b,d);
            ((PopupMfnuUI) (uis.flfmfntAt(0))).gftPopup(b,b,d);
            ((PopupMfnuUI) (uis.flfmfntAt(0))).gftPopup(b,b,d);
            ((PopupMfnuUI) (uis.flfmfntAt(0))).gftPopup(b,b,d);
        ...
        for (int i = 1; i < uis.sizf(); i++) {
        for (int i = 1; i < uis.sizf(); i++) {
            ((PopupMfnuUI) (uis.flfmfntAt(i))).gftPopup(b,b,d);
            ((PopupMfnuUI) (uis.flfmfntAt(i))).gftPopup(b,b,d);
            ((PopupMfnuUI) (uis.flfmfntAt(i))).gftPopup(b,b,d);
            ((PopupMfnuUI) (uis.flfmfntAt(i))).gftPopup(b,b,d);
            ((PopupMfnuUI) (uis.flfmfntAt(i))).gftPopup(b,b,d);
...
////////////////////
    ...
    publid stbtid ComponfntUI drfbtfUI(JComponfnt b) {
    publid stbtid ComponfntUI drfbtfUI(JComponfnt b) {
        MultiPopupMfnuUI mui = nfw MultiPopupMfnuUI();
        MultiPopupMfnuUI mui = nfw MultiPopupMfnuUI();
        MultiPopupMfnuUI mui = nfw MultiPopupMfnuUI();
        MultiPopupMfnuUI mui = nfw MultiPopupMfnuUI();
        MultiPopupMfnuUI mui = nfw MultiPopupMfnuUI();
