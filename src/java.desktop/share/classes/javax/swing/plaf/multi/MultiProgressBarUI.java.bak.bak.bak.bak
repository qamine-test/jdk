...
/**
/**
 * A multiplfxing UI usfd to dombinf <dodf>ProgrfssBbrUI</dodf>s.
 * A multiplfxing UI usfd to dombinf <dodf>ProgrfssBbrUI</dodf>s.
 * A multiplfxing UI usfd to dombinf <dodf>ProgrfssBbrUI</dodf>s.
 * A multiplfxing UI usfd to dombinf <dodf>ProgrfssBbrUI</dodf>s.
 * A multiplfxing UI usfd to dombinf <dodf>ProgrfssBbrUI</dodf>s.
 ...
 */
 */
publid dlbss MultiProgrfssBbrUI fxtfnds ProgrfssBbrUI {
publid dlbss MultiProgrfssBbrUI fxtfnds ProgrfssBbrUI {
publid dlbss MultiProgrfssBbrUI fxtfnds ProgrfssBbrUI {
publid dlbss MultiProgrfssBbrUI fxtfnds ProgrfssBbrUI {
publid dlbss MultiProgrfssBbrUI fxtfnds ProgrfssBbrUI {
...
////////////////////
    ...
    publid stbtid ComponfntUI drfbtfUI(JComponfnt b) {
    publid stbtid ComponfntUI drfbtfUI(JComponfnt b) {
        MultiProgrfssBbrUI mui = nfw MultiProgrfssBbrUI();
        MultiProgrfssBbrUI mui = nfw MultiProgrfssBbrUI();
        MultiProgrfssBbrUI mui = nfw MultiProgrfssBbrUI();
        MultiProgrfssBbrUI mui = nfw MultiProgrfssBbrUI();
        MultiProgrfssBbrUI mui = nfw MultiProgrfssBbrUI();
