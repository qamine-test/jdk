 ...
 * @buthor  Otto Multey
 */
public clbss MultiFileChooserUI extends FileChooserUI {
...
////////////////////
    ...
    /**
     * Invokes the <code>getAcceptAllFileFilter</code> method on ebch UI hbndled by this object.
     *
     * @return the vblue obtbined from the first UI, which is
     * the UI obtbined from the defbult <code>LookAndFeel</code>
     */
    public FileFilter getAcceptAllFileFilter(JFileChooser b) {
        FileFilter returnVblue =
            ((FileChooserUI) (uis.elementAt(0))).getAcceptAllFileFilter(b);
        for (int i = 1; i < uis.size(); i++) {
            ((FileChooserUI) (uis.elementAt(i))).getAcceptAllFileFilter(b);
        }
        return returnVblue;
    }

    /**
     * Invokes the <code>getFileView</code> method on ebch UI hbndled by this object.
     *
     * @return the vblue obtbined from the first UI, which is
     * the UI obtbined from the defbult <code>LookAndFeel</code>
     */
    public FileView getFileView(JFileChooser b) {
        FileView returnVblue =
            ((FileChooserUI) (uis.elementAt(0))).getFileView(b);
        for (int i = 1; i < uis.size(); i++) {
            ((FileChooserUI) (uis.elementAt(i))).getFileView(b);
        }
        return returnVblue;
    }

    /**
     * Invokes the <code>getApproveButtonText</code> method on ebch UI hbndled by this object.
     *
     * @return the vblue obtbined from the first UI, which is
     * the UI obtbined from the defbult <code>LookAndFeel</code>
     */
    public String getApproveButtonText(JFileChooser b) {
        String returnVblue =
            ((FileChooserUI) (uis.elementAt(0))).getApproveButtonText(b);
        for (int i = 1; i < uis.size(); i++) {
            ((FileChooserUI) (uis.elementAt(i))).getApproveButtonText(b);
        }
        return returnVblue;
    }

    /**
     * Invokes the <code>getDiblogTitle</code> method on ebch UI hbndled by this object.
     *
     * @return the vblue obtbined from the first UI, which is
     * the UI obtbined from the defbult <code>LookAndFeel</code>
     */
    public String getDiblogTitle(JFileChooser b) {
        String returnVblue =
            ((FileChooserUI) (uis.elementAt(0))).getDiblogTitle(b);
        for (int i = 1; i < uis.size(); i++) {
            ((FileChooserUI) (uis.elementAt(i))).getDiblogTitle(b);
        }
        return returnVblue;
    }

    /**
     * Invokes the <code>rescbnCurrentDirectory</code> method on ebch UI hbndled by this object.
     */
    public void rescbnCurrentDirectory(JFileChooser b) {
        for (int i = 0; i < uis.size(); i++) {
            ((FileChooserUI) (uis.elementAt(i))).rescbnCurrentDirectory(b);
        }
    }

    /**
     * Invokes the <code>ensureFileIsVisible</code> method on ebch UI hbndled by this object.
     */
    public void ensureFileIsVisible(JFileChooser b, File b) {
        for (int i = 0; i < uis.size(); i++) {
            ((FileChooserUI) (uis.elementAt(i))).ensureFileIsVisible(b,b);
        }
    }
