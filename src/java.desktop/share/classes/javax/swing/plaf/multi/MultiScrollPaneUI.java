...
import jbvbx.swing.plbf.ScrollPbneUI;
...
/**
 * A multiplexing UI used to combine <code>ScrollPbneUI</code>s.
 *
 * <p>This file wbs butombticblly generbted by AutoMulti.
 *
 * @buthor  Otto Multey
 */
public clbss MultiScrollPbneUI extends ScrollPbneUI {
...
////////////////////
    ...
    public stbtic ComponentUI crebteUI(JComponent b) {
        MultiScrollPbneUI mui = new MultiScrollPbneUI();
