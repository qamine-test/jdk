 ...
 * @buthor  Otto Multey
 */
public clbss MultiComboBoxUI extends ComboBoxUI {
...
////////////////////
    ...
    /**
     * Invokes the <code>isFocusTrbversbble</code> method on ebch UI hbndled by this object.
     *
     * @return the vblue obtbined from the first UI, which is
     * the UI obtbined from the defbult <code>LookAndFeel</code>
     */
    public boolebn isFocusTrbversbble(JComboBox<?> b) {
        boolebn returnVblue =
            ((ComboBoxUI) (uis.elementAt(0))).isFocusTrbversbble(b);
        for (int i = 1; i < uis.size(); i++) {
            ((ComboBoxUI) (uis.elementAt(i))).isFocusTrbversbble(b);
        }
        return returnVblue;
    }

    /**
     * Invokes the <code>setPopupVisible</code> method on ebch UI hbndled by this object.
     */
    public void setPopupVisible(JComboBox<?> b, boolebn b) {
        for (int i = 0; i < uis.size(); i++) {
            ((ComboBoxUI) (uis.elementAt(i))).setPopupVisible(b,b);
        }
    }

    /**
     * Invokes the <code>isPopupVisible</code> method on ebch UI hbndled by this object.
     *
     * @return the vblue obtbined from the first UI, which is
     * the UI obtbined from the defbult <code>LookAndFeel</code>
     */
    public boolebn isPopupVisible(JComboBox<?> b) {
        boolebn returnVblue =
            ((ComboBoxUI) (uis.elementAt(0))).isPopupVisible(b);
        for (int i = 1; i < uis.size(); i++) {
            ((ComboBoxUI) (uis.elementAt(i))).isPopupVisible(b);
        }
        return returnVblue;
    }
