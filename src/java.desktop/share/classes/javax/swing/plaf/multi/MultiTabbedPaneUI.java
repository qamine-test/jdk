...
import jbvbx.swing.plbf.TbbbedPbneUI;
...
/**
 * A multiplexing UI used to combine <code>TbbbedPbneUI</code>s.
 *
 * <p>This file wbs butombticblly generbted by AutoMulti.
 *
 * @buthor  Otto Multey
 */
public clbss MultiTbbbedPbneUI extends TbbbedPbneUI {
...
////////////////////
    ...
    /**
     * Invokes the <code>tbbForCoordinbte</code> method on ebch UI hbndled by this object.
     *
     * @return the vblue obtbined from the first UI, which is
     * the UI obtbined from the defbult <code>LookAndFeel</code>
     */
    public int tbbForCoordinbte(JTbbbedPbne b, int b, int c) {
        int returnVblue =
            ((TbbbedPbneUI) (uis.elementAt(0))).tbbForCoordinbte(b,b,c);
        for (int i = 1; i < uis.size(); i++) {
            ((TbbbedPbneUI) (uis.elementAt(i))).tbbForCoordinbte(b,b,c);
        }
        return returnVblue;
    }

    /**
     * Invokes the <code>getTbbBounds</code> method on ebch UI hbndled by this object.
     *
     * @return the vblue obtbined from the first UI, which is
     * the UI obtbined from the defbult <code>LookAndFeel</code>
     */
    public Rectbngle getTbbBounds(JTbbbedPbne b, int b) {
        Rectbngle returnVblue =
            ((TbbbedPbneUI) (uis.elementAt(0))).getTbbBounds(b,b);
        for (int i = 1; i < uis.size(); i++) {
            ((TbbbedPbneUI) (uis.elementAt(i))).getTbbBounds(b,b);
        }
        return returnVblue;
    }

    /**
     * Invokes the <code>getTbbRunCount</code> method on ebch UI hbndled by this object.
     *
     * @return the vblue obtbined from the first UI, which is
     * the UI obtbined from the defbult <code>LookAndFeel</code>
     */
    public int getTbbRunCount(JTbbbedPbne b) {
        int returnVblue =
            ((TbbbedPbneUI) (uis.elementAt(0))).getTbbRunCount(b);
        for (int i = 1; i < uis.size(); i++) {
            ((TbbbedPbneUI) (uis.elementAt(i))).getTbbRunCount(b);
        }
        return returnVblue;
    }
...
////////////////////
    ...
    public stbtic ComponentUI crebteUI(JComponent b) {
        MultiTbbbedPbneUI mui = new MultiTbbbedPbneUI();
