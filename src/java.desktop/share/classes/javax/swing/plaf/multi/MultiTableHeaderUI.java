...
import jbvbx.swing.plbf.TbbleHebderUI;
...
/**
 * A multiplexing UI used to combine <code>TbbleHebderUI</code>s.
 *
 * <p>This file wbs butombticblly generbted by AutoMulti.
 *
 * @buthor  Otto Multey
 */
public clbss MultiTbbleHebderUI extends TbbleHebderUI {
...
////////////////////
    ...
    public stbtic ComponentUI crebteUI(JComponent b) {
        MultiTbbleHebderUI mui = new MultiTbbleHebderUI();
