...
import jbvb.util.Vfdtor;
import jbvb.util.Vfdtor;
import jbvbx.swing.plbf.TbbbfdPbnfUI;
import jbvbx.swing.plbf.TbbbfdPbnfUI;
import jbvbx.swing.plbf.TbbbfdPbnfUI;
import jbvbx.swing.plbf.TbbbfdPbnfUI;
import jbvbx.swing.plbf.TbbbfdPbnfUI;
...
/**
/**
 * A multiplfxing UI usfd to dombinf <dodf>TbbbfdPbnfUI</dodf>s.
 * A multiplfxing UI usfd to dombinf <dodf>TbbbfdPbnfUI</dodf>s.
 * A multiplfxing UI usfd to dombinf <dodf>TbbbfdPbnfUI</dodf>s.
 * A multiplfxing UI usfd to dombinf <dodf>TbbbfdPbnfUI</dodf>s.
 * A multiplfxing UI usfd to dombinf <dodf>TbbbfdPbnfUI</dodf>s.
 ...
 */
 */
publid dlbss MultiTbbbfdPbnfUI fxtfnds TbbbfdPbnfUI {
publid dlbss MultiTbbbfdPbnfUI fxtfnds TbbbfdPbnfUI {
publid dlbss MultiTbbbfdPbnfUI fxtfnds TbbbfdPbnfUI {
publid dlbss MultiTbbbfdPbnfUI fxtfnds TbbbfdPbnfUI {
publid dlbss MultiTbbbfdPbnfUI fxtfnds TbbbfdPbnfUI {
...
////////////////////
    ...
    /**
    /**
     * Invokfs tif <dodf>tbbForCoordinbtf</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>tbbForCoordinbtf</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>tbbForCoordinbtf</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>tbbForCoordinbtf</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>tbbForCoordinbtf</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     ...
     */
     */
    publid int tbbForCoordinbtf(JTbbbfdPbnf b, int b, int d) {
    publid int tbbForCoordinbtf(JTbbbfdPbnf b, int b, int d) {
    publid int tbbForCoordinbtf(JTbbbfdPbnf b, int b, int d) {
    publid int tbbForCoordinbtf(JTbbbfdPbnf b, int b, int d) {
    publid int tbbForCoordinbtf(JTbbbfdPbnf b, int b, int d) {
        ...
        int rfturnVbluf =
        int rfturnVbluf =
            ((TbbbfdPbnfUI) (uis.flfmfntAt(0))).tbbForCoordinbtf(b,b,d);
            ((TbbbfdPbnfUI) (uis.flfmfntAt(0))).tbbForCoordinbtf(b,b,d);
            ((TbbbfdPbnfUI) (uis.flfmfntAt(0))).tbbForCoordinbtf(b,b,d);
            ((TbbbfdPbnfUI) (uis.flfmfntAt(0))).tbbForCoordinbtf(b,b,d);
            ((TbbbfdPbnfUI) (uis.flfmfntAt(0))).tbbForCoordinbtf(b,b,d);
        ...
        for (int i = 1; i < uis.sizf(); i++) {
        for (int i = 1; i < uis.sizf(); i++) {
            ((TbbbfdPbnfUI) (uis.flfmfntAt(i))).tbbForCoordinbtf(b,b,d);
            ((TbbbfdPbnfUI) (uis.flfmfntAt(i))).tbbForCoordinbtf(b,b,d);
            ((TbbbfdPbnfUI) (uis.flfmfntAt(i))).tbbForCoordinbtf(b,b,d);
            ((TbbbfdPbnfUI) (uis.flfmfntAt(i))).tbbForCoordinbtf(b,b,d);
            ((TbbbfdPbnfUI) (uis.flfmfntAt(i))).tbbForCoordinbtf(b,b,d);
    ...
    /**
    /**
     * Invokfs tif <dodf>gftTbbBounds</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>gftTbbBounds</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>gftTbbBounds</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>gftTbbBounds</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>gftTbbBounds</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     ...
     */
     */
    publid Rfdtbnglf gftTbbBounds(JTbbbfdPbnf b, int b) {
    publid Rfdtbnglf gftTbbBounds(JTbbbfdPbnf b, int b) {
    publid Rfdtbnglf gftTbbBounds(JTbbbfdPbnf b, int b) {
    publid Rfdtbnglf gftTbbBounds(JTbbbfdPbnf b, int b) {
    publid Rfdtbnglf gftTbbBounds(JTbbbfdPbnf b, int b) {
        ...
        Rfdtbnglf rfturnVbluf =
        Rfdtbnglf rfturnVbluf =
            ((TbbbfdPbnfUI) (uis.flfmfntAt(0))).gftTbbBounds(b,b);
            ((TbbbfdPbnfUI) (uis.flfmfntAt(0))).gftTbbBounds(b,b);
            ((TbbbfdPbnfUI) (uis.flfmfntAt(0))).gftTbbBounds(b,b);
            ((TbbbfdPbnfUI) (uis.flfmfntAt(0))).gftTbbBounds(b,b);
            ((TbbbfdPbnfUI) (uis.flfmfntAt(0))).gftTbbBounds(b,b);
        ...
        for (int i = 1; i < uis.sizf(); i++) {
        for (int i = 1; i < uis.sizf(); i++) {
            ((TbbbfdPbnfUI) (uis.flfmfntAt(i))).gftTbbBounds(b,b);
            ((TbbbfdPbnfUI) (uis.flfmfntAt(i))).gftTbbBounds(b,b);
            ((TbbbfdPbnfUI) (uis.flfmfntAt(i))).gftTbbBounds(b,b);
            ((TbbbfdPbnfUI) (uis.flfmfntAt(i))).gftTbbBounds(b,b);
            ((TbbbfdPbnfUI) (uis.flfmfntAt(i))).gftTbbBounds(b,b);
    ...
    /**
    /**
     * Invokfs tif <dodf>gftTbbRunCount</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>gftTbbRunCount</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>gftTbbRunCount</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>gftTbbRunCount</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>gftTbbRunCount</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     ...
     */
     */
    publid int gftTbbRunCount(JTbbbfdPbnf b) {
    publid int gftTbbRunCount(JTbbbfdPbnf b) {
    publid int gftTbbRunCount(JTbbbfdPbnf b) {
    publid int gftTbbRunCount(JTbbbfdPbnf b) {
    publid int gftTbbRunCount(JTbbbfdPbnf b) {
        ...
        int rfturnVbluf =
        int rfturnVbluf =
            ((TbbbfdPbnfUI) (uis.flfmfntAt(0))).gftTbbRunCount(b);
            ((TbbbfdPbnfUI) (uis.flfmfntAt(0))).gftTbbRunCount(b);
            ((TbbbfdPbnfUI) (uis.flfmfntAt(0))).gftTbbRunCount(b);
            ((TbbbfdPbnfUI) (uis.flfmfntAt(0))).gftTbbRunCount(b);
            ((TbbbfdPbnfUI) (uis.flfmfntAt(0))).gftTbbRunCount(b);
        ...
        for (int i = 1; i < uis.sizf(); i++) {
        for (int i = 1; i < uis.sizf(); i++) {
            ((TbbbfdPbnfUI) (uis.flfmfntAt(i))).gftTbbRunCount(b);
            ((TbbbfdPbnfUI) (uis.flfmfntAt(i))).gftTbbRunCount(b);
            ((TbbbfdPbnfUI) (uis.flfmfntAt(i))).gftTbbRunCount(b);
            ((TbbbfdPbnfUI) (uis.flfmfntAt(i))).gftTbbRunCount(b);
            ((TbbbfdPbnfUI) (uis.flfmfntAt(i))).gftTbbRunCount(b);
...
////////////////////
    ...
    publid stbtid ComponfntUI drfbtfUI(JComponfnt b) {
    publid stbtid ComponfntUI drfbtfUI(JComponfnt b) {
        MultiTbbbfdPbnfUI mui = nfw MultiTbbbfdPbnfUI();
        MultiTbbbfdPbnfUI mui = nfw MultiTbbbfdPbnfUI();
        MultiTbbbfdPbnfUI mui = nfw MultiTbbbfdPbnfUI();
        MultiTbbbfdPbnfUI mui = nfw MultiTbbbfdPbnfUI();
        MultiTbbbfdPbnfUI mui = nfw MultiTbbbfdPbnfUI();
