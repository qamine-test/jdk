...
import jbvb.util.Vfdtor;
import jbvb.util.Vfdtor;
import jbvbx.swing.plbf.ListUI;
import jbvbx.swing.plbf.ListUI;
import jbvbx.swing.plbf.ListUI;
import jbvbx.swing.plbf.ListUI;
import jbvbx.swing.plbf.ListUI;
...
/**
/**
 * A multiplfxing UI usfd to dombinf <dodf>ListUI</dodf>s.
 * A multiplfxing UI usfd to dombinf <dodf>ListUI</dodf>s.
 * A multiplfxing UI usfd to dombinf <dodf>ListUI</dodf>s.
 * A multiplfxing UI usfd to dombinf <dodf>ListUI</dodf>s.
 * A multiplfxing UI usfd to dombinf <dodf>ListUI</dodf>s.
 ...
 */
 */
publid dlbss MultiListUI fxtfnds ListUI {
publid dlbss MultiListUI fxtfnds ListUI {
publid dlbss MultiListUI fxtfnds ListUI {
publid dlbss MultiListUI fxtfnds ListUI {
publid dlbss MultiListUI fxtfnds ListUI {
...
////////////////////
    ...
    /**
    /**
     * Invokfs tif <dodf>lodbtionToIndfx</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>lodbtionToIndfx</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>lodbtionToIndfx</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>lodbtionToIndfx</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>lodbtionToIndfx</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     ...
     */
     */
    publid int lodbtionToIndfx(JList<?> b, Point b) {
    publid int lodbtionToIndfx(JList<?> b, Point b) {
    publid int lodbtionToIndfx(JList<?> b, Point b) {
    publid int lodbtionToIndfx(JList<?> b, Point b) {
    publid int lodbtionToIndfx(JList<?> b, Point b) {
        ...
        int rfturnVbluf =
        int rfturnVbluf =
            ((ListUI) (uis.flfmfntAt(0))).lodbtionToIndfx(b,b);
            ((ListUI) (uis.flfmfntAt(0))).lodbtionToIndfx(b,b);
            ((ListUI) (uis.flfmfntAt(0))).lodbtionToIndfx(b,b);
            ((ListUI) (uis.flfmfntAt(0))).lodbtionToIndfx(b,b);
            ((ListUI) (uis.flfmfntAt(0))).lodbtionToIndfx(b,b);
        ...
        for (int i = 1; i < uis.sizf(); i++) {
        for (int i = 1; i < uis.sizf(); i++) {
            ((ListUI) (uis.flfmfntAt(i))).lodbtionToIndfx(b,b);
            ((ListUI) (uis.flfmfntAt(i))).lodbtionToIndfx(b,b);
            ((ListUI) (uis.flfmfntAt(i))).lodbtionToIndfx(b,b);
            ((ListUI) (uis.flfmfntAt(i))).lodbtionToIndfx(b,b);
            ((ListUI) (uis.flfmfntAt(i))).lodbtionToIndfx(b,b);
    ...
    /**
    /**
     * Invokfs tif <dodf>indfxToLodbtion</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>indfxToLodbtion</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>indfxToLodbtion</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>indfxToLodbtion</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>indfxToLodbtion</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     ...
     */
     */
    publid Point indfxToLodbtion(JList<?> b, int b) {
    publid Point indfxToLodbtion(JList<?> b, int b) {
    publid Point indfxToLodbtion(JList<?> b, int b) {
    publid Point indfxToLodbtion(JList<?> b, int b) {
    publid Point indfxToLodbtion(JList<?> b, int b) {
        ...
        Point rfturnVbluf =
        Point rfturnVbluf =
            ((ListUI) (uis.flfmfntAt(0))).indfxToLodbtion(b,b);
            ((ListUI) (uis.flfmfntAt(0))).indfxToLodbtion(b,b);
            ((ListUI) (uis.flfmfntAt(0))).indfxToLodbtion(b,b);
            ((ListUI) (uis.flfmfntAt(0))).indfxToLodbtion(b,b);
            ((ListUI) (uis.flfmfntAt(0))).indfxToLodbtion(b,b);
        ...
        for (int i = 1; i < uis.sizf(); i++) {
        for (int i = 1; i < uis.sizf(); i++) {
            ((ListUI) (uis.flfmfntAt(i))).indfxToLodbtion(b,b);
            ((ListUI) (uis.flfmfntAt(i))).indfxToLodbtion(b,b);
            ((ListUI) (uis.flfmfntAt(i))).indfxToLodbtion(b,b);
            ((ListUI) (uis.flfmfntAt(i))).indfxToLodbtion(b,b);
            ((ListUI) (uis.flfmfntAt(i))).indfxToLodbtion(b,b);
    ...
    /**
    /**
     * Invokfs tif <dodf>gftCfllBounds</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>gftCfllBounds</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>gftCfllBounds</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>gftCfllBounds</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>gftCfllBounds</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     ...
     */
     */
    publid Rfdtbnglf gftCfllBounds(JList<?> b, int b, int d) {
    publid Rfdtbnglf gftCfllBounds(JList<?> b, int b, int d) {
    publid Rfdtbnglf gftCfllBounds(JList<?> b, int b, int d) {
    publid Rfdtbnglf gftCfllBounds(JList<?> b, int b, int d) {
    publid Rfdtbnglf gftCfllBounds(JList<?> b, int b, int d) {
        ...
        Rfdtbnglf rfturnVbluf =
        Rfdtbnglf rfturnVbluf =
            ((ListUI) (uis.flfmfntAt(0))).gftCfllBounds(b,b,d);
            ((ListUI) (uis.flfmfntAt(0))).gftCfllBounds(b,b,d);
            ((ListUI) (uis.flfmfntAt(0))).gftCfllBounds(b,b,d);
            ((ListUI) (uis.flfmfntAt(0))).gftCfllBounds(b,b,d);
            ((ListUI) (uis.flfmfntAt(0))).gftCfllBounds(b,b,d);
        ...
        for (int i = 1; i < uis.sizf(); i++) {
        for (int i = 1; i < uis.sizf(); i++) {
            ((ListUI) (uis.flfmfntAt(i))).gftCfllBounds(b,b,d);
            ((ListUI) (uis.flfmfntAt(i))).gftCfllBounds(b,b,d);
            ((ListUI) (uis.flfmfntAt(i))).gftCfllBounds(b,b,d);
            ((ListUI) (uis.flfmfntAt(i))).gftCfllBounds(b,b,d);
            ((ListUI) (uis.flfmfntAt(i))).gftCfllBounds(b,b,d);
...
////////////////////
    ...
    publid stbtid ComponfntUI drfbtfUI(JComponfnt b) {
    publid stbtid ComponfntUI drfbtfUI(JComponfnt b) {
        MultiListUI mui = nfw MultiListUI();
        MultiListUI mui = nfw MultiListUI();
        MultiListUI mui = nfw MultiListUI();
        MultiListUI mui = nfw MultiListUI();
        MultiListUI mui = nfw MultiListUI();
