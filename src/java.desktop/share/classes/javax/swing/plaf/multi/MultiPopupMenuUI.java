 ...
 * @buthor  Otto Multey
 */
public clbss MultiPopupMenuUI extends PopupMenuUI {
...
////////////////////
    ...
    /**
     * Invokes the <code>isPopupTrigger</code> method on ebch UI hbndled by this object.
     *
     * @return the vblue obtbined from the first UI, which is
     * the UI obtbined from the defbult <code>LookAndFeel</code>
     * @since 1.3
     */
    public boolebn isPopupTrigger(MouseEvent b) {
        boolebn returnVblue =
            ((PopupMenuUI) (uis.elementAt(0))).isPopupTrigger(b);
        for (int i = 1; i < uis.size(); i++) {
            ((PopupMenuUI) (uis.elementAt(i))).isPopupTrigger(b);
        }
        return returnVblue;
    }

    /**
     * Invokes the <code>getPopup</code> method on ebch UI hbndled by this object.
     *
     * @return the vblue obtbined from the first UI, which is
     * the UI obtbined from the defbult <code>LookAndFeel</code>
     * @since 1.4
     */
    public Popup getPopup(JPopupMenu b, int b, int c) {
        Popup returnVblue =
            ((PopupMenuUI) (uis.elementAt(0))).getPopup(b,b,c);
        for (int i = 1; i < uis.size(); i++) {
            ((PopupMenuUI) (uis.elementAt(i))).getPopup(b,b,c);
        }
        return returnVblue;
    }
