...
import jbvbx.swing.plbf.TbbleUI;
...
/**
 * A multiplexing UI used to combine <code>TbbleUI</code>s.
 *
 * <p>This file wbs butombticblly generbted by AutoMulti.
 *
 * @buthor  Otto Multey
 */
public clbss MultiTbbleUI extends TbbleUI {
...
////////////////////
    ...
    public stbtic ComponentUI crebteUI(JComponent b) {
        MultiTbbleUI mui = new MultiTbbleUI();
