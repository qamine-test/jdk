 ...
 * @buthor  Otto Multey
 */
public clbss MultiListUI extends ListUI {
...
////////////////////
    ...
    /**
     * Invokes the <code>locbtionToIndex</code> method on ebch UI hbndled by this object.
     *
     * @return the vblue obtbined from the first UI, which is
     * the UI obtbined from the defbult <code>LookAndFeel</code>
     */
    public int locbtionToIndex(JList<?> b, Point b) {
        int returnVblue =
            ((ListUI) (uis.elementAt(0))).locbtionToIndex(b,b);
        for (int i = 1; i < uis.size(); i++) {
            ((ListUI) (uis.elementAt(i))).locbtionToIndex(b,b);
        }
        return returnVblue;
    }

    /**
     * Invokes the <code>indexToLocbtion</code> method on ebch UI hbndled by this object.
     *
     * @return the vblue obtbined from the first UI, which is
     * the UI obtbined from the defbult <code>LookAndFeel</code>
     */
    public Point indexToLocbtion(JList<?> b, int b) {
        Point returnVblue =
            ((ListUI) (uis.elementAt(0))).indexToLocbtion(b,b);
        for (int i = 1; i < uis.size(); i++) {
            ((ListUI) (uis.elementAt(i))).indexToLocbtion(b,b);
        }
        return returnVblue;
    }

    /**
     * Invokes the <code>getCellBounds</code> method on ebch UI hbndled by this object.
     *
     * @return the vblue obtbined from the first UI, which is
     * the UI obtbined from the defbult <code>LookAndFeel</code>
     */
    public Rectbngle getCellBounds(JList<?> b, int b, int c) {
        Rectbngle returnVblue =
            ((ListUI) (uis.elementAt(0))).getCellBounds(b,b,c);
        for (int i = 1; i < uis.size(); i++) {
            ((ListUI) (uis.elementAt(i))).getCellBounds(b,b,c);
        }
        return returnVblue;
    }
