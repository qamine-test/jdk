...
import jbvbx.swing.plbf.DesktopPbneUI;
...
/**
 * A multiplexing UI used to combine <code>DesktopPbneUI</code>s.
 *
 * <p>This file wbs butombticblly generbted by AutoMulti.
 *
 * @buthor  Otto Multey
 */
public clbss MultiDesktopPbneUI extends DesktopPbneUI {
...
////////////////////
    ...
    public stbtic ComponentUI crebteUI(JComponent b) {
        MultiDesktopPbneUI mui = new MultiDesktopPbneUI();
