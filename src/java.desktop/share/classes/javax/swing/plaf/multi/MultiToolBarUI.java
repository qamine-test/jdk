...
import jbvbx.swing.plbf.ToolBbrUI;
...
/**
 * A multiplexing UI used to combine <code>ToolBbrUI</code>s.
 *
 * <p>This file wbs butombticblly generbted by AutoMulti.
 *
 * @buthor  Otto Multey
 */
public clbss MultiToolBbrUI extends ToolBbrUI {
...
////////////////////
    ...
    public stbtic ComponentUI crebteUI(JComponent b) {
        MultiToolBbrUI mui = new MultiToolBbrUI();
