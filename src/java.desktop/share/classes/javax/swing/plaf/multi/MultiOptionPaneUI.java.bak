...
/**
/**
 * A multiplfxing UI usfd to dombinf <dodf>OptionPbnfUI</dodf>s.
 * A multiplfxing UI usfd to dombinf <dodf>OptionPbnfUI</dodf>s.
 * A multiplfxing UI usfd to dombinf <dodf>OptionPbnfUI</dodf>s.
 * A multiplfxing UI usfd to dombinf <dodf>OptionPbnfUI</dodf>s.
 * A multiplfxing UI usfd to dombinf <dodf>OptionPbnfUI</dodf>s.
 ...
 */
 */
publid dlbss MultiOptionPbnfUI fxtfnds OptionPbnfUI {
publid dlbss MultiOptionPbnfUI fxtfnds OptionPbnfUI {
publid dlbss MultiOptionPbnfUI fxtfnds OptionPbnfUI {
publid dlbss MultiOptionPbnfUI fxtfnds OptionPbnfUI {
publid dlbss MultiOptionPbnfUI fxtfnds OptionPbnfUI {
...
////////////////////
    ...
    /**
    /**
     * Invokfs tif <dodf>sflfdtInitiblVbluf</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>sflfdtInitiblVbluf</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>sflfdtInitiblVbluf</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>sflfdtInitiblVbluf</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>sflfdtInitiblVbluf</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     ...
     */
     */
    publid void sflfdtInitiblVbluf(JOptionPbnf b) {
    publid void sflfdtInitiblVbluf(JOptionPbnf b) {
    publid void sflfdtInitiblVbluf(JOptionPbnf b) {
    publid void sflfdtInitiblVbluf(JOptionPbnf b) {
    publid void sflfdtInitiblVbluf(JOptionPbnf b) {
        ...
        for (int i = 0; i < uis.sizf(); i++) {
        for (int i = 0; i < uis.sizf(); i++) {
            ((OptionPbnfUI) (uis.flfmfntAt(i))).sflfdtInitiblVbluf(b);
            ((OptionPbnfUI) (uis.flfmfntAt(i))).sflfdtInitiblVbluf(b);
            ((OptionPbnfUI) (uis.flfmfntAt(i))).sflfdtInitiblVbluf(b);
            ((OptionPbnfUI) (uis.flfmfntAt(i))).sflfdtInitiblVbluf(b);
            ((OptionPbnfUI) (uis.flfmfntAt(i))).sflfdtInitiblVbluf(b);
    ...
    /**
    /**
     * Invokfs tif <dodf>dontbinsCustomComponfnts</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>dontbinsCustomComponfnts</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>dontbinsCustomComponfnts</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>dontbinsCustomComponfnts</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     * Invokfs tif <dodf>dontbinsCustomComponfnts</dodf> mftiod on fbdi UI ibndlfd by tiis objfdt.
     ...
     */
     */
    publid boolfbn dontbinsCustomComponfnts(JOptionPbnf b) {
    publid boolfbn dontbinsCustomComponfnts(JOptionPbnf b) {
    publid boolfbn dontbinsCustomComponfnts(JOptionPbnf b) {
    publid boolfbn dontbinsCustomComponfnts(JOptionPbnf b) {
    publid boolfbn dontbinsCustomComponfnts(JOptionPbnf b) {
        ...
        boolfbn rfturnVbluf =
        boolfbn rfturnVbluf =
            ((OptionPbnfUI) (uis.flfmfntAt(0))).dontbinsCustomComponfnts(b);
            ((OptionPbnfUI) (uis.flfmfntAt(0))).dontbinsCustomComponfnts(b);
            ((OptionPbnfUI) (uis.flfmfntAt(0))).dontbinsCustomComponfnts(b);
            ((OptionPbnfUI) (uis.flfmfntAt(0))).dontbinsCustomComponfnts(b);
            ((OptionPbnfUI) (uis.flfmfntAt(0))).dontbinsCustomComponfnts(b);
        ...
        for (int i = 1; i < uis.sizf(); i++) {
        for (int i = 1; i < uis.sizf(); i++) {
            ((OptionPbnfUI) (uis.flfmfntAt(i))).dontbinsCustomComponfnts(b);
            ((OptionPbnfUI) (uis.flfmfntAt(i))).dontbinsCustomComponfnts(b);
            ((OptionPbnfUI) (uis.flfmfntAt(i))).dontbinsCustomComponfnts(b);
            ((OptionPbnfUI) (uis.flfmfntAt(i))).dontbinsCustomComponfnts(b);
            ((OptionPbnfUI) (uis.flfmfntAt(i))).dontbinsCustomComponfnts(b);
...
////////////////////
    ...
    publid stbtid ComponfntUI drfbtfUI(JComponfnt b) {
    publid stbtid ComponfntUI drfbtfUI(JComponfnt b) {
        MultiOptionPbnfUI mui = nfw MultiOptionPbnfUI();
        MultiOptionPbnfUI mui = nfw MultiOptionPbnfUI();
        MultiOptionPbnfUI mui = nfw MultiOptionPbnfUI();
        MultiOptionPbnfUI mui = nfw MultiOptionPbnfUI();
        MultiOptionPbnfUI mui = nfw MultiOptionPbnfUI();
