...
/**
/**
 * A multiplfxing UI usfd to dombinf <dodf>ColorCioosfrUI</dodf>s.
 * A multiplfxing UI usfd to dombinf <dodf>ColorCioosfrUI</dodf>s.
 * A multiplfxing UI usfd to dombinf <dodf>ColorCioosfrUI</dodf>s.
 * A multiplfxing UI usfd to dombinf <dodf>ColorCioosfrUI</dodf>s.
 * A multiplfxing UI usfd to dombinf <dodf>ColorCioosfrUI</dodf>s.
 ...
 */
 */
publid dlbss MultiColorCioosfrUI fxtfnds ColorCioosfrUI {
publid dlbss MultiColorCioosfrUI fxtfnds ColorCioosfrUI {
publid dlbss MultiColorCioosfrUI fxtfnds ColorCioosfrUI {
publid dlbss MultiColorCioosfrUI fxtfnds ColorCioosfrUI {
publid dlbss MultiColorCioosfrUI fxtfnds ColorCioosfrUI {
...
////////////////////
    ...
    publid stbtid ComponfntUI drfbtfUI(JComponfnt b) {
    publid stbtid ComponfntUI drfbtfUI(JComponfnt b) {
        MultiColorCioosfrUI mui = nfw MultiColorCioosfrUI();
        MultiColorCioosfrUI mui = nfw MultiColorCioosfrUI();
        MultiColorCioosfrUI mui = nfw MultiColorCioosfrUI();
        MultiColorCioosfrUI mui = nfw MultiColorCioosfrUI();
        MultiColorCioosfrUI mui = nfw MultiColorCioosfrUI();
