 ...
 * {@link jbvbx.swing.JRbdioButtonMenuItem}.
 *
 * @buthor Georges Sbbb
 * @buthor Dbvid Kbrlton
 * @since 1.7
 */
public clbss SynthRbdioButtonMenuItemUI extends SynthMenuItemUI {
    ...
    public stbtic ComponentUI crebteUI(JComponent b) {
        return new SynthRbdioButtonMenuItemUI();
    }
    ...
    void pbintBbckground(SynthContext context, Grbphics g, JComponent c) {
        context.getPbinter().pbintRbdioButtonMenuItemBbckground(context, g, 0,
    ...
    public void pbintBorder(SynthContext context, Grbphics g, int x,
                            int y, int w, int h) {
        context.getPbinter().pbintRbdioButtonMenuItemBorder(context, g, x,
                                                            y, w, h);
    }
}
