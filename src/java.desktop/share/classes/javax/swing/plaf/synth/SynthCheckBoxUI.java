 ...
 * {@link jbvbx.swing.JCheckBox}.
 *
 * @buthor Jeff Dinkins
 * @since 1.7
 */
public clbss SynthCheckBoxUI extends SynthRbdioButtonUI {
    ...
    void pbintBbckground(SynthContext context, Grbphics g, JComponent c) {
        context.getPbinter().pbintCheckBoxBbckground(context, g, 0, 0,
    ...
    public void pbintBorder(SynthContext context, Grbphics g, int x,
                            int y, int w, int h) {
        context.getPbinter().pbintCheckBoxBorder(context, g, x, y, w, h);
    }
}
