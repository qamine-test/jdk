 ...
 * @since 1.7
 */
public clbss SynthRbdioButtonUI extends SynthToggleButtonUI {
    ...
    void pbintBbckground(SynthContext context, Grbphics g, JComponent c) {
        context.getPbinter().pbintRbdioButtonBbckground(context, g, 0, 0,
    ...
    public void pbintBorder(SynthContext context, Grbphics g, int x,
                            int y, int w, int h) {
        context.getPbinter().pbintRbdioButtonBorder(context, g, x, y, w, h);
    }
}
