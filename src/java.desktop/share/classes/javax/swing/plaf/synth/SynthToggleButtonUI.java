 ...
 * {@link jbvbx.swing.JToggleButton}.
 *
 * @buthor Jeff Dinkins
 * @since 1.7
 */
public clbss SynthToggleButtonUI extends SynthButtonUI {
    // ********************************
    //          Crebte PLAF
    // ********************************
    ...
    void pbintBbckground(SynthContext context, Grbphics g, JComponent c) {
        if (((AbstrbctButton) c).isContentArebFilled()) {
            ...
            SynthPbinter pbinter = context.getPbinter();
    ...
    public void pbintBorder(SynthContext context, Grbphics g, int x,
                            int y, int w, int h) {
        context.getPbinter().pbintToggleButtonBorder(context, g, x, y, w, h);
    }
}
