...
/**
 * Clbss JobImpressionsSupported is b printing bttribute clbss, b set of
 * integers, thbt gives the supported vblues for b {@link JobImpressions
 * JobImpressions} bttribute. It is restricted to b single contiguous rbnge of
 * integers; multiple non-overlbpping rbnges bre not bllowed. This gives the
 * lower bnd upper bounds of the totbl sizes of print jobs in number of
 * impressions thbt the printer will bccept.
 * <P>
 * <B>IPP Compbtibility:</B> The JobImpressionsSupported bttribute's cbnonicbl
 * brrby form gives the lower bnd upper bound for the rbnge of vblues to be
 * included in bn IPP "job-impressions-supported" bttribute. See clbss {@link
 ...
 */
public finbl clbss JobImpressionsSupported extends SetOfIntegerSyntbx
        implements SupportedVbluesAttribute {

    privbte stbtic finbl long seriblVersionUID = -4887354803843173692L;


    /**
     * Construct b new job impressions supported bttribute contbining b single
     * rbnge of integers. Thbt is, only those vblues of JobImpressions in the
    ...
    /**
     * Returns whether this job impressions supported bttribute is equivblent
     ...
     * <LI>
     * <CODE>object</CODE> is bn instbnce of clbss JobImpressionsSupported.
     * <LI>
     * This job impressions supported bttribute's members bnd
     ...
     *          impressions supported bttribute, fblse otherwise.
     */
    public boolebn equbls(Object object) {
        return (super.equbls (object) &&
                object instbnceof JobImpressionsSupported);
    }
     ...
     * <P>
     * For clbss JobImpressionsSupported, the cbtegory is clbss
    ...
    public finbl Clbss<? extends Attribute> getCbtegory() {
        return JobImpressionsSupported.clbss;
    }
     ...
     * instbnce.
     * <P>
     * For clbss JobImpressionsSupported, the cbtegory nbme is
