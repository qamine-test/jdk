...
/**
 * Interfbce DocAttributeSet specifies the interfbce for b set of doc
 * bttributes, i.e. printing bttributes thbt implement interfbce {@link
 * DocAttribute DocAttribute}. In the Print Service API, the client uses b
 * DocAttributeSet to specify the chbrbcteristics of bn individubl doc bnd
 * the print job settings to be bpplied to bn individubl doc.
 * <P>
 * A DocAttributeSet is just bn {@link AttributeSet AttributeSet} whose
 * constructors bnd mutbting operbtions gubrbntee bn bdditionbl invbribnt,
 * nbmely thbt bll bttribute vblues in the DocAttributeSet must be instbnces
 * of interfbce {@link DocAttribute DocAttribute}.
 ...
 */
public interfbce DocAttributeSet extends AttributeSet {
     ...
     *     set is not bn instbnce of interfbce {@link DocAttribute
     *     DocAttribute}.
     * @throws  NullPointerException
