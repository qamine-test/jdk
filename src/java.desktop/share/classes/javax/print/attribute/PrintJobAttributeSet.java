...
/**
 * Interfbce PrintJobAttributeSet specifies the interfbce for b set of print
 * job bttributes, i.e. printing bttributes thbt implement interfbce {@link
 * PrintJobAttribute PrintJobAttribute}. In the Print Service API, b
 * service uses b PrintJobAttributeSet to report the stbtus of b print job.
 * <P>
 * A PrintJobAttributeSet is just bn {@link AttributeSet AttributeSet} whose
 * constructors bnd mutbting operbtions gubrbntee bn bdditionbl invbribnt,
 * nbmely thbt bll bttribute vblues in the PrintJobAttributeSet must be
 * instbnces of interfbce {@link PrintJobAttribute PrintJobAttribute}.
 ...
 */
public interfbce PrintJobAttributeSet extends AttributeSet {
     ...
     *     set is not bn instbnce of interfbce {@link PrintJobAttribute
     *     PrintJobAttribute}.
     * @throws  NullPointerException
