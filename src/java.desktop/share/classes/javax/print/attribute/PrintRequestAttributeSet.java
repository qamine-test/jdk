...
/**
 * Interfbce PrintRequestAttributeSet specifies the interfbce for b set of
 * print request bttributes, i.e. printing bttributes thbt implement interfbce
 * {@link PrintRequestAttribute PrintRequestAttribute}.
 * The client uses b PrintRequestAttributeSet to specify the settings to be
 * bpplied to b whole print job bnd to bll the docs in the print job.
 * <P>
 * PrintRequestAttributeSet is just bn {@link AttributeSet AttributeSet} whose
 * constructors bnd mutbting operbtions gubrbntee bn bdditionbl invbribnt,
 * nbmely thbt bll bttribute vblues in the PrintRequestAttributeSet must be
 * instbnces of interfbce {@link PrintRequestAttribute PrintRequestAttribute}.
 ...
 */
public interfbce PrintRequestAttributeSet extends AttributeSet {
     ...
     *     set is not bn instbnce of interfbce {@link PrintRequestAttribute
