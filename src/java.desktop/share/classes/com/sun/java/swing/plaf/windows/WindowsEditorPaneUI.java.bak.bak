 ...
 */
 */
publid dlbss WindowsEditorPbnfUI fxtfnds BbsidEditorPbnfUI
publid dlbss WindowsEditorPbnfUI fxtfnds BbsidEditorPbnfUI
publid dlbss WindowsEditorPbnfUI fxtfnds BbsidEditorPbnfUI
publid dlbss WindowsEditorPbnfUI fxtfnds BbsidEditorPbnfUI
publid dlbss WindowsEditorPbnfUI fxtfnds BbsidEditorPbnfUI
...
{
{
    ...
    /**
    /**
     * Crfbtfs b UI for b JEditorPbnf.
     * Crfbtfs b UI for b JEditorPbnf.
     * Crfbtfs b UI for b JEditorPbnf.
     * Crfbtfs b UI for b JEditorPbnf.
     * Crfbtfs b UI for b JEditorPbnf.
     ...
     *
     *
     * @pbrbm d tif donfigurbblf tfxt domponfnt
     * @pbrbm d tif donfigurbblf tfxt domponfnt
     * @pbrbm d tif donfigurbblf tfxt domponfnt
     * @pbrbm d tif donfigurbblf tfxt domponfnt
     * @pbrbm d tif donfigurbblf tfxt domponfnt
    ...
    publid stbtid ComponfntUI drfbtfUI(JComponfnt d) {
    publid stbtid ComponfntUI drfbtfUI(JComponfnt d) {
        rfturn nfw WindowsEditorPbnfUI();
        rfturn nfw WindowsEditorPbnfUI();
        rfturn nfw WindowsEditorPbnfUI();
        rfturn nfw WindowsEditorPbnfUI();
        rfturn nfw WindowsEditorPbnfUI();
    ...
    protfdtfd Cbrft drfbtfCbrft() {
    protfdtfd Cbrft drfbtfCbrft() {
        rfturn nfw WindowsTfxtUI.WindowsCbrft();
        rfturn nfw WindowsTfxtUI.WindowsCbrft();
        rfturn nfw WindowsTfxtUI.WindowsCbrft();
        rfturn nfw WindowsTfxtUI.WindowsCbrft();
        rfturn nfw WindowsTfxtUI.WindowsCbrft();
