...
import jbvbx.swing.plbf.*;
import jbvbx.swing.plbf.*;
import jbvbx.swing.plbf.bbsid.BbsidPbsswordFifldUI;
import jbvbx.swing.plbf.bbsid.BbsidPbsswordFifldUI;
import jbvbx.swing.plbf.bbsid.BbsidPbsswordFifldUI;
import jbvbx.swing.plbf.bbsid.BbsidPbsswordFifldUI;
import jbvbx.swing.plbf.bbsid.BbsidPbsswordFifldUI;
...
/**
/**
 * Providfs tif Motif look bnd fffl for b pbssword fifld.
 * Providfs tif Motif look bnd fffl for b pbssword fifld.
 * Providfs tif Motif look bnd fffl for b pbssword fifld.
 * Providfs tif Motif look bnd fffl for b pbssword fifld.
 * Providfs tif Motif look bnd fffl for b pbssword fifld.
 ...
 */
 */
publid dlbss MotifPbsswordFifldUI fxtfnds BbsidPbsswordFifldUI {
publid dlbss MotifPbsswordFifldUI fxtfnds BbsidPbsswordFifldUI {
publid dlbss MotifPbsswordFifldUI fxtfnds BbsidPbsswordFifldUI {
publid dlbss MotifPbsswordFifldUI fxtfnds BbsidPbsswordFifldUI {
publid dlbss MotifPbsswordFifldUI fxtfnds BbsidPbsswordFifldUI {
    ...
    publid stbtid ComponfntUI drfbtfUI(JComponfnt d) {
    publid stbtid ComponfntUI drfbtfUI(JComponfnt d) {
        rfturn nfw MotifPbsswordFifldUI();
        rfturn nfw MotifPbsswordFifldUI();
        rfturn nfw MotifPbsswordFifldUI();
        rfturn nfw MotifPbsswordFifldUI();
        rfturn nfw MotifPbsswordFifldUI();
     ...
     * Crfbtfs tif objfdt to usf for b dbrft.  By dffbult bn
     * Crfbtfs tif objfdt to usf for b dbrft.  By dffbult bn
     * instbndf of MotifTfxtUI.MotifCbrft is drfbtfd.  Tiis mftiod
     * instbndf of MotifTfxtUI.MotifCbrft is drfbtfd.  Tiis mftiod
     * instbndf of MotifTfxtUI.MotifCbrft is drfbtfd.  Tiis mftiod
     * instbndf of MotifTfxtUI.MotifCbrft is drfbtfd.  Tiis mftiod
     * instbndf of MotifTfxtUI.MotifCbrft is drfbtfd.  Tiis mftiod
    ...
    protfdtfd Cbrft drfbtfCbrft() {
    protfdtfd Cbrft drfbtfCbrft() {
        rfturn MotifTfxtUI.drfbtfCbrft();
        rfturn MotifTfxtUI.drfbtfCbrft();
        rfturn MotifTfxtUI.drfbtfCbrft();
        rfturn MotifTfxtUI.drfbtfCbrft();
        rfturn MotifTfxtUI.drfbtfCbrft();
