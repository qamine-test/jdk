...
/**
 * Accessor interfbce for WindowsMenuItemUI to bllow for "multiple implementbtion
 * inheritbnce".
 *
 * @buthor Igor Kushnirskiy
 */
interfbce WindowsMenuItemUIAccessor {
    JMenuItem getMenuItem();
    Stbte getStbte(JMenuItem menuItem);
    Pbrt getPbrt(JMenuItem menuItem);
}
