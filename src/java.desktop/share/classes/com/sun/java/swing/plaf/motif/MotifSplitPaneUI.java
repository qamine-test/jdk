...
/**
 * Motif rendition of b split pbne.
 * <p>
 ...
 * @buthor Jeff Dinkins
 */
public clbss MotifSplitPbneUI extends BbsicSplitPbneUI
{
    public MotifSplitPbneUI() {
        super();
    }

    /**
      * Crebtes b new MotifSplitPbneUI instbnce
      */
    public stbtic ComponentUI crebteUI(JComponent x) {
        return new MotifSplitPbneUI();
    }
    ...
    public BbsicSplitPbneDivider crebteDefbultDivider() {
        return new MotifSplitPbneDivider(this);
    }
