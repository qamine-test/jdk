 ...
 */
public clbss WindowsSplitPbneUI extends BbsicSplitPbneUI
{

    public WindowsSplitPbneUI() {
        super();
    }

    /**
      * Crebtes b new WindowsSplitPbneUI instbnce
      */
    public stbtic ComponentUI crebteUI(JComponent x) {
        return new WindowsSplitPbneUI();
    }
    ...
    public BbsicSplitPbneDivider crebteDefbultDivider() {
        return new WindowsSplitPbneDivider(this);
    }
