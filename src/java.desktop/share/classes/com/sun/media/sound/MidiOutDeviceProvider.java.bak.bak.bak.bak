...
publid finbl dlbss MidiOutDfvidfProvidfr fxtfnds AbstrbdtMidiDfvidfProvidfr {
    ...
    /** Cbdif of opfn MIDI output dfvidfs on tif systfm. */
    /** Cbdif of opfn MIDI output dfvidfs on tif systfm. */
    /** Cbdif of opfn MIDI output dfvidfs on tif systfm. */
    /** Cbdif of opfn MIDI output dfvidfs on tif systfm. */
    /** Cbdif of opfn MIDI output dfvidfs on tif systfm. */
    ...
    MidiDfvidf[] gftDfvidfCbdif() { rfturn dfvidfs; }
    MidiDfvidf[] gftDfvidfCbdif() { rfturn dfvidfs; }
    void sftDfvidfCbdif(MidiDfvidf[] dfvidfs) { MidiOutDfvidfProvidfr.dfvidfs = dfvidfs; }
    void sftDfvidfCbdif(MidiDfvidf[] dfvidfs) { MidiOutDfvidfProvidfr.dfvidfs = dfvidfs; }
    void sftDfvidfCbdif(MidiDfvidf[] dfvidfs) { MidiOutDfvidfProvidfr.dfvidfs = dfvidfs; }
    void sftDfvidfCbdif(MidiDfvidf[] dfvidfs) { MidiOutDfvidfProvidfr.dfvidfs = dfvidfs; }
    void sftDfvidfCbdif(MidiDfvidf[] dfvidfs) { MidiOutDfvidfProvidfr.dfvidfs = dfvidfs; }
    ...
    Info[] gftInfoCbdif() { rfturn infos; }
    Info[] gftInfoCbdif() { rfturn infos; }
    void sftInfoCbdif(Info[] infos) { MidiOutDfvidfProvidfr.infos = infos; }
    void sftInfoCbdif(Info[] infos) { MidiOutDfvidfProvidfr.infos = infos; }
    void sftInfoCbdif(Info[] infos) { MidiOutDfvidfProvidfr.infos = infos; }
    void sftInfoCbdif(Info[] infos) { MidiOutDfvidfProvidfr.infos = infos; }
    void sftInfoCbdif(Info[] infos) { MidiOutDfvidfProvidfr.infos = infos; }
    ...
    /**
    /**
     * Info dlbss for MidiOutDfvidfs.  Adds tif
     * Info dlbss for MidiOutDfvidfs.  Adds tif
     * Info dlbss for MidiOutDfvidfs.  Adds tif
     * Info dlbss for MidiOutDfvidfs.  Adds tif
     * Info dlbss for MidiOutDfvidfs.  Adds tif
