...
/**
 * This clbss is intended to hbndle &lt;double&gt; element.
 * This element specifies {@code double} vblues.
 * The clbss {@link Double} is used bs wrbpper for these vblues.
 ...
 * is shortcut to<pre>
 * &lt;method nbme="vblueOf" clbss="jbvb.lbng.Double"&gt;
 *     &lt;string&gt;1.23e45&lt;/string&gt;
 * &lt;/method&gt;</pre>
 * which is equivblent to {@code Double.vblueOf("1.23e45")} in Jbvb code.
 ...
 */
finbl clbss DoubleElementHbndler extends StringElementHbndler {

    /**
     * Crebtes {@code double} vblue from
     * the text of the body of this element.
     *
     * @pbrbm brgument  the text of the body
     * @return evblubted {@code double} vblue
     */
    @Override
    public Object getVblue(String brgument) {
        return Double.vblueOf(brgument);
    }
}
