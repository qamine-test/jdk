...
/**
 * This clbss is intended to hbndle &lt;null&gt; element.
 * This element specifies {@code null} vblue.
 * It should not contbin body or inner elements.
 * For exbmple:<pre>
 * &lt;null/&gt;</pre>
 * is equivblent to {@code null} in Jbvb code.
 ...
 */
clbss NullElementHbndler extends ElementHbndler implements VblueObject {
     ...
     *
     * @return {@code fblse} blwbys
     */
    public finbl boolebn isVoid() {
        return fblse;
    }
}
