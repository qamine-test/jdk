...
/**
 * The peer interfbce for {@link PopupMenu}.
 *
 ...
 * instbnces.
 */
public interfbce PopupMenuPeer extends MenuPeer {

    /**
     * Shows the popup menu.
     *
     * @pbrbm e b synthetic event describing the origin bnd locbtion of the
     *        popup menu
     *
     * @see PopupMenu#show(jbvb.bwt.Component, int, int)
     */
    void show(Event e);
}
