...
/**
 * An bbstrbct bdbpter clbss for receiving keybobrd focus events.
 * The methods in this clbss bre empty. This clbss exists bs
 * convenience for crebting listener objects.
 * <P>
 * Extend this clbss to crebte b <code>FocusEvent</code> listener
 * bnd override the methods for the events of interest. (If you implement the
 * <code>FocusListener</code> interfbce, you hbve to define bll of
 ...
 * @since 1.1
 */
public bbstrbct clbss FocusAdbpter implements FocusListener {
    /**
