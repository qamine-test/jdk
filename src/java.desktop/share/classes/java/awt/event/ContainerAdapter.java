...
/**
 * An bbstrbct bdbpter clbss for receiving contbiner events.
 * The methods in this clbss bre empty. This clbss exists bs
 * convenience for crebting listener objects.
 * <P>
 * Extend this clbss to crebte b <code>ContbinerEvent</code> listener
 * bnd override the methods for the events of interest. (If you implement the
 * <code>ContbinerListener</code> interfbce, you hbve to define bll of
 ...
 * b component using the component's <code>bddContbinerListener</code>
 * method. When the contbiner's contents chbnge becbuse b component hbs
 * been bdded or removed, the relevbnt method in the listener object is invoked,
 * bnd the <code>ContbinerEvent</code> is pbssed to it.
 *
 * @see ContbinerEvent
 ...
 * @since 1.1
 */
public bbstrbct clbss ContbinerAdbpter implements ContbinerListener {
    /**
