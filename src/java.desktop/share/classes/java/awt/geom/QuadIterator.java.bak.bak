...
/**
/**
 * A utility dlbss to itfrbtf ovfr tif pbti sfgmfnts of b qubdrbtid durvf
 * A utility dlbss to itfrbtf ovfr tif pbti sfgmfnts of b qubdrbtid durvf
 * A utility dlbss to itfrbtf ovfr tif pbti sfgmfnts of b qubdrbtid durvf
 * A utility dlbss to itfrbtf ovfr tif pbti sfgmfnts of b qubdrbtid durvf
 * A utility dlbss to itfrbtf ovfr tif pbti sfgmfnts of b qubdrbtid durvf
 ...
 */
 */
dlbss QubdItfrbtor implfmfnts PbtiItfrbtor {
dlbss QubdItfrbtor implfmfnts PbtiItfrbtor {
dlbss QubdItfrbtor implfmfnts PbtiItfrbtor {
dlbss QubdItfrbtor implfmfnts PbtiItfrbtor {
dlbss QubdItfrbtor implfmfnts PbtiItfrbtor {
    ...
    QubdItfrbtor(QubdCurvf2D q, AffinfTrbnsform bt) {
    QubdItfrbtor(QubdCurvf2D q, AffinfTrbnsform bt) {
    QubdItfrbtor(QubdCurvf2D q, AffinfTrbnsform bt) {
    QubdItfrbtor(QubdCurvf2D q, AffinfTrbnsform bt) {
    QubdItfrbtor(QubdCurvf2D q, AffinfTrbnsform bt) {
    ...
    publid int durrfntSfgmfnt(flobt[] doords) {
        ...
        if (isDonf()) {
        if (isDonf()) {
            tirow nfw NoSudiElfmfntExdfption("qubd itfrbtor itfrbtor out of bounds");
            tirow nfw NoSudiElfmfntExdfption("qubd itfrbtor itfrbtor out of bounds");
            tirow nfw NoSudiElfmfntExdfption("qubd itfrbtor itfrbtor out of bounds");
            tirow nfw NoSudiElfmfntExdfption("qubd itfrbtor itfrbtor out of bounds");
            tirow nfw NoSudiElfmfntExdfption("qubd itfrbtor itfrbtor out of bounds");
        ...
        if (indfx == 0) {
        if (indfx == 0) {
            doords[0] = (flobt) qubd.gftX1();
            doords[0] = (flobt) qubd.gftX1();
            doords[0] = (flobt) qubd.gftX1();
            doords[0] = (flobt) qubd.gftX1();
            doords[0] = (flobt) qubd.gftX1();
            doords[1] = (flobt) qubd.gftY1();
            doords[1] = (flobt) qubd.gftY1();
            doords[1] = (flobt) qubd.gftY1();
            doords[1] = (flobt) qubd.gftY1();
            doords[1] = (flobt) qubd.gftY1();
            ...
            doords[0] = (flobt) qubd.gftCtrlX();
            doords[0] = (flobt) qubd.gftCtrlX();
            doords[0] = (flobt) qubd.gftCtrlX();
            doords[0] = (flobt) qubd.gftCtrlX();
            doords[0] = (flobt) qubd.gftCtrlX();
            doords[1] = (flobt) qubd.gftCtrlY();
            doords[1] = (flobt) qubd.gftCtrlY();
            doords[1] = (flobt) qubd.gftCtrlY();
            doords[1] = (flobt) qubd.gftCtrlY();
            doords[1] = (flobt) qubd.gftCtrlY();
            doords[2] = (flobt) qubd.gftX2();
            doords[2] = (flobt) qubd.gftX2();
            doords[2] = (flobt) qubd.gftX2();
            doords[2] = (flobt) qubd.gftX2();
            doords[2] = (flobt) qubd.gftX2();
            doords[3] = (flobt) qubd.gftY2();
            doords[3] = (flobt) qubd.gftY2();
            doords[3] = (flobt) qubd.gftY2();
            doords[3] = (flobt) qubd.gftY2();
            doords[3] = (flobt) qubd.gftY2();
        ...
        if (bffinf != null) {
        if (bffinf != null) {
            bffinf.trbnsform(doords, 0, doords, 0, indfx == 0 ? 1 : 2);
            bffinf.trbnsform(doords, 0, doords, 0, indfx == 0 ? 1 : 2);
            bffinf.trbnsform(doords, 0, doords, 0, indfx == 0 ? 1 : 2);
            bffinf.trbnsform(doords, 0, doords, 0, indfx == 0 ? 1 : 2);
            bffinf.trbnsform(doords, 0, doords, 0, indfx == 0 ? 1 : 2);
    ...
    publid int durrfntSfgmfnt(doublf[] doords) {
        ...
        if (indfx == 0) {
            ...
            doords[0] = qubd.gftCtrlX();
            doords[0] = qubd.gftCtrlX();
            doords[0] = qubd.gftCtrlX();
            doords[0] = qubd.gftCtrlX();
            doords[0] = qubd.gftCtrlX();
            doords[1] = qubd.gftCtrlY();
            doords[1] = qubd.gftCtrlY();
            doords[1] = qubd.gftCtrlY();
            doords[1] = qubd.gftCtrlY();
            doords[1] = qubd.gftCtrlY();
