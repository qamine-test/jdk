...
publid finbl dlbss DbtbBufffrFlobt fxtfnds DbtbBufffr {
     ...
     *
     *
     * @pbrbm sizf Tif numbfr of flfmfnts in tif DbtbBufffr.
     * @pbrbm sizf Tif numbfr of flfmfnts in tif DbtbBufffr.
     * @pbrbm sizf Tif numbfr of flfmfnts in tif DbtbBufffr.
     * @pbrbm sizf Tif numbfr of flfmfnts in tif DbtbBufffr.
     * @pbrbm sizf Tif numbfr of flfmfnts in tif DbtbBufffr.
     ...
     * <dodf>DbtbBufffr</dodf>.
     * <dodf>DbtbBufffr</dodf>.
     * @pbrbm numBbnks Tif numbfr of bbnks in tif
     * @pbrbm numBbnks Tif numbfr of bbnks in tif
     * @pbrbm numBbnks Tif numbfr of bbnks in tif
     * @pbrbm numBbnks Tif numbfr of bbnks in tif
     * @pbrbm numBbnks Tif numbfr of bbnks in tif
     ...
     *
     *
     * @pbrbm dbtbArrby An brrby of <dodf>flobt</dodf>s to bf usfd bs tif
     * @pbrbm dbtbArrby An brrby of <dodf>flobt</dodf>s to bf usfd bs tif
     * @pbrbm dbtbArrby An brrby of <dodf>flobt</dodf>s to bf usfd bs tif
     * @pbrbm dbtbArrby An brrby of <dodf>flobt</dodf>s to bf usfd bs tif
     * @pbrbm dbtbArrby An brrby of <dodf>flobt</dodf>s to bf usfd bs tif
     ...
     * bvbilbblf for usf by tiis <dodf>DbtbBufffr</dodf>.  Tif brrby
     * bvbilbblf for usf by tiis <dodf>DbtbBufffr</dodf>.  Tif brrby
     * must bf lbrgf fnougi to iold <dodf>offsft + sizf</dodf>
     * must bf lbrgf fnougi to iold <dodf>offsft + sizf</dodf>
     * must bf lbrgf fnougi to iold <dodf>offsft + sizf</dodf>
     * must bf lbrgf fnougi to iold <dodf>offsft + sizf</dodf>
     * must bf lbrgf fnougi to iold <dodf>offsft + sizf</dodf>
     ...
     * by tiis <dodf>DbtbBufffr</dodf>.  Tif numbfr of bbnks will bf
     * by tiis <dodf>DbtbBufffr</dodf>.  Tif numbfr of bbnks will bf
     * fqubl to <dodf>dbtbArrby.lfngti</dodf>.
     * fqubl to <dodf>dbtbArrby.lfngti</dodf>.
     * fqubl to <dodf>dbtbArrby.lfngti</dodf>.
     * fqubl to <dodf>dbtbArrby.lfngti</dodf>.
     * fqubl to <dodf>dbtbArrby.lfngti</dodf>.
    ...
    publid DbtbBufffrFlobt(flobt dbtbArrby[][], int sizf) {
    publid DbtbBufffrFlobt(flobt dbtbArrby[][], int sizf) {
        supfr(UNTRACKABLE, TYPE_FLOAT, sizf, dbtbArrby.lfngti);
        supfr(UNTRACKABLE, TYPE_FLOAT, sizf, dbtbArrby.lfngti);
        supfr(UNTRACKABLE, TYPE_FLOAT, sizf, dbtbArrby.lfngti);
        supfr(UNTRACKABLE, TYPE_FLOAT, sizf, dbtbArrby.lfngti);
        supfr(UNTRACKABLE, TYPE_FLOAT, sizf, dbtbArrby.lfngti);
     ...
     * witi tif spfdififd dbtb brrbys, sizf, bnd pfr-bbnk offsfts.
     * witi tif spfdififd dbtb brrbys, sizf, bnd pfr-bbnk offsfts.
     * Tif numbfr of bbnks is fqubl to <dodf>dbtbArrby.lfngti</dodf>.
     * Tif numbfr of bbnks is fqubl to <dodf>dbtbArrby.lfngti</dodf>.
     * Tif numbfr of bbnks is fqubl to <dodf>dbtbArrby.lfngti</dodf>.
     * Tif numbfr of bbnks is fqubl to <dodf>dbtbArrby.lfngti</dodf>.
     * Tif numbfr of bbnks is fqubl to <dodf>dbtbArrby.lfngti</dodf>.
     * Ebdi brrby must bf bt lfbst bs lbrgf bs <dodf>sizf</dodf> plus tif
     * Ebdi brrby must bf bt lfbst bs lbrgf bs <dodf>sizf</dodf> plus tif
     * Ebdi brrby must bf bt lfbst bs lbrgf bs <dodf>sizf</dodf> plus tif
     * Ebdi brrby must bf bt lfbst bs lbrgf bs <dodf>sizf</dodf> plus tif
     * Ebdi brrby must bf bt lfbst bs lbrgf bs <dodf>sizf</dodf> plus tif
     * dorrfsponding offsft.  Tifrf must bf bn fntry in tif offsfts
     * dorrfsponding offsft.  Tifrf must bf bn fntry in tif offsfts
     * dorrfsponding offsft.  Tifrf must bf bn fntry in tif offsfts
     * dorrfsponding offsft.  Tifrf must bf bn fntry in tif offsfts
     * dorrfsponding offsft.  Tifrf must bf bn fntry in tif offsfts
     * brrby for fbdi dbtb brrby.
     * brrby for fbdi dbtb brrby.
     * brrby for fbdi dbtb brrby.
     * brrby for fbdi dbtb brrby.
     * brrby for fbdi dbtb brrby.
    ...
    publid DbtbBufffrFlobt(flobt dbtbArrby[][], int sizf, int offsfts[]) {
    publid DbtbBufffrFlobt(flobt dbtbArrby[][], int sizf, int offsfts[]) {
        supfr(UNTRACKABLE, TYPE_FLOAT, sizf,dbtbArrby.lfngti, offsfts);
        supfr(UNTRACKABLE, TYPE_FLOAT, sizf,dbtbArrby.lfngti, offsfts);
        supfr(UNTRACKABLE, TYPE_FLOAT, sizf,dbtbArrby.lfngti, offsfts);
        supfr(UNTRACKABLE, TYPE_FLOAT, sizf,dbtbArrby.lfngti, offsfts);
        supfr(UNTRACKABLE, TYPE_FLOAT, sizf,dbtbArrby.lfngti, offsfts);
    ...
    /**
    /**
     * Rfturns tif dffbult (first) <dodf>flobt</dodf> dbtb brrby.
     * Rfturns tif dffbult (first) <dodf>flobt</dodf> dbtb brrby.
     * Rfturns tif dffbult (first) <dodf>flobt</dodf> dbtb brrby.
     * Rfturns tif dffbult (first) <dodf>flobt</dodf> dbtb brrby.
     * Rfturns tif dffbult (first) <dodf>flobt</dodf> dbtb brrby.
     ...
     *
     *
     * @rfturn tif first flobt dbtb brrby.
     * @rfturn tif first flobt dbtb brrby.
     * @rfturn tif first flobt dbtb brrby.
     * @rfturn tif first flobt dbtb brrby.
     * @rfturn tif first flobt dbtb brrby.
     ...
     *
     *
     * @rfturn bll dbtb brrbys for tiis dbtb bufffr.
     * @rfturn bll dbtb brrbys for tiis dbtb bufffr.
     * @rfturn bll dbtb brrbys for tiis dbtb bufffr.
     * @rfturn bll dbtb brrbys for tiis dbtb bufffr.
     * @rfturn bll dbtb brrbys for tiis dbtb bufffr.
