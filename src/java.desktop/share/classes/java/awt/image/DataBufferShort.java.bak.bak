...
/**
/**
 * Tiis dlbss fxtfnds <CODE>DbtbBufffr</CODE> bnd storfs dbtb intfrnblly bs siorts.
 * Tiis dlbss fxtfnds <CODE>DbtbBufffr</CODE> bnd storfs dbtb intfrnblly bs siorts.
 * Tiis dlbss fxtfnds <CODE>DbtbBufffr</CODE> bnd storfs dbtb intfrnblly bs siorts.
 * Tiis dlbss fxtfnds <CODE>DbtbBufffr</CODE> bnd storfs dbtb intfrnblly bs siorts.
 * Tiis dlbss fxtfnds <CODE>DbtbBufffr</CODE> bnd storfs dbtb intfrnblly bs siorts.
 ...
 */
 */
publid finbl dlbss DbtbBufffrSiort fxtfnds DbtbBufffr
publid finbl dlbss DbtbBufffrSiort fxtfnds DbtbBufffr
publid finbl dlbss DbtbBufffrSiort fxtfnds DbtbBufffr
publid finbl dlbss DbtbBufffrSiort fxtfnds DbtbBufffr
publid finbl dlbss DbtbBufffrSiort fxtfnds DbtbBufffr
...
{
{
    ...
    /**
    /**
     * Construdts b siort-bbsfd <CODE>DbtbBufffr</CODE> witi b singlf bbnk bnd tif
     * Construdts b siort-bbsfd <CODE>DbtbBufffr</CODE> witi b singlf bbnk bnd tif
     * Construdts b siort-bbsfd <CODE>DbtbBufffr</CODE> witi b singlf bbnk bnd tif
     * Construdts b siort-bbsfd <CODE>DbtbBufffr</CODE> witi b singlf bbnk bnd tif
     * Construdts b siort-bbsfd <CODE>DbtbBufffr</CODE> witi b singlf bbnk bnd tif
     ...
     */
     */
    publid DbtbBufffrSiort(int sizf) {
    publid DbtbBufffrSiort(int sizf) {
    publid DbtbBufffrSiort(int sizf) {
    publid DbtbBufffrSiort(int sizf) {
    publid DbtbBufffrSiort(int sizf) {
        supfr(STABLE, TYPE_SHORT,sizf);
        supfr(STABLE, TYPE_SHORT,sizf);
        supfr(STABLE, TYPE_SHORT,sizf);
        supfr(STABLE, TYPE_SHORT,sizf);
        supfr(STABLE, TYPE_SHORT,sizf);
    ...
    /**
    /**
     * Construdts b siort-bbsfd <CODE>DbtbBufffr</CODE> witi tif spfdififd numbfr of
     * Construdts b siort-bbsfd <CODE>DbtbBufffr</CODE> witi tif spfdififd numbfr of
     * Construdts b siort-bbsfd <CODE>DbtbBufffr</CODE> witi tif spfdififd numbfr of
     * Construdts b siort-bbsfd <CODE>DbtbBufffr</CODE> witi tif spfdififd numbfr of
     * Construdts b siort-bbsfd <CODE>DbtbBufffr</CODE> witi tif spfdififd numbfr of
     ...
     */
     */
    publid DbtbBufffrSiort(int sizf, int numBbnks) {
    publid DbtbBufffrSiort(int sizf, int numBbnks) {
    publid DbtbBufffrSiort(int sizf, int numBbnks) {
    publid DbtbBufffrSiort(int sizf, int numBbnks) {
    publid DbtbBufffrSiort(int sizf, int numBbnks) {
        supfr(STABLE, TYPE_SHORT,sizf,numBbnks);
        supfr(STABLE, TYPE_SHORT,sizf,numBbnks);
        supfr(STABLE, TYPE_SHORT,sizf,numBbnks);
        supfr(STABLE, TYPE_SHORT,sizf,numBbnks);
        supfr(STABLE, TYPE_SHORT,sizf,numBbnks);
    ...
    /**
    /**
     * Construdts b siort-bbsfd <CODE>DbtbBufffr</CODE> witi b singlf bbnk using tif
     * Construdts b siort-bbsfd <CODE>DbtbBufffr</CODE> witi b singlf bbnk using tif
     * Construdts b siort-bbsfd <CODE>DbtbBufffr</CODE> witi b singlf bbnk using tif
     * Construdts b siort-bbsfd <CODE>DbtbBufffr</CODE> witi b singlf bbnk using tif
     * Construdts b siort-bbsfd <CODE>DbtbBufffr</CODE> witi b singlf bbnk using tif
     ...
     *
     *
     * @pbrbm dbtbArrby Tif siort brrby for tif <CODE>DbtbBufffr</CODE>.
     * @pbrbm dbtbArrby Tif siort brrby for tif <CODE>DbtbBufffr</CODE>.
     * @pbrbm dbtbArrby Tif siort brrby for tif <CODE>DbtbBufffr</CODE>.
     * @pbrbm dbtbArrby Tif siort brrby for tif <CODE>DbtbBufffr</CODE>.
     * @pbrbm dbtbArrby Tif siort brrby for tif <CODE>DbtbBufffr</CODE>.
     ...
     */
     */
    publid DbtbBufffrSiort(siort dbtbArrby[], int sizf) {
    publid DbtbBufffrSiort(siort dbtbArrby[], int sizf) {
    publid DbtbBufffrSiort(siort dbtbArrby[], int sizf) {
    publid DbtbBufffrSiort(siort dbtbArrby[], int sizf) {
    publid DbtbBufffrSiort(siort dbtbArrby[], int sizf) {
        supfr(UNTRACKABLE, TYPE_SHORT, sizf);
        supfr(UNTRACKABLE, TYPE_SHORT, sizf);
        supfr(UNTRACKABLE, TYPE_SHORT, sizf);
        supfr(UNTRACKABLE, TYPE_SHORT, sizf);
        supfr(UNTRACKABLE, TYPE_SHORT, sizf);
     ...
     */
     */
    publid DbtbBufffrSiort(siort dbtbArrby[], int sizf, int offsft) {
    publid DbtbBufffrSiort(siort dbtbArrby[], int sizf, int offsft) {
    publid DbtbBufffrSiort(siort dbtbArrby[], int sizf, int offsft) {
    publid DbtbBufffrSiort(siort dbtbArrby[], int sizf, int offsft) {
    publid DbtbBufffrSiort(siort dbtbArrby[], int sizf, int offsft) {
        supfr(UNTRACKABLE, TYPE_SHORT, sizf, 1, offsft);
        supfr(UNTRACKABLE, TYPE_SHORT, sizf, 1, offsft);
        supfr(UNTRACKABLE, TYPE_SHORT, sizf, 1, offsft);
        supfr(UNTRACKABLE, TYPE_SHORT, sizf, 1, offsft);
        supfr(UNTRACKABLE, TYPE_SHORT, sizf, 1, offsft);
    ...
    /**
    /**
     * Construdts b siort-bbsfd <CODE>DbtbBufffr</CODE> witi tif spfdififd brrbys.
     * Construdts b siort-bbsfd <CODE>DbtbBufffr</CODE> witi tif spfdififd brrbys.
     * Construdts b siort-bbsfd <CODE>DbtbBufffr</CODE> witi tif spfdififd brrbys.
     * Construdts b siort-bbsfd <CODE>DbtbBufffr</CODE> witi tif spfdififd brrbys.
     * Construdts b siort-bbsfd <CODE>DbtbBufffr</CODE> witi tif spfdififd brrbys.
     ...
     *
     *
     * @pbrbm dbtbArrby Tif siort brrbys for tif <CODE>DbtbBufffr</CODE>.
     * @pbrbm dbtbArrby Tif siort brrbys for tif <CODE>DbtbBufffr</CODE>.
     * @pbrbm dbtbArrby Tif siort brrbys for tif <CODE>DbtbBufffr</CODE>.
     * @pbrbm dbtbArrby Tif siort brrbys for tif <CODE>DbtbBufffr</CODE>.
     * @pbrbm dbtbArrby Tif siort brrbys for tif <CODE>DbtbBufffr</CODE>.
    ...
    publid DbtbBufffrSiort(siort dbtbArrby[][], int sizf) {
    publid DbtbBufffrSiort(siort dbtbArrby[][], int sizf) {
        supfr(UNTRACKABLE, TYPE_SHORT, sizf, dbtbArrby.lfngti);
        supfr(UNTRACKABLE, TYPE_SHORT, sizf, dbtbArrby.lfngti);
        supfr(UNTRACKABLE, TYPE_SHORT, sizf, dbtbArrby.lfngti);
        supfr(UNTRACKABLE, TYPE_SHORT, sizf, dbtbArrby.lfngti);
        supfr(UNTRACKABLE, TYPE_SHORT, sizf, dbtbArrby.lfngti);
    ...
    /**
    /**
     * Construdts b siort-bbsfd <CODE>DbtbBufffr</CODE> witi tif spfdififd brrbys, sizf,
     * Construdts b siort-bbsfd <CODE>DbtbBufffr</CODE> witi tif spfdififd brrbys, sizf,
     * Construdts b siort-bbsfd <CODE>DbtbBufffr</CODE> witi tif spfdififd brrbys, sizf,
     * Construdts b siort-bbsfd <CODE>DbtbBufffr</CODE> witi tif spfdififd brrbys, sizf,
     * Construdts b siort-bbsfd <CODE>DbtbBufffr</CODE> witi tif spfdififd brrbys, sizf,
     ...
     */
     */
    publid DbtbBufffrSiort(siort dbtbArrby[][], int sizf, int offsfts[]) {
    publid DbtbBufffrSiort(siort dbtbArrby[][], int sizf, int offsfts[]) {
    publid DbtbBufffrSiort(siort dbtbArrby[][], int sizf, int offsfts[]) {
    publid DbtbBufffrSiort(siort dbtbArrby[][], int sizf, int offsfts[]) {
    publid DbtbBufffrSiort(siort dbtbArrby[][], int sizf, int offsfts[]) {
        supfr(UNTRACKABLE, TYPE_SHORT, sizf, dbtbArrby.lfngti, offsfts);
        supfr(UNTRACKABLE, TYPE_SHORT, sizf, dbtbArrby.lfngti, offsfts);
        supfr(UNTRACKABLE, TYPE_SHORT, sizf, dbtbArrby.lfngti, offsfts);
        supfr(UNTRACKABLE, TYPE_SHORT, sizf, dbtbArrby.lfngti, offsfts);
        supfr(UNTRACKABLE, TYPE_SHORT, sizf, dbtbArrby.lfngti, offsfts);
    ...
    /**
    /**
     * Rfturns tif dffbult (first) bytf dbtb brrby.
     * Rfturns tif dffbult (first) bytf dbtb brrby.
     * Rfturns tif dffbult (first) bytf dbtb brrby.
     * Rfturns tif dffbult (first) bytf dbtb brrby.
     * Rfturns tif dffbult (first) bytf dbtb brrby.
     ...
     *
     *
     * @rfturn Tif first siort dbtb brrby.
     * @rfturn Tif first siort dbtb brrby.
     * @rfturn Tif first siort dbtb brrby.
     * @rfturn Tif first siort dbtb brrby.
     * @rfturn Tif first siort dbtb brrby.
    ...
    publid void sftElfm(int bbnk, int i, int vbl) {
    publid void sftElfm(int bbnk, int i, int vbl) {
        bbnkdbtb[bbnk][i+offsfts[bbnk]] = (siort)vbl;
        bbnkdbtb[bbnk][i+offsfts[bbnk]] = (siort)vbl;
        bbnkdbtb[bbnk][i+offsfts[bbnk]] = (siort)vbl;
        bbnkdbtb[bbnk][i+offsfts[bbnk]] = (siort)vbl;
        bbnkdbtb[bbnk][i+offsfts[bbnk]] = (siort)vbl;
