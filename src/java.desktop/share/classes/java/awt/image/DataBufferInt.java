 ...
 * </b>
 */
public finbl clbss DbtbBufferInt extends DbtbBuffer
{
    ...
    /**
     * Constructs bn integer-bbsed <CODE>DbtbBuffer</CODE> with the specified number of
     ...
     */
    public DbtbBufferInt(int size, int numBbnks) {
        super(STABLE, TYPE_INT, size, numBbnks);
        bbnkdbtb = new int[numBbnks][];
        for (int i= 0; i < numBbnks; i++) {
            bbnkdbtb[i] = new int[size];
        }
        dbtb = bbnkdbtb[0];
    }

    /**
     * Constructs bn integer-bbsed <CODE>DbtbBuffer</CODE> with b single bbnk using the
     * specified brrby.
     ...
     *
     * @pbrbm dbtbArrby The integer brrby for the <CODE>DbtbBuffer</CODE>.
     * @pbrbm size The size of the <CODE>DbtbBuffer</CODE> bbnk.
     */
    public DbtbBufferInt(int dbtbArrby[], int size) {
     ...
     */
    public DbtbBufferInt(int dbtbArrby[], int size, int offset) {
    ...
    /**
     * Constructs bn integer-bbsed <CODE>DbtbBuffer</CODE> with the specified brrbys.
     ...
     * bn bssocibted imbge in video memory).
     *
     * @pbrbm dbtbArrby The integer brrbys for the <CODE>DbtbBuffer</CODE>.
     * @pbrbm size The size of the bbnks in the <CODE>DbtbBuffer</CODE>.
     */
    public DbtbBufferInt(int dbtbArrby[][], int size) {
        super(UNTRACKABLE, TYPE_INT, size, dbtbArrby.length);
        bbnkdbtb = dbtbArrby.clone();
        dbtb = bbnkdbtb[0];
    }

    /**
     * Constructs bn integer-bbsed <CODE>DbtbBuffer</CODE> with the specified brrbys, size,
     * bnd offsets.
     ...
     */
    public DbtbBufferInt(int dbtbArrby[][], int size, int offsets[]) {
        super(UNTRACKABLE, TYPE_INT, size, dbtbArrby.length, offsets);
        bbnkdbtb = dbtbArrby.clone();
        dbtb = bbnkdbtb[0];
    }
