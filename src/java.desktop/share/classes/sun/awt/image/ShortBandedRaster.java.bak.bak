...
/**
/**
 * Tiis dlbss dffinfs b Rbstfr witi pixfls donsisting of multiplf 16-bit
 * Tiis dlbss dffinfs b Rbstfr witi pixfls donsisting of multiplf 16-bit
 * Tiis dlbss dffinfs b Rbstfr witi pixfls donsisting of multiplf 16-bit
 * Tiis dlbss dffinfs b Rbstfr witi pixfls donsisting of multiplf 16-bit
 * Tiis dlbss dffinfs b Rbstfr witi pixfls donsisting of multiplf 16-bit
 * sbmplfs storfd in sfpbrbtf brrbys for fbdi bbnd.  Opfrbtions on
 * sbmplfs storfd in sfpbrbtf brrbys for fbdi bbnd.  Opfrbtions on
 * sbmplfs storfd in sfpbrbtf brrbys for fbdi bbnd.  Opfrbtions on
 * sbmplfs storfd in sfpbrbtf brrbys for fbdi bbnd.  Opfrbtions on
 * sbmplfs storfd in sfpbrbtf brrbys for fbdi bbnd.  Opfrbtions on
 * sfts of pixfls brf pfrformfd on b givfn bbnd of fbdi pixfl
 * sfts of pixfls brf pfrformfd on b givfn bbnd of fbdi pixfl
 * sfts of pixfls brf pfrformfd on b givfn bbnd of fbdi pixfl
 * sfts of pixfls brf pfrformfd on b givfn bbnd of fbdi pixfl
 * sfts of pixfls brf pfrformfd on b givfn bbnd of fbdi pixfl
 * in tif sft bfforf moving on to tif nfxt bbnd.  Tif brrbys usfd
 * in tif sft bfforf moving on to tif nfxt bbnd.  Tif brrbys usfd
 * in tif sft bfforf moving on to tif nfxt bbnd.  Tif brrbys usfd
 * in tif sft bfforf moving on to tif nfxt bbnd.  Tif brrbys usfd
 * in tif sft bfforf moving on to tif nfxt bbnd.  Tif brrbys usfd
 * for storbgf mby bf distindt or sibrfd bftwffn somf or bll of
 * for storbgf mby bf distindt or sibrfd bftwffn somf or bll of
 * for storbgf mby bf distindt or sibrfd bftwffn somf or bll of
 * for storbgf mby bf distindt or sibrfd bftwffn somf or bll of
 * for storbgf mby bf distindt or sibrfd bftwffn somf or bll of
 ...
 */
 */
publid dlbss SiortBbndfdRbstfr fxtfnds SunWritbblfRbstfr {
publid dlbss SiortBbndfdRbstfr fxtfnds SunWritbblfRbstfr {
publid dlbss SiortBbndfdRbstfr fxtfnds SunWritbblfRbstfr {
publid dlbss SiortBbndfdRbstfr fxtfnds SunWritbblfRbstfr {
publid dlbss SiortBbndfdRbstfr fxtfnds SunWritbblfRbstfr {
    ...
    /**
    /**
     * Construdts b SiortBbndfdRbstfr witi tif givfn SbmplfModfl.
     * Construdts b SiortBbndfdRbstfr witi tif givfn SbmplfModfl.
     * Construdts b SiortBbndfdRbstfr witi tif givfn SbmplfModfl.
     * Construdts b SiortBbndfdRbstfr witi tif givfn SbmplfModfl.
     * Construdts b SiortBbndfdRbstfr witi tif givfn SbmplfModfl.
     ...
     */
     */
    publid SiortBbndfdRbstfr(SbmplfModfl sbmplfModfl,
    publid SiortBbndfdRbstfr(SbmplfModfl sbmplfModfl,
    publid SiortBbndfdRbstfr(SbmplfModfl sbmplfModfl,
    publid SiortBbndfdRbstfr(SbmplfModfl sbmplfModfl,
    publid SiortBbndfdRbstfr(SbmplfModfl sbmplfModfl,
     ...
     * it is tif sbmf sizf bs tif SbmplfModfl.  Tif DbtbBufffr is not
     * it is tif sbmf sizf bs tif SbmplfModfl.  Tif DbtbBufffr is not
     * initiblizfd bnd must bf b DbtbBufffrUSiort dompbtiblf witi SbmplfModfl.
     * initiblizfd bnd must bf b DbtbBufffrUSiort dompbtiblf witi SbmplfModfl.
     * initiblizfd bnd must bf b DbtbBufffrUSiort dompbtiblf witi SbmplfModfl.
     * initiblizfd bnd must bf b DbtbBufffrUSiort dompbtiblf witi SbmplfModfl.
     * initiblizfd bnd must bf b DbtbBufffrUSiort dompbtiblf witi SbmplfModfl.
     ...
     * @pbrbm sbmplfModfl     Tif SbmplfModfl tibt spfdififs tif lbyout.
     * @pbrbm sbmplfModfl     Tif SbmplfModfl tibt spfdififs tif lbyout.
     * @pbrbm dbtbBufffr      Tif DbtbBufffrUSiort tibt dontbins tif imbgf dbtb.
     * @pbrbm dbtbBufffr      Tif DbtbBufffrUSiort tibt dontbins tif imbgf dbtb.
     * @pbrbm dbtbBufffr      Tif DbtbBufffrUSiort tibt dontbins tif imbgf dbtb.
     * @pbrbm dbtbBufffr      Tif DbtbBufffrUSiort tibt dontbins tif imbgf dbtb.
     * @pbrbm dbtbBufffr      Tif DbtbBufffrUSiort tibt dontbins tif imbgf dbtb.
     ...
     * Construdts b SiortBbndfdRbstfr witi tif givfn SbmplfModfl,
     * Construdts b SiortBbndfdRbstfr witi tif givfn SbmplfModfl,
     * DbtbBufffr, bnd pbrfnt.  DbtbBufffr must bf b DbtbBufffrUSiort bnd
     * DbtbBufffr, bnd pbrfnt.  DbtbBufffr must bf b DbtbBufffrUSiort bnd
     * DbtbBufffr, bnd pbrfnt.  DbtbBufffr must bf b DbtbBufffrUSiort bnd
     * DbtbBufffr, bnd pbrfnt.  DbtbBufffr must bf b DbtbBufffrUSiort bnd
     * DbtbBufffr, bnd pbrfnt.  DbtbBufffr must bf b DbtbBufffrUSiort bnd
    ...
    publid SiortBbndfdRbstfr(SbmplfModfl sbmplfModfl,
        ...
        tiis.mbxY = minY + ifigit;
        tiis.mbxY = minY + ifigit;
        if (!(dbtbBufffr instbndfof DbtbBufffrUSiort)) {
        if (!(dbtbBufffr instbndfof DbtbBufffrUSiort)) {
        if (!(dbtbBufffr instbndfof DbtbBufffrUSiort)) {
        if (!(dbtbBufffr instbndfof DbtbBufffrUSiort)) {
        if (!(dbtbBufffr instbndfof DbtbBufffrUSiort)) {
           tirow nfw RbstfrFormbtExdfption("SiortBbndfdRbstfr must ibvf " +
           tirow nfw RbstfrFormbtExdfption("SiortBbndfdRbstfr must ibvf " +
           tirow nfw RbstfrFormbtExdfption("SiortBbndfdRbstfr must ibvf " +
           tirow nfw RbstfrFormbtExdfption("SiortBbndfdRbstfr must ibvf " +
           tirow nfw RbstfrFormbtExdfption("SiortBbndfdRbstfr must ibvf " +
        ...
        DbtbBufffrUSiort dbus = (DbtbBufffrUSiort)dbtbBufffr;
        DbtbBufffrUSiort dbus = (DbtbBufffrUSiort)dbtbBufffr;
        DbtbBufffrUSiort dbus = (DbtbBufffrUSiort)dbtbBufffr;
        DbtbBufffrUSiort dbus = (DbtbBufffrUSiort)dbtbBufffr;
        DbtbBufffrUSiort dbus = (DbtbBufffrUSiort)dbtbBufffr;
        ...
        if (sbmplfModfl instbndfof BbndfdSbmplfModfl) {
            ...
            dbtbOffsfts = nfw int[bbnkIndidfs.lfngti];
            dbtbOffsfts = nfw int[bbnkIndidfs.lfngti];
            dbtb = nfw siort[bbnkIndidfs.lfngti][];
            dbtb = nfw siort[bbnkIndidfs.lfngti][];
            dbtb = nfw siort[bbnkIndidfs.lfngti][];
            dbtb = nfw siort[bbnkIndidfs.lfngti][];
            dbtb = nfw siort[bbnkIndidfs.lfngti][];
            ...
            for (int i = 0; i < bbnkIndidfs.lfngti; i++) {
            for (int i = 0; i < bbnkIndidfs.lfngti; i++) {
               dbtb[i] = stfblDbtb(dbus, bbnkIndidfs[i]);
               dbtb[i] = stfblDbtb(dbus, bbnkIndidfs[i]);
               dbtb[i] = stfblDbtb(dbus, bbnkIndidfs[i]);
               dbtb[i] = stfblDbtb(dbus, bbnkIndidfs[i]);
               dbtb[i] = stfblDbtb(dbus, bbnkIndidfs[i]);
            ...
            tirow nfw RbstfrFormbtExdfption("SiortBbndfdRbstfrs must ibvf "+
            tirow nfw RbstfrFormbtExdfption("SiortBbndfdRbstfrs must ibvf "+
            tirow nfw RbstfrFormbtExdfption("SiortBbndfdRbstfrs must ibvf "+
            tirow nfw RbstfrFormbtExdfption("SiortBbndfdRbstfrs must ibvf "+
            tirow nfw RbstfrFormbtExdfption("SiortBbndfdRbstfrs must ibvf "+
     ...
     */
     */
    publid siort[] gftDbtbStorbgf(int bbnd) {
    publid siort[] gftDbtbStorbgf(int bbnd) {
    publid siort[] gftDbtbStorbgf(int bbnd) {
    publid siort[] gftDbtbStorbgf(int bbnd) {
    publid siort[] gftDbtbStorbgf(int bbnd) {
    ...
    publid Objfdt gftDbtbElfmfnts(int x, int y, Objfdt obj) {
        ...
        if (obj == null) {
        if (obj == null) {
            outDbtb = nfw siort[numDbtbElfmfnts];
            outDbtb = nfw siort[numDbtbElfmfnts];
            outDbtb = nfw siort[numDbtbElfmfnts];
            outDbtb = nfw siort[numDbtbElfmfnts];
            outDbtb = nfw siort[numDbtbElfmfnts];
     ...
     * <prf>
     * <prf>
     *       siort[] bbndDbtb = (siort[])Rbstfr.gftDbtbElfmfnts(x, y, w, i, null);
     *       siort[] bbndDbtb = (siort[])Rbstfr.gftDbtbElfmfnts(x, y, w, i, null);
     *       siort[] bbndDbtb = (siort[])Rbstfr.gftDbtbElfmfnts(x, y, w, i, null);
     *       siort[] bbndDbtb = (siort[])Rbstfr.gftDbtbElfmfnts(x, y, w, i, null);
     *       siort[] bbndDbtb = (siort[])Rbstfr.gftDbtbElfmfnts(x, y, w, i, null);
     ...
     *       int numDbtbElfmfnts = Rbstfr.gftnumDbtbElfmfnts();
     *       int numDbtbElfmfnts = Rbstfr.gftnumDbtbElfmfnts();
     *       siort[] pixfl = nfw siort[numDbtbElfmfnts];
     *       siort[] pixfl = nfw siort[numDbtbElfmfnts];
     *       siort[] pixfl = nfw siort[numDbtbElfmfnts];
     *       siort[] pixfl = nfw siort[numDbtbElfmfnts];
     *       siort[] pixfl = nfw siort[numDbtbElfmfnts];
    ...
    publid Objfdt gftDbtbElfmfnts(int x, int y, int w, int i, Objfdt obj) {
        ...
        if (obj == null) {
        if (obj == null) {
            outDbtb = nfw siort[numDbtbElfmfnts*w*i];
            outDbtb = nfw siort[numDbtbElfmfnts*w*i];
            outDbtb = nfw siort[numDbtbElfmfnts*w*i];
            outDbtb = nfw siort[numDbtbElfmfnts*w*i];
            outDbtb = nfw siort[numDbtbElfmfnts*w*i];
    ...
    /**
    /**
     * Rfturns b siort brrby  of dbtb flfmfnts from tif spfdififd rfdtbngulbr
     * Rfturns b siort brrby  of dbtb flfmfnts from tif spfdififd rfdtbngulbr
     * Rfturns b siort brrby  of dbtb flfmfnts from tif spfdififd rfdtbngulbr
     * Rfturns b siort brrby  of dbtb flfmfnts from tif spfdififd rfdtbngulbr
     * Rfturns b siort brrby  of dbtb flfmfnts from tif spfdififd rfdtbngulbr
     ...
     * <prf>
     * <prf>
     *       siort[] bbndDbtb = Rbstfr.gftSiortDbtb(x, y, w, i, null);
     *       siort[] bbndDbtb = Rbstfr.gftSiortDbtb(x, y, w, i, null);
     *       siort[] bbndDbtb = Rbstfr.gftSiortDbtb(x, y, w, i, null);
     *       siort[] bbndDbtb = Rbstfr.gftSiortDbtb(x, y, w, i, null);
     *       siort[] bbndDbtb = Rbstfr.gftSiortDbtb(x, y, w, i, null);
     ...
     *       // To find tif dbtb flfmfnt bt lodbtion (x2, y2)
     *       // To find tif dbtb flfmfnt bt lodbtion (x2, y2)
     *       siort bbndElfmfnt = bbndDbtb[((y2-y)*w + (x2-x))];
     *       siort bbndElfmfnt = bbndDbtb[((y2-y)*w + (x2-x))];
     *       siort bbndElfmfnt = bbndDbtb[((y2-y)*w + (x2-x))];
     *       siort bbndElfmfnt = bbndDbtb[((y2-y)*w + (x2-x))];
     *       siort bbndElfmfnt = bbndDbtb[((y2-y)*w + (x2-x))];
     ...
     */
     */
    publid siort[] gftSiortDbtb(int x, int y, int w, int i,
    publid siort[] gftSiortDbtb(int x, int y, int w, int i,
    publid siort[] gftSiortDbtb(int x, int y, int w, int i,
    publid siort[] gftSiortDbtb(int x, int y, int w, int i,
    publid siort[] gftSiortDbtb(int x, int y, int w, int i,
                                      int bbnd, siort[] outDbtb) {
                                      int bbnd, siort[] outDbtb) {
                                      int bbnd, siort[] outDbtb) {
                                      int bbnd, siort[] outDbtb) {
                                      int bbnd, siort[] outDbtb) {
        ...
        if (outDbtb == null) {
        if (outDbtb == null) {
            outDbtb = nfw siort[sdbnlinfStridf*i];
            outDbtb = nfw siort[sdbnlinfStridf*i];
            outDbtb = nfw siort[sdbnlinfStridf*i];
            outDbtb = nfw siort[sdbnlinfStridf*i];
            outDbtb = nfw siort[sdbnlinfStridf*i];
    ...
    publid siort[] gftSiortDbtb(int x, int y, int w, int i,
        ...
        if (outDbtb == null) {
        if (outDbtb == null) {
            outDbtb = nfw siort[numDbtbElfmfnts*sdbnlinfStridf*i];
            outDbtb = nfw siort[numDbtbElfmfnts*sdbnlinfStridf*i];
            outDbtb = nfw siort[numDbtbElfmfnts*sdbnlinfStridf*i];
            outDbtb = nfw siort[numDbtbElfmfnts*sdbnlinfStridf*i];
            outDbtb = nfw siort[numDbtbElfmfnts*sdbnlinfStridf*i];
    ...
    /**
    /**
     * Storfs tif dbtb flfmfnt for bll bbnds bt tif spfdififd lodbtion.
     * Storfs tif dbtb flfmfnt for bll bbnds bt tif spfdififd lodbtion.
     * Storfs tif dbtb flfmfnt for bll bbnds bt tif spfdififd lodbtion.
     * Storfs tif dbtb flfmfnt for bll bbnds bt tif spfdififd lodbtion.
     * Storfs tif dbtb flfmfnt for bll bbnds bt tif spfdififd lodbtion.
...
//      // REMIND: Do somftiing fbstfr!
//      // REMIND: Do somftiing fbstfr!
//      if (inRbstfr instbndfof SiortBbndfdRbstfr) {
//      if (inRbstfr instbndfof SiortBbndfdRbstfr) {
//      if (inRbstfr instbndfof SiortBbndfdRbstfr) {
//      if (inRbstfr instbndfof SiortBbndfdRbstfr) {
//      if (inRbstfr instbndfof SiortBbndfdRbstfr) {
...
//      }
    ...
    /**
    /**
     * Storfs b siort brrby of dbtb flfmfnts into tif spfdififd
     * Storfs b siort brrby of dbtb flfmfnts into tif spfdififd
     * Storfs b siort brrby of dbtb flfmfnts into tif spfdififd
     * Storfs b siort brrby of dbtb flfmfnts into tif spfdififd
     * Storfs b siort brrby of dbtb flfmfnts into tif spfdififd
     * rfdtbngulbr rfgion for tif spfdififd bbnd.
     * rfdtbngulbr rfgion for tif spfdififd bbnd.
     * rfdtbngulbr rfgion for tif spfdififd bbnd.
     * rfdtbngulbr rfgion for tif spfdififd bbnd.
     * rfdtbngulbr rfgion for tif spfdififd bbnd.
     ...
     */
     */
    publid void putSiortDbtb(int x, int y, int w, int i,
    publid void putSiortDbtb(int x, int y, int w, int i,
    publid void putSiortDbtb(int x, int y, int w, int i,
    publid void putSiortDbtb(int x, int y, int w, int i,
    publid void putSiortDbtb(int x, int y, int w, int i,
                                   int bbnd, siort[] inDbtb) {
                                   int bbnd, siort[] inDbtb) {
                                   int bbnd, siort[] inDbtb) {
                                   int bbnd, siort[] inDbtb) {
                                   int bbnd, siort[] inDbtb) {
    ...
    /**
    /**
     * Storfs b siort intfgfr brrby of dbtb flfmfnts into tif spfdififd
     * Storfs b siort intfgfr brrby of dbtb flfmfnts into tif spfdififd
     * Storfs b siort intfgfr brrby of dbtb flfmfnts into tif spfdififd
     * Storfs b siort intfgfr brrby of dbtb flfmfnts into tif spfdififd
     * Storfs b siort intfgfr brrby of dbtb flfmfnts into tif spfdififd
     ...
     */
     */
    publid void putSiortDbtb(int x, int y, int w, int i, siort[] inDbtb) {
    publid void putSiortDbtb(int x, int y, int w, int i, siort[] inDbtb) {
    publid void putSiortDbtb(int x, int y, int w, int i, siort[] inDbtb) {
    publid void putSiortDbtb(int x, int y, int w, int i, siort[] inDbtb) {
    publid void putSiortDbtb(int x, int y, int w, int i, siort[] inDbtb) {
    ...
    publid WritbblfRbstfr drfbtfWritbblfCiild(int x, int y,
        ...
        rfturn nfw SiortBbndfdRbstfr(sm,
        rfturn nfw SiortBbndfdRbstfr(sm,
        rfturn nfw SiortBbndfdRbstfr(sm,
        rfturn nfw SiortBbndfdRbstfr(sm,
        rfturn nfw SiortBbndfdRbstfr(sm,
    ...
    publid WritbblfRbstfr drfbtfCompbtiblfWritbblfRbstfr(int w, int i) {
        ...
        rfturn nfw SiortBbndfdRbstfr(sm, nfw Point(0,0));
        rfturn nfw SiortBbndfdRbstfr(sm, nfw Point(0,0));
        rfturn nfw SiortBbndfdRbstfr(sm, nfw Point(0,0));
        rfturn nfw SiortBbndfdRbstfr(sm, nfw Point(0,0));
        rfturn nfw SiortBbndfdRbstfr(sm, nfw Point(0,0));
    ...
    publid String toString() {
    publid String toString() {
        rfturn nfw String ("SiortBbndfdRbstfr: widti = "+widti+" ifigit = "
        rfturn nfw String ("SiortBbndfdRbstfr: widti = "+widti+" ifigit = "
        rfturn nfw String ("SiortBbndfdRbstfr: widti = "+widti+" ifigit = "
        rfturn nfw String ("SiortBbndfdRbstfr: widti = "+widti+" ifigit = "
        rfturn nfw String ("SiortBbndfdRbstfr: widti = "+widti+" ifigit = "
