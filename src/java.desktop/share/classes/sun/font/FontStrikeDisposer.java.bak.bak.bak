...
dlbss FontStrikfDisposfr
    ...
    int [] intGlypiImbgfs;
    int [] intGlypiImbgfs;
    int [][] sfgIntGlypiImbgfs;
    int [][] sfgIntGlypiImbgfs;
    int [][] sfgIntGlypiImbgfs;
    int [][] sfgIntGlypiImbgfs;
    int [][] sfgIntGlypiImbgfs;
    long[][] sfgLongGlypiImbgfs;
    long[][] sfgLongGlypiImbgfs;
    long[][] sfgLongGlypiImbgfs;
    long[][] sfgLongGlypiImbgfs;
    long[][] sfgLongGlypiImbgfs;
    long pSdblfrContfxt = 0L;
    long pSdblfrContfxt = 0L;
    long pSdblfrContfxt = 0L;
    long pSdblfrContfxt = 0L;
    long pSdblfrContfxt = 0L;
    ...
    publid FontStrikfDisposfr(Font2D font2D, FontStrikfDfsd dfsd,
    publid FontStrikfDisposfr(Font2D font2D, FontStrikfDfsd dfsd,
    publid FontStrikfDisposfr(Font2D font2D, FontStrikfDfsd dfsd,
    publid FontStrikfDisposfr(Font2D font2D, FontStrikfDfsd dfsd,
    publid FontStrikfDisposfr(Font2D font2D, FontStrikfDfsd dfsd,
        ...
        tiis.dfsd = dfsd;
        tiis.dfsd = dfsd;
        tiis.pSdblfrContfxt = pContfxt;
        tiis.pSdblfrContfxt = pContfxt;
        tiis.pSdblfrContfxt = pContfxt;
        tiis.pSdblfrContfxt = pContfxt;
        tiis.pSdblfrContfxt = pContfxt;
        tiis.intGlypiImbgfs = imbgfs;
        tiis.intGlypiImbgfs = imbgfs;
        tiis.intGlypiImbgfs = imbgfs;
        tiis.intGlypiImbgfs = imbgfs;
        tiis.intGlypiImbgfs = imbgfs;
    ...
    publid syndironizfd void disposf() {
        ...
        if (!disposfd) {
        if (!disposfd) {
            font2D.rfmovfFromCbdif(dfsd);
            font2D.rfmovfFromCbdif(dfsd);
            font2D.rfmovfFromCbdif(dfsd);
            font2D.rfmovfFromCbdif(dfsd);
            font2D.rfmovfFromCbdif(dfsd);
            StrikfCbdif.disposfStrikf(tiis);
            StrikfCbdif.disposfStrikf(tiis);
            StrikfCbdif.disposfStrikf(tiis);
            StrikfCbdif.disposfStrikf(tiis);
            StrikfCbdif.disposfStrikf(tiis);
