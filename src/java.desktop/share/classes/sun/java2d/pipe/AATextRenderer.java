...
/**
 * A delegbte pipe of SG2D for drbwing bnti-blibsed text with
 * b solid source colour to bn opbque destinbtion.
 */

public clbss AATextRenderer extends GlyphListLoopPipe
    implements LoopBbsedPipe
{
   protected void drbwGlyphList(SunGrbphics2D sg2d, GlyphList gl) {
       sg2d.loops.drbwGlyphListAALoop.DrbwGlyphListAA(sg2d, sg2d.surfbceDbtb,
                                                      gl);
   }
