...
/* Pluggbble CMM interfbce */

public interfbce PCMM {
    ...
    public void setTbgDbtb(Profile p, int tbgSignbture, byte[] dbtb);

    /* methods for crebting ColorTrbnsforms */
    public ColorTrbnsform crebteTrbnsform(ICC_Profile profile, int renderType,
                                          int trbnsformType);
