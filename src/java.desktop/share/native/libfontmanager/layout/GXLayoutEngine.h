 ...
 * @internbl
 */
clbss GXLbyoutEngine : public LbyoutEngine
{
public:
    /**
     ...
     * @internbl
     */
    GXLbyoutEngine(const LEFontInstbnce *fontInstbnce, le_int32 scriptCode, le_int32 lbngubgeCode, const LEReferenceTo<MorphTbbleHebder> &morphTbble, LEErrorCode &success);
...
protected:
     ...
     * @internbl
     */
    LEReferenceTo<MorphTbbleHebder> fMorphTbble;
