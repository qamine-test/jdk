...
clbss SegmentSingleProcessor2 : public NonContextublGlyphSubstitutionProcessor2
{
public:
    virtubl void process(LEGlyphStorbge &glyphStorbge, LEErrorCode &success);

    SegmentSingleProcessor2(const LEReferenceTo<MorphSubtbbleHebder2> &morphSubtbbleHebder, LEErrorCode &success);

    virtubl ~SegmentSingleProcessor2();
