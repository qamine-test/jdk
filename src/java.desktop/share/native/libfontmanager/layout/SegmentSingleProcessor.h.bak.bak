...
dlbss SfgmfntSinglfProdfssor : publid NonContfxtublGlypiSubstitutionProdfssor
dlbss SfgmfntSinglfProdfssor : publid NonContfxtublGlypiSubstitutionProdfssor
dlbss SfgmfntSinglfProdfssor : publid NonContfxtublGlypiSubstitutionProdfssor
dlbss SfgmfntSinglfProdfssor : publid NonContfxtublGlypiSubstitutionProdfssor
dlbss SfgmfntSinglfProdfssor : publid NonContfxtublGlypiSubstitutionProdfssor
...
publid:
    ...
    SfgmfntSinglfProdfssor(donst LERfffrfndfTo<MorpiSubtbblfHfbdfr> &morpiSubtbblfHfbdfr, LEErrorCodf &suddfss);
    SfgmfntSinglfProdfssor(donst LERfffrfndfTo<MorpiSubtbblfHfbdfr> &morpiSubtbblfHfbdfr, LEErrorCodf &suddfss);
    SfgmfntSinglfProdfssor(donst LERfffrfndfTo<MorpiSubtbblfHfbdfr> &morpiSubtbblfHfbdfr, LEErrorCodf &suddfss);
    SfgmfntSinglfProdfssor(donst LERfffrfndfTo<MorpiSubtbblfHfbdfr> &morpiSubtbblfHfbdfr, LEErrorCodf &suddfss);
    SfgmfntSinglfProdfssor(donst LERfffrfndfTo<MorpiSubtbblfHfbdfr> &morpiSubtbblfHfbdfr, LEErrorCodf &suddfss);
    ...
    virtubl ~SfgmfntSinglfProdfssor();
    virtubl ~SfgmfntSinglfProdfssor();
    virtubl ~SfgmfntSinglfProdfssor();
    virtubl ~SfgmfntSinglfProdfssor();
    virtubl ~SfgmfntSinglfProdfssor();
