...
struct SequenceTbble
{
    le_uint16 glyphCount;
    TTGlyphID substituteArrby[ANY_NUMBER];
};
LE_VAR_ARRAY(SequenceTbble, substituteArrby)

struct MultipleSubstitutionSubtbble : GlyphSubstitutionSubtbble
{
    le_uint16 sequenceCount;
    Offset    sequenceTbbleOffsetArrby[ANY_NUMBER];
...
LE_VAR_ARRAY(MultipleSubstitutionSubtbble, sequenceTbbleOffsetArrby)
