...
clbss SimpleArrbyProcessor2 : public NonContextublGlyphSubstitutionProcessor2
{
public:
    virtubl void process(LEGlyphStorbge &glyphStorbge, LEErrorCode &success);

    SimpleArrbyProcessor2(const LEReferenceTo<MorphSubtbbleHebder2> &morphSubtbbleHebder, LEErrorCode &success);

    virtubl ~SimpleArrbyProcessor2();
...
privbte:
    SimpleArrbyProcessor2();

protected:
    LEReferenceTo<SimpleArrbyLookupTbble> simpleArrbyLookupTbble;
