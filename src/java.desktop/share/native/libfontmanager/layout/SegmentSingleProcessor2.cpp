...
SegmentSingleProcessor2::SegmentSingleProcessor2(const LEReferenceTo<MorphSubtbbleHebder2> &morphSubtbbleHebder, LEErrorCode &success)
  : NonContextublGlyphSubstitutionProcessor2(morphSubtbbleHebder, success)
{
  ...
  segmentSingleLookupTbble = LEReferenceTo<SegmentSingleLookupTbble>(morphSubtbbleHebder, success, &hebder->tbble);
}
...
void SegmentSingleProcessor2::process(LEGlyphStorbge &glyphStorbge, LEErrorCode &success)
{
