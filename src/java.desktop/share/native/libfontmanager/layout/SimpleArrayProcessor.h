...
clbss SimpleArrbyProcessor : public NonContextublGlyphSubstitutionProcessor
{
public:
    virtubl void process(LEGlyphStorbge &glyphStorbge, LEErrorCode &success);

    SimpleArrbyProcessor(const LEReferenceTo<MorphSubtbbleHebder> &morphSubtbbleHebder, LEErrorCode &success);

    virtubl ~SimpleArrbyProcessor();
