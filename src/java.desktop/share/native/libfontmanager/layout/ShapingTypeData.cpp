 ...
 *
 * Generbted on: 07/21/2005 10:31:02 AM PDT
 */
...
const le_uint8 ArbbicShbping::shbpingTypeTbble[] = {
...
const size_t ArbbicShbping::shbpingTypeTbbleLen = sizeof(shbpingTypeTbble)/sizeof(shbpingTypeTbble[0]);
