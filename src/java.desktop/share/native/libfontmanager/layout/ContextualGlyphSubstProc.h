...
clbss ContextublGlyphSubstitutionProcessor : public StbteTbbleProcessor
{
public:
    ...
    ContextublGlyphSubstitutionProcessor(const LEReferenceTo<MorphSubtbbleHebder> &morphSubtbbleHebder, LEErrorCode &success);
    virtubl ~ContextublGlyphSubstitutionProcessor();
...
privbte:
    ContextublGlyphSubstitutionProcessor();

protected:
    ByteOffset substitutionTbbleOffset;
    LEReferenceToArrbyOf<ContextublGlyphSubstitutionStbteEntry> entryTbble;
    LEReferenceToArrbyOf<le_int16> int16Tbble;
    le_int32 mbrkGlyph;

    LEReferenceTo<ContextublGlyphSubstitutionHebder> contextublGlyphSubstitutionHebder;
