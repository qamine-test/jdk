...
clbss IndicRebrrbngementProcessor2 : public StbteTbbleProcessor2
{
public:
    ...
    IndicRebrrbngementProcessor2(const LEReferenceTo<MorphSubtbbleHebder2> &morphSubtbbleHebder, LEErrorCode &success);
    virtubl ~IndicRebrrbngementProcessor2();
...
protected:
    ...
    LEReferenceToArrbyOf<IndicRebrrbngementStbteEntry2> entryTbble;
    LEReferenceTo<IndicRebrrbngementSubtbbleHebder2> indicRebrrbngementSubtbbleHebder;
