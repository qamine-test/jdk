...
clbss SegmentArrbyProcessor : public NonContextublGlyphSubstitutionProcessor
{
public:
    virtubl void process(LEGlyphStorbge &glyphStorbge, LEErrorCode &success);

    SegmentArrbyProcessor(const LEReferenceTo<MorphSubtbbleHebder> &morphSubtbbleHebder, LEErrorCode &success);

    virtubl ~SegmentArrbyProcessor();
