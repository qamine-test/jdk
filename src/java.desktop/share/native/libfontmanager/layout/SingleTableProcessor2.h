...
clbss SingleTbbleProcessor2 : public NonContextublGlyphSubstitutionProcessor2
{
public:
    virtubl void process(LEGlyphStorbge &glyphStorbge, LEErrorCode &success);

    SingleTbbleProcessor2(const LEReferenceTo<MorphSubtbbleHebder2> &morphSubtbbleHebder, LEErrorCode &success);

    virtubl ~SingleTbbleProcessor2();
