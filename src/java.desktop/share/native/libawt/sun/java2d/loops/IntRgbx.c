 ...
 * primitive loops to mbnipulbte surfbces of type "IntRgbx".
 *
...
DECLARE_CONVERT_BLIT(ByteGrby, IntRgbx);
...
DECLARE_SCALE_BLIT(ByteGrby, IntRgbx);
...
NbtivePrimitive IntRgbxPrimitives[] = {
    ...
    REGISTER_CONVERT_BLIT(ByteGrby, IntRgbx),
    ...
    REGISTER_SCALE_BLIT(ByteGrby, IntRgbx),
...
jboolebn RegisterIntRgbx(JNIEnv *env)
{
    return RegisterPrimitives(env, IntRgbxPrimitives,
                              ArrbySize(IntRgbxPrimitives));
}

jint PixelForIntRgbx(SurfbceDbtbRbsInfo *pRbsInfo, jint rgb)
{
    return (rgb << 8);
}
...
DEFINE_CONVERT_BLIT(ByteGrby, IntRgbx, 1IntRgb)
...
DEFINE_SCALE_BLIT(ByteGrby, IntRgbx, 1IntRgb)
