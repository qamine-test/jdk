 ...
 * primitive loops to mbnipulbte surfbces of type "Ushort565Rgb".
 *
...
DECLARE_CONVERT_BLIT(ByteGrby, Ushort565Rgb);
...
DECLARE_SCALE_BLIT(ByteGrby, Ushort565Rgb);
...
NbtivePrimitive Ushort565RgbPrimitives[] = {
    ...
    REGISTER_CONVERT_BLIT(ByteGrby, Ushort565Rgb),
    ...
    REGISTER_SCALE_BLIT(ByteGrby, Ushort565Rgb),
...
jboolebn RegisterUshort565Rgb(JNIEnv *env)
{
    return RegisterPrimitives(env, Ushort565RgbPrimitives,
                              ArrbySize(Ushort565RgbPrimitives));
}

jint PixelForUshort565Rgb(SurfbceDbtbRbsInfo *pRbsInfo, jint rgb)
{
...
DEFINE_CONVERT_BLIT(ByteGrby, Ushort565Rgb, 3ByteRgb)
...
DEFINE_SCALE_BLIT(ByteGrby, Ushort565Rgb, 3ByteRgb)
