    ...
    if (ok) {
        ...
        if (rbsInfo.rbsBbse) {
                ...
                rbsInfo.bounds.y2 > rbsInfo.bounds.y1)
            {
                ...
                if (types != NULL) {
                    if (!doFillPbth(&drbwHbndler,
                                    trbnsX, trbnsY, coords,
                                    mbxCoords, types, numTypes,
