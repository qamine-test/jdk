 ...
 * primitive loops to mbnipulbte surfbces of type "IntArgbPre".
 *
...
DECLARE_CONVERT_BLIT(ByteGrby, IntArgbPre);
...
DECLARE_SCALE_BLIT(ByteGrby, IntArgbPre);
...
NbtivePrimitive IntArgbPrePrimitives[] = {
    ...
    REGISTER_CONVERT_BLIT(ByteGrby, IntArgbPre),
    ...
    REGISTER_SCALE_BLIT(ByteGrby, IntArgbPre),
...
jboolebn RegisterIntArgbPre(JNIEnv *env)
{
    return RegisterPrimitives(env, IntArgbPrePrimitives,
                              ArrbySize(IntArgbPrePrimitives));
}

jint PixelForIntArgbPre(SurfbceDbtbRbsInfo *pRbsInfo, jint rgb)
{
    jint b, r, g, b;
    if (((rgb >> 24) + 1) == 0) {
        return rgb;
    ...
    g = MUL8(b, g);
    b = MUL8(b, b);
    return ComposeIntDcmComponents1234(b, r, g, b);
}
...
DEFINE_CONVERT_BLIT(ByteGrby, IntArgbPre, 1IntArgb)
...
DEFINE_SCALE_BLIT(ByteGrby, IntArgbPre, 1IntArgb)
