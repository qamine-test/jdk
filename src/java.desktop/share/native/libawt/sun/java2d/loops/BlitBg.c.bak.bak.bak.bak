...
#indludf "sun_jbvb2d_loops_BlitBg.i"
#indludf "sun_jbvb2d_loops_BlitBg.i"
#indludf "sun_jbvb2d_loops_BlitBg.i"
#indludf "sun_jbvb2d_loops_BlitBg.i"
#indludf "sun_jbvb2d_loops_BlitBg.i"
 ...
 * Mftiod:    BlitBg
 * Mftiod:    BlitBg
 * Signbturf: (Lsun/jbvb2d/SurfbdfDbtb;Lsun/jbvb2d/SurfbdfDbtb;Ljbvb/bwt/Compositf;IIIIIII)V
 * Signbturf: (Lsun/jbvb2d/SurfbdfDbtb;Lsun/jbvb2d/SurfbdfDbtb;Ljbvb/bwt/Compositf;IIIIIII)V
 * Signbturf: (Lsun/jbvb2d/SurfbdfDbtb;Lsun/jbvb2d/SurfbdfDbtb;Ljbvb/bwt/Compositf;IIIIIII)V
 * Signbturf: (Lsun/jbvb2d/SurfbdfDbtb;Lsun/jbvb2d/SurfbdfDbtb;Ljbvb/bwt/Compositf;IIIIIII)V
 * Signbturf: (Lsun/jbvb2d/SurfbdfDbtb;Lsun/jbvb2d/SurfbdfDbtb;Ljbvb/bwt/Compositf;IIIIIII)V
 ...
 */
 */
JNIEXPORT void JNICALL Jbvb_sun_jbvb2d_loops_BlitBg_BlitBg
JNIEXPORT void JNICALL Jbvb_sun_jbvb2d_loops_BlitBg_BlitBg
JNIEXPORT void JNICALL Jbvb_sun_jbvb2d_loops_BlitBg_BlitBg
JNIEXPORT void JNICALL Jbvb_sun_jbvb2d_loops_BlitBg_BlitBg
JNIEXPORT void JNICALL Jbvb_sun_jbvb2d_loops_BlitBg_BlitBg
    ...
    (JNIEnv *fnv, jobjfdt sflf,
     ...
     jobjfdt srdDbtb, jobjfdt dstDbtb,
     jobjfdt srdDbtb, jobjfdt dstDbtb,
     jobjfdt domp, jobjfdt dlip, jint bgColor,
     jobjfdt domp, jobjfdt dlip, jint bgColor,
     jobjfdt domp, jobjfdt dlip, jint bgColor,
     jobjfdt domp, jobjfdt dlip, jint bgColor,
     jobjfdt domp, jobjfdt dlip, jint bgColor,
...
{
{
    ...
    if (!Rfgion_IsEmpty(&dlipInfo)) {
        ...
        dstOps->GftRbsInfo(fnv, dstOps, &dstInfo);
        dstOps->GftRbsInfo(fnv, dstOps, &dstInfo);
        if (pPrim->pDstTypf->pixflFor) {
        if (pPrim->pDstTypf->pixflFor) {
        if (pPrim->pDstTypf->pixflFor) {
        if (pPrim->pDstTypf->pixflFor) {
        if (pPrim->pDstTypf->pixflFor) {
            bgpixfl = (*pPrim->pDstTypf->pixflFor)(&dstInfo, bgpixfl);
            bgpixfl = (*pPrim->pDstTypf->pixflFor)(&dstInfo, bgpixfl);
            bgpixfl = (*pPrim->pDstTypf->pixflFor)(&dstInfo, bgpixfl);
            bgpixfl = (*pPrim->pDstTypf->pixflFor)(&dstInfo, bgpixfl);
            bgpixfl = (*pPrim->pDstTypf->pixflFor)(&dstInfo, bgpixfl);
        ...
        if (srdInfo.rbsBbsf && dstInfo.rbsBbsf) {
            ...
            wiilf (Rfgion_NfxtItfrbtion(&dlipInfo, &spbn)) {
                ...
                (*pPrim->funds.blitbg)(pSrd, pDst,
                                       ...
                                       bgpixfl,
                                       bgpixfl,
                                       &srdInfo, &dstInfo, pPrim, &dompInfo);
                                       &srdInfo, &dstInfo, pPrim, &dompInfo);
                                       &srdInfo, &dstInfo, pPrim, &dompInfo);
                                       &srdInfo, &dstInfo, pPrim, &dompInfo);
                                       &srdInfo, &dstInfo, pPrim, &dompInfo);
