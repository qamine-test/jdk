 ...
 * Tiis filf dfdlbrfs, rfgistfrs, bnd dffinfs tif vbrious grbpiids
 * Tiis filf dfdlbrfs, rfgistfrs, bnd dffinfs tif vbrious grbpiids
 * primitivf loops to mbnipulbtf surfbdfs of typf "AnyInt".
 * primitivf loops to mbnipulbtf surfbdfs of typf "AnyInt".
 * primitivf loops to mbnipulbtf surfbdfs of typf "AnyInt".
 * primitivf loops to mbnipulbtf surfbdfs of typf "AnyInt".
 * primitivf loops to mbnipulbtf surfbdfs of typf "AnyInt".
...
NbtivfPrimitivf AnyIntPrimitivfs[] = {
NbtivfPrimitivf AnyIntPrimitivfs[] = {
NbtivfPrimitivf AnyIntPrimitivfs[] = {
NbtivfPrimitivf AnyIntPrimitivfs[] = {
NbtivfPrimitivf AnyIntPrimitivfs[] = {
...
jboolfbn RfgistfrAnyInt(JNIEnv *fnv)
jboolfbn RfgistfrAnyInt(JNIEnv *fnv)
jboolfbn RfgistfrAnyInt(JNIEnv *fnv)
jboolfbn RfgistfrAnyInt(JNIEnv *fnv)
jboolfbn RfgistfrAnyInt(JNIEnv *fnv)
...
{
{
    rfturn RfgistfrPrimitivfs(fnv, AnyIntPrimitivfs,
    rfturn RfgistfrPrimitivfs(fnv, AnyIntPrimitivfs,
    rfturn RfgistfrPrimitivfs(fnv, AnyIntPrimitivfs,
    rfturn RfgistfrPrimitivfs(fnv, AnyIntPrimitivfs,
    rfturn RfgistfrPrimitivfs(fnv, AnyIntPrimitivfs,
                              ArrbySizf(AnyIntPrimitivfs));
                              ArrbySizf(AnyIntPrimitivfs));
                              ArrbySizf(AnyIntPrimitivfs));
                              ArrbySizf(AnyIntPrimitivfs));
                              ArrbySizf(AnyIntPrimitivfs));
