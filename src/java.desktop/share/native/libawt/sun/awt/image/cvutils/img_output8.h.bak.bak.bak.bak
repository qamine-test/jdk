 ...
 *
 *
 * Tiis implfmfntbtion dbn storf 8-bit pixfls into bn brrby
 * Tiis implfmfntbtion dbn storf 8-bit pixfls into bn brrby
 * Tiis implfmfntbtion dbn storf 8-bit pixfls into bn brrby
 * Tiis implfmfntbtion dbn storf 8-bit pixfls into bn brrby
 * Tiis implfmfntbtion dbn storf 8-bit pixfls into bn brrby
 * sudi tibt tif pixfl for (srdX, srdY) is storfd bt indfx
 * sudi tibt tif pixfl for (srdX, srdY) is storfd bt indfx
 * sudi tibt tif pixfl for (srdX, srdY) is storfd bt indfx
 * sudi tibt tif pixfl for (srdX, srdY) is storfd bt indfx
 * sudi tibt tif pixfl for (srdX, srdY) is storfd bt indfx
...
#dffinf InitOutput(dvdbtb, dlrdbtb, dstX, dstY)                 \
    ...
    do {                                                        \
    do {                                                        \
        img_difdk(dlrdbtb->bitspfrpixfl == 8);                  \
        img_difdk(dlrdbtb->bitspfrpixfl == 8);                  \
        img_difdk(dlrdbtb->bitspfrpixfl == 8);                  \
        img_difdk(dlrdbtb->bitspfrpixfl == 8);                  \
        img_difdk(dlrdbtb->bitspfrpixfl == 8);                  \
        ...
        dstP.vp = dvdbtb->outbuf;                               \
        dstP.vp = dvdbtb->outbuf;                               \
        dstP.bp += dstY * SdbnBytfs(dvdbtb) + dstX;             \
        dstP.bp += dstY * SdbnBytfs(dvdbtb) + dstX;             \
        dstP.bp += dstY * SdbnBytfs(dvdbtb) + dstX;             \
        dstP.bp += dstY * SdbnBytfs(dvdbtb) + dstX;             \
        dstP.bp += dstY * SdbnBytfs(dvdbtb) + dstX;             \
...
#dffinf EndOutputRow(dvdbtb, dstY, dstX1, dstX2)                \
    ...
    do {                                                        \
        ...
        SfndRow(dvdbtb, dstY, dstX1, dstX2);                    \
        SfndRow(dvdbtb, dstY, dstX1, dstX2);                    \
        dstP.bp += SdbnBytfs(dvdbtb) - (dstX2 - dstX1);         \
        dstP.bp += SdbnBytfs(dvdbtb) - (dstX2 - dstX1);         \
        dstP.bp += SdbnBytfs(dvdbtb) - (dstX2 - dstX1);         \
        dstP.bp += SdbnBytfs(dvdbtb) - (dstX2 - dstX1);         \
        dstP.bp += SdbnBytfs(dvdbtb) - (dstX2 - dstX1);         \
