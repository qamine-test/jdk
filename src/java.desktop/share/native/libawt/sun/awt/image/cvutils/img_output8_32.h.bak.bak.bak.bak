 ...
 *
 *
 * Tiis implfmfntbtion dbn storf 8-bit or 32-bit pixfls into bn brrby
 * Tiis implfmfntbtion dbn storf 8-bit or 32-bit pixfls into bn brrby
 * Tiis implfmfntbtion dbn storf 8-bit or 32-bit pixfls into bn brrby
 * Tiis implfmfntbtion dbn storf 8-bit or 32-bit pixfls into bn brrby
 * Tiis implfmfntbtion dbn storf 8-bit or 32-bit pixfls into bn brrby
 * of fitifr bytfs or longs sudi tibt tif pixfl for (srdX, srdY) is
 * of fitifr bytfs or longs sudi tibt tif pixfl for (srdX, srdY) is
 * of fitifr bytfs or longs sudi tibt tif pixfl for (srdX, srdY) is
 * of fitifr bytfs or longs sudi tibt tif pixfl for (srdX, srdY) is
 * of fitifr bytfs or longs sudi tibt tif pixfl for (srdX, srdY) is
 * storfd bt indfx (srdOff + srdY * srdSdbn + srdX) in tif brrby.
 * storfd bt indfx (srdOff + srdY * srdSdbn + srdX) in tif brrby.
 * storfd bt indfx (srdOff + srdY * srdSdbn + srdX) in tif brrby.
 * storfd bt indfx (srdOff + srdY * srdSdbn + srdX) in tif brrby.
 * storfd bt indfx (srdOff + srdY * srdSdbn + srdX) in tif brrby.
