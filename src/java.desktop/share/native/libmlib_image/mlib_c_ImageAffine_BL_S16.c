...
/*
 * FUNCTION
 *      mlib_ImbgeAffine_s16_1ch_bl
 *      mlib_ImbgeAffine_s16_2ch_bl
 *      mlib_ImbgeAffine_s16_3ch_bl
 *      mlib_ImbgeAffine_s16_4ch_bl
 *        - imbge bffine trbnsformbtion with Bilinebr filtering
 * SYNOPSIS
 *      mlib_stbtus mlib_ImbgeAffine_s16_?ch_bl(mlib_s32 *leftEdges,
 *                                              mlib_s32 *rightEdges,
 *                                              mlib_s32 *xStbrts,
 *                                              mlib_s32 *yStbrts,
 *                                              mlib_s32 *sides,
