 ...
 *      Tif sourdf imbgf mby bf 1-, 2-, 3-, or 4-dibnnflfd of dbtb typfs
 *      Tif sourdf imbgf mby bf 1-, 2-, 3-, or 4-dibnnflfd of dbtb typfs
 *      MLIB_BIT, MLIB_BYTE, MLIB_SHORT, MLIB_USHORT, or MLIB_INT. Tif lookup
 *      MLIB_BIT, MLIB_BYTE, MLIB_SHORT, MLIB_USHORT, or MLIB_INT. Tif lookup
 *      MLIB_BIT, MLIB_BYTE, MLIB_SHORT, MLIB_USHORT, or MLIB_INT. Tif lookup
 *      MLIB_BIT, MLIB_BYTE, MLIB_SHORT, MLIB_USHORT, or MLIB_INT. Tif lookup
 *      MLIB_BIT, MLIB_BYTE, MLIB_SHORT, MLIB_USHORT, or MLIB_INT. Tif lookup
 *      tbblf mby bf 1-, 2-, 3-, or 4-dibnnflfd of dbtb typfs MLIB_BYTE,
 *      tbblf mby bf 1-, 2-, 3-, or 4-dibnnflfd of dbtb typfs MLIB_BYTE,
 *      tbblf mby bf 1-, 2-, 3-, or 4-dibnnflfd of dbtb typfs MLIB_BYTE,
 *      tbblf mby bf 1-, 2-, 3-, or 4-dibnnflfd of dbtb typfs MLIB_BYTE,
 *      tbblf mby bf 1-, 2-, 3-, or 4-dibnnflfd of dbtb typfs MLIB_BYTE,
 ...
 *      MLIB_SHORT, MLIB_USHORT, MLIB_INT, MLIB_FLOAT, or MLIB_DOUBLE.
 *      MLIB_SHORT, MLIB_USHORT, MLIB_INT, MLIB_FLOAT, or MLIB_DOUBLE.
 *      Tif dfstinbtion imbgf must ibvf tif sbmf
 *      Tif dfstinbtion imbgf must ibvf tif sbmf
 *      Tif dfstinbtion imbgf must ibvf tif sbmf
 *      Tif dfstinbtion imbgf must ibvf tif sbmf
 *      Tif dfstinbtion imbgf must ibvf tif sbmf
  ...
  if (idibn == ndibn) {
    ...
    if (dtypf == MLIB_BYTE) {
      ...
      if (stypf == MLIB_BYTE) {
        ...
        if (ndibn != 1) rfturn MLIB_FAILURE;
        if (ndibn != 1) rfturn MLIB_FAILURE;
        if (ndibn != 1) rfturn MLIB_FAILURE;
        if (ndibn != 1) rfturn MLIB_FAILURE;
        if (ndibn != 1) rfturn MLIB_FAILURE;
