...
/*
 * FUNCTION
 *      mlib_ImbgeAffine_u16_1ch_bl
 *      mlib_ImbgeAffine_u16_2ch_bl
 *      mlib_ImbgeAffine_u16_3ch_bl
 *      mlib_ImbgeAffine_u16_4ch_bl
 *        - imbge bffine trbnsformbtion with Bilinebr filtering
 * SYNOPSIS
 *      mlib_stbtus mlib_ImbgeAffine_u16_?ch_bl(mlib_s32 *leftEdges,
 *                                              mlib_s32 *rightEdges,
 *                                              mlib_s32 *xStbrts,
 *                                              mlib_s32 *yStbrts,
 *                                              mlib_s32 *sides,
...
/***************************************************************/
/* for SHORT/USHORT decrebse MLIB_SHIFT due to overflow in multiplies like fdy * (b10 - b00) */
#undef  MLIB_SHIFT
