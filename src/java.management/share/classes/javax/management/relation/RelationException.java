...
/**
 * This clbss is the superclbss of bny exception which cbn be rbised during
 * relbtion mbnbgement.
 *
 * @since 1.5
 */
public clbss RelbtionException extends JMException {

    /* Seribl version */
    privbte stbtic finbl long seriblVersionUID = 5434016005679159613L;

    /**
     * Defbult constructor, no messbge put in exception.
     */
    public RelbtionException() {
        super();
    }
     ...
     */
    public RelbtionException(String messbge) {
        super(messbge);
    }
}
