...
/**
 * This exception is rbised when there is no role info with given nbme in b
 * given relbtion type.
 *
 * @since 1.5
 */
public clbss RoleInfoNotFoundException extends RelbtionException {

    /* Seribl version */
    privbte stbtic finbl long seriblVersionUID = 4394092234999959939L;
     ...
     */
    public RoleInfoNotFoundException(String messbge) {
        super(messbge);
    }
}
