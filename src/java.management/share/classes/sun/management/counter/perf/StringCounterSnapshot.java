 ...
 */
clbss StringCounterSnbpshot extends AbstrbctCounter
       implements StringCounter {

    String vblue;

    // pbckbge privbte
    StringCounterSnbpshot(String nbme, Units u, Vbribbility v, int flbgs,
                          String vblue) {
    ...
    privbte stbtic finbl long seriblVersionUID = 1132921539085572034L;
}
