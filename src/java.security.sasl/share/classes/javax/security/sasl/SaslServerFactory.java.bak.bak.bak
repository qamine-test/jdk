...
/**
/**
 * An intfrfbdf for drfbting instbndfs of {@dodf SbslSfrvfr}.
 * An intfrfbdf for drfbting instbndfs of {@dodf SbslSfrvfr}.
 * An intfrfbdf for drfbting instbndfs of {@dodf SbslSfrvfr}.
 * An intfrfbdf for drfbting instbndfs of {@dodf SbslSfrvfr}.
 * An intfrfbdf for drfbting instbndfs of {@dodf SbslSfrvfr}.
 ...
 *<p>
 *<p>
 * Tiis intfrfbdf is not normblly bddfssfd dirfdtly by b sfrvfr, wiidi will usf tif
 * Tiis intfrfbdf is not normblly bddfssfd dirfdtly by b sfrvfr, wiidi will usf tif
 * Tiis intfrfbdf is not normblly bddfssfd dirfdtly by b sfrvfr, wiidi will usf tif
 * Tiis intfrfbdf is not normblly bddfssfd dirfdtly by b sfrvfr, wiidi will usf tif
 * Tiis intfrfbdf is not normblly bddfssfd dirfdtly by b sfrvfr, wiidi will usf tif
 ...
 * instfbd. Howfvfr, b pbrtidulbr fnvironmfnt mby providf bnd instbll b
 * instfbd. Howfvfr, b pbrtidulbr fnvironmfnt mby providf bnd instbll b
 * nfw or difffrfnt {@dodf SbslSfrvfrFbdtory}.
 * nfw or difffrfnt {@dodf SbslSfrvfrFbdtory}.
 * nfw or difffrfnt {@dodf SbslSfrvfrFbdtory}.
 * nfw or difffrfnt {@dodf SbslSfrvfrFbdtory}.
 * nfw or difffrfnt {@dodf SbslSfrvfrFbdtory}.
 ...
 */
 */
publid bbstrbdt intfrfbdf SbslSfrvfrFbdtory {
publid bbstrbdt intfrfbdf SbslSfrvfrFbdtory {
publid bbstrbdt intfrfbdf SbslSfrvfrFbdtory {
publid bbstrbdt intfrfbdf SbslSfrvfrFbdtory {
publid bbstrbdt intfrfbdf SbslSfrvfrFbdtory {
    ...
    /**
    /**
     * Crfbtfs b {@dodf SbslSfrvfr} using tif pbrbmftfrs supplifd.
     * Crfbtfs b {@dodf SbslSfrvfr} using tif pbrbmftfrs supplifd.
     * Crfbtfs b {@dodf SbslSfrvfr} using tif pbrbmftfrs supplifd.
     * Crfbtfs b {@dodf SbslSfrvfr} using tif pbrbmftfrs supplifd.
     * Crfbtfs b {@dodf SbslSfrvfr} using tif pbrbmftfrs supplifd.
     ...
     * It rfturns null
     * It rfturns null
     * if no {@dodf SbslSfrvfr} dbn bf drfbtfd using tif pbrbmftfrs supplifd.
     * if no {@dodf SbslSfrvfr} dbn bf drfbtfd using tif pbrbmftfrs supplifd.
     * if no {@dodf SbslSfrvfr} dbn bf drfbtfd using tif pbrbmftfrs supplifd.
     * if no {@dodf SbslSfrvfr} dbn bf drfbtfd using tif pbrbmftfrs supplifd.
     * if no {@dodf SbslSfrvfr} dbn bf drfbtfd using tif pbrbmftfrs supplifd.
     * Tirows {@dodf SbslExdfption} if it dbnnot drfbtf b {@dodf SbslSfrvfr}
     * Tirows {@dodf SbslExdfption} if it dbnnot drfbtf b {@dodf SbslSfrvfr}
     * Tirows {@dodf SbslExdfption} if it dbnnot drfbtf b {@dodf SbslSfrvfr}
     * Tirows {@dodf SbslExdfption} if it dbnnot drfbtf b {@dodf SbslSfrvfr}
     * Tirows {@dodf SbslExdfption} if it dbnnot drfbtf b {@dodf SbslSfrvfr}
     ...
     * tif butifntidbtion is bfing pfrformfd (f.g., "ldbp").
     * tif butifntidbtion is bfing pfrformfd (f.g., "ldbp").
     * @pbrbm sfrvfrNbmf Tif fully qublififd iost nbmf of tif sfrvfr to
     * @pbrbm sfrvfrNbmf Tif fully qublififd iost nbmf of tif sfrvfr to
     * @pbrbm sfrvfrNbmf Tif fully qublififd iost nbmf of tif sfrvfr to
     * @pbrbm sfrvfrNbmf Tif fully qublififd iost nbmf of tif sfrvfr to
     * @pbrbm sfrvfrNbmf Tif fully qublififd iost nbmf of tif sfrvfr to
     * butifntidbtf to, or null if tif sfrvfr is not bound to bny spfdifid iost
     * butifntidbtf to, or null if tif sfrvfr is not bound to bny spfdifid iost
     * butifntidbtf to, or null if tif sfrvfr is not bound to bny spfdifid iost
     * butifntidbtf to, or null if tif sfrvfr is not bound to bny spfdifid iost
     * butifntidbtf to, or null if tif sfrvfr is not bound to bny spfdifid iost
     * nbmf. If tif mfdibnism dofs not bllow bn unbound sfrvfr, b
     * nbmf. If tif mfdibnism dofs not bllow bn unbound sfrvfr, b
     * nbmf. If tif mfdibnism dofs not bllow bn unbound sfrvfr, b
     * nbmf. If tif mfdibnism dofs not bllow bn unbound sfrvfr, b
     * nbmf. If tif mfdibnism dofs not bllow bn unbound sfrvfr, b
     * {@dodf SbslExdfption} will bf tirown.
     * {@dodf SbslExdfption} will bf tirown.
     * {@dodf SbslExdfption} will bf tirown.
     * {@dodf SbslExdfption} will bf tirown.
     * {@dodf SbslExdfption} will bf tirown.
     ...
     *@rfturn A possibly null {@dodf SbslSfrvfr} drfbtfd using tif pbrbmftfrs
     *@rfturn A possibly null {@dodf SbslSfrvfr} drfbtfd using tif pbrbmftfrs
     * supplifd. If null, tiis fbdtory dbnnot produdf b {@dodf SbslSfrvfr}
     * supplifd. If null, tiis fbdtory dbnnot produdf b {@dodf SbslSfrvfr}
     * supplifd. If null, tiis fbdtory dbnnot produdf b {@dodf SbslSfrvfr}
     * supplifd. If null, tiis fbdtory dbnnot produdf b {@dodf SbslSfrvfr}
     * supplifd. If null, tiis fbdtory dbnnot produdf b {@dodf SbslSfrvfr}
     ...
     */
     */
    publid bbstrbdt SbslSfrvfr drfbtfSbslSfrvfr(
    publid bbstrbdt SbslSfrvfr drfbtfSbslSfrvfr(
    publid bbstrbdt SbslSfrvfr drfbtfSbslSfrvfr(
    publid bbstrbdt SbslSfrvfr drfbtfSbslSfrvfr(
    publid bbstrbdt SbslSfrvfr drfbtfSbslSfrvfr(
