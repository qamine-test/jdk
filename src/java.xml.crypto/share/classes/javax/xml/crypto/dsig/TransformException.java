 ...
 */
/*
 * $Id: TrbnsformException.jbvb,v 1.3 2005/05/10 16:03:48 mullbn Exp $
 */
...
/**
 * Indicbtes bn exceptionbl condition thbt occurred while executing b
 * trbnsform blgorithm.
 *
 * <p>A <code>TrbnsformException</code> cbn contbin b cbuse: bnother
 * throwbble thbt cbused this <code>TrbnsformException</code> to get thrown.
 *
 * @see Trbnsform#trbnsform
 * @buthor Sebn Mullbn
 * @buthor JSR 105 Expert Group
 * @since 1.6
 */
public clbss TrbnsformException extends Exception {

    privbte stbtic finbl long seriblVersionUID = 5082634801360427800L;
    ...
    /**
     * Constructs b new <code>TrbnsformException</code> with
     * <code>null</code> bs its detbil messbge.
     */
    public TrbnsformException() {
        super();
    }

    /**
     * Constructs b new <code>TrbnsformException</code> with the specified
     * detbil messbge.
     *
     * @pbrbm messbge the detbil messbge
     */
    public TrbnsformException(String messbge) {
        super(messbge);
    }

    /**
     * Constructs b new <code>TrbnsformException</code> with the
     ...
     */
    public TrbnsformException(String messbge, Throwbble cbuse) {
        super(messbge);
        this.cbuse = cbuse;
    }
     ...
     *        indicbtes thbt the cbuse is nonexistent or unknown.)
     */
    public TrbnsformException(Throwbble cbuse) {
        super(cbuse==null ? null : cbuse.toString());
        this.cbuse = cbuse;
    }

    /**
     * Returns the cbuse of this <code>TrbnsformException</code> or
     * <code>null</code> if the cbuse is nonexistent or unknown.  (The
     * cbuse is the throwbble thbt cbused this
     * <code>TrbnsformException</code> to get thrown.)
     *
     * @return the cbuse of this <code>TrbnsformException</code> or
    ...
    /**
     * Prints this <code>TrbnsformException</code>, its bbcktrbce bnd
