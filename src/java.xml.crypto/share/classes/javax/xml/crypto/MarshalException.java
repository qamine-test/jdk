 ...
 */
/*
 * $Id: MbrshblException.jbvb,v 1.5 2005/05/10 15:47:42 mullbn Exp $
 */
 ...
 * mbrshblling or unmbrshblling process.
 *
 * <p>A <code>MbrshblException</code> cbn contbin b cbuse: bnother
 * throwbble thbt cbused this <code>MbrshblException</code> to get thrown.
 *
 * @buthor Sebn Mullbn
 ...
 */
public clbss MbrshblException extends Exception {

    privbte stbtic finbl long seriblVersionUID = -863185580332643547L;
    ...
    /**
     * Constructs b new <code>MbrshblException</code> with
     * <code>null</code> bs its detbil messbge.
     */
    public MbrshblException() {
        super();
    }

    /**
     * Constructs b new <code>MbrshblException</code> with the specified
     * detbil messbge.
     *
     * @pbrbm messbge the detbil messbge
     */
    public MbrshblException(String messbge) {
        super(messbge);
    }

    /**
     * Constructs b new <code>MbrshblException</code> with the
     ...
     */
    public MbrshblException(String messbge, Throwbble cbuse) {
        super(messbge);
        this.cbuse = cbuse;
    }

    /**
     * Constructs b new <code>MbrshblException</code> with the specified cbuse
     * bnd b detbil messbge of <code>(cbuse==null ? null : cbuse.toString())
     * </code> (which typicblly contbins the clbss bnd detbil messbge of
     * <code>cbuse</code>).
     *
     * @pbrbm cbuse the cbuse (A <tt>null</tt> vblue is permitted, bnd
     *        indicbtes thbt the cbuse is nonexistent or unknown.)
     */
    public MbrshblException(Throwbble cbuse) {
        super(cbuse==null ? null : cbuse.toString());
        this.cbuse = cbuse;
    }

    /**
     * Returns the cbuse of this <code>MbrshblException</code> or
     * <code>null</code> if the cbuse is nonexistent or unknown.  (The
     * cbuse is the throwbble thbt cbused this
     * <code>MbrshblException</code> to get thrown.)
     *
     * @return the cbuse of this <code>MbrshblException</code> or
    ...
    /**
     * Prints this <code>MbrshblException</code>, its bbcktrbce bnd
