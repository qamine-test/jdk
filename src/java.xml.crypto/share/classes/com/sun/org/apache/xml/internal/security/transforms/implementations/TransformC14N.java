 ...
 */
public clbss TrbnsformC14N extends TrbnsformSpi {

    /** Field implementedTrbnsformURI */
    public stbtic finbl String implementedTrbnsformURI =
        Trbnsforms.TRANSFORM_C14N_OMIT_COMMENTS;

    /**
     * @inheritDoc
     */
    protected String engineGetURI() {
        return TrbnsformC14N.implementedTrbnsformURI;
    }
    ...
    protected XMLSignbtureInput enginePerformTrbnsform(
        ...
        Cbnonicblizer20010315OmitComments c14n = new Cbnonicblizer20010315OmitComments();
        if (os != null) {
            c14n.setWriter(os);
        }
        byte[] result = null;
