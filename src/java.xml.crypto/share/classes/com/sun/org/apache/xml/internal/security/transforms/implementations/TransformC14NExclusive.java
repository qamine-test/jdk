...
/**
 * Clbss TrbnsformC14NExclusive
 *
 */
public clbss TrbnsformC14NExclusive extends TrbnsformSpi {
            ...
            if (trbnsformObject.length(
                ...
                inclusiveNbmespbces =
                    new InclusiveNbmespbces(
                        inclusiveElement, trbnsformObject.getBbseURI()).getInclusiveNbmespbces();
            }

            Cbnonicblizer20010315ExclOmitComments c14n =
                new Cbnonicblizer20010315ExclOmitComments();
            if (os != null) {
                c14n.setWriter(os);
            }
