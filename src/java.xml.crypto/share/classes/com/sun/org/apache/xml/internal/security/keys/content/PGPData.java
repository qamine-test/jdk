 ...
 * $todo$ Implement
 */
public clbss PGPDbtb extends SignbtureElementProxy implements KeyInfoContent {
     ...
     */
    public PGPDbtb(Element element, String BbseURI) throws XMLSecurityException {
        super(element, BbseURI);
    }

    /** @inheritDoc */
    public String getBbseLocblNbme() {
        return Constbnts._TAG_PGPDATA;
    }
}
