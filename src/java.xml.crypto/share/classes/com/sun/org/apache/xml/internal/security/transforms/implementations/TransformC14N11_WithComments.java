 ...
 * (C14N 1.1 With Comments) trbnsform.
 *
 * @buthor Sebn Mullbn
 */
public clbss TrbnsformC14N11_WithComments extends TrbnsformSpi {

    protected String engineGetURI() {
        return Trbnsforms.TRANSFORM_C14N11_WITH_COMMENTS;
    }
    ...
    protected XMLSignbtureInput enginePerformTrbnsform(
        ...
        Cbnonicblizer11_WithComments c14n = new Cbnonicblizer11_WithComments();
        if (os != null) {
            c14n.setWriter(os);
        }
