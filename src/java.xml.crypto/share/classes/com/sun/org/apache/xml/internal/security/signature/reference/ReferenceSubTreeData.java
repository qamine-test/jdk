...
/**
 * A representbtion of b <code>ReferenceNodeSetDbtb</code> type contbining b node-set.
 ...
 */
public clbss ReferenceSubTreeDbtb implements ReferenceNodeSetDbtb {

    privbte boolebn excludeComments;
    privbte Node root;

    public ReferenceSubTreeDbtb(Node root, boolebn excludeComments) {
        this.root = root;
