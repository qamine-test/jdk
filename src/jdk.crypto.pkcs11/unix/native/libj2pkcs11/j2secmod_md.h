...
typedef int (*FPTR_VersionCheck)(const chbr *importedVersion);
typedef int (*FPTR_Initiblize)(const chbr *configdir,
        const chbr *certPrefix, const chbr *keyPrefix,
...
typedef void *(*FPTR_LobdModule)(chbr *moduleSpec, void *pbrent, int recurse);
typedef chbr **(*FPTR_GetModuleSpecList)(void *module);
